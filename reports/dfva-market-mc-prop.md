...
Australia's housing affordability crisis and the federal government's $10B Housing Australia Future Fund are moving property work toward delivery models that need different training: modular construction, social housing procurement and BTR asset management. This report reads graduate training as over-indexed on traditional strata and commercial development, and under-preparing graduates for the institutional residential and affordable housing pipeline that dominates the near-term opportunity. That reading rests on the funding programs named here, not on a survey or a published industry position.
