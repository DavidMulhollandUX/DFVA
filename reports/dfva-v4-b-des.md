# DFVA v4 DURABILITY REPORT: Bachelor of Design (B-DES)
...
<!-- AUTHOR:S4 — condense reports/dfva-market-b-des.md into two tables: destination
...
<!-- AUTHOR:S5 — fill Implication and Cost per row from
     reports/dfva-v4-recommend-b-des.md. Options with costs, never directives. -->

| Item | Score | Implication | Cost | Sources |
| --- | --- | --- | --- | --- |
| C1 Distributed cognition & relational capability | 1/3 | TO BE AUTHORED | TO BE AUTHORED | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
