# DFVA MARKET INTELLIGENCE: Master of Environmental Law (MC-ENVLAW)
...
AI tools sold into Australian legal practice — Harvey, CoCounsel, Thomson Reuters AI — target junior document review and discovery. The environmental law applications are specific: processing large environmental impact assessments, modelling regulatory risk across jurisdictions, and flagging non-compliance in complex EIS documents. This report reads the effect as raising the floor rather than the ceiling, with routine volume work compressing while strategic advice, litigation judgement and negotiation stay human. No source consulted for this section surveys practitioners on where that line falls. On either reading, demand increases for graduates who can work with the tools rather than around them.
