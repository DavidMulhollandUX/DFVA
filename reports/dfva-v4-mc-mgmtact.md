...
| --- | --- | --- | --- |
| Financial Accounting, Corporate Reporting & Advisory | Graduate Accountant, Financial Analyst; later Senior Financial Accountant, Financial Controller | VERY HIGH (exposure 98.20) | AI ledger reconciliation auditing, multi-jurisdiction IFRS consolidation, complex financial synthesis |
| Audit, Assurance & Forensics | Audit Associate, Assurance Analyst; later Senior Audit Manager, Assurance Partner | HIGH (exposure 97.50) | Continuous algorithmic audit verification, forensic anomaly detection, ESG / sustainability assurance |
| Management Accounting & Commercial Advisory | Management Accountant, Cost Analyst; later Commercial Finance Director, Head of FP&A | HIGH (exposure 97.80) | Strategic decision modeling, predictive cost analytics, capital budgeting under market volatility |
| Taxation Advisory & Structural Compliance | Tax Consultant, Tax Analyst; later Senior Tax Manager, Head of Group Tax | VERY HIGH (exposure 98.40) | Algorithmic tax rule verification, cross-border transfer pricing audit, statutory dispute resolution |
...
**Panel A metadata.** Basis tier **exact** (measured), n = 73, 15 destination titles, 4 at medium mapping confidence. Index variant AIOE-2021; destination titles mapped to the published Felten index.
