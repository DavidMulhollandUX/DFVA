# DFVA v4 IMPROVEMENT PLAN: Master of Biomedical Science (MC-BMEDSC)
...
**Assessment date:** 2026-08-23 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-bmedsc.md
**Position basis:** Destination AI Exposure 82.09 (cognate basis) × Curriculum Adaptiveness 11/15 (v4.2 draft, sub-scale A) · Workplace practice 5/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
> the body.
>
> The exposure value is an **estimate**: it rests on a cognate basis (Bachelor of Biomedicine (Human Structure and ∪ Bachelor of Biomedicine (Neuroscience) ∪ Bachelor of Biomedicine (Pathology) ∪ Bachelor of Biomedicine (Pharmacology) ∪ Bachelor of Biomedicine (Physiology)), not on this program's own graduates. It is sound enough to say the destinations are highly exposed and not sound enough to rank this program against a peer on exposure alone — see [the estimated-basis methods note](../docs/dfva-panela-estimated-basis-methods.md).
...
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | TO BE AUTHORED | 3 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | TO BE AUTHORED | 4 |
| C4 Life-long learning & transfer | Adaptive | 3 / 3 | 0 | TO BE AUTHORED | 6 |
| C5 Inquiry & evidence generation | Adaptive | 3 / 3 | 0 | TO BE AUTHORED | 7 |
| **Adaptive capabilities** | **Adaptive** | **11 / 15** | **4** | — | — |
| W3 Work-situated learning | Workplace | 0 / 3 | 3 | TO BE AUTHORED | 1 |
| W1 Professional communication & conduct | Workplace | 2 / 3 | 1 | TO BE AUTHORED | 5 |
| W2 Authentic task design | Workplace | 3 / 3 | 0 | TO BE AUTHORED | 8 |
...
|---|---|---|---|---|
| W3 Work-situated learning | 0 → 1 | "Work-situated learning exists only as an elective, an optional internship, or an unassessed extracurricular or careers activity." | TO BE AUTHORED | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
...
<!-- AUTHOR:S3 — one row per lever, evidence drawn from reports/dfva-market-mc-bmedsc.md.
...
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | The program documents a coherent, highly structured specialist core with staged methodological and empirical depth: 25 credit points of compulsory Year 1 subjects (methods/integrity and enterprise translation), 125 credit points of compulsory Research Project subjects (staged across Project A pilot/literature review to Project B 20,000-word thesis), and required discipline/industry elective distributions. | TO BE AUTHORED | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | Assessments require substantial decision-making under uncertainty: the compulsory 125-point Research Project requires students to design experiments, handle empirical data and experimental unpredictability under staged supervisor assessment, and defend experimental design in Conversational Questions (BIOM40001); HLTH90021 assesses a commercial translation strategy and pitch navigating real-world regulatory and economic constraints. | TO BE AUTHORED | [16] |
...
|---|---|---|---|---|---|---|
| P1 | W3 | 0 | 1 | +1 workplace | 11 / 15 | 6 / 9 |
| P2 | W3 | 1 | 2 | +1 workplace | 11 / 15 | 7 / 9 |
| P3 | W3 | 2 | 3 | +1 workplace | 11 / 15 | 8 / 9 |
| P4 | C3 | 1 | 2 | +1 adaptive | 12 / 15 | 8 / 9 |
| P5 | C3 | 2 | 3 | +1 adaptive | 13 / 15 | 8 / 9 |
| P6 | C1 | 2 | 3 | +1 adaptive | 14 / 15 | 8 / 9 |
| P7 | C2 | 2 | 3 | +1 adaptive | 15 / 15 | 8 / 9 |
| P8 | W1 | 2 | 3 | +1 workplace | 15 / 15 | 9 / 9 |
