...
The average complexity of medically compromised patients requiring specialist dental care is rising, driven by ageing, polypharmacy, increasing cancer survivorship and organ transplant volumes. No source consulted for this section quantifies that rise, so the direction is this report's reading. Its consequence for training is not: complexity of this kind moves specialist practice toward interdisciplinary hospital and community health settings, which are systematically underrepresented in private-practice-oriented specialist training.

**Theme 6 — Student Debt and Return on Investment Concerns**
MCD program fees above $150,000 weigh against the expected specialist practice income trajectory. This report reads the return as positive but back-loaded, with income inflection at years 3–5 after specialist registration, when a practitioner typically moves from employee to principal or owner in a specialist practice. Nothing consulted here models the payback period; the timing is an inference from the practice-ownership pattern, not a measurement. It remains a recruitment-and-retention framing issue for programs.
