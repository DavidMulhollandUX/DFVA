# DFVA v4 DURABILITY REPORT: Master of Veterinary Science (872BB)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/872bb (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 7 pages captured
**Course Director:** Sebastien Bauquier
...
> **This program is outside the v3.1 registry, but not outside Panel A.** Master of Veterinary Science
...
> a cognate program basis (Doctor of Veterinary Medicine). What such a
...
**Destination AI Exposure: 62.40.** Destination titles are mapped to the published Felten AI Occupational Exposure (AIOE) index and rescaled 0–100 by the Panel A procedure used for every other program; 1 of 12 titles carry medium mapping confidence. Basis: borrowed from a related program's alumni record — Doctor of Veterinary Medicine (n = 275, 12 titles); an estimate, not this program's own graduates. The portfolio median is 90.9, so this program sits **at or below** it.
...
- **G1 Disciplinary foundation:** PASS — PASS on the 'coherent specialist core with progressive technical or methodological depth' condition. Both components are compulsory and mutually tied ('A pass is required in both components'; the practicum 'must be clearly related to the research project'), the practicum is located in a named veterinary clinical specialty (small animal medicine and surgery, anaesthesia, equine medicine and surgery, diagnostic imaging, dairy medicine, pathology), and depth is staged through candidature milestones — probationary period, confirmation report and seminar, completion seminar — ending in external examination of a 30,000-word thesis. This is not generic or interchangeable content.
- **G2 Decision-making under uncertainty:** PASS — PASS on the 'live projects with real uncertainty and accountability' condition rather than the trade-off-decision condition. The required thesis is a live research project whose outcome is not known in advance — it must 'make an independent contribution to existing scholarship' — conducted through experiments or analysis of clinical cases and held accountable by examination by two external examiners plus staged candidature review. The practicum places candidates in the clinical investigation and management of real cases under senior supervision. This is not recall or scripted response, although the practicum's own assessment instrument (an unspecified three-hour written examination) carries no documented uncertainty of its own.

## 4. MARKET EVIDENCE — Basis: reported

The market intelligence gathered for this program indicates strong demand across veterinary specialist referral hospitals (U-Vet, MVSC, ARH, SASH), university veterinary clinical departments, and diagnostic pathology laboratories, accompanied by the integration of AI imaging triage tools (SignalPET, Vetology AI) where specialist surgical intervention, complex patient work-ups, and empathetic client communications remain non-delegable human professional responsibilities under Veterinary Practitioners Board of Victoria (VPBV) and Australian and New Zealand College of Veterinary Scientists (ANZCVS) benchmarks.

### Destination Job Families

| Job family | Entry titles | AI substitution pressure | Skills rising in that family |
| --- | --- | --- | --- |
| Veterinary Referral & Specialist Clinical Practice | Veterinary Clinical Resident, Referral Clinician; later Registered Veterinary Specialist (ANZCVS), Clinical Director | VERY LOW | Advanced surgical/diagnostic procedures, AI imaging verification, complex case mgmt |
| Academic & Translational Veterinary Research | Clinical Postdoctoral Researcher, Lecturer; later Associate Professor, Head of Clinical Research Lab | LOW | Multi-omics clinical trials, grant leadership, empirical veterinary science |
| Veterinary Pathology & Diagnostic Services | Clinical Pathology Resident, Diagnostic Pathologist; later Senior Veterinary Pathologist, Diagnostic Lab Director | LOW | Digital pathology scanning, AI image screening oversight, biopsy interpretation |
| Animal Health Biosecurity & Regulatory Science | Veterinary Biosecurity Officer, Technical Specialist; later Principal Veterinary Officer (DAFF / Agriculture Victoria) | LOW | Epidemiological surveillance, zoonotic disease risk modeling, emergency response |

**Exposure basis declaration.** Destination AI exposure is **44.92** (exact basis derived from Veterinary Science / Clinical Specialist destinations), sitting substantially **below** the portfolio median of 90.9.
...
and the score deltas are in the [improvement plan](dfva-v4-recommend-872bb.md); rows
below are ordered by headroom, which is not the plan's P-lever order.

| Item | Score | Implication | Cost | Sources |
| --- | --- | --- | --- | --- |
| C1 Distributed cognition & relational capability | 1/3 | Introduce an assessed collaborative hospital case-management simulation in VETS70002 with individual clinical accountability; require candidate teams to submit an assessed protocol defining work allocation across specialists, nurses, and AI imaging tools. | Veterinary clinical seminar moderation time. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 1/3 | Introduce a structured peer critique task in VETS70002 where candidates evaluate peer diagnostic case work-ups against ANZCVS specialist criteria; require candidates to maintain an assessed clinical decision log documenting tool overrides. | Peer review rubric design and calibration. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1/3 | Introduce an assessed module in core clinical veterinary science on veterinary AI imaging platforms (e.g. SignalPET), algorithmic false-positive risks, and patient data privacy; introduce an assessed veterinary AI governance audit. | Software tool licensing and syllabus updates. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W1 Professional communication & conduct | 1/3 | Introduce a mandatory clinical case presentation and specialist treatment plan in VETS70002; mandate that the case presentation is evaluated by external ANZCVS veterinary specialists and hospital directors with assessed conduct criteria. | External practitioner honoraria and scheduling. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 1/3 | Introduce an authentic veterinary clinical task reproducing a complete patient diagnostic work-up and surgical/therapeutic management plan end to end; establish an authentic assessment spine. | Clinical assessment redesign. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| C4 Life-long learning & transfer | 2/3 | Require candidates to independently scope and defend their clinical research proposal and learning goals, identifying their own scholarship gaps. | Research supervision and syllabus redesign. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W3 Work-situated learning | 2/3 | For the hospital practicum, institute a mandatory clinical case logbook with regular host hospital sign-offs and structured reflection on clinical decision-making. | Practicum coordination and host hospital liaison. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
...
**Panel A metadata.** Basis tier **cognate** (cognate program), n = 275, 12 destination titles, 1 at medium mapping confidence. Index variant AIOE-2021; destination titles mapped to the published Felten index. Basis note: Veterinary graduate program; DVM is the discipline-matched record.

**Panel C provenance.** Scored from the 2026 handbook capture (7 pages) and verified on 2026-08-16: adversarial refutation of every level-3 score and every gate PASS (run), verbatim evidence check (run), and the construct-boundary pass.
