...
var __dsPreview = (() => {
  ...
  function Variants() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: { display: "flex", gap: 12, flexWrap: "wrap" }, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.Button, { variant: "primary", children: "Request an assessment" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.Button, { variant: "accent", children: "View rating" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.Button, { variant: "secondary", children: "Methodology" }),
  ...
  function Disabled() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ds_exports.Button, { variant: "accent", disabled: true, children: "View rating" });
  }
