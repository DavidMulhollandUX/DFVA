...
After every full DFVA assessment, append a **COMPASS UI Data Block** as a fenced TypeScript code block. This is the exact object to paste into `compass/app/src/compass/sharedProgramData.ts` to make the report appear in the COMPASS interface with correct visualisations.
...
```typescript
// Paste into PROGRAMS array in compass/app/src/compass/sharedProgramData.ts
{
...
The COMPASS frontend (`compass/app/src/compass/ReportDetailPage.tsx`) auto-detects markdown patterns and renders them as polished UI components. All report content MUST follow these patterns to get correct visual treatment.
