...
export const brand = {
  ...
  legalNote: "A University of Melbourne research project. Independence structure in development.",
  confidentialityNote: "All assessments are confidential to the commissioning institution. No program score is published without explicit consent.",
} as const;
