...
export interface ProgramReport {
  ...
  handbookUrl?: string;
  /**
   * Source-evidence confidence. "low" = scored from a thin capture (the research
   * doctorates' handbook pages are one-paragraph descriptions, median ~390 chars,
   * vs ~19k for coursework programs); the report prose carries a matching
   * "Confidence: Low" note. Absent = full handbook capture.
   */
