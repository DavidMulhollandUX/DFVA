 ...
 */
export function normalizeSeekCategory(seekCategory: string | null | undefined): string {
 ...
 * Case-insensitive. Returns "Other" for unknown categories.
 */
export function normalizeAdzunaCategory(adzunaCategory: string | null | undefined): string {
 ...
 */
export function mapJsaIviToField(iviOccupationGroup: string | null | undefined): string {
