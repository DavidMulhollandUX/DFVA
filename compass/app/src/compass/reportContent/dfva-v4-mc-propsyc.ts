...
const content = {
  title: "Master of Professional Psychology (MC-PROPSYC) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Professional Psychology (MC-PROPSYC)
...
| C3 Digital & AI literacy, including governance [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) | 1 | Not level 0 — digital content is present in core units: statistical software for model-fitting in PSYC40005, and telehealth service delivery training in PSYC90116 with an assessed written report (15%). But every instance is tool operation/training, the operational level the anchor caps at 1. Not level 2: no core unit in the extract addresses AI capabilities AND limitations/ethics — the word 'AI' and any generative-AI content are absent from the whole extract, and the telehealth report's description says only that it addresses 'aspects of' delivery, with no documented treatment of limits. The Ethics subject's privacy and legal-framework content attaches to research and professional conduct, not to digital or AI systems, so it does not lift the item. |
| C4 Life-long learning & transfer [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) | 3 | Level 3 anchor is met by the self-scoped research-project route, with assessment evidence as R2 requires: PSYC90112 is a compulsory 25-point year-long subject in which the student investigates a substantive individual research question of their own choosing, and the assessment sequence opens with a student-written proposal (pass/fail hurdle) before the 6000-word report. The course structure documents the progression requirement explicitly (compulsory sequence, first-year achievement gating second year). Level 2 is independently satisfied by assessments on unseen case material, so the level-3 finding rests on the required self-scoped project rather than on transfer alone. Placement evidence is excluded from C4 by the one-construct-one-home rule. |
...
- **G1 Disciplinary foundation:** PASS — An all-compulsory specialist core taken in a mandated sequence with a staged progression rule, plus an accredited pathway — every one of the three PASS routes the gate names. No generic or interchangeable content.
- **G2 Decision-making under uncertainty:** PASS — Assessment requires defended trade-off decisions rather than recall or scripted response: intervention and treatment plans must be justified from a case formulation, the risk-assessment task requires a written rationale referenced to established literature, and the patient case-work component requires assessment, diagnosis and intervention planning under real clinical uncertainty. The assessed outcomes make the trade-off explicit — determining when more complex interventions are appropriate, and modifying interventions as the formulation evolves.

## 4. MARKET EVIDENCE — Basis: reported

The market intelligence gathered for this program indicates strong demand across Psychology Board of Australia (PsyBA / AHPRA) provisional registration pathways, community mental health networks, NDIS providers, and hospital networks, accompanied by growing clinical integration of telehealth delivery and digital intake platforms where live diagnostic interviewing, suicide risk formulation, and real-time therapeutic alliance remain exclusive human clinician responsibilities under Australian Psychology Accreditation Council (APAC) standards.
...
| --- | --- | --- | --- | --- |
| C3 Digital & AI literacy, including governance | 1/3 | Introduce an assessed module in core professional practice on clinical AI documentation tools, telehealth video-therapy ethics, and automated psychometric testing limits; introduce an assessed clinical AI governance audit. | Software tool licensing and syllabus updates. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C1 Distributed cognition & relational capability | 2/3 | In clinical case management seminars, require candidate teams to develop an interprofessional care plan explicitly allocating tasks between clinical team members and digital triage/monitoring systems. | Case seminar facilitation and interprofessional moderation time. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2/3 | Require candidates to maintain an assessed clinical decision log documenting and justifying decisions to override automated psychometric scoring algorithms or AI draft notes. | Logbook rubric calibration for clinical supervisors. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C5 Inquiry & evidence generation | 2/3 | Require all candidates in the minor research thesis to conduct a primary empirical clinical investigation with methodology defended in a formal oral thesis defence. | Oral thesis defence scheduling and examiner panel time. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2/3 | Mandate that the final diagnostic interview demonstration is judged by external PsyBA registered clinical supervisors with explicit professional conduct marking rubrics. | External registered psychologist honoraria and scheduling. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W3 Work-situated learning | 2/3 | Disaggregate and extend direct workplace client contact hours with required host supervisor reports and assessed structured reflection on professional practice. | Clinical placement liaison and supervisor coordination. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
