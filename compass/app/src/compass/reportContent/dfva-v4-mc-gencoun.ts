...
const content = {
  title: "Master of Genetic Counselling (MC-GENCOUN) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Genetic Counselling (MC-GENCOUN)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/mc-gencoun (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 31 pages captured
...
- **G1 Disciplinary foundation:** PASS — An all-compulsory specialist core plus an accredited sequence: the whole 200 credit points are compulsory subjects, the award is the accredited professional qualification for HGSA certification, and depth is staged — GENE90001 into GENE90002 into Advanced Clinical Genomics 1 and 2, foundational into advanced counselling practice, and research methods into two research-project subjects — with a documented 70% progression requirement gating entry to the second year. No generic or interchangeable content substitutes for the disciplinary core.
- **G2 Decision-making under uncertainty:** PASS — Assessment goes well beyond recall or scripted response. Core outcomes require defended clinical trade-off judgements under acknowledged limits — interpreting genomic reports into clinical recommendations, appraising care recommendations, and reasoning about the limits of integrating variant analysis into routine care — and these are exercised in live clinical placements with genuine uncertainty and accountability to a supervisor and host service, assessed through long case reports and supervisor assessment. Counselling assessment likewise requires managing emotionally charged, multi-party interactions with no scripted answer.

## 4. MARKET EVIDENCE — Basis: reported

The market intelligence gathered for this program indicates sustained demand across public hospital Familial Cancer Clinics (Peter MacCallum Cancer Centre, RMH, Monash Health), prenatal and reproductive genetics services (VCGS), and private diagnostic laboratories, accompanied by rapid adoption of automated variant curation platforms (Fabric Genomics, Franklin by Genoox) where non-delegable clinical interpretation, VUS risk communication, and empathetic patient counselling remain exclusive human responsibilities under Human Genetics Society of Australasia (HGSA) certification standards.
...
| --- | --- | --- | --- | --- |
| C3 Digital & AI literacy, including governance | 0/3 | Introduce an assessed module in Advanced Clinical Genomics on AI-assisted variant classification platforms, algorithmic error modes in VUS interpretation, and HGSA ethical standards; introduce an assessed genomic AI governance audit. | Software licensing for clinical variant curation suites and syllabus updates. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C1 Distributed cognition & relational capability | 2/3 | In the multidisciplinary case conference assessment, require student teams to document a protocol allocating clinical tasks between genetic counsellor, medical geneticist, and automated variant curation pipelines. | Case conference workshop moderation time. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2/3 | In the Clinical Practice placement portfolio, require students to document and defend reliance decisions when overriding AI-suggested variant pathogenicities or automated pedigree risk classifications. | Placement portfolio rubric development for AI override logs. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| W1 Professional communication & conduct | 2/3 | Formalize the simulated counselling session in WELF90004/WELF90010 to be delivered before simulated patients and evaluated by practising HGSA genetic counsellors with explicit conduct rubrics. | Simulated patient actor recruitment and HGSA marker calibration. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
