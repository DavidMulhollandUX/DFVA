...
const content = {
  title: "Doctor of Medicine (MC-DMED) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Doctor of Medicine (MC-DMED)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/mc-dmed (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 35 pages captured
**Course Director:** Leonie Griffiths
...
- **G2 Decision-making under uncertainty:** PASS — Assessment is not recall or scripted response only. Situational judgement tests and the mini clinical encounter/OSCE hurdle require judgements made under uncertainty with accountability, and the Year 4 placement-based capstone places students in live clinical work as trainee junior doctors. The course-level outcome names prioritising a differential diagnosis and informing a management plan - a defended trade-off decision - and the assessment tasks above are where that is examined, so the gate does not rest on an outcome statement alone.

## 4. MARKET EVIDENCE — Basis: reported

The market intelligence gathered for this program indicates near-universal graduate employment driven by statutory health department internship matching (PMCV) across major public hospital networks (Melbourne Health, Monash Health, Austin Health, Alfred Health) and persistent nationwide shortages in General Practice and rural medicine, alongside the rapid integration of ambient AI clinical documentation tools and diagnostic clinical decision support systems (CDSS).
...
| --- | --- | --- | --- | --- |
| C3 Digital & AI literacy, including governance | 1/3 | Introduce an assessed module in Principles of Clinical Practice on clinical AI decision support, ambient documentation verification, and diagnostic bias; introduce an assessed clinical AI governance audit. | Developing simulated clinical AI cases and training clinical tutors without displacing core pathology hours. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 1/3 | Require all MD students to complete an assessed clinical inquiry or clinical audit involving primary patient data collection in the core, with an examined oral viva defence before hospital consultant examiners. | Hospital ethics approvals, audit registry access, and consultant viva panel scheduling. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C1 Distributed cognition & relational capability | 2/3 | In clinical simulation or ward placements, require student teams to document a protocol allocating tasks between medical officers, nursing staff, and automated clinical triage/EMR alerts. | Designing interprofessional human-and-AI team rubrics. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2/3 | In the clinical placement ePortfolio, require an assessed clinical reliance log where students defend overriding automated clinical decision-support flags or ambient AI summaries. | Clinical educator moderation of student clinical reliance logs. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C4 Life-long learning & transfer | 2/3 | In the Year 4 transition-to-practice ePortfolio, require an assessed learning plan identifying personal clinical knowledge gaps and mapping a post-internship CPD roadmap. | Structured post-graduate CPD gap-analysis rubrics. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W1 Professional communication & conduct | 2/3 | Formalize consultant-graded clinical encounters and longitudinal patient communication rubrics across all four years with explicit professional conduct hurdles. | Coordinating hospital consultant examiners across health networks. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2/3 | Ensure authentic bedside clinical examinations and emergency simulation stations form the assessed spine across every stage of the 4-year degree. | Simulation centre operations and standardized patient recruitment. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
