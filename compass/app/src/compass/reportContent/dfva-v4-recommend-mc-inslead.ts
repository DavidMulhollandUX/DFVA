...
const content = {
  title: "Master of Instructional Leadership (MC-INSLEAD) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Instructional Leadership (MC-INSLEAD)
...
**Assessment date:** 2026-08-24 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-inslead.md
**Position basis:** Destination AI Exposure 92.27 (exact basis) × Curriculum Adaptiveness 10/15 (v4.2 draft, sub-scale A) · Workplace practice 6/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
|---|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 2 | AITSL and AERO mandate critical evaluation of educational AI tools, diagnostic platforms, and student data privacy | 1 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Modern school leadership requires structured task allocation between instructional teams and AI analytics/lesson drafting tools | 2 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Fiduciary and pedagogical responsibility demands documented justification when overriding automated diagnostic scores or AI lesson plans | 3 |
| C5 Inquiry & evidence generation | Adaptive | 2 / 3 | 1 | Evidence-based school turnaround requires rigorous empirical practitioner research with oral defense of methodology | 4 |
| W1 Professional communication & conduct | Workplace | 2 / 3 | 1 | School leaders must defend reform initiatives before external school councils, regional superintendents, and community bodies | 5 |
| W2 Authentic task design | Workplace | 2 / 3 | 1 | Real-world school review tasks carry live community volatility, staff resistance, and policy compliance constraints | 6 |
| W3 Work-situated learning | Workplace | 2 / 3 | 1 | Advanced school leadership development requires documented accountability to external school governing boards and systemic authorities | 7 |
| C4 Life-long learning & transfer | Adaptive | 3 / 3 | 0 | Meets maximum anchor through assessed self-capability gap analysis in EDUC90753 and self-scoped practitioner inquiry in EDUC90752 | 8 |
...
|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Embed an assessed module in core EDUC90755/EDUC90754 evaluating generative AI capabilities, automated rubric generation risks, and student data privacy limits | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Introduce an assessed School AI Governance Audit in EDUC90754/EDUC90751 analyzing algorithmic bias in standardized testing, student data privacy compliance, and school AI policies | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | Require team data projects in EDUC90755 to submit an assessed Human-AI Collaboration Charter detailing task allocation between instructional leaders and automated analytics tools | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | Implement an assessed 'AI Curriculum Tool Reliance and Override Log' in EDUC90753/EDUC90754 where leaders document and justify overrides of automated lesson generators or diagnostic scores | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C5 Inquiry & evidence generation | 2 → 3 | "A substantial project generating primary evidence is REQUIRED (not one route among several), with methodology defended under scrutiny (viva, defence, or staged supervised review)." | Structure the practitioner research presentation in EDUC90752 as a formal oral viva defense of empirical methodology before faculty and school leadership panels | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2 → 3 | "Professional communication is assessed repeatedly and progressively across the program AND at least one core assessment is delivered to, or judged by, a real external audience or practitioner (industry panel, client, patient or simulated patient, public exhibition), with professional conduct or accountability explicitly among the assessed criteria." | Mandate that school improvement research presentations in EDUC90752 are evaluated by an external panel of practicing school principals and regional education directors | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2 → 3 | "Such tasks are the program's assessment spine rather than a single instance (a capstone plus earlier scaffolding, or at least one per stage) AND at least one carries a genuine constraint of practice — an ambiguous or externally supplied problem, real resource/time limits, a consequential audience, or the profession's own standards of performance." | Structure the core case-study assessment in EDUC90751 around externally supplied, ambiguous school review scenarios with real community and resource constraints | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| W3 Work-situated learning | 2 → 3 | "Substantial required work-situated learning: an extended placement or practicum, or a sequence of them, in the core, supervised by a practitioner, assessed, with accountability to the host and structured reflection on professional practice — OR, for a cohort documented as already practising, a required sequence of assessed own-practice activity with structured reflection and documented accountability to workplace stakeholders (trainees, patients, clients or employer)." | Require capstone practitioner research in EDUC90752 to include documented formal accountability to school governing bodies (School Council, Board, or Department of Education) with evaluated stakeholder feedback | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C3 | Proliferation of generative AI lesson planners and student diagnostic tools requires explicit training in algorithmic limits and data ethics | Section 1, Section 3 (AITSL & AERO Guidelines) | HIGH |
| P2 | C3 | National and state education policies mandate school leaders implement robust AI governance, equity safeguards, and student privacy controls | Section 1, Section 3 (ACARA / Dept of Education) | HIGH |
| P3 | C1 | Industry standards (AITSL Standards for Principals) require collaborative instructional leadership dividing work between human mentors and digital tools | Section 1, Section 3 | HIGH |
| P4 | C2 | Peer-reviewed research (*Educational Management Administration & Leadership* Jan 2025) highlights evaluative judgement is vital to override flawed automated assessments | Section 3, Section 4 | HIGH |
| P5 | C5 | Academic research (*Australian Educational Researcher* 2024) proves evidence-based school reform requires empirical practitioner inquiry with oral defense | Section 3, Section 4 | HIGH |
| P6 | W1 | School governance bodies demand executive leaders capable of defending pedagogical reforms before critical parent and department panels | Section 2, Section 4 | HIGH |
| P7 | W2 | Authentic school turnaround cases with live community and union constraints reflect the true operational challenges of school principalship | Section 2, Section 4 | HIGH |
| P8 | W3 | Professional leadership standards (AITSL) mandate documented accountability to school councils and systemic authorities for leadership actions | Section 2, Section 4 | HIGH |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C3 | Introduce an assessed module in core EDUC90755/EDUC90754 evaluating generative AI lesson generators and student data privacy risks | C3 Level 2 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727) |
| P2 | C1 | Add an assessed Human-AI Collaborative Workflow Charter to the group student data project in EDUC90755 | C1 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022) |
| P3 | C2 | Implement an assessed AI Curriculum Tool Reliance and Override Log in EDUC90753 Leading Learning and Teaching | C2 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P4 | C3 | Embed an assessed School AI Governance Audit assignment in core EDUC90754/EDUC90751 | C3 Level 3 | Medium | Term 2 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P5 | W1 | Mandate external panels of practicing principals and regional superintendents to judge practitioner presentations in EDUC90752 | W1 Level 3 | Medium | Term 2 | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined) |
| P6 | W2 | Partner with school networks to supply live, ambiguous school turnaround briefs with real community constraints | W2 Level 3 | Medium | Term 2 | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| P7 | C5 | Implement a formal oral viva defense for the 4250-word empirical practitioner research project in EDUC90752 | C5 Level 3 | Medium | Term 2 | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| P8 | W3 | Require capstone practitioner research in EDUC90752 to include documented formal accountability and briefings to school councils | W3 Level 3 | High | Term 2 | [[19]](https://www.legislation.gov.au/F2021L00488)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | PASS condition is met: the program documents 50 credit points of compulsory specialist subjects plus a 50-point option — either the sequenced capstone (EDUC90750, EDUC90786, EDUC90752) with one Master of Education elective, or the research option (EDUC90419 Education Research Methodology and EDUC91197 Research Project in Education) — aligned to the AITSL National Professional Standard for Principals. Coherent, rigorous disciplinary educational leadership sequence. | Any curriculum redesign must preserve the core focus on evidence-based pedagogical leadership and the science of learning without diluting research foundations. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | PASS condition is met: assessment requires complex strategic and pedagogical trade-off decisions under school and community uncertainty — students implement an intervention in their own setting and document planning and implementation decisions (EDUC90752), explore alternative rival hypotheses about impact (EDUC90755), and discuss how within-school assessment practices can be strengthened (EDUC90754). | Interventions must maintain authentic, complex school leadership case analyses and intervention designs rather than shifting to standardized testing. | [16] |
...
|---|---|---|---|---|---|---|
| P1 | C3 | 1 | 2 | +1 adaptive | 11 / 15 | 6 / 9 |
| P2 | C1 | 2 | 3 | +1 adaptive | 12 / 15 | 6 / 9 |
| P3 | C2 | 2 | 3 | +1 adaptive | 13 / 15 | 6 / 9 |
| P4 | C3 | 2 | 3 | +1 adaptive | 14 / 15 | 6 / 9 |
| P5 | W1 | 2 | 3 | +1 workplace | 14 / 15 | 7 / 9 |
| P6 | W2 | 2 | 3 | +1 workplace | 14 / 15 | 8 / 9 |
| P7 | C5 | 2 | 3 | +1 adaptive | 15 / 15 | 8 / 9 |
| P8 | W3 | 2 | 3 | +1 workplace | 15 / 15 | 9 / 9 |
