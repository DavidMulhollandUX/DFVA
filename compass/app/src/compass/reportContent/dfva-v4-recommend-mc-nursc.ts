...
const content = {
  title: "Master of Nursing Science (MC-NURSC) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Nursing Science (MC-NURSC)
...
**Assessment date:** 2026-08-15 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-nursc.md
**Position basis:** Destination AI Exposure 45.02 (exact basis) × Curriculum Adaptiveness 8/15 (v4.2 draft, sub-scale A) · Workplace practice 8/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
Operating in an exceptionally low AI exposure domain (**45.02**, far below the portfolio median of 90.9) due to the physical and relational irreducibility of direct bedside patient care, the program achieves world-class Workplace Practice (**8 / 9**) while exhibiting targeted headroom on Adaptiveness (**8 / 15**). Workplace practice is a national benchmark: W2 (3/3) and W3 (3/3) score maximum levels via 920 hours of mandatory hospital placements, ANSAT clinical evaluations, hurdle-gated OSCEs, and simulated resuscitation labs. The adaptiveness score is supported by assessed peer review and longitudinal e-portfolios (C2: 2/3), group projects with individual reflection (C1: 2/3), and novel case studies (C4: 2/3), but C3 (1/3) is held at tool operation (basic EMR use without assessed clinical AI governance) and C5 (1/3) terminates in a written research proposal without assessed primary empirical data collection.

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 2 | Direct — Market §2 Signal 2 and §3 Theme 1 document rapid deployment of AI-assisted Clinical Decision Support Systems (CDSS) and Epic/Cerner EMRs; nurses must audit algorithmic alerts and manage digital health privacy. | 1 |
| C5 Inquiry & evidence generation | Adaptive | 1 / 3 | 2 | Direct — Market §1 Job Family 5 highlights expanding clinical trial coordination; research methods unit assesses a proposal without primary empirical clinical data collection. | 2 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Direct — Interprofessional healthcare workflows require nurses to coordinate care across clinicians, allied health, and automated diagnostic triage tools. | 3 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Direct — Market §3 Theme 1 underlines that nurses must maintain independent clinical judgement to audit and override automated CDSS recommendations. | 4 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Direct — Transfer is assessed via complex clinical case variations, but the core lacks a self-scoped inquiry project. | 5 |
| W1 Professional communication & conduct | Workplace | 2 / 3 | 1 | Direct — Core assesses clinical communication in labs and placements, but lacks an external standardised patient exam with explicit conduct criteria homed in W1. | 6 |
...
|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Add an assessed module in core acute nursing coursework analyzing AI clinical decision support tools, diagnostic alert limits, and digital patient privacy ethics. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Introduce an assessed clinical AI governance audit: students critique algorithmic triage tools and clinical decision support systems against NMBA statutory accountability standards. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 1 → 2 | "Students design and conduct an inquiry with methodology selection and data collection, assessed." | In the research methods subject, require students to conduct a primary clinical audit or ward-based empirical data collection alongside methodology selection. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C5 Inquiry & evidence generation | 2 → 3 | "A substantial project generating primary evidence is REQUIRED (not one route among several), with methodology defended under scrutiny (viva, defence, or staged supervised review)." | Mandate a substantial primary clinical quality-improvement project with an examined oral viva defence before hospital clinical nurse consultants. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | In simulated resuscitation or acute care tasks, assess student clinical teams documenting role and tool allocations between nurses, doctors, allied health, and digital EMR/CDSS systems. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | Attach an assessed Clinical Decision Support reliance and override log to acute simulation tasks where students defend overriding automated clinical alerts. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C4 Life-long learning & transfer | 2 → 3 | "The program documents structured progression toward independent learning: a self-scoped capstone or research project, or assessed identification of one's own knowledge gaps together with the plan to close them." | In the capstone e-portfolio, require an assessed continuing professional development plan identifying clinical specialty gaps and mapping a structured post-registration learning pathway. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W1 Professional communication & conduct | 2 → 3 | "Professional communication is assessed repeatedly and progressively across the program AND at least one core assessment is delivered to, or judged by, a real external audience or practitioner (industry panel, client, patient or simulated patient, public exhibition), with professional conduct or accountability explicitly among the assessed criteria." | In the clinical communication OSCE, formalize the inclusion of simulated patient actors and external clinical nurse educators with assessed professional conduct criteria. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 3 → 3 | "Such tasks are the program's assessment spine rather than a single instance (a capstone plus earlier scaffolding, or at least one per stage) AND at least one carries a genuine constraint of practice — an ambiguous or externally supplied problem, real resource/time limits, a consequential audience, or the profession's own standards of performance." | None — no intervention proposed and none needed. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| W3 Work-situated learning | 3 → 3 | "Substantial required work-situated learning: an extended placement or practicum, or a sequence of them, in the core, supervised by a practitioner, assessed, with accountability to the host and structured reflection on professional practice — OR, for a cohort documented as already practising, a required sequence of assessed own-practice activity with structured reflection and documented accountability to workplace stakeholders (trainees, patients, clients or employer)." | None — no intervention proposed and none needed. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C3 | Hospital EMRs (Epic/Cerner) and automated CDSS require nurses to critically evaluate algorithmic recommendations and safeguard patient data privacy. | §2 Signal 2; §3 Theme 1 | HIGH (ADHA & ACN reports) |
| P2 | C2 | Clinical accountability mandates that registered nurses physically audit and override automated CDSS alerts when patient signs dictate. | §3 Theme 1; §4 rising skills | HIGH (clinical safety standards) |
| P3 | W1 | Safe acute patient transitions depend on rigorous clinical communication (ISBAR) evaluated against professional conduct standards. | §1 Job Family 1; §3 Theme 2 | HIGH (ANMAC accreditation criteria) |
| P4 | C5 | Hospital clinical nurse specialists must conduct empirical quality audits and appraise clinical research evidence at the bedside. | §1 Job Family 5; §3 Theme 3 | HIGH (clinical research benchmarks) |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C3 | Add an assessed module on clinical AI and CDSS limits in acute nursing coursework | C3 level 2 (capabilities and limits discussed/assessed) | Low | Year 1 Term 1; syllabus update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P2 | C2 | Attach an assessed CDSS reliance and override log to acute simulation tasks | C2 level 3 (reliance decisions justified) | Low | Year 1 Term 2; task brief update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P3 | W1 | Formalize simulated patient actors and external educator grading in clinical OSCEs | W1 level 3 (external audience & conduct criteria) | Low–Medium | Year 2 Term 1; OSCE rubric update | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| P4 | C5 | Require a primary clinical quality audit in the research methods coursework | C5 level 2 (data collection assessed) | Medium | Year 2 Term 2; task redesign | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | The G1 PASS condition is met on all three of its alternative routes at once: an all-compulsory specialist core (13 compulsory subjects, 187.5 of 200 credit points, with only one elective), an accredited sequence (NMBA approval and ANMAC accreditation), and a staged prerequisite chain. | Redesign must preserve the 187.5-point accredited core sequence, maintaining full compliance with ANMAC Registered Nurse Accreditation Standards (2019). | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | Core assessment requires defended clinical trade-off decisions — prioritising nursing problems and planning interventions under a Clinical Decision Making Framework, individualising the decision-making process to a practice context, and modifying practice where clinically indicated. | Assessment tasks must preserve live clinical uncertainty, rapid patient deterioration response under pressure, and defended pharmacological intervention planning. | [16] |
...
|---|---|---|---|---|---|---|
| P1 | C3 | 1 | 2 | +1 adaptive | 9 / 15 | 8 / 9 |
| P2 | C2 | 2 | 3 | +1 adaptive | 10 / 15 | 8 / 9 |
| P3 | W1 | 2 | 3 | +1 workplace | 10 / 15 | 9 / 9 |
| P4 | C5 | 1 | 2 | +1 adaptive | 11 / 15 | 9 / 9 |
