...
const content = {
  title: "Master of Urban Design (MC-URBDES) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Urban Design (MC-URBDES)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/mc-urbdes (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 35 pages captured
**Course Director:** David Mah
...
- **G1 Disciplinary foundation:** PASS — An all-compulsory specialist core with staged technical depth: 125 points of named compulsory subjects plus a compulsory 25-point capstone, carrying a progressive studio sequence (Studio A introductory exercises → Studio B in-depth propositional work → Studio C integrating urban analytics and complex adaptive systems → Urban Design Thesis as culmination), with an external professional body accrediting the academic requirement. This is disciplinary identity, not interchangeable generic content.
- **G2 Decision-making under uncertainty:** PASS — Core assessment requires defended trade-off decisions and capstone-scale work under real uncertainty, not recall or scripted response: studio jury reviews require students to argue for propositions generated and tested against alternatives for complex metropolitan sites; the core economics subject frames its content as judgements about competing demands; and the core planning-law assignment requires a considered position formulated and communicated on the limitations of current statutory provisions. Recall assessment exists (the 40% open book examination, a 15% quiz) but does not exhaust the core.

## 4. MARKET EVIDENCE — Basis: reported

The market intelligence gathered for this program indicates strong demand across the Victorian Department of Transport and Planning (DTP), metropolitan councils (City of Melbourne, Merri-bek, Yarra), and major private multidisciplinary design consultancies (Urbis, Arup, Hansen Partnership, Architectus), accompanied by rapid adoption of AI-driven generative massing tools (Autodesk Forma, TestFit) and parametric solar/wind simulation engines where community consultation, First Nations cultural landscape co-design, and statutory planning liability remain core non-delegable human responsibilities under Planning Institute of Australia (PIA) and Australian Institute of Landscape Architects (AILA) professional standards.
...
| --- | --- | --- | --- | --- |
| C3 Digital & AI literacy, including governance | 1/3 | Introduce an assessed module in core studios on generative urban form algorithms (Autodesk Forma, TestFit), solar/wind simulation, and micro-climate validation limits; introduce an assessed urban AI governance audit. | Software licensing and syllabus update time. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W3 Work-situated learning | 1/3 | Embed a compulsory live-client precinct studio or supervised vocational placement into the degree core; formalize extended workplace internships with municipal planning departments. | Studio industry partnership coordination and placement oversight. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C1 Distributed cognition & relational capability | 2/3 | In core design studios, require multidisciplinary student teams to document a protocol allocating tasks between urban designers, GIS analysts, and generative massing algorithms. | Collaborative studio moderation and peer evaluation time. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2/3 | Require students in the capstone thesis to maintain an assessed design journal justifying decisions to adopt, modify, or reject AI-generated massing options and parametric environmental simulations. | Design journal rubric calibration and feedback moderation. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C4 Life-long learning & transfer | 2/3 | Restructure the capstone thesis so that all students independently scope their own urban design research problem and site investigation rather than selecting from pre-set studio briefs. | Capstone research proposal supervision and mentoring load. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 2/3 | Require all students to complete an empirical urban design thesis with primary site fieldwork and defend design methodology in an oral viva examination. | Viva examination scheduling and academic panel load. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2/3 | Formalize capstone exhibition juries to include external municipal planning officers and PIA practitioners with assessed professional conduct criteria. | External juror honoraria, scheduling, and assessment moderation. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
