...
const content = {
  title: "Master of Tax (742AB) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Tax (742AB)
...
> **This program is outside the v3.1 registry, but not outside Panel A.** Master of Tax
...
- **G1 Disciplinary foundation:** PASS — PASS on the accredited-sequence and staged-foundation limbs of the anchor rather than the all-compulsory-core limb. Content is unambiguously specialist tax law with a clear disciplinary identity — not generic or interchangeable — and the handbook documents an externally accredited introductory/advanced structure for Tax Practitioners Board registration, a foundation subject stated to underpin later tax subjects, and explicit progression advice that an integrative subject is best taken late in the course.
- **G2 Decision-making under uncertainty:** PASS — PASS on the 'defended trade-off decisions' limb, not the simulation/capstone limb. Assessed subjects require weighing competing solutions and reaching a defended conclusion, evaluating policy options against competing criteria, and distinguishing permissible planning from impermissible avoidance — judgement under genuine legal uncertainty rather than recall or scripted response. Assessment is by extended take-home examination, written assignment and in-class task rather than closed recall tests.

## 4. MARKET EVIDENCE — Basis: reported

The market intelligence gathered for this program indicates massive structural shifts across Big Four accounting firms, multinational corporate tax teams, revenue authorities (ATO, Treasury), and specialist tax dispute practices, driven by OECD Pillar Two / GloBE international tax architecture and aggressive AI deployment in automated compliance where complex transactional tax structuring, Part IVA anti-avoidance defense, and contentious tribunal advocacy remain non-delegable human professional responsibilities under Tax Practitioners Board (TPB) and Law Council of Australia (LCA) benchmarks.
...
| --- | --- | --- | --- | --- |
| C1 Distributed cognition & relational capability | 0/3 | Establish a compulsory core subject in Corporate Tax Planning assessing a collaborative corporate transaction structuring project with individual accountability; require candidate teams to submit an assessed protocol allocating cross-border analysis between tax counsel, accountants, and automated transfer pricing NLP tools. | Corporate tax seminar moderation time. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 0/3 | Introduce a structured peer critique task in the core where students evaluate draft client advice memos against TPB professional standards and ATO guidance; require candidates to maintain an assessed legal decision log documenting overrides of automated tax calculations or AI-generated statutory summaries. | Peer review rubric design and calibration. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| W3 Work-situated learning | 0/3 | For the practising tax cohort, establish an assessed own-practice tax planning portfolio with client/workplace accountability and structured reflection; introduce an optional tax clinic placement route. | Placement coordination and host organisation liaison. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C3 Digital & AI literacy, including governance | 1/3 | Introduce an assessed module in core tax law on tax AI platforms (e.g. Checkpoint Edge, iKnowConnect), automated return calculation boundaries, and TASA ethical obligations; introduce an assessed tax AI governance audit. | Software tool licensing and syllabus updates. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C4 Life-long learning & transfer | 1/3 | In core tax assessments, evaluate candidate advice across novel cross-border OECD Pillar Two restructuring; establish a required self-scoped taxation law capstone research project. | Capstone project supervision and syllabus redesign. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 1/3 | Introduce an assessed tax inquiry unit requiring students to select empirical tax policy methodologies; require all candidates to complete a primary empirical tax law inquiry or policy reform thesis. | Thesis viva scheduling and academic supervision. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 1/3 | Introduce a mandatory core client advice memorandum and ATO notice of objection; mandate that oral client tax pitches and ATO dispute negotiations are judged by external tax partners and ATO assistant commissioners. | External practitioner honoraria and scheduling. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 1/3 | Introduce an authentic tax task reproducing a complete private ruling application and Part IVA risk assessment end to end; establish an authentic task spine across all stages. | Course assessment spine redesign. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
...
**Ambiguities and construct-boundary notes** (12):
