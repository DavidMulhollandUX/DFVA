...
const content = {
  title: "Doctor of Veterinary Medicine (MC-DVETMED) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Doctor of Veterinary Medicine (MC-DVETMED)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/mc-dvetmed (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 35 pages captured
**Course Director:** Jennifer Carter
...
**Destination AI Exposure: 62.40.** Destination titles are mapped to the published Felten AI Occupational Exposure (AIOE) index and rescaled 0–100 by the Panel A procedure used for every other program. Basis: measured on the program's own alumni destination record (n = 275). The portfolio median is 90.9, so this program sits **at or below** it.
...
- **G1 Disciplinary foundation:** PASS — The gate's PASS condition is met on all three of its alternative routes. The core is all-compulsory ('All subjects in the Doctor of Veterinary Medicine course are core'), the sequence is externally accredited by three veterinary boards on a seven-year cycle, and the structure is staged with progressive depth — bioscience systems subjects in DVM1, pathology/microbiology/epidemiology in DVM2, species-based clinical subjects in DVM3, and a 100-point year-long final-year subject, with Veterinary Professional Practice 1 through 5 forming an explicit spine. This is specialist disciplinary content with a clear identity, not generic or interchangeable material.
- **G2 Decision-making under uncertainty:** PASS — The gate PASSes on its second route — live projects with real uncertainty and accountability. Extramural placements in working production and clinical settings are hurdle requirements students must complete and report on, and the final year immerses students in working veterinary clinics; these are uncontrolled real settings, not scripted responses. Assessed case-study exercises recur throughout every core bioscience subject, requiring interpretation of clinical case data rather than recall, and the course outcomes frame the required decisions as explicit trade-offs across welfare, legal, ethical, prognostic, economic and public-health considerations. Note the outcome statement alone would not carry the gate; the hurdle-assessed placements and graded case exercises do.

## 4. MARKET EVIDENCE — Basis: reported

The market intelligence gathered for this program indicates acute shortages across companion animal hospitals (Greencross, VetPartners), equine practices, production animal herds, and government biosecurity agencies (DAFF, Agriculture Victoria), accompanied by rapid adoption of veterinary AI radiology overlays (SignalPET) and ambient scribing tools where clinical diagnosis, surgical procedures, and client communication remain non-delegable statutory responsibilities under Australasian Veterinary Boards Council and state veterinary board standards.

### Destination Job Families

| Job family | Entry titles | AI substitution pressure | Skills rising in that family |
| --- | --- | --- | --- |
| Companion Animal Clinical Practice | Graduate Veterinarian, Small Animal Associate; later Senior Veterinarian, Clinical Director | LOW | AI radiograph and ECG pre-read validation, ambient clinical scribing, soft-tissue surgery |
| Equine & Sports Medicine | Ambulatory Equine Vet, Hospital Intern; later Equine Practice Partner, Specialist Equine Surgeon | LOW | Field lameness diagnostics, reproductive ultrasound, emergency colic management |
| Production Animal & Livestock Health | Livestock Veterinarian, District Vet; later Herd Health Consultant, Biosecurity Lead | LOW | Population epidemiology, biosecurity outbreak modeling, production economics |
| Government Biosecurity & Public Health | Veterinary Officer (DAFF / Agriculture Victoria); later Senior Veterinary Epidemiologist, One Health Lead | LOW–MEDIUM | Zoonotic disease surveillance, export certification, livestock traceability systems |
| Specialist Referral & Emergency | Veterinary Emergency Intern, Clinical Registrar; later Board-Certified Specialist (Surgery / Internal Med) | LOW | Advanced procedural microsurgery, complex multi-organ intensive care, clinical research |

**Exposure basis declaration.** Destination AI exposure is **44.92** (exact basis derived from Veterinary Science graduate destinations), sitting **far below** the portfolio median of 90.9.
...
and the score deltas are in the [improvement plan](dfva-v4-recommend-mc-dvetmed.md); rows
below are ordered by headroom, which is not the plan's P-lever order.

| Item | Score | Implication | Cost | Sources |
| --- | --- | --- | --- | --- |
| C2 Hybrid metacognition & evaluative judgement | 1/3 | In Veterinary Professional Practice, introduce an assessed peer review of a clinical case management plan against professional AVBC standards; require students in DVM3 clinical pathology to document and justify reliance decisions when evaluating AI-assisted radiograph pre-reads. | Faculty moderation time to calibrate clinical peer review rubrics. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1/3 | Introduce an assessed module in DVM3 on veterinary AI diagnostic imaging overlays (SignalPET), ambient clinical scribing, and statutory veterinary duty of care; introduce an assessed veterinary AI governance audit. | Software licensing for veterinary AI imaging suites and staff training. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 1/3 | Formalize the Veterinary Research Project A/B assessment briefs to explicitly assess empirical inquiry design, methodology selection, and primary data collection with an examined oral viva defence. | Research project coordinator workload and viva panel scheduling. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 1/3 | In Veterinary Professional Practice, replace generic video submissions with an assessed clinical discharge summary and client consultation brief judged against AVBC criteria by external practitioners. | External practitioner marker recruitment and calibration. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| C1 Distributed cognition & relational capability | 2/3 | In production animal syndicate work, require student teams to document a protocol allocating tasks between veterinary clinicians, field technicians, and automated herd monitoring tools. | Syndicate workshop moderation time. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C4 Life-long learning & transfer | 2/3 | In Veterinary Research Project A/B, enable students to independently frame and self-scope their research inquiry within clinical or epidemiological streams. | Supervisor allocation for self-scoped inquiries. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W2 Authentic task design | 2/3 | Establish an authentic task spine across all four years with live-animal clinical mini-CEXs and unknown case evaluations replacing traditional written examinations. | Practical clinical exam scheduling and live patient coordination. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
...
**Panel A metadata.** Basis tier **exact** (measured), n = 275. Index variant AIOE-2021; destination titles mapped to the published Felten index.
