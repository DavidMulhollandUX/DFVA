...
const content = {
  title: "Master of Advanced Social Enterprise (MC-BASE) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Advanced Social Enterprise (MC-BASE)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/mc-base (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 23 pages captured
**Course Director:** Vivek Chaudhri
...
> a related program basis (Master of Social Policy). What such a
...
- **G1 Disciplinary foundation:** PASS — An all-compulsory specialist core: every one of the ten subjects is core, and the sequence is staged from Foundations of Decision-Making through leadership, value creation and uncertainty modules to a named consolidation subject, with the Leading with Influence and Senior Executive Project strands running I to V across it. This is a coherent core with progressive depth, not generic interchangeable content.
- **G2 Decision-making under uncertainty:** PASS — Assessment goes well beyond recall or scripted response: a whole core subject is built on leading through uncertainty, component outcomes require decision-making under uncertainty, ambiguity and time pressure and the design of strategy for high-stakes auction and tender settings, and the live consulting project requires defended trade-off decisions about project viability, feasibility and financing under real organisational conditions. These sit behind hurdle-weighted individual assignments.

## 4. MARKET EVIDENCE — Basis: reported

The market intelligence gathered for this program indicates strong demand across social enterprise intermediaries (Social Ventures Australia, Social Traders), major charities and non-profit organisations (Brotherhood of St Laurence, Australian Red Cross), top-tier management and ESG consultancies (PwC, EY, Deloitte), and ASX-listed corporate sustainability departments, accompanied by emerging adoption of AI-driven ESG data analytics dashboards, automated social procurement matching, and predictive outcome reporting tools where multi-stakeholder governance, ethical leadership under uncertainty, and mission-commercial dual-mandate synthesis remain exclusive human executive responsibilities under Social Ventures Australia (SVA) and Centre for Social Impact (CSI) sector standards.
...
| --- | --- | --- | --- | --- |
| C2 Hybrid metacognition & evaluative judgement | 1/3 | In core leadership modules, introduce an assessed criterion-referenced peer review and structured critique of executive business cases against industry benchmarks; require candidates to maintain an assessed decision log justifying overrides of automated market models. | Peer review rubric calibration and moderation time. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1/3 | Introduce an assessed module in Technology & Innovation on AI predictive analytics in business, automated ESG screening, and data quality limits; introduce an assessed corporate AI governance audit. | Software tool licensing and syllabus updates. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C1 Distributed cognition & relational capability | 2/3 | In the Senior Executive Project syndicate deliverables, require teams to document a protocol allocating tasks between syndicate members, client managers, and AI analytics tools. | Workshop moderation time for collaborative syndicate deliverables. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C5 Inquiry & evidence generation | 2/3 | Require all candidates to complete a primary empirical field study generating primary evidence with formal oral defence before an academic and industry review panel. | Oral panel review coordination and examiner time. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2/3 | Formalize the final Senior Executive Project pitch as an assessed board-level presentation judged by external industry mentors with professional conduct criteria. | External mentor assessment moderation and honoraria. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2/3 | Structure the Senior Executive Project around an externally supplied problem with real budget constraints and consequential client sign-off. | Industry partner project sourcing and scoping effort. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| W3 Work-situated learning | 2/3 | For this in-practice executive cohort, require a multi-stage sequence of assessed own-practice consulting interventions with structured reflection and documented client stakeholder evaluation. | Syllabus assessment rubric update across consulting project modules. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
