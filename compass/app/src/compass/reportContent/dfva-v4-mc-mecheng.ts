...
const content = {
  title: "Master of Mechanical Engineering (MC-MECHENG) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Mechanical Engineering (MC-MECHENG)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/mc-mecheng (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 35 pages captured
**Course Director:** Raquel de Souza
...
> **This program is outside the v3.1 registry, but not outside Panel A.** Master of Mechanical Engineering
...
| W3 Work-situated learning [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) | 1 | Level 1 anchor is met: assessed laboratory classes in MCEN30018, MCEN90008, MCEN90014 and MCEN90038, and a design-and-manufacture project in MCEN90054, appear across the core. Level 2 is unmet: the Engineering Practice Hurdle allows completing the STEP program (non-placement) or optional internship ENGR90033, so guaranteed workplace placement is not a universal curriculum requirement for all graduating students (R1). |
...
The market context is condensed from [\`reports/dfva-market-mc-mecheng.md\`](dfva-market-mc-mecheng.md), which synthesises published accreditation standards, technical reports, and peer-reviewed mechanical engineering literature from Engineers Australia ([EA](https://www.engineersaustralia.org.au/)), American Society of Mechanical Engineers ([ASME](https://www.asme.org/)), Institution of Mechanical Engineers ([IMechE](https://www.imeche.org/)), Standards Australia ([AS/NZS](https://www.standards.org.au/)), Safe Work Australia ([SWA](https://www.safeworkaustralia.gov.au/)), and peer-reviewed studies in *IEEE/ASME Transactions on Mechatronics* and *Journal of Mechanical Design*.
...
| Multidisciplinary human-AI collaborative design engineering and systems integration | Rising | C1, W1, G2 |
| Physical prototyping, hardware-in-the-loop validation, and destructive stress testing | Rising | C5, W2 |
| Routine manual 2D drafting, basic CAD detailing, and static hand calculations | Declining | C3, C2 |

*Market evidence confidence is rated HIGH across statutory engineering accreditation bodies, national safety standards agencies, and peer-reviewed mechanical engineering literature.*
...
| --- | --- | --- | --- | --- |
| W3 Work-situated learning | 1/3 | Integrate live client engineering design briefs from industry partners across core coursework for all degree specialisations | Industry partnership coordination | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C1 Distributed cognition & relational capability | 2/3 | Require multidisciplinary teams in ENGR90051/MCEN90054 to submit an assessed Human-AI Engineering Workflow Charter | Minor rubric revision in ENGR90051; zero additional credit points | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2/3 | Implement an assessed 'Generative Design & Simulation Override Log' in MCEN90054 where students justify overrides of AI-generated CAD/FEA geometries | Low teaching overhead; rubric integration | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1/3 | Embed an assessed Cyber-Physical AI Governance & Safety Compliance Audit assignment in core ENGR90051 evaluating statutory AS/NZS standards | Modest curriculum development; safety governance materials | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C4 Life-long learning & transfer | 2/3 | Embed an assessed engineering capability gap analysis and professional development portfolio in the Practice Hurdle | Low administrative overhead | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 2/3 | Implement a formal oral viva defense for the final engineering design and experimental validation in ENGR90038 | Academic staff time for oral examination panels | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2/3 | Mandate external industry panels of chartered professional engineers to evaluate final project prototypes in MCEN90054 | Panel coordination; presentation scheduling | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2/3 | Partner with engineering companies to supply live, ambiguous engineering briefs with real production constraints | Partnering with engineering firms for live briefs | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
