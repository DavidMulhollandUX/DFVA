...
const content = {
  title: "Juris Doctor (MC-JURISD) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Juris Doctor (MC-JURISD)
...
**Course Director:** Megan Prictor (Associate Dean, Juris Doctor)
...
- **G1 Disciplinary foundation:** PASS — A coherent all-compulsory specialist core with documented progressive depth and an accredited sequence. Sixteen compulsory subjects (200 of 300 credit points) are stated to deliver cumulative learning with private and public law building progressively across semesters, individual subjects state their dependence on earlier compulsory subjects (Administrative Law builds on Principles of Public Law and Constitutional Law), and the whole sequence is accredited by the Victorian Legal Admissions Board for admission to practice, with prescribed areas of knowledge declared examinable in each core subject. Nothing generic or interchangeable about the content.
- **G2 Decision-making under uncertainty:** PASS — Core assessment requires defended trade-off decisions rather than recall or scripted responses. Disputes and Ethics requires advising on which of negotiation, mediation or litigation is the most appropriate resolution method for a complex factual scenario, and assesses a negotiation plan and live negotiation activity; Remedies requires recommending appropriate remedies in complex factual problems via a memorandum to a partner; Constitutional Law and Administrative Law both require developing arguments about which principles should apply where provisions or decisions are unclear or in conflict.

## 4. MARKET EVIDENCE — Basis: reported

The market intelligence gathered for this program indicates strong demand across commercial law firms (Allens, KWM, HSF, Ashurst, Clayton Utz), government solicitor offices (VGSO, Commonwealth AGD), and corporate in-house counsel, accompanied by rapid adoption of legal generative AI tools (Harvey, CoCounsel, Lexis+ AI) that automate routine discovery and first-pass drafting while elevating expectations for ethical verification, client counselling, and advocacy.
...
| --- | --- | --- | --- | --- |
| C2 Hybrid metacognition & evaluative judgement | 1/3 | In Legal Method and Reasoning, introduce an assessed peer review of a legal argument against professional judicial benchmark criteria; require students in Remedies and Disputes & Ethics to document and defend reliance decisions on legal AI tools. | Faculty time to develop judicial benchmark rubrics and review student reliance logs. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1/3 | Introduce an assessed core module in Legal Research / Disputes & Ethics on legal generative AI capabilities, hallucination verification, and professional conduct rules; introduce an assessed legal AI governance audit. | Designing legal AI verification exercises and training teaching staff on citation audit tools. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W3 Work-situated learning | 1/3 | Embed a mandatory clinical rotation (MLS Tax Clinic, Public Interest Law Clinic) or live pro bono legal advisory project into the core for all JD candidates with solicitor supervision. | Expanding clinical supervisor staffing and host organisation agreements under HESF 5.4.1. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C1 Distributed cognition & relational capability | 2/3 | In the Criminal Law and Procedure group research assignment, require student teams to document a protocol allocating tasks between co-counsel, researchers, and legal AI research tools. | Developing multidisciplinary legal teamwork rubrics. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C5 Inquiry & evidence generation | 2/3 | Require an examined oral viva defence of the 8,000-word research project before a panel of legal scholars and practitioners. | Scheduling viva examiner panels across the final-year cohort. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2/3 | Formalize the Disputes & Ethics negotiation and advocacy assessments to be judged by practising barristers and solicitors with explicit professional conduct rubrics. | Practitioner panel recruitment and assessment calibration. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2/3 | Establish an authentic task spine across all three years with real client briefs and court-ready pleadings replacing traditional supervised examinations. | Redesigning exam formats into authentic case file assessments. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
