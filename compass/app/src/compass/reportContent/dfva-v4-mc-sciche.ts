...
const content = {
  title: "Master of Science (Chemistry) (MC-SCICHE) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Science (Chemistry) (MC-SCICHE)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/mc-sciche (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 35 pages captured
**Course Director:** Ivanhoe Leung
...
> a cognate program basis (Bachelor of Science (Chemistry)). What such a
...
- **G1 Disciplinary foundation:** PASS — The gate's PASS condition — 'a coherent specialist core with progressive technical or methodological depth… or a staged prerequisite chain' — is documented twice over. A compulsory 125-credit-point Chemistry research project forms a staged chain of four (or five) parts in which progression is conditional on successful completion of the earlier component, and on top of that every student must take 37.5–62.5 credit points from a closed list of advanced CHEM-coded discipline subjects. The content is unmistakably disciplinary rather than generic or interchangeable.
- **G2 Decision-making under uncertainty:** PASS — The gate passes on the capstone route: a compulsory, self-scoped, four-semester research project that the student must plan and execute independently and submit for formal examination carries genuine methodological uncertainty and personal accountability for the result — this is not recall or scripted response. Discipline coursework reinforces it with outcomes requiring plausible syntheses to be proposed and defensible risk assessments to be produced from evidence. Noted against the PASS: the project's own assessment page is absent from the extract, so the gate rests on the course-structure requirement and the course-level outcome rather than a task description.

## 4. MARKET EVIDENCE — Basis: reported

The market intelligence gathered for this program indicates consistent hiring across analytical testing laboratories (ALS Global, Eurofins), pharmaceutical R&D facilities (CSL, Pfizer ANZ), battery/critical minerals ventures, and CSIRO research divisions, accompanied by early adoption of machine learning retrosynthetic planners (IBM RXN) and automated spectral assignment tools where laboratory synthesis, bench experimentation, and regulatory chemical hazard evaluation remain non-delegable human responsibilities under Royal Australian Chemical Institute (RACI) chartered chemist standards.
...
| --- | --- | --- | --- | --- |
| C1 Distributed cognition & relational capability | 0/3 | In a required discipline coursework unit, introduce an assessed collaborative laboratory project allocating synthetic and analytical tasks with individual accountability; require student teams to document human-plus-AI task allocation. | Workshop moderation time for collaborative laboratory assessment. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 1/3 | In discipline coursework, introduce an assessed peer review of research proposals or synthesis routes evaluated against published RACI criteria; require students to maintain an assessed reliance log justifying decisions to override ML-predicted reaction pathways. | Peer review rubric calibration and grading time. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1/3 | Introduce an assessed module in core chemistry coursework on ML retrosynthetic algorithms (IBM RXN), computational docking, and physical validation limits; introduce an assessed chemical AI governance audit. | Software licensing for computational chemistry suites and syllabus updates. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W1 Professional communication & conduct | 1/3 | Replace internal literature presentations with an assessed chemical safety briefing or commercial technology pitch judged against industry standards by external practitioners. | External practitioner marker recruitment and moderation. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 1/3 | Introduce an assessed AICIS chemical notification dossier or industrial method validation protocol judged against regulatory criteria; replace written exams with simulated industrial R&D projects. | Assessment brief redesign away from written examinations. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| W3 Work-situated learning | 1/3 | Embed a compulsory industrial placement or collaborative CSIRO/pharma industry-linked research module into the degree structure. | Placement coordinator resourcing and industry agreement management. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C5 Inquiry & evidence generation | 2/3 | Formalize an examined oral viva defence of the 125-credit-point research thesis methodology before a panel of academic and industrial chemists. | Oral viva examination scheduling and examiner honoraria. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
...
**Not scoreable from the handbook** (6):
