...
const content = {
  title: "Doctor of Clinical Dentistry (ME-DCD) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Doctor of Clinical Dentistry (ME-DCD)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/me-dcd (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 9 pages captured
**Course Director:** Satish Alapati
...
> **This program is outside the v3.1 registry, but not outside Panel A.** Doctor of Clinical Dentistry
...
**Destination AI Exposure: 60.96.** Destination titles are mapped to the published Felten AI Occupational Exposure (AIOE) index and rescaled 0–100 by the Panel A procedure used for every other program; 9 of 15 titles carry medium mapping confidence. Basis: measured on the program's own alumni destination record (n = 40, 15 titles). The portfolio median is 90.9, so this program sits **at or below** it.
...
- **G1 Disciplinary foundation:** PASS — The program documents an all-compulsory specialist curriculum with progressive depth and external accreditation: a 300-credit-point program consisting of 75 credit points of common core research subjects (staged across three years: DENT90108 -> DENT90109 -> DENT90110) plus 225 credit points of core specialisation subjects in one of seven specialist disciplines. The entire sequence is accredited by the Australian Dental Council (ADC) for specialist registration with AHPRA, with zero interchangeable or generic elective space.
- **G2 Decision-making under uncertainty:** PASS — Assessment requires defended methodology, problem formulation, experimental design, and data analysis in a self-scoped 3-year research project (DENT90108, DENT90109, DENT90110) with three oral presentations and a 13,000-word Minor Thesis under experimental uncertainty and ethical constraints. This requires substantial decision-making under uncertainty and defended trade-offs rather than recall or scripted responses.

## 4. MARKET EVIDENCE — Basis: reported

The market intelligence gathered for this program indicates strong demand across Australian Dental Council (ADC) specialist registers, major public dental hospitals (Dental Health Services Victoria / Royal Dental Hospital of Melbourne), and private specialist practices across all seven recognised disciplines, accompanied by early adoption of AI-assisted diagnostic radiograph and CBCT screening software (Pearl, Overjet, Diagnocat) where intraoral microsurgery, complex orthodontic treatment planning, and statutory medico-legal liability remain exclusive human responsibilities under Dental Board of Australia (AHPRA) and Australian Dental Council specialist accreditation standards.

### Destination Job Families

| Job family | Entry titles | AI substitution pressure | Skills rising in that family |
| --- | --- | --- | --- |
| Private Specialist Dental Practice | Registered Specialist Dentist (Orthodontist, Periodontist, Endodontist); later Practice Partner, Specialist Clinic Director | LOW | Advanced microsurgical technique, CBCT 3D interpretation, AI imaging critique |
| Hospital Specialist & Special Needs Dentistry | Staff Specialist (Dental Hospital), Clinical Fellow; later Head of Department / Director of Dental Services | LOW | Complex multidisciplinary case coordination, medically compromised patient care |
| Academic & Clinical Dental Research | Clinical Lecturer, Postdoctoral Dental Researcher; later Clinical Associate Professor, Director of Clinical Research | LOW | Clinical trial design, primary biomaterials evidence generation, grant governance |
| Dental Regulatory & College Leadership | ADC Accreditation Panel Member, RACDS Examiner; later College Censor / Dental Board Member (AHPRA) | LOW | Specialist training accreditation, clinical governance, ethical dental AI appraisal |
...
and the score deltas are in the [improvement plan](dfva-v4-recommend-me-dcd.md); rows
below are ordered by headroom, which is not the plan's P-lever order.

| Item | Score | Implication | Cost | Sources |
| --- | --- | --- | --- | --- |
| C1 Distributed cognition & relational capability | 1/3 | In core coursework, introduce an assessed collaborative multidisciplinary clinical case planning project with individual accountability; require candidate teams to document human-plus-AI task allocation. | Interprofessional clinical seminar moderation time. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C3 Digital & AI literacy, including governance | 1/3 | Introduce an assessed module in core coursework on AI diagnostic imaging software (Pearl, Overjet, Diagnocat), automated CBCT segmentation, and diagnostic accuracy limits; introduce an assessed dental AI clinical governance audit. | Software access licensing and syllabus updates. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W1 Professional communication & conduct | 1/3 | Replace internal research seminars with an assessed specialist clinical case defence or hospital referral presentation judged by external college examiners against RACDS standards. | External specialist examiner honoraria and scheduling. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 1/3 | Introduce an assessed end-to-end specialist treatment plan and clinical case record portfolio judged against DBA specialist practice standards; establish an authentic clinical assessment spine. | Portfolio assessment rubric design and moderation. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| C2 Hybrid metacognition & evaluative judgement | 2/3 | Require candidates to maintain an assessed clinical decision log documenting and justifying decisions to override automated diagnostic imaging annotations and CAD/CAM prosthodontic designs. | Clinical logbook rubric calibration. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| W3 Work-situated learning | 2/3 | Document and formalize the 3-year hospital clinical residency assessment tables including structured reflection hurdles and practitioner supervisor sign-offs. | Documentation updates in handbook subject entries. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
...
**Panel A metadata.** Basis tier **exact** (measured), n = 40, 15 destination titles, 9 at medium mapping confidence. Index variant AIOE-2021; destination titles mapped to the published Felten index.

**Panel C provenance.** Scored from the 2026 handbook capture (9 pages) and verified on 2026-08-23: adversarial refutation of every level-3 score and every gate PASS (run), verbatim evidence check (run), and the construct-boundary pass.
