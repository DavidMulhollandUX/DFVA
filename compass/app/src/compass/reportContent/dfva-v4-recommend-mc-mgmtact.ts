...
const content = {
  title: "Master of Management (Accounting) (MC-MGMTACT) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Management (Accounting) (MC-MGMTACT)
...
**Assessment date:** 2026-08-24 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-mgmtact.md
**Position basis:** Destination AI Exposure 97.99 (exact basis) × Curriculum Adaptiveness 8/15 (v4.2 draft, sub-scale A) · Workplace practice 4/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
The Master of Management (Accounting) is a professional entry-to-practice degree accredited by CPA Australia and CAANZ, preparing graduates for professional careers across financial accounting, audit, tax advisory, and commercial management (AI Occupational Exposure (AIOE) 97.99). The curriculum demonstrates rigorous technical and statutory foundations (C1: 2/3, C2: 2/3, C4: 2/3, G1 PASS) with group financial analyses in ACCT90002, corporate reporting in ACCT90012, auditing projects in ACCT90014, and information systems control in ACCT90030, while AI literacy, inquiry and professional communication sit at the floor (C3: 1/3, C5: 1/3, W1: 1/3). However, the accounting profession faces extreme automation pressure on routine bookkeeping, ledger reconciliation, and statutory tax calculations. The program's primary developmental headroom lies in formalizing human-AI workflow allocation charters (C1), introducing assessed reliance and anomaly verification logs for AI audit and tax reconciliation outputs (C2), bringing AI capabilities and their limits into core assessment on the way to systemic AI audit governance and APESB ethical compliance (C3), requiring an assessed inquiry with methodology selection and data collection (C5), putting a recognised professional accounting genre judged against practice criteria into core assessment (W1), and transitioning optional accounting internships into guaranteed core client engagements (W3).

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| W3 Work-situated learning | Workplace | 1 / 3 | 2 | Big 4 and mid-tier accounting firms prioritize graduates with verified client accounting engagement experience | 1 |
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 2 | CPA Australia, CAANZ, and ASIC mandate statutory compliance, data privacy, and ethical AI accounting governance | 2 |
| C5 Inquiry & evidence generation | Adaptive | 1 / 3 | 2 | Complex audit and forensic accounting investigations require primary evidence defended under oral examination | 3 |
| W1 Professional communication & conduct | Workplace | 1 / 3 | 2 | Accountants and auditors must defend complex financial reports before external audit partners and client boards | 4 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Accounting teams must explicitly coordinate tasks between human auditors and automated AI audit agents | 5 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Accountants must systematically audit and document overrides of AI financial statements and ledger reconciliations | 6 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Continuous evolution of international accounting and sustainability standards demands assessed lifelong learning plans | 7 |
| W2 Authentic task design | Workplace | 2 / 3 | 1 | Real-world accounting carries ambiguous transaction data, multi-jurisdiction tax rules, and live client constraints | 8 |
...
|---|---|---|---|---|
| W3 Work-situated learning | 1 → 2 | "A core unit places students in a real workplace or professional-community setting with practitioner supervision and assessment — placement, practicum, live client project, community-based project..." | Integrate live corporate client accounting and audit projects from partner firms across core coursework for all degree streams | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| W3 Work-situated learning | 2 → 3 | "Substantial required work-situated learning: an extended placement or practicum, or a sequence of them, in the core, supervised by a practitioner, assessed, with accountability to the host and structured reflection on professional practice..." | Expand accounting internships into a guaranteed core requirement or mandatory industry-hosted practicum for the entire cohort | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | Require teams in ACCT90012/ACCT90014 to submit an assessed Human-AI Accounting Workflow Charter dividing tasks between auditors and AI agents | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | Implement an assessed 'AI Financial Analysis & Audit Override Log' in ACCT90002/ACCT90014 where students justify overrides of AI-generated audit reports | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Bring AI capabilities and their limitations and ethics into a core subject — ACCT90030 or ACCT90014 — and assess use with limits rather than accounting-software and ERP operation | Embed an assessed module in core ACCT90030 evaluating algorithmic bias in credit risk modeling, APRA/ASIC compliance, and AI data security |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Embed an assessed module in core ACCT90030 evaluating algorithmic bias in credit risk modeling, APRA/ASIC compliance, and AI data security | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C4 Life-long learning & transfer | 2 → 3 | "The program documents structured progression toward independent learning: a self-scoped capstone or research project, or assessed identification of one's own knowledge gaps together with the plan to close them." | Embed an assessed accounting professional capability gap analysis and lifelong development portfolio across the core sequence | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 1 → 2 | "Students design and conduct an inquiry with methodology selection and data collection, assessed." | Require the ACCT90033 capstone to select a methodology and collect its own evidence beyond published financial statements, with both steps assessed | Structure the final capstone project in ACCT90033 as a formal oral viva defense of audit and financial accounting evidence |
| C5 Inquiry & evidence generation | 2 → 3 | "A substantial project generating primary evidence is REQUIRED (not one route among several), with methodology defended under scrutiny (viva, defence, or staged supervised review)." | Structure the final capstone project in ACCT90033 as a formal oral viva defense of audit and financial accounting evidence | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 1 → 2 | "At least one core assessment requires a recognised professional genre or an audience beyond the teaching team — client brief, consultancy or policy advice, clinical handover, pitch, public-facing artefact — judged against criteria drawn from professional practice." | Recast one core accounting assessment as a named professional artefact — an audit working paper and opinion, or written tax advice to a client — marked against criteria drawn from professional practice | Mandate external industry panels of chartered accountants (CA/CPA) and audit partners to evaluate Capstone accounting projects in ACCT90033 |
| W1 Professional communication & conduct | 2 → 3 | "Professional communication is assessed repeatedly and progressively across the program AND at least one core assessment is delivered to, or judged by, a real external audience or practitioner (industry panel, client, patient or simulated patient, public exhibition), with professional conduct or accountability explicitly among the assessed criteria." | Mandate external industry panels of chartered accountants (CA/CPA) and audit partners to evaluate Capstone accounting projects in ACCT90033 | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2 → 3 | "Such tasks are the program's assessment spine rather than a single instance (a capstone plus earlier scaffolding, or at least one per stage) AND at least one carries a genuine constraint of practice — an ambiguous or externally supplied problem, real resource/time limits, a consequential audience, or the profession's own standards of performance." | Partner with accounting firms to supply live, ambiguous corporate accounting and audit briefs carrying real commercial constraints | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | W3 | Big 4 and mid-tier accounting firms prioritize graduates with verified client accounting engagement experience | Section 2, Section 4 (CPA Australia / QILT) | HIGH |
| P2 | C1 | Industry standards (CPA / CAANZ) mandate structured collaboration between accountants and automated financial AI agents | Section 1, Section 3 (*The Accounting Review*) | HIGH |
| P3 | C2 | Peer-reviewed research (*AJPT* 2025) demonstrates evaluative judgement is critical to override flawed AI audit and reconciliation outputs | Section 3, Section 4 | HIGH |
| P4 | C3 | ASIC, APRA, and APESB standards require professional accountants to implement statutory AI data security and ethical compliance | Section 1, Section 3 | HIGH |
| P5 | W1 | Accounting employers demand graduates capable of defending financial and audit briefs before external audit partner panels | Section 2, Section 4 | HIGH |
| P6 | W2 | Live accounting and audit projects with authentic commercial constraints reflect the true operational environment of professional practice | Section 2, Section 4 | HIGH |
| P7 | C5 | Academic and professional standards require empirical accounting inquiry defended under rigorous oral examination | Section 3, Section 4 | HIGH |
| P8 | C4 | Continuous evolution of international accounting and sustainability reporting standards requires assessed lifelong learning plans | Section 2, Section 4 | HIGH |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C1 | Require teams in ACCT90012/ACCT90014 to submit an assessed Human-AI Accounting Workflow Charter | C1 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022) |
| P2 | C2 | Implement an assessed AI Financial Analysis & Audit Override Log in ACCT90002/ACCT90014 | C2 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P3 | C3 | Embed an assessed Algorithmic Audit Governance & Data Compliance assignment in core ACCT90030 | C3 Level 3 | Medium | Term 2 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P4 | W1 | Mandate external industry panels of chartered accountants (CA/CPA) to evaluate Capstone projects in ACCT90033 | W1 Level 3 | Medium | Term 2 | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined) |
| P5 | W2 | Partner with accounting firms to supply live, ambiguous corporate accounting and audit briefs | W2 Level 3 | Medium | Term 2 | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| P6 | C4 | Embed an assessed accounting capability gap analysis and lifelong professional development portfolio across the core | C4 Level 3 | Medium | Term 2 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2) |
| P7 | C5 | Require the ACCT90033 capstone to generate primary accounting evidence under a selected methodology, defended in a formal oral viva | C5 Level 3 | Medium | Term 2 | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| P8 | W3 | Embed live externally mentored client accounting and audit projects into core coursework for all degree specialisations | W3 Level 2 | High | Term 3 | [[19]](https://www.legislation.gov.au/F2021L00488)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | PASS condition is met: the program documents a comprehensive 200-point curriculum accredited by CPA Australia and CAANZ, covering financial accounting, managerial accounting, auditing, taxation, corporate law, quantitative methods, and accounting information systems. Rigorous, coherent professional accounting core. | Any curriculum redesign must preserve the rigorous financial accounting, statutory taxation, and auditing foundations mandated by CPA/CAANZ accreditation. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | PASS condition is met: assessment explicitly requires complex professional accounting judgements under statutory and commercial ambiguity. ACCT90014 requires students to 'gather evidence and formulate judgments with respect to the underlying information' and ACCT90012 to 'Resolve accounting issues by reference to the conceptual framework and accounting standards, including those not covered in the subject', each assessed through a 5000-word group assignment; ACCT90016 covers 'compliance with statutory and professional requirements in relation to taxation ... including tax avoidance arrangements'. | Interventions must maintain authentic, complex accounting trade-offs and audit judgements rather than oversimplifying to closed-form rule-matching tests. | [16] |
...
|---|---|---|---|---|---|---|
| P1 | C1 | 2 | 3 | +1 adaptive | 9 / 15 | 4 / 9 |
| P2 | C2 | 2 | 3 | +1 adaptive | 10 / 15 | 4 / 9 |
| P3 | C3 | 1 | 3 | +2 adaptive | 12 / 15 | 4 / 9 |
| P4 | W1 | 1 | 3 | +2 workplace | 12 / 15 | 6 / 9 |
| P5 | W2 | 2 | 3 | +1 workplace | 12 / 15 | 7 / 9 |
| P6 | C4 | 2 | 3 | +1 adaptive | 13 / 15 | 7 / 9 |
| P7 | C5 | 1 | 3 | +2 adaptive | 15 / 15 | 7 / 9 |
