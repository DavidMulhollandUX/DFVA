...
const content = {
  title: "Master of Psychology (Clinical Psychology)/Doctor of Philosophy (080CL) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Psychology (Clinical Psychology)/Doctor of Philosophy (080CL)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/080cl (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 43 pages captured
...
> **This program is outside the v3.1 registry, but not outside Panel A.** Master of Psychology (Clinical Psychology)/Doctor of Philosophy
...
**W1 Professional communication & conduct — 3/3**
...
- **G1 Disciplinary foundation:** PASS — PASS on the anchor's 'all-compulsory specialist core' and 'accredited sequence' routes simultaneously: every subject is compulsory, the sequence is externally accredited as the required sequence for registration, and the structure is staged year by year with depth building from introductory assessment and basic interventions to advanced psychopathology, advanced practice and a PhD. Nothing generic or interchangeable.
- **G2 Decision-making under uncertainty:** PASS — PASS on the anchor's 'assessments require defended trade-off decisions' route and on the live-project route. Assessed ethical-dilemma resolution, assessed decisions about when a brief intervention suffices and when a more complex one is warranted, assessed risk assessment drawing on multiple sources, and a thesis proposal that must be successfully defended before a committee are all decisions under genuine uncertainty with accountability, not recall or scripted response.

## 4. MARKET EVIDENCE — Basis: reported

Condensed from [the market intelligence report](dfva-market-080cl.md).

**Destination job families.**

| Job family | Entry titles | AI substitution pressure | Skills rising in that family |
| --- | --- | --- | --- |
| Clinical psychologist (public health) | Provisional/Registrar Clinical Psychologist | Low | Complex-comorbidity treatment, telehealth-adapted delivery, trauma-informed care |
| Clinical psychologist (private practice) | Clinical Psychologist (private practice), Endorsed Psychologist | Low-medium, on the reporting layer only | Digital and telehealth practice management, AI-assisted documentation literacy |
| Child and family clinical psychologist | Child Clinical Psychologist, Developmental Psychologist | Low | Neurodevelopmental assessment literacy, parent-mediated intervention |
| Forensic / correctional clinical psychologist | Forensic Psychologist, Correctional Services Psychologist | Low | Structured professional risk-assessment tools, expert-witness communication |
| Academic / clinical researcher | Postdoctoral Research Fellow, Lecturer in Clinical Psychology | Low | AI-assisted literature synthesis with methodological critique, large-dataset clinical research |
| *Clinical documentation / intake support* | *Intake Coordinator, Psychometric Test Administrator* | *High* | *— the automatable periphery, listed by the market report for contrast; not a graduate destination* |

> **The exposure figure and this table disagree, and the table is the better guide.** §1 reports 95.57, borrowed from the Master of Applied Psychology alumni record — a *partial* basis, not this program's own graduates, and one that mixes registered and unregistered psychology destinations. Every graduate destination the market report identifies for this program carries **low** substitution pressure, and the market report includes the high-exposure row deliberately, to name it as the band an 080CL graduate supervises rather than occupies. PsyBA registration and area-of-practice endorsement are hard supply gates. Read 95.57 as an artefact of the borrowed basis; the estimated-basis methods note sets out what such a value may and may not be used for.

**Signals and skill shifts.**

| Signal or shift | Direction | Bearing on the scored items |
| --- | --- | --- |
| Persistent public mental health workforce shortage, particularly regional and outer-metropolitan | Sustained demand | W3, W1 |
| Medicare Better Access sustaining private-practice demand, with waitlists commonly cited | Sustained demand | W2 |
| Child and adolescent mental health expansion (headspace, dedicated hubs) | Rising | W3 |
| Ambient clinical documentation and AI note-summarisation tools piloted across allied health | Rising | C3, C2 |
| Registration and endorsement as hard supply gates, insulating graduates from oversupply | Structural | No scored item — a market-structure signal |
| Manual session note-taking; manual psychometric scoring; paper-based intake admin | Declining fast | C3 |
| AI-assisted documentation review and correction; critical interpretation of AI-scored psychometric output | Rising | C3, C2 |
| AI-assisted literature synthesis with methodological critique, against manual review | Rising fast | C2, C5 |
| Defensible, AI-literate risk and diagnostic reasoning, against purely descriptive case reporting | Rising fast | C2, C3 |
| Multidisciplinary team-embedded practice, against isolated individual practice models | Rising | C1 |
| Hybrid telehealth/in-person service design | Rising fast | C4 |

**Confidence, restated from the market report.** The job-ad signals section carries an explicit **LOW** confidence label: it reflects structural labour-market knowledge — registration requirements, public mental-health workforce shortages, Medicare-funded private practice dynamics — and no real-time job board data was queried. The structural claims (registration gating, workforce shortage, Better Access demand) are the durable part; nothing here supports a quantitative statement about posting volumes.
...
and the score deltas are in the [improvement plan](dfva-v4-recommend-080cl.md); rows
below are ordered by headroom, which is not the plan's P-lever order.

| Item | Score | Implication | Cost | Sources |
| --- | --- | --- | --- | --- |
| C2 Hybrid metacognition & evaluative judgement | 1/3 | The single clearest gap. A sweep of every core assessment found no criterion-referenced appraisal of the quality of work — this was demoted from 2 on adversarial verification — while the market's fastest-rising items are exactly appraisal tasks: critical interpretation of AI-scored psychometric output, AI-assisted documentation review and *correction*, and defensible AI-literate diagnostic reasoning against purely descriptive case reporting | Low to medium. The program already runs clinical supervision, case formulation and treatment planning; adding published criteria and an assessed appraisal component — of a peer's formulation, or of an AI-drafted note against the clinical record — uses machinery that already exists | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1/3 | Level 0 is falsified by exactly one program-level outcome line, which is the whole of the program's documented AI content. Meanwhile ambient documentation and note-summarisation tools are being piloted across allied health right now, and the tasks they absorb — session notes, psychometric scoring, intake admin — are declining Fast. Graduates will supervise these tools from their first placement | Low for the first step: an assessed component on what these tools get wrong, and the professional-responsibility and privacy obligations attaching to their use in a clinical record, fits inside existing core teaching. High for the governance step | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C1 Distributed cognition & relational capability | 2/3 | Interprofessional activity is assessed in the compulsory Ways of Knowing subject, which meets the anchor, and multidisciplinary team-embedded practice is rising against isolated individual practice. The step to 3 needs recurrence plus a task where the division of work between clinician and tool is itself assessed — which is, precisely, the AI-documentation supervision the market is describing | Medium — the placement structure already puts students in multidisciplinary teams; what is added is assessment of the coordination rather than of the clinical work | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W2 Authentic task design | 2/3 | Coursework task fidelity is clearly at level 2. The step to 3 asks for such tasks to be the assessment spine with a genuine constraint of practice. Note the boundary: the 125 days of placement are scored in W3, so W2 is scored on coursework alone and cannot borrow the placement's authenticity | Medium — largely a matter of extending existing case-based assessment across stages rather than building new tasks | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| C4 Life-long learning & transfer | 3/3 | At the ceiling. A required self-scoped research project with documented progression toward independent learning — the PhD component that also underwrites the academic and clinical-researcher destination | None | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 3/3 | At the ceiling. A required substantial primary-evidence project with methodology defended under scrutiny. Against a market where AI-assisted literature synthesis is rising Fast, the durable half is the methodological critique, and this is where the program teaches it | None | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 3/3 | At the ceiling, and unusually well evidenced: repeated and progressive assessed professional communication from first-year clinical case formulation onward, in genres addressed to real clinical audiences | None | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W3 Work-situated learning | 3/3 | At the ceiling on the placement route: 125 days of required, supervised, assessed placement with host accountability and structured reflection. This is what the destination set — every family of it registration-gated — actually requires, and it is the program's strongest asset | None. The equity caveat still applies to how such placement is resourced [[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report), and a high W3 describes curriculum design rather than student welfare | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
...
**Panel C provenance.** Scored from the 2026 handbook capture (43 pages) and verified on 2026-08-23: adversarial refutation of every level-3 score and every gate PASS (run), verbatim evidence check (run), and the construct-boundary pass.
