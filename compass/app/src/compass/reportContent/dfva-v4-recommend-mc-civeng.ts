...
const content = {
  title: "Master of Civil Engineering (MC-CIVENG) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Civil Engineering (MC-CIVENG)
...
**Assessment date:** 2026-08-24 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-civeng.md
**Position basis:** Destination AI Exposure 91.09 (exact basis) × Curriculum Adaptiveness 8/15 (v4.2 draft, sub-scale A) · Workplace practice 5/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
|---|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 2 | Market §2 Signal 2 and §3 Theme 1 show automated FEA, generative layout optimization, and AI flood modeling require explicit algorithmic critique in core units | 1 |
| C5 Inquiry & evidence generation | Adaptive | 1 / 3 | 2 | Market §4 highlights low-carbon geopolymer concrete development and dynamic soil-structure interactions require student-designed primary empirical investigations | 2 |
| W3 Work-situated learning | Workplace | 1 / 3 | 2 | Market §1 and §2 show Tier 1 engineering consultancies prioritize candidates with verified site-based internships; internships currently sit in non-credit hurdles or electives | 3 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Market §3 Theme 2 emphasizes multidisciplinary precinct delivery requires coordinating human teams integrated with automated BIM modeling platforms | 4 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Market §3 Theme 1 notes chartered engineers maintain statutory sign-off liability requiring documented software override audits | 5 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Market §4 indicates climate adaptation mandates require independent learning transfer to novel infrastructure typologies | 6 |
| **Adaptive capabilities** | **Adaptive** | **8 / 15** | **7** | — | — |
| W1 Professional communication & conduct | Workplace | 2 / 3 | 1 | Market §3 Theme 2 indicates structural design pitches must be judged by external chartered engineers and municipal clients | 7 |
| W2 Authentic task design | Workplace | 2 / 3 | 1 | Market §2 Signal 1 notes civil engineering plans must navigate live municipal planning bylaws and constructability constraints | 8 |
...
|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Introduce an assessed module in core unit CVEN90049 Structural Design analyzing generative layout algorithms and automated FEA solvers with explicit error boundaries | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Mandate an assessed engineering data governance and AI ethics critique in CVEN90075 evaluating liability and algorithmic bias in autonomous structural design | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 1 → 2 | "Students design and conduct an inquiry with methodology selection and data collection, assessed." | Restructure core laboratory practicals into a student-designed empirical inquiry on material fatigue or hydraulic flume dynamics with methodology selection and data collection | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C5 Inquiry & evidence generation | 2 → 3 | "A substantial project generating primary evidence is REQUIRED (not one route among several), with methodology defended under scrutiny (viva, defence, or staged supervised review)." | Establish a compulsory primary empirical research project in the core with methodology defended in a formal oral viva examination before an academic/industry panel | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W3 Work-situated learning | 1 → 2 | "A core unit places students in a real workplace or professional-community setting with practitioner supervision and assessment — placement, practicum, live client project, community-based project — OR, for a cohort documented as already practising in the profession, a core unit assesses activity conducted in the student's own professional practice with real recipients and a documented outcome measure — but it is short or stands alone." | Convert the optional internship (ENGR90033) or live industry consulting project into a compulsory credit-bearing requirement within the core sequence | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2011.642845)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
...
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | Require capstone teams in CVEN90060 to submit an assessed collaboration charter and role-tool allocation matrix documenting the division of work between human engineers and automated design software | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | Introduce an assessed 'Reliance and Override Log' in CVEN90049 where students document and justify overrides of automated structural analysis software | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C4 Life-long learning & transfer | 2 → 3 | "The program documents structured progression toward independent learning: a self-scoped capstone or research project, or assessed identification of one's own knowledge gaps together with the plan to close them." | Require students in the final-year capstone to complete a self-scoped infrastructure innovation study with an assessed personal learning gap analysis | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W1 Professional communication & conduct | 2 → 3 | "Professional communication is assessed repeatedly and progressively across the program AND at least one core assessment is delivered to, or judged by, a real external audience or practitioner (industry panel, client, patient or simulated patient, public exhibition), with professional conduct or accountability explicitly among the assessed criteria." | Mandate that oral design presentations in CVEN90060 are judged by a panel of practicing chartered engineers from Engineers Australia and industry consultancies | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2 → 3 | "Such tasks are the program's assessment spine rather than a single instance (a capstone plus earlier scaffolding, or at least one per stage) AND at least one carries a genuine constraint of practice — an ambiguous or externally supplied problem, real resource/time limits, a consequential audience, or the profession's own standards of performance." | Frame core engineering design tasks around externally supplied live municipal infrastructure briefs with strict budget and planning constraints | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C3 | Engineers Australia guidelines mandate that chartered engineers understand the limitations and failure modes of automated FEA software | §3 Theme 1 | HIGH |
| P2 | C3 | Infrastructure consultancies require digital engineering governance and cyber-physical security in BIM platforms | §2 Signal 2, §3 Theme 1 | MEDIUM |
| P3 | C5 | Low-carbon concrete development and circular economy materials require primary empirical laboratory testing | §2 Signal 4 | HIGH |
| P4 | C5 | Journal of Civil Engineering and Management scholarship emphasizes empirical testing under dynamic geotechnical volatility | §3 Theme 3 | HIGH |
| P5 | W3 | Tier 1 consultancies recruit graduates with verified on-site experience in major civil infrastructure projects | §1 Job Family 1 & 2, §2 Signal 1 | HIGH |
| P6 | W3 | Professional registration boards require documented workplace engineering practice under chartered practitioner supervision | §2 Signal 4 | HIGH |
| P7 | C1 | Major infrastructure delivery requires multidisciplinary engineering coordination integrated across digital BIM environments | §1 Job Family 2, §3 Theme 2 | HIGH |
| P8 | C2 | Non-delegable legal liability requires chartered engineers to document independent audits of automated design software | §3 Theme 1 | HIGH |
| P9 | C4 | Climate resilience mandates require independent learning transfer to novel flood and seismic risk scenarios | §4 Rising Demand | MEDIUM |
| P10 | W1 | Civil engineers must conduct direct oral defenses of design calculations before client review panels | §3 Theme 2 | MEDIUM |
| P11 | W2 | Engineering consultancies must deliver designs compliant with Australian Standards (AS 5100, AS 3600) and statutory planning constraints | §1 Job Family 1, §3 Theme 1 | HIGH |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C3 | Add an assessed module on generative layout algorithms and automated FEA solvers with explicit error boundaries in CVEN90049 | Level 2 | Low | Year 2 Semester 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13] |
| P2 | C2 | Implement an assessed 'Reliance and Override Log' in CVEN90049 where students document and justify overrides of automated design software | Level 3 | Low | Year 2 Semester 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3) |
| P3 | C1 | Require capstone teams in CVEN90060 to submit an assessed collaboration charter and tool-human work allocation agreement | Level 3 | Low | Year 3 Semester 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022) |
| P4 | W1 | Mandate that oral design presentations in CVEN90060 are judged by practicing chartered engineers from industry consultancies | Level 3 | Medium | Year 3 Semester 1 | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29) |
| P5 | C5 | Restructure laboratory practicals into a student-designed empirical inquiry on materials or hydraulics with methodology selection | Level 2 | Medium | Year 2 Semester 2 | [14][15] |
| P6 | W2 | Frame core engineering design tasks around externally supplied live municipal infrastructure briefs with budget constraints | Level 3 | Medium | Year 3 Semester 1 | [[22]](https://doi.org/10.1007/BF02504676)[[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| P7 | W3 | Formalize an assessed credit-bearing engineering practicum or live consulting project as a mandatory core requirement | Level 2 | Medium | Year 2 Semester 2 | [[19]](https://www.legislation.gov.au/F2021L00488)[[29]](https://doi.org/10.1080/07294360.2011.642845) |
| P8 | C4 | Require a self-scoped independent project component in the capstone with an assessed personal learning gap closure plan | Level 3 | Medium | Year 3 Semester 2 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2) |
| P9 | C3 | Introduce an assessed engineering data governance and AI ethics critique in CVEN90075 | Level 3 | Medium | Year 3 Semester 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
...
| P11 | W3 | Establish an extended 200-hour supervised industry engineering placement with structured employer assessment | Level 3 | High | Year 2 Summer/Term | [[19]](https://www.legislation.gov.au/F2021L00488)[[28]](https://doi.org/10.1007/s10734-017-0216-z) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | PASS condition is met: the program documents an extensive compulsory core establishing technical and methodological depth in civil engineering — covering Structural Theory and Design (CVEN30010, CVEN90049), Fluid Mechanics & Hydraulics (ENGR30002, CVEN90051), Earth Processes & Geotechnics (ENEN20002), Sustainable Infrastructure Development (CVEN90044), Transport Systems (CVEN90050), Civil Engineering Management (CVEN90075), and Integrated Infrastructure Design (CVEN90060). Coherent professional engineering sequence accredited by Engineers Australia. | Curriculum redesign must maintain accreditation alignment with Engineers Australia Stage 1 competencies and preserve core technical depth across structural, hydraulic, and geotechnical engineering | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | PASS condition is met: assessment goes well beyond formulaic calculations to require complex trade-off decisions under structural, environmental, and geotechnical uncertainty — including multidisciplinary trade-offs between structural stability, geotechnical capacity, energy efficiency, and embodied carbon in CVEN90060, flood risk and coastal sediment transport under hydraulic variability in CVEN90051, and precinct-scale sustainability trade-offs in CVEN90044. | All assessments must preserve unscripted decision-making under physical load and environmental uncertainty, avoiding multiple-choice calculation drills | [16] |
