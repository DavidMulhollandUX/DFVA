...
const content = {
  title: "Master of TESOL (MC-TESOL) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of TESOL (MC-TESOL)
...
**Assessment date:** 2026-08-15 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-tesol.md
**Position basis:** Destination AI Exposure 92.44 (partial basis) × Curriculum Adaptiveness 9/15 (v4.2 draft, sub-scale A) · Workplace practice 3/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
Operating in a high AI exposure domain (**92.44**, slightly above the portfolio median of 90.9), the program achieves a maximum score in **C4: 3 / 3** (a compulsory student-scoped final-semester inquiry capstone or supervised research project). However, Adaptiveness sits at **9 / 15** and Workplace Practice at **3 / 9** because AI language evaluation tools are absent from core units (**C3: 1 / 3**), inquiry design lacks assessed primary data collection in core units (**C5: 1 / 3**), collaborative practice rests on a single group task without human-plus-AI task allocation (**C1: 2 / 3**), assessed reflection lacks longitudinal reliance logs (**C2: 2 / 3**), spoken communication is internal to the tutorial group (**W1: 1 / 3**), authentic practitioner lesson design is restricted to electives (**W2: 1 / 3**), and supervised practicum teaching is confined to the VIT-gated EAL specialisation (**W3: 1 / 3**).

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 2 | Direct — Market §2 Signal 3 and §3 Theme 1 emphasize that language teachers must critically evaluate automated grammar and pronunciation tools; core contains no assessed AI modules. | 1 |
| C5 Inquiry & evidence generation | Adaptive | 1 / 3 | 2 | Direct — Language educators conduct classroom-based action research with learner data; core methods unit assesses only an annotated bibliography without data collection. | 2 |
| W1 Professional communication & conduct | Workplace | 1 / 3 | 2 | Direct — Academic coordinators present curriculum pitches and NEAS compliance audits; core assesses internal classroom discussions only. | 3 |
| W2 Authentic task design | Workplace | 1 / 3 | 2 | Direct — Coursework is dominated by academic essays and reports; authentic lesson plans sit only in electives. | 4 |
| W3 Work-situated learning | Workplace | 1 / 3 | 2 | Direct — 22-day supervised teaching placement is restricted to the VIT-registered EAL specialisation rather than guaranteed across the degree. | 5 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Direct — Language teaching in schools and ELICOS requires multidisciplinary co-teaching with mainstream faculty and AI tool coordination. | 6 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Direct — Language educators must audit AI writing generators for sociolinguistic bias; core lacks process-focused reliance logs. | 7 |
...
|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Introduce an assessed module in core coursework on evaluating AI language generators (ChatGPT), automated grammar tools, and sociolinguistic bias limits. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Introduce an assessed language AI governance audit: students critique commercial automated language testing and scoring algorithms against ACTA fairness and dialectal diversity standards. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 1 → 2 | "Students design and conduct an inquiry with methodology selection and data collection, assessed." | In core educational research subjects, require students to collect and analyse primary language learner data (interviews, writing samples) rather than solely reviewing literature. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C5 Inquiry & evidence generation | 2 → 3 | "A substantial project generating primary evidence is REQUIRED (not one route among several), with methodology defended under scrutiny (viva, defence, or staged supervised review)." | Require all students to complete an empirical classroom inquiry project generating primary evidence, with methodology defended under staged supervised review. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 1 → 2 | "At least one core assessment requires a recognised professional genre or an audience beyond the teaching team — client brief, consultancy or policy advice, clinical handover, pitch, public-facing artefact — judged against criteria drawn from professional practice." | Replace internal presentations with an assessed ELICOS curriculum proposal or NEAS quality review brief judged by external language center directors. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W1 Professional communication & conduct | 2 → 3 | "Professional communication is assessed repeatedly and progressively across the program AND at least one core assessment is delivered to, or judged by, a real external audience or practitioner (industry panel, client, patient or simulated patient, public exhibition), with professional conduct or accountability explicitly among the assessed criteria." | Formalize a professional symposium where students present curriculum designs to practicing school principals and ELICOS directors with assessed professional conduct rubrics. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 1 → 2 | "At least one core assessment reproduces a professional task end to end: a real or realistic problem, producing the artefact a practitioner would produce, judged against criteria drawn from practice." | Introduce an assessed end-to-end differentiated lesson sequence and assessment rubric into the core, judged against ACTA professional standards. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| W2 Authentic task design | 2 → 3 | "Such tasks are the program's assessment spine rather than a single instance (a capstone plus earlier scaffolding, or at least one per stage) AND at least one carries a genuine constraint of practice — an ambiguous or externally supplied problem, real resource/time limits, a consequential audience, or the profession's own standards of performance." | Establish an authentic task spine across core units requiring multimodal materials design, diagnostic learner profiling, and capstone curriculum plans replacing academic essays. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| W3 Work-situated learning | 1 → 2 | "A core unit places students in a real workplace or professional-community setting with practitioner supervision and assessment — placement, practicum, live client project, community-based project — OR, for a cohort documented as already practising in the profession, a core unit assesses activity conducted in the student's own professional practice with real recipients and a documented outcome measure — but it is short or stands alone." | Embed a compulsory teaching practicum or supervised language classroom observation placement into the degree core for all students. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | In the core pedagogy curriculum, require student teacher teams to document a protocol allocating tasks between co-teachers and AI materials-generation tools. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | Require students in the capstone inquiry project to maintain an assessed reliance log justifying decisions to override AI-generated lesson scaffolds and learner feedback. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C3 | ELT curriculum designers deploy AI writing tools; teachers need assessed capabilities and sociolinguistic bias evaluation skills. | §2 Signal 2; §3 Theme 1 | HIGH (ACTA guidelines) |
| P2 | C5 | Language teachers must conduct empirical diagnostic assessments and action research on second language acquisition. | §1 Job Family 1; §3 Theme 3 | HIGH (TESOL Quarterly literature) |
| P3 | W1 | ELICOS coordinators and EAL leading teachers present curriculum frameworks to school leadership and NEAS auditors. | §1 Job Family 2; §3 Theme 3 | HIGH (NEAS quality standards) |
| P4 | W2 | Schools and language colleges require practitioner-ready differentiated lesson sequences and multimodal learning resources. | §2 Signal 6; §3 Theme 3 | HIGH (VIT standards) |
| P5 | W3 | Professional registration and ELICOS accreditation mandate supervised classroom teaching practice. | §2 Signal 5; §3 Theme 2 | HIGH (AITSL & NEAS standards) |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C3 | Add an assessed module evaluating AI language generation tools, writing assistants, and bias limits | C3 level 2 (capabilities and limits discussed/assessed) | Low | Year 1 Term 1; syllabus update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P2 | C5 | Require assessed primary language learner data collection and analysis in the core research methods subject | C5 level 2 (methodology selection and data collection) | Low | Year 1 Term 2; syllabus update | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| P3 | W1 | Replace internal presentations with an assessed ELICOS curriculum proposal judged by industry practitioners | W1 level 2 (recognised professional genre) | Low | Year 2 Term 1; assessment brief update | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| P4 | W2 | Introduce an assessed differentiated lesson sequence judged against ACTA professional standards | W2 level 2 (reproduces professional task) | Low | Year 2 Term 1; syllabus update | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | FAIL | Every TESOL-specialist subject sits in optional elective pools; compulsory core is generic Master of Education content without sequenced prerequisites or accreditation. | Program redesign must mandate a compulsory TESOL specialist core (SLA, grammar pedagogy, language methodology) with staged progression chains. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | Compulsory final-semester self-scoped research inquiry capstone directly related to the student's professional practice, plus critical evaluation of evidence in policy debates. | Redesign must preserve independent inquiry design and unscripted pedagogical problem-solving. | [16] |
...
|---|---|---|---|---|---|---|
| P1 | C3 | 1 | 2 | +1 adaptive | 10 / 15 | 3 / 9 |
| P2 | C5 | 1 | 2 | +1 adaptive | 11 / 15 | 3 / 9 |
| P3 | W1 | 1 | 2 | +1 workplace | 11 / 15 | 4 / 9 |
| P4 | W2 | 1 | 2 | +1 workplace | 11 / 15 | 5 / 9 |
