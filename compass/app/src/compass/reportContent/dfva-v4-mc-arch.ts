...
const content = {
  title: "Master of Architecture (MC-ARCH) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Architecture (MC-ARCH)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/mc-arch (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 38 pages captured
**Course Director:** Dennis Prior
...
| C3 Digital & AI literacy, including governance [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) | 1 | Level 1 anchor — AI appears as electives and digital content appears at the level of tool operation. AI is named in a core learning outcome in Architectural Practice, but R2 binds: that subject's four assessment tasks (procurement letters, contract-administration letters, class participation, invigilated exam) nowhere document AI or digital-technology content being assessed, so an outcome statement cannot carry level 2. Dedicated AI and machine-learning content sits in the architecture electives (AI in Architectural Design and Practice; Computational Design and Optimisation), and the core studios introduce 'digital tools' as technique support. Not level 2: no core unit is documented as addressing AI capabilities AND limitations/ethics with use-with-limits assessed; not level 3: no core assessment requires critique or governance of AI systems (bias, accountability, transparency, regulation, data governance). |
| C4 Life-long learning & transfer [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) | 3 | Level 3 anchor — the program documents structured progression toward independent learning through a self-scoped capstone, and it is carried by assessment rather than outcome statements. Design Thesis is a required core capstone named in the course structure; students scope their own research question and thesis statement in an assessed Week 4 proposal, refine it in an assessed Week 8 interim crit, and are hurdled on a resolved thesis that explores that self-set question, with the studios explicitly framed around self-directed research inquiries. The staging (proposal to interim to resolved, each separately weighted) is the documented progression the anchor asks for. Ambiguity noted: 'opportunities for' is hedged language, but the assessed proposal task applies to all students in the subject. |
...
The market intelligence gathered for this program indicates sustained demand across leading architectural practices (Woods Bagot, HASSELL, Architectus, Cox Architecture, BVN), urban design consultancies, and government planning authorities, alongside rapid adoption of BIM/Revit workflows and generative AI design tools that heighten the demand for statutory constructability and NCC compliance auditing.
...
| --- | --- | --- | --- | --- |
| C3 Digital & AI literacy, including governance | 1/3 | Add an assessed module in core architectural technology analyzing AI generative design capabilities, structural limits, and ethical IP considerations; introduce an assessed statutory AI governance audit. | Syllabus development for statutory AI and NCC compliance auditing. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W3 Work-situated learning | 1/3 | Embed a compulsory live client project with real community stakeholders and registered architect co-supervision into a core studio, or establish an extended required architectural office placement sequence. | Community partner liaison and workplace supervision quality assurance under HESF 5.4.1. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C1 Distributed cognition & relational capability | 2/3 | In Applied Architectural Technology, require student teams to document a protocol allocating tasks between architects, structural consultants, and generative AI scripting tools. | Designing interdisciplinary human-and-AI collaboration rubrics. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2/3 | In the studio design booklets, require students to document and justify reliance decisions over AI visualisation tools and defend overriding automated parametric suggestions. | Teaching-team time to review student reliance logs against architectural principles. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C5 Inquiry & evidence generation | 2/3 | Require an examined oral viva defence of design research methodology before a panel of registered architects for the Design Thesis. | Scheduling external examiner panels and calibrating viva criteria. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2/3 | In the final thesis crit, formalize external registered architects as official marking panellists with assessed professional conduct criteria. | Industry guest panellist coordination and rubric moderation. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
