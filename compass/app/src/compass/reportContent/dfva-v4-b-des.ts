...
const content = {
  title: "Bachelor of Design (B-DES) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Bachelor of Design (B-DES)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/b-des (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 35 pages captured
**Course Director:** Janet McGaw
...
| Junior roles asking for evidence of research and decision rationale | Rising | C2, C5 |
| Commodity visual-production tasks increasingly bundled or automated | Rising (automation) | W2, C4 |
| Cross-functional collaboration requirements across product, engineering, data and marketing | Rising | C1, W1 |
| High-volume static asset production, as standalone signal value | Declining | W2 |
| Template adaptation without rationale | Declining | C2 |
| Tool operation without verification | Declining | C3 |
| Surface-only portfolio polish, against evidence-backed research and impact metrics | Declining | C5 |
| Isolated creative output, against cross-functional delivery and stakeholder alignment | Declining | C1, W1 |
| Decision quality under ambiguity; systems-level design and governance; AI workflow supervision and QA | Rising | C2, C3, C4 |

**Confidence, restated from the market report.** Medium overall. What the report calls strong is the *directional* consistency across mainstream job-market and professional discourse signals. What it calls limited is everything quantitative: there was no API-fed count extraction in that run, so the table above carries directions, not magnitudes, and no posting-count claim should be read into it. The report's own recommended fix is a structured scraping pipeline for dated posting counts by role family and region.

> **This market report is a handbook vintage behind.** It was assessed against the 2025 handbook; the Panel C scoring in §2 above is from the 2026 capture. Nothing in the signals above is vintage-sensitive at the level of direction, but a reader comparing a specific subject reference between the two sections should check which year it comes from.
...
| --- | --- | --- | --- | --- |
| C1 Distributed cognition & relational capability | 1/3 | Cross-functional delivery and stakeholder alignment are named as rising against isolated creative output, and design-system governance — coordinating other people's work against a shared standard — is now named in postings. Assessed group work is documented in the captured subjects, but under an Electives heading, so no student is guaranteed it | Low as teaching, high as governance: the activity already exists. The cost is the course rule that puts it in a compulsory list, plus publishing the assessment criteria that the captured pages do not show | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 1/3 | Junior roles are asking for "evidence of research and decision rationale" and template adaptation without rationale is named as declining. Studio critique points are documented, which is the right activity — but no assessment criteria, rubrics or exemplars appear for any task in any captured subject, which independently defeats the level-2 anchor even where the task is right | Low — this is the cheapest lever in the program: publishing criteria already in use, rather than designing anything new | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1/3 | Postings expecting AI-assisted workflow capability are rising, and "tool operation without verification" is explicitly named as declining signal value — the market is asking for the verification, which is the part the curriculum does not document | Medium — AI workflow supervision and QA content can sit inside existing studio subjects, but the governance step needs a discipline-specific case built around design tooling | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C4 Life-long learning & transfer | 1/3 | Commodity visual production is being bundled and automated, so the retained work concentrates in unfamiliar problems. A cross-context planning transfer task is documented in the captured subjects — again as an elective | Medium once a core exists; the task itself is already designed and running | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 1/3 | Evidence-backed research and impact metrics are named as rising against surface-only portfolio polish. Assessed site-observation and field-study data collection are documented, and C5 is the one adaptive item whose level-2 anchor carries no core clause — so it can move before the structural question is settled | Low, and it is the one adaptive lever available without a course-rule change | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 1/3 | Cross-functional collaboration across product, engineering, data and marketing is rising. A 40 per cent hurdle oral presentation and a 20-minute technical interview for a named professional role are both documented — genuinely professional genres — but as electives and without criteria | Low to publish criteria and place one such task in a required list; high for an externally judged version | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 1/3 | Built-environment design support carries medium-high substitution pressure with regulatory interpretation rising, and the entry artefacts across the families are specific: documentation packs, compliance sets, journey maps, prototypes. The studio work is close to this already; what is missing is criteria drawn from practice and a required placement in the structure | Low to medium — the tasks exist; the gap is documentary and structural rather than pedagogic | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| W3 Work-situated learning | 1/3 | Entry titles across five of six job families are practice-situated, so the destination set is unusually placement-shaped. No work-situated learning is documented in the captured structure as a requirement | High, and the market case is the weakest of the eight: the market report makes no employment-rate claim, and work-integrated learning is not evidenced to raise employment rates [[28]](https://doi.org/10.1007/s10734-017-0216-z). Required placement can also disadvantage students who cannot afford unpaid work or relocation [[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
...
**Not scoreable from the handbook** (5):
