...
const content = {
  title: "Doctor of Optometry (MC-DOPTOM) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Doctor of Optometry (MC-DOPTOM)
...
**Assessment date:** 2026-08-14 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-doptom.md
**Position basis:** Destination AI Exposure 63.31 (exact basis) × Curriculum Adaptiveness 9/15 (v4.2 draft, sub-scale A) · Workplace practice 9/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
Operating in a moderate AI exposure domain (**63.31**, below the portfolio median of 90.9), the program achieves a **perfect score across Workplace Practice (9 / 9)**, driven by real patient examinations, signed clinical logs, multi-source feedback (W1: 3/3), a practice-reproducing assessment spine of competency examinations and OSCE hurdles (W2: 3/3), and an extended 1,000+ hour clinical internship across teaching clinics, public hospitals, and external practices (W3: 3/3). In Adaptiveness (**9 / 15**), it achieves a maximum score in **C5: 3 / 3** (compulsory research project with primary experimental data on humans/animals, staged proposal hurdles, and publication-ready manuscript). However, AI literacy sits at **C3: 0 / 3** because generative and diagnostic AI tools are entirely absent from the assessed core, while C1, C2, and C4 sit at 2/3.

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | Adaptive | 0 / 3 | 3 | Direct — Market §2 Signal 1 and §3 Theme 1 emphasize that optometrists must audit AI retinal screening (LumineticsCore) and OCT tools under OBA legal liability; core currently lacks assessed AI modules. | 1 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Direct — Modern clinical eye care coordinates optometrists, ophthalmologists, GPs, and automated diagnostic AI platforms. | 2 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Direct — Core assesses peer evaluation of MCQs, but lacks assessed reliance/override logs over automated retinal lesion and OCT diagnostic suggestions. | 3 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Direct — Research capstone is supervisor-scoped rather than self-scoped; students need independent problem framing to adapt to evolving ophthalmic technologies. | 4 |
...
|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | 0 → 1 | "AI or digital tools appear only as electives or as tool operation/training — the operational level TEQSA identifies as non-durable." | Introduce training on digital ophthalmic instruments and automated visual field / retinal imaging software into pre-clinical units. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Introduce an assessed module in Year 3 Clinical Optometry on autonomous retinal screening AI (diabetic retinopathy and macular degeneration), OCT algorithms, system limits, and clinician legal liability. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Introduce an assessed clinical AI governance audit: students critique ophthalmic deep-learning screening systems against OBA statutory duty of care, demographic training bias, and Medicare billing frameworks. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | In the Year 3 clinical training subject, require student clinical pairs to document a protocol allocating diagnostic tasks between optometrist, optical dispenser, and automated refraction/OCT screening systems. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | In the Year 4 Optometry Internship portfolio, require students to document and justify clinician override decisions when evaluating AI-flagged retinal pathology or automated OCT segmentation errors. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C4 Life-long learning & transfer | 2 → 3 | "The program documents structured progression toward independent learning: a self-scoped capstone or research project, or assessed identification of one's own knowledge gaps together with the plan to close them." | In the Year 2 capstone research project, require students to independently frame and self-scope their own clinical research questions and experimental protocols under faculty mentorship. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C3 | Optical retail chains and hospital clinics deploy AI retinal screening; clinicians carry non-delegable statutory liability for misdiagnoses. | §2 Signal 1; §3 Theme 1 | HIGH (Optometry Australia & Clinical and Experimental Optometry) |
| P2 | C2 | Overriding deep-learning retinal diagnostic suggestions requires documented evidence to justify clinical management. | §1 Job Family 1; §3 Theme 1 | HIGH (OBA registration guidelines) |
| P3 | C1 | Multidisciplinary eye care requires seamless task coordination between optometrists, ophthalmologists, and automated imaging tools. | §1 Job Family 2; §3 Theme 2 | HIGH (OCANZ competency standards) |
| P4 | C4 | Independent research framing equips graduates to evaluate emerging ophthalmic technologies throughout their careers. | §1 Job Family 5; §3 Theme 3 | HIGH (OCANZ research attributes) |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C3 | Add an assessed module on autonomous retinal screening AI, OCT algorithms, and clinician legal liability | C3 level 2 (capabilities and limits discussed/assessed) | Low | Year 3 Term 1; syllabus update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P2 | C2 | Require an assessed AI reliance and override log in the Year 4 Optometry Internship portfolio | C2 level 3 (reliance decisions documented) | Low | Year 4 Term 1; portfolio rubric update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P3 | C4 | Transition the Year 2 capstone research project to self-scoped research question formulation | C4 level 3 (self-scoped research project) | Low | Year 2 Term 1; assessment brief update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | 400 credit points of compulsory subjects accredited by OCANZ, with progressive year-by-year clinical progression moving from basic vision sciences to advanced internship. | Redesign must preserve the OCANZ statutory accreditation and prerequisite progression chain. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | Clinical performance exams requiring students to develop and defend evidence-based management plans by weighing research evidence, clinical findings, patient context, and therapeutic scope of practice. | Redesign must maintain unscripted clinical examinations with authentic diagnostic and prescribing uncertainty. | [16] |
...
|---|---|---|---|---|---|---|
| P1 | C3 | 0 | 2 | +2 adaptive | 11 / 15 | 9 / 9 |
| P2 | C2 | 2 | 3 | +1 adaptive | 12 / 15 | 9 / 9 |
| P3 | C4 | 2 | 3 | +1 adaptive | 13 / 15 | 9 / 9 |
