...
const content = {
  title: "Doctor of Philosophy - Medicine, Dentistry and Health Sciences (DR-PHILMDH) — Research Degree Report",
  institution: "University of Melbourne",
  markdown: `# DFVA RESEARCH DEGREE REPORT: Doctor of Philosophy - Medicine, Dentistry and Health Sciences (DR-PHILMDH)
...
Carried from [the v1 assessment](dfva-dr-philmdh.md) as narrative. The v1 composite, its
...
Market intelligence for this program is in [the market report](dfva-market-dr-philmdh.md). **Its §3 discussion-signal section is unsourced** — it predates the sourcing
