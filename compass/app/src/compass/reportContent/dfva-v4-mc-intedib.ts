...
|---|---|---|---|---|---|
| 1 | IB Curriculum Coordination & Leadership | IB Coordinator (PYP/MYP/DP), Curriculum Lead | Director of Studies, Head of International School | LOW | IBO programme standards & practices, interdisciplinary curriculum mapping, Managebac |
| 2 | Specialist IB Classroom Teaching | IB Diploma Teacher, MYP Subject Teacher | Senior IB Examiner, Lead Pedagogical Coach | LOW–MEDIUM | Concept-based instruction, inquiry design, criterion-referenced assessment, AI integrity |
| 3 | International School Advisory & Consultancy | IB Education Consultant, School Improvement Advisor | Regional Education Director, IBO School Inspector | LOW–MEDIUM | Cross-cultural school transformation, IBO authorisation audits, teacher coaching |
| 4 | EdTech & International Curriculum Design | IB Instructional Designer, EdTech Content Lead | Head of Learning Design, Digital Curriculum Director | MEDIUM | Digital unit authoring, AI-assisted assessment rubric design, learning analytics |
