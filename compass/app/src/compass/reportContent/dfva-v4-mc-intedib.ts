...
const content = {
  title: "Master of International Education (IB) (MC-INTEDIB) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of International Education (IB) (MC-INTEDIB)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/mc-intedib (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 35 pages captured
**Course Director:** Stephen Chatelier
...
- **G1 Disciplinary foundation:** PASS — The program documents a coherent specialist core with progressive depth by two of the three routes the gate names: an accredited sequence (the course carries International Baccalaureate professional accreditation) and a staged prerequisite chain (Introduction to the IB gates the Curriculum Frameworks subject in every specialisation, Assessment & Reporting gates each Advanced subject, and Researching Education Practice gates the capstone). Content is disciplinarily specific rather than interchangeable — it is described as a specialist degree, and subject content is IB curriculum, assessment and pedagogy throughout.
- **G2 Decision-making under uncertainty:** PASS — The gate's capstone route is satisfied: the compulsory AQF capstone requires students to design their own research and plan and execute the project, with the design itself assessed (Research design report, 40% in the prerequisite subject) and the outcome assessed (Final research report, 50%) — defended methodological trade-offs under genuine uncertainty rather than recall or scripted response. The specialisation core adds designed-and-critiqued curriculum judged against IB standards. Noted as a bound: the capstone's data are supplied rather than collected, which narrows the uncertainty, and the ILO permits a literature-review route; the gate is nonetheless met on the research-design evidence.

## 4. MARKET EVIDENCE — Basis: reported

The market intelligence gathered for this program indicates strong demand across International Baccalaureate (IB) World Schools, domestic independent and Catholic colleges, international school groups (Nord Anglia, Cognita), and educational consulting agencies, accompanied by rapid adoption of digital curriculum management platforms (Managebac, Toddle) and AI-assisted lesson resource generators where concept-based inquiry facilitation, intercultural pedagogical leadership, and assessment integrity governance remain vital human capabilities under International Baccalaureate Organization (IBO) and Australian Institute for Teaching and School Leadership (AITSL) standards.

### Destination Job Families

| Job family | Entry titles | AI substitution pressure | Skills rising in that family |
| --- | --- | --- | --- |
| IB Curriculum Coordination & Leadership | IB Coordinator (PYP/MYP/DP), Curriculum Lead; later Director of Studies, Head of International School | LOW | IBO programme standards & practices, interdisciplinary curriculum mapping, Managebac |
| Specialist IB Classroom Teaching | IB Diploma Teacher, MYP Subject Teacher; later Senior IB Examiner, Lead Pedagogical Coach | LOW–MEDIUM | Concept-based instruction, inquiry design, criterion-referenced assessment, AI integrity |
| International School Advisory & Consultancy | IB Education Consultant, School Improvement Advisor; later Regional Education Director, IBO School Inspector | LOW–MEDIUM | Cross-cultural school transformation, IBO authorisation audits, teacher coaching |
| EdTech & International Curriculum Design | IB Instructional Designer, EdTech Content Lead; later Head of Learning Design, Digital Curriculum Director | MEDIUM | Digital unit authoring, AI-assisted assessment rubric design, learning analytics |

**Exposure basis declaration.** Destination AI exposure is **92.44** (exact basis derived from School Teaching / International Education destinations), sitting **above** the portfolio median of 90.9.
...
and the score deltas are in the [improvement plan](dfva-v4-recommend-mc-intedib.md); rows
below are ordered by headroom, which is not the plan's P-lever order.

| Item | Score | Implication | Cost | Sources |
| --- | --- | --- | --- | --- |
| W3 Work-situated learning | 0/3 | For this in-service teaching cohort, introduce an assessed own-practice classroom intervention project in a core subject with documented student learning outcome measures; establish a required sequence with structured reflection. | Practicum rubric design and mentor teacher liaison. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C3 Digital & AI literacy, including governance | 1/3 | Introduce an assessed module in core curriculum units on AI lesson-generation tools, automated rubric authoring, and IBO academic integrity limits; introduce an assessed educational AI governance audit. | Software tool licensing and syllabus updates. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 1/3 | Require capstone candidates in EDUC90871 to collect primary classroom pedagogical data (e.g. student work samples, classroom observation protocols) rather than relying on supplied datasets; require defended classroom inquiry. | Classroom ethics clearance and data collection support. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 1/3 | Replace internal presentations with an assessed IB curriculum proposal presentation or parent/community workshop judged against IBO communication standards; mandate external panel review. | External IB school examiner honoraria and scheduling. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| C1 Distributed cognition & relational capability | 2/3 | In curriculum planning units, require candidate teams to document a protocol allocating unit-authoring tasks between teachers, IB coordinators, and AI resource generators. | Collaborative workshop moderation time. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2/3 | Require candidates to maintain an assessed pedagogical reliance log documenting and justifying decisions to adopt or override AI-generated unit assessments and differentiated learning tasks. | Reflective logbook rubric calibration. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| W2 Authentic task design | 2/3 | Establish an authentic curriculum design spine across every stage of the degree evaluated directly against IBO Programme Standards and Practices. | Assessment spine mapping and syllabus updates. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
