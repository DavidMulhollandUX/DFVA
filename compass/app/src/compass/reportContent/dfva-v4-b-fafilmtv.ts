...
const content = {
  title: "Bachelor of Fine Arts (Film and Television) (B-FAFILMTV) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Bachelor of Fine Arts (Film and Television) (B-FAFILMTV)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/b-fafilmtv (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 36 pages captured
**Course Director:** Andrew Blogg
...
> **This program is outside the v3.1 registry, but not outside Panel A.** Bachelor of Fine Arts (Film and Television)
...
| --- | --- | --- |
| C1 Distributed cognition & relational capability [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) | 2 | Meets Level 2: assessed collaborative crewing practice recurs across the program (hurdle-backed crewing duties in FLTV10006, FLTV10008, FLTV20006, FLTV20009, FLTV30027; graded Story Team exercises in FLTV20008). Does not reach Level 3 — no evidence of an assessment requiring coordination across people AND tools/AI systems. |
| C2 Hybrid metacognition & evaluative judgement [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) | 2 | Meets Level 2: Languages of the Screen grades a '5-minute presentation: critical appraisal of performance direction' (10%) — a criterion-referenced appraisal-of-quality task, not unassessed reflection. No evidence of Level 3 (documented reliance-decision justification on a tool/source/collaborator). |
| C3 Digital & AI literacy, including governance [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) | 1 | Matches Level 1: digital-tool content is confined to a generic 'employ technological resources' outcome in a core subject and operating accounting/budgeting systems in the Movies and Money 1 elective — both operational, not addressing capabilities/limitations/ethics as Level 2 requires. No AI content of any kind appears in the extract. |
| C4 Life-long learning & transfer [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) | 2 | Meets Level 2: each Screen Practice subject requires a new, escalating-complexity produced project (case variation). The 3A/3B capstone shows students devising their own screenplay, suggestive of Level 3's self-scoped capstone, but format/duration/weighting are course-prescribed; resolved to Level 2 per the lower-level ambiguity rule. |
| C5 Inquiry & evidence generation [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) | 2 | Meets Level 2: Screen Culture and Industry Perspectives both grade an interview-based investigation/research paper on a real industry professional — assessed primary data collection with implicit methodology (interview design). No evidence of a required substantial primary-evidence project defended under scrutiny (Level 3). |
| **Adaptive capabilities** | **9 / 15** | |
| W1 Professional communication & conduct [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) | 2 | Meets Level 2: Screen Culture and Industry Perspectives require interviewing a real industry practitioner, and Industry Perspectives grades an 'Electronic press kit' (a recognised professional genre). The practitioner is documented only as an interview source, not as assessor/judge of the deliverable, so Level 3's 'judged by a real external audience or practitioner' is unevidenced. |
| W2 Authentic task design [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) | 3 | Meets Level 3: authentic film-production tasks are the program's assessment spine (graded end-to-end film production at every stage, 1A/1B through the 3B capstone, 'to an industry-recognised professional standard'), and at least one carries genuine constraints of practice — staggered production schedules, a compressed one-day shoot ('60 hours of work required'), and assessed OHS responsibilities. |
| W3 Work-situated learning [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) | 0 | Matches Level 0: no placement, practicum, live external-client project, or community-based project appears anywhere in the course structure. Crewing is entirely on internal student productions; the two festival-attendance electives are cultural-immersion study experiences, not workplace placements. |
...
> Screen Practice 3B is a capstone subject focusing on the production of a developed short film project.
>
> devise and develop an engaging and practicable screenplay for a short film;
>
> 5 to 10-minute graduate film project
>
> Direct and produce a 1 to 2-minute short film
...
>
> Practical assignments are completed within a staggered production schedule.
>
...
>
> 12.5 credit points of Film and Television Electives
>
> International Film Festival Studio
>
> Melbourne Film Festival Studio

## 3. GATES — Basis: scored

- **G1 Disciplinary foundation:** PASS — Matches PASS: an all-compulsory specialist core with a staged prerequisite chain — 237.5 of 300 credit points compulsory, gated Level 1 → 2 → 3 progression with explicit prerequisites.
- **G2 Decision-making under uncertainty:** PASS — Matches PASS via a capstone live-production project with real uncertainty and accountability — the 3B capstone follows 'industry protocols through pre-production, production, and post-production' under staggered real production schedules, not recall or scripted responses.

## 4. MARKET EVIDENCE — Basis: reported

**Destination job families (condensed from market report §1).** Film and television
graduates enter audio-visual production families — director, producer, cinematographer,
editor/post-production, screenwriter/development — crosswalked to the JSA HEO field
**100701 Audio Visual Studies**.

| Job family | Entry titles | AI substitution pressure | Skills rising in that family |
| --- | --- | --- | --- |
| Director / AD | Director, Assistant Director | MEDIUM — prep compresses; on-set judgement human | Virtual production, real-time previs |
| Producer / Production management | Producer, Line Producer | LOW — coordination and risk judgement human | AI-governance, rights-clearance tracking |
| Cinematographer / Camera | DP, Camera Operator | MEDIUM — virtual cinematography affects B-camera/insert work | LED-volume operation, colour/look AI |
| Editor / Post-Production | Editor, VFX Compositor, Colourist | HIGH (task-level) — clipping, dubbing, VFX assist automating | AI conform, multilingual dubbing, footage discovery |
| Screenwriter / Development | Writer, Script Developer | MEDIUM — ideation assist; premise and voice human | Prompt-shaped development, IP awareness |

**What the §1 exposure number is.** The Destination AI Exposure of **73.61** rests on a
**field-of-education** basis (JSA HEO field 100701) — graduates of the whole audio-visual
field, not this program's own cohort. It is compared against the field median, not the
portfolio median, and sits **at or below** it.

| Signal or shift | Direction | Bears on |
| --- | --- | --- |
| AI reshaping production workflows, post-production first (McKinsey 2025) | Compression in post/task execution; resilience in evaluative judgement | C2, C3, W2 |
| Performer digital-replica consent governed by union agreements (SAG-AFTRA 2024–2025) | New rights/consent competency in production | C3, W3 |
| Generative video reaching production footage, below premium quality (2025) | Rising tool fluency; resilient reliability judgement | C4, C5 |

**Confidence, restated from the market report.** MEDIUM. Global studio and union discourse
is well documented (McKinsey, SAG-AFTRA); Australian employer hiring volumes and local role
redesign are not sourced here and are not inferred from global signals.
...
and the score deltas are in the [improvement plan](dfva-v4-recommend-b-fafilmtv.md); rows
below are ordered by headroom, which is not the plan's P-lever order.

| Item | Score | Implication | Cost | Sources |
| --- | --- | --- | --- | --- |
| W3 Work-situated learning | 0/3 | The structure contains no work-integrated learning or industry placement; the 3B capstone is a live-production project under real schedules but is not a hosted placement, so work-situated learning is absent. | Adding a hosted industry or client-facing production placement would require displacing compulsory specialist craft credits and securing host capacity outside the faculty. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C3 Digital & AI literacy, including governance | 1/3 | AI literacy and governance sit in elective space, not core; the market treats performer-replica consent and rights-clearance as a baseline production competency. | Lifting AI governance into core needs curriculum space and staff capability in rights/AIOE that may not currently exist. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C1 Distributed cognition & relational capability | 2/3 | Collaborative practice with external audiences is present but not structured as distributed cognition with external industry stakeholders. | Adding cross-disciplinary or industry-collaboration units displaces specialist craft credits. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2/3 | Evaluative judgement is taught through critique but not yet extended to appraising AI-generated production material for reliability and premise. | Low — add AI-output appraisal to existing assessment design (documentation-only change). | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C4 Life-long learning & transfer | 2/3 | Transfer and life-long learning are present but not made explicit about tool-fluency transfer across production roles as the market shifts. | Low — reframe existing capstone reflection to name tool-fluency transfer. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 2/3 | Inquiry is present via research methods but not linked to generating or criticising AI-derived production evidence. | Low — embed AI-evidence critique within the existing research-method unit. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2/3 | Professional communication (calling, documentation) is present but not extended to AI-disclosure audiences and provenance conventions. | Low — add an AI-disclosure convention to existing communication instruction. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 3/3 | Authentic task design is at maximum — the capstone is a live, industry-protocol production with real schedules and accountability. | None — no intervention proposed and none needed. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
...
- C1: assessed collaborative crewing recurs across the program, but no evidence shows an assessment requiring coordination across people AND tools/AI systems, so the item stops at Level 2 rather than Level 3.
- C2: the 'critical appraisal of performance direction' presentation is graded criterion-referenced appraisal but appraises the student's own directorial approach via oral presentation rather than the peer-review/structured-critique/exemplar forms the Level 2 anchor names; resolved to Level 2 as assessed appraisal rather than unassessed reflection.
- C4: the Screen Practice 3A/3B capstone has students devise their own screenplay, suggestive of a self-scoped capstone (Level 3), but format/duration/weighting are course-prescribed rather than independently scoped; resolved to Level 2 per the lower-level rule.
