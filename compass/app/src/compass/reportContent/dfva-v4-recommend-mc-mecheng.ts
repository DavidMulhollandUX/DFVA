...
**Position basis:** Destination AI Exposure 85.55 (exact basis) × Curriculum Adaptiveness 10/15 (v4.2 draft, sub-scale A) · Workplace practice 5/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
| C3 Digital & AI literacy, including governance | Adaptive | 2 / 3 | 1 | Engineers Australia and Standards Australia mandate statutory safety governance for autonomous cyber-physical systems | 4 |
