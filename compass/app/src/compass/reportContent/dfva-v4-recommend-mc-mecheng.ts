...
const content = {
  title: "Master of Mechanical Engineering (MC-MECHENG) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Mechanical Engineering (MC-MECHENG)
...
**Assessment date:** 2026-08-24 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-mecheng.md
**Position basis:** Destination AI Exposure 85.55 (exact basis) × Curriculum Adaptiveness 9/15 (v4.2 draft, sub-scale A) · Workplace practice 5/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
The Master of Mechanical Engineering is an entry-to-practice degree accredited by Engineers Australia and EUR-ACE, preparing graduates for professional mechanical, mechatronics, manufacturing, and energy infrastructure careers (AI Occupational Exposure (AIOE) 85.55). The curriculum demonstrates robust technical and empirical foundations (C1: 2/3, C2: 2/3, C3: 1/3, C5: 2/3, G1 PASS) with multidisciplinary team projects in ENGR90051, design manufacturing vivas in MCEN90054, and mechanical systems prototyping in MCEN30021. However, rapid industry integration of generative CAD, automated topology optimization, and AI-accelerated simulation tools is reshaping professional engineering practice. The program's primary developmental headroom lies in formalizing human-AI engineering workflow allocation charters (C1), introducing assessed reliance and fatigue/manufacturing override logs for AI generative design tools (C2), embedding safety-critical cyber-physical AI governance (C3), and transitioning the optional STEP/internship hurdle into guaranteed work-situated placements or live industry client projects (W1, W3).

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| W3 Work-situated learning | Workplace | 1 / 3 | 2 | Engineering consultancies and heavy industry prioritize graduates with verified on-site engineering placement experience | 1 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Engineering teams must explicitly coordinate tasks between design engineers and generative AI design agents | 2 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Engineers must systematically audit and document overrides of AI topology optimization and simulation geometries | 3 |
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 1 | Engineers Australia and Standards Australia mandate statutory safety governance for autonomous cyber-physical systems | 4 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Rapid evolution of advanced materials and automation requires assessed metacognitive gap analysis and lifelong learning plans | 5 |
| C5 Inquiry & evidence generation | Adaptive | 2 / 3 | 1 | Advanced mechanical systems require experimental validation defended under rigorous external examination | 6 |
| W1 Professional communication & conduct | Workplace | 2 / 3 | 1 | Engineers must defend technical design briefs before external industry clients and chartered professional engineer panels | 7 |
| W2 Authentic task design | Workplace | 2 / 3 | 1 | Real-world engineering carries live commercial constraints, manufacturing tolerances, and third-party client standards | 8 |
...
|---|---|---|---|---|
| W3 Work-situated learning | 1 → 2 | "A core unit places students in a real workplace or professional-community setting with practitioner supervision and assessment — placement, practicum, live client project, community-based project..." | Integrate live client engineering design briefs from industry partners across core coursework for all degree streams | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| W3 Work-situated learning | 2 → 3 | "Substantial required work-situated learning: an extended placement or practicum, or a sequence of them, in the core, supervised by a practitioner, assessed, with accountability to the host and structured reflection on professional practice..." | Expand industry internships into a guaranteed core requirement or mandatory industry-hosted practicum for the entire cohort | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | Require multidisciplinary teams in ENGR90051/MCEN90054 to submit an assessed Human-AI Engineering Workflow Charter | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | Implement an assessed 'Generative Design & Simulation Override Log' in MCEN90054 where students justify overrides of AI-generated CAD/FEA geometries | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Add an assessed component to a compulsory core subject such as ENGR90051 or MCEN90054 covering what AI and generative design tools can and cannot do in mechanical engineering, together with the ethical limits on their use, and assess practice within those limits | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Embed an assessed Cyber-Physical AI Governance & Safety Compliance Audit in core ENGR90051 evaluating statutory AS/NZS standards | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C4 Life-long learning & transfer | 2 → 3 | "The program documents structured progression toward independent learning: a self-scoped capstone or research project, or assessed identification of one's own knowledge gaps together with the plan to close them." | Embed an assessed technical capability gap analysis and lifelong professional development plan in the Engineering Practice Hurdle | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 2 → 3 | "A substantial project generating primary evidence is REQUIRED (not one route among several), with methodology defended under scrutiny (viva, defence, or staged supervised review)." | Structure the final capstone project demonstration in ENGR90038 as a formal oral viva defense of experimental and physical validation | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2 → 3 | "Professional communication is assessed repeatedly and progressively across the program AND at least one core assessment is delivered to, or judged by, a real external audience or practitioner (industry panel, client, patient or simulated patient, public exhibition), with professional conduct or accountability explicitly among the assessed criteria." | Mandate external industry panels of chartered professional engineers (CPEng) to evaluate final capstone prototypes in MCEN90054/ENGR90051 | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2 → 3 | "Such tasks are the program's assessment spine rather than a single instance (a capstone plus earlier scaffolding, or at least one per stage) AND at least one carries a genuine constraint of practice — an ambiguous or externally supplied problem, real resource/time limits, a consequential audience, or the profession's own standards of performance." | Partner with engineering enterprises to supply live, ambiguous engineering design briefs carrying real commercial and manufacturing constraints | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | W3 | Engineering consultancies and resource firms prioritize graduates with verified on-site professional placement | Section 2, Section 4 (Engineers Australia / QILT) | HIGH |
| P2 | C1 | Industry standards (ASME / EA) mandate structured collaboration between design engineers and AI simulation tools | Section 1, Section 3 (*IEEE/ASME Trans Mechatronics*) | HIGH |
| P3 | C2 | Peer-reviewed research (*J Mech Des* 2024) demonstrates evaluative judgement is critical to override flawed AI topology geometries | Section 3, Section 4 | HIGH |
| P4 | C3 | Standards Australia and Safe Work Australia require engineers to implement statutory safety and cyber-physical governance | Section 1, Section 3 | HIGH |
| P5 | W1 | Engineering employers demand graduates capable of defending physical systems designs before external client panels | Section 2, Section 4 | HIGH |
| P6 | W2 | Live engineering projects with authentic enterprise constraints reflect the operational reality of mechanical engineering | Section 2, Section 4 | HIGH |
| P7 | C5 | Academic and industry standards require experimental prototyping and physical validation defended under viva scrutiny | Section 3, Section 4 | HIGH |
| P8 | C4 | Rapid continuous evolution of advanced materials and automation requires assessed gap analysis and lifelong learning plans | Section 2, Section 4 | HIGH |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C1 | Require teams in ENGR90051/MCEN90054 to submit an assessed Human-AI Engineering Workflow Charter | C1 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022) |
| P2 | C2 | Implement an assessed Generative Design & Simulation Override Log in MCEN90054 Design and Manufacturing Practice | C2 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P3 | C3 | Embed an assessed Cyber-Physical AI Governance & Safety Compliance Audit assignment in core ENGR90051 | C3 Level 3 | Medium | Term 2 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P4 | W1 | Mandate external industry panels of chartered professional engineers to evaluate final project prototypes in MCEN90054 | W1 Level 3 | Medium | Term 2 | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined) |
| P5 | W2 | Partner with engineering companies to supply live, ambiguous engineering briefs with real production constraints | W2 Level 3 | Medium | Term 2 | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| P6 | C4 | Embed an assessed engineering capability gap analysis and professional development portfolio in the Practice Hurdle | C4 Level 3 | Medium | Term 2 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2) |
| P7 | C5 | Implement a formal oral viva defense for the final engineering design and experimental validation in ENGR90038 | C5 Level 3 | Medium | Term 2 | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| P8 | W3 | Embed live externally mentored client engineering projects into core coursework for all degree specialisations | W3 Level 2 | High | Term 3 | [[19]](https://www.legislation.gov.au/F2021L00488)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | PASS condition is met: the program documents a comprehensive 300-point Engineers Australia and EUR-ACE accredited master's curriculum spanning engineering mathematics, solid mechanics, fluid dynamics, thermodynamics, materials science, dynamics, control systems, and mechanical systems design. Rigorous, coherent engineering core. | Any curriculum redesign must preserve the rigorous mathematical, mechanical, and thermal-fluids foundations mandated by Engineers Australia accreditation. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | PASS condition is met: assessment explicitly requires complex engineering trade-off decisions under physical and operational uncertainty — including optimizing aerodynamic and thermal efficiency against weight and manufacturing tolerances in MCEN90054, tuning closed-loop control stability under unmodeled plant dynamics in ELEN90055, and resolving competing structural stiffness versus cost constraints under physical prototyping limits in ENGR90051. | Interventions must maintain authentic, complex engineering trade-offs and physical prototyping decisions rather than oversimplifying to closed-form analytical tasks. | [16] |
...
|---|---|---|---|---|---|---|
| P1 | C1 | 2 | 3 | +1 adaptive | 11 / 15 | 5 / 9 |
| P2 | C2 | 2 | 3 | +1 adaptive | 12 / 15 | 5 / 9 |
| P3 | C3 | 2 | 3 | +1 adaptive | 13 / 15 | 5 / 9 |
| P4 | W1 | 2 | 3 | +1 workplace | 13 / 15 | 6 / 9 |
| P5 | W2 | 2 | 3 | +1 workplace | 13 / 15 | 7 / 9 |
