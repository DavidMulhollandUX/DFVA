...
const content = {
  title: "Master of Clinical Audiology (305BB) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Clinical Audiology (305BB)
...
**Assessment date:** 2026-08-17 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-305bb.md
**Position basis:** Destination AI Exposure 81.09 (exact basis) × Curriculum Adaptiveness 10/15 (v4.2 draft, sub-scale A) · Workplace practice 9/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
Under moderate exposure (**81.09**, below portfolio median), the primary area of curriculum headroom lies in Adaptiveness (**10 / 15**), specifically C3 (1/3). While the curriculum covers operational hearing device fitting, it lacks explicit critical appraisal and governance of machine learning algorithms (e.g. deep neural network noise filtering, automated tablet audiometry) and health data privacy. Modest headroom also exists in C1 (2/3), C2 (2/3), and C4 (2/3) to introduce human-and-AI collaborative protocols, AI reliance/override logs, and student-scoped inquiry framing.

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 2 | Direct — Market §2 Signal 3 and §3 Theme 1 document rapid integration of on-chip deep neural networks (DNNs) in hearing aids and automated tablet audiometry; clinicians require training to critically audit algorithmic acoustic presets against real-ear measurements (REM). | 1 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Direct — Core assesses extensive team-based case presentations, but lacks explicit protocols allocating roles across clinicians and automated diagnostic/fitting systems. | 2 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Direct — Market §3 Theme 1 highlights that automated manufacturer fittings often fail patient-specific auditory processing needs; students need assessed practice documenting when they override automated device settings. | 3 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Direct — Core assesses complex multifaceted case variations, but the capstone inquiry problem is staff-supported rather than independently self-scoped. | 4 |
...
| W1 Professional communication & conduct | Workplace | 3 / 3 | 0 | None — no intervention proposed and none needed. | — |
...
|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Add an assessed module in hearing device science analyzing on-chip deep neural network (DNN) noise reduction, automated audiometry limits, and patient data privacy. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Introduce an assessed clinical algorithmic governance problem in Year 2: students audit automated diagnostic screening bias, tele-audiology data security, and regulatory accountability. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | In the Audiology Research Project capstone, require student teams to document and defend an explicit collaboration protocol allocating tasks between clinicians, biostatistical tools, and automated testing devices. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | In the longitudinal E-portfolio, introduce a formal requirement to document and justify instances where automated hearing aid fitting algorithms or diagnostic thresholds were clinically overridden. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C4 Life-long learning & transfer | 2 → 3 | "The program documents structured progression toward independent learning: a self-scoped capstone or research project, or assessed identification of one's own knowledge gaps together with the plan to close them." | Require an assessed independent clinical learning plan in Year 2 where students formally audit their procedural and diagnostic gaps and design a structured post-graduation CPD pathway. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C3 | Manufacturers deploy deep neural networks for noise reduction; audiologists must audit algorithmic presets against real-ear measurements. | §2 Signal 3; §3 Theme 1 | HIGH (NAL technical reports) |
| P2 | C2 | Over-reliance on automated hearing aid programming leads to poor clinical outcomes; clinicians must justify overriding software presets. | §3 Theme 1; §4 rising skills | HIGH (AudA practice guidelines) |
| P3 | C1 | Clinical audiology operates in interdisciplinary teams coordinating ENT surgeons, speech pathologists, and automated audiological equipment. | §1 Job Families 1 & 4; §3 Theme 2 | HIGH (hospital clinical benchmarks) |
| P4 | C4 | Rapid technological evolution in auditory prosthetics requires clinicians to identify emerging knowledge gaps and self-direct professional development. | §1 Job Family 3; §4 rising skills | HIGH (AudA CCP CPD standards) |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C3 | Add an assessed module on deep neural network noise reduction and automated audiometry limits | C3 level 2 (capabilities and limits discussed/assessed) | Low–Medium | Year 1 Term 2; curriculum update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P2 | C3 | Introduce an assessed clinical algorithmic governance problem in Year 2 | C3 level 3 (critique and governance of AI in context) | Medium | Year 2 Term 1; subject update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P3 | C2 | Introduce an assessed algorithmic override and reliance section in the E-portfolio | C2 level 3 (reliance/override justification) | Low | Year 1 Term 2; E-portfolio rubric update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P4 | C1 | Require an assessed team-and-tool collaboration protocol in the capstone | C1 level 3 (people and tools collaboration assessed) | Low–Medium | Year 2 Term 1; capstone brief update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| P5 | C4 | Embed an assessed clinical CPD gap analysis and learning plan in Year 2 | C4 level 3 (assessed gap identification and plan) | Low | Year 2 Term 2; assessment update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | The gate's PASS condition — 'a coherent specialist core with progressive technical or methodological depth: an all-compulsory specialist core, an accredited sequence, or a staged prerequisite chain' — is satisfied on all three routes simultaneously. Every one of the 200 credit points is compulsory, all twelve subjects carry the single AUDI discipline prefix, the paired A/B subjects and Year 2 advanced subjects form a staged depth chain, progression from Year 1 to Year 2 is gated on completing all first-year subjects, and the course is built to a named regulator's registration requirements with professional accreditation. Nothing here is generic or interchangeable. | Redesign must strictly maintain full alignment with Audiology Australia accreditation and registration requirements. Adding AI governance or collaboration rubrics must not compromise clinical practicum hours or diagnostic competency milestones. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | The gate's PASS condition — 'Assessments require defended trade-off decisions, or simulations/capstones/live projects with real uncertainty and accountability' — is met on both routes. Defended trade-offs: a compulsory subject requires weighing evidence-based methodology to differentially diagnose and plan, and another requires justifying a management plan against competing considerations (research evidence, clinical expertise, the individual patient, the practice context). Uncertainty with accountability: hurdle-gated OSCEs and a clinical simulation patient exam, a year-long complex-case subject explicitly framed around external and internal constraints, and a capstone research project whose methodology is defended orally under a hurdle. This is not recall or scripted response. | Assessment tasks must preserve live simulated patient interactions, unscripted clinical OSCE stations, and defended oral research examinations. | [16] |
...
|---|---|---|---|---|---|---|
| P1 | C3 | 1 | 2 | +1 adaptive | 11 / 15 | 9 / 9 |
| P2 | C3 | 2 | 3 | +1 adaptive | 12 / 15 | 9 / 9 |
| P3 | C2 | 2 | 3 | +1 adaptive | 13 / 15 | 9 / 9 |
| P4 | C1 | 2 | 3 | +1 adaptive | 14 / 15 | 9 / 9 |
| P5 | C4 | 2 | 3 | +1 adaptive | 15 / 15 | 9 / 9 |
