...
**Position basis:** Destination AI Exposure 90.73 (exact basis) × Curriculum Adaptiveness 10/15 (v4.2 draft, sub-scale A) · Workplace practice 5/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
The Master of Management provides generalist and functional training for management consultants, business analysts, operations managers, and corporate leaders (AIOE 90.73). The program demonstrates solid collaborative and analytical foundations across the core (C1: 2/3, C2: 2/3, C3: 2/3, C5: 2/3, G1 PASS) via capstone board reports in MGMT90146, business analysis in MGMT90141, and decision analytics in MGMT90280. However, routine market synthesis, slide drafting, financial memo authoring, and operational KPI reporting are heavily automated by enterprise LLMs. The program's developmental headroom lies in formalizing human-AI workflow allocation charters (C1), introducing assessed reliance and hallucination verification logs for AI strategic outputs (C2), establishing systemic AI workforce governance and algorithmic transparency (C3), and transitioning optional business practicums into guaranteed core consulting engagements with live corporate clients (W1, W3).
...
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Management teams must explicitly coordinate work between human strategists and autonomous AI market intelligence agents | 2 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Managers must systematically evaluate and document overrides of AI-generated market scenario analyses and financial models | 3 |
| C3 Digital & AI literacy, including governance | Adaptive | 2 / 3 | 1 | AICD and ASIC corporate governance standards mandate algorithmic accountability, privacy compliance, and workforce ethics | 4 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Rapid structural changes across industries demand assessed metacognitive gap analysis and lifelong professional development | 5 |
| C5 Inquiry & evidence generation | Adaptive | 2 / 3 | 1 | Strategic management recommendations require empirical business evidence defended under rigorous oral examination | 6 |
...
| P7 | C5 | Implement a formal oral board defense for the final Capstone Board Report in MGMT90146 | C5 Level 3 | Medium | Term 2 | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
