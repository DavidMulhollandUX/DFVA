...
const content = {
  title: "Master of Management (MC-MGMT) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Management (MC-MGMT)
...
**Assessment date:** 2026-08-24 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-mgmt.md
**Position basis:** Destination AI Exposure 90.73 (exact basis) × Curriculum Adaptiveness 8/15 (v4.2 draft, sub-scale A) · Workplace practice 5/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
The Master of Management provides generalist and functional training for management consultants, business analysts, operations managers, and corporate leaders (AI Occupational Exposure (AIOE) 90.73). The program demonstrates solid collaborative and evaluative foundations across the core (C1: 2/3, C2: 2/3, C4: 2/3, G1 PASS) via capstone board reports in MGMT90146, business analysis in MGMT90141, and decision analytics in MGMT90280, while AI literacy and inquiry sit at the floor (C3: 1/3, C5: 1/3). However, routine market synthesis, slide drafting, financial memo authoring, and operational KPI reporting are heavily automated by enterprise LLMs. The program's developmental headroom lies in formalizing human-AI workflow allocation charters (C1), introducing assessed reliance and hallucination verification logs for AI strategic outputs (C2), requiring an assessed inquiry with methodology selection and data collection (C5), bringing AI capabilities and their limits into core assessment on the way to systemic AI workforce governance and algorithmic transparency (C3), and transitioning optional business practicums into guaranteed core consulting engagements with live corporate clients (W1, W3).

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| W3 Work-situated learning | Workplace | 1 / 3 | 2 | Top consulting firms and enterprises prioritize graduates with verified client consulting engagement experience | 1 |
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 2 | AICD and ASIC corporate governance standards mandate algorithmic accountability, privacy compliance, and workforce ethics | 2 |
| C5 Inquiry & evidence generation | Adaptive | 1 / 3 | 2 | Strategic management recommendations require empirical business evidence defended under rigorous oral examination | 3 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Management teams must explicitly coordinate work between human strategists and autonomous AI market intelligence agents | 4 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Managers must systematically evaluate and document overrides of AI-generated market scenario analyses and financial models | 5 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Rapid structural changes across industries demand assessed metacognitive gap analysis and lifelong professional development | 6 |
| W1 Professional communication & conduct | Workplace | 2 / 3 | 1 | Consultants and executives must defend strategic board reports before external corporate directors and client panels | 7 |
| W2 Authentic task design | Workplace | 2 / 3 | 1 | Real-world management carries ambiguous client politics, uncurated enterprise data, and live commercial constraints | 8 |
...
|---|---|---|---|---|
| W3 Work-situated learning | 1 → 2 | "A core unit places students in a real workplace or professional-community setting with practitioner supervision and assessment — placement, practicum, live client project, community-based project..." | Integrate live corporate client strategic consulting projects from industry partners across core coursework for all degree streams | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| W3 Work-situated learning | 2 → 3 | "Substantial required work-situated learning: an extended placement or practicum, or a sequence of them, in the core, supervised by a practitioner, assessed, with accountability to the host and structured reflection on professional practice..." | Expand business practicums into a guaranteed core requirement or mandatory industry-hosted consulting practicum for the entire cohort | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | Require capstone teams in MGMT90146 to submit an assessed Human-AI Management Workflow Charter dividing tasks between human analysts and AI strategic agents | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | Implement an assessed 'AI Strategy & Analytics Override Log' in MGMT90146/MGMT90280 where students justify overrides of AI-generated market scenario analyses | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Bring AI capabilities and their limitations and ethics into a core subject — MGMT90140 or MGMT90280 — and assess use with limits rather than software operation | Embed an assessed module in core MGMT90140/MGMT90280 examining algorithmic bias, AI workplace surveillance, and corporate data governance |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Embed an assessed module in core MGMT90140/MGMT90280 examining algorithmic bias, AI workplace surveillance, and corporate data governance | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C4 Life-long learning & transfer | 2 → 3 | "The program documents structured progression toward independent learning: a self-scoped capstone or research project, or assessed identification of one's own knowledge gaps together with the plan to close them." | Embed an assessed managerial capability gap analysis and lifelong executive development portfolio across the core sequence | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 1 → 2 | "Students design and conduct an inquiry with methodology selection and data collection, assessed." | Require the MGMT90141 and MGMT90146 written exercises to select a methodology and collect their own evidence, with both steps assessed | Structure the final capstone board report in MGMT90146 as a formal oral board defense of strategic evidence and competitive analysis |
| C5 Inquiry & evidence generation | 2 → 3 | "A substantial project generating primary evidence is REQUIRED (not one route among several), with methodology defended under scrutiny (viva, defence, or staged supervised review)." | Structure the final capstone board report in MGMT90146 as a formal oral board defense of strategic evidence and competitive analysis | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2 → 3 | "Professional communication is assessed repeatedly and progressively across the program AND at least one core assessment is delivered to, or judged by, a real external audience or practitioner (industry panel, client, patient or simulated patient, public exhibition), with professional conduct or accountability explicitly among the assessed criteria." | Mandate external industry panels of corporate directors and management consultants to evaluate Capstone Board Reports in MGMT90146 | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2 → 3 | "Such tasks are the program's assessment spine rather than a single instance (a capstone plus earlier scaffolding, or at least one per stage) AND at least one carries a genuine constraint of practice — an ambiguous or externally supplied problem, real resource/time limits, a consequential audience, or the profession's own standards of performance." | Partner with corporate enterprises to supply live, ambiguous strategic management briefs carrying real commercial constraints | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | W3 | Premier management consultancies prioritize graduates with verified live client consulting experience | Section 2, Section 4 (AIM / QILT) | HIGH |
| P2 | C1 | Industry standards (AIM / CMI) mandate structured collaboration between managers and autonomous AI market intelligence agents | Section 1, Section 3 (*HBR* Jan 2025) | HIGH |
| P3 | C2 | Peer-reviewed research (*SMJ* 2024) demonstrates evaluative judgement is critical to override flawed AI market scenario analyses | Section 3, Section 4 | HIGH |
| P4 | C3 | AICD and ASIC corporate governance standards require managers to implement algorithmic transparency and workforce ethics | Section 1, Section 3 | HIGH |
| P5 | W1 | Employers demand management graduates capable of pitching complex strategic plans before external corporate boards | Section 2, Section 4 | HIGH |
| P6 | W2 | Live management consulting projects with authentic commercial constraints reflect the true operational environment of enterprise strategy | Section 2, Section 4 | HIGH |
| P7 | C5 | Academic and industry standards require empirical business inquiry defended under rigorous oral board examination | Section 3, Section 4 | HIGH |
| P8 | C4 | Rapid continuous evolution of business models demands assessed metacognitive gap analysis and lifelong learning plans | Section 2, Section 4 | HIGH |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C1 | Require teams in MGMT90146 to submit an assessed Human-AI Management Workflow Charter | C1 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022) |
| P2 | C2 | Implement an assessed AI Strategy & Analytics Override Log in MGMT90146 Strategic Management | C2 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P3 | C3 | Embed an assessed Algorithmic Governance & AI Ethics Audit assignment in core MGMT90140 | C3 Level 3 | Medium | Term 2 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P4 | W1 | Mandate external industry panels of corporate directors to evaluate Capstone Board Reports in MGMT90146 | W1 Level 3 | Medium | Term 2 | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined) |
| P5 | W2 | Partner with corporate enterprises to supply live, ambiguous management briefs with real market constraints | W2 Level 3 | Medium | Term 2 | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| P6 | C4 | Embed an assessed managerial capability gap analysis and lifelong executive development portfolio across the core | C4 Level 3 | Medium | Term 2 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2) |
| P7 | C5 | Require the MGMT90146 capstone to generate primary strategic evidence under a selected methodology, defended in a formal oral board review | C5 Level 3 | Medium | Term 2 | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| P8 | W3 | Embed live externally mentored client consulting projects into core coursework for all degree specialisations | W3 Level 2 | High | Term 3 | [[19]](https://www.legislation.gov.au/F2021L00488)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | PASS condition is met: the program documents a comprehensive 200-point graduate management curriculum spanning organizational behavior, accounting, economics, finance, decision analytics, marketing management, operations, and strategic leadership. Rigorous, coherent management core. | Any curriculum redesign must preserve the rigorous business economics, organizational behavior, and strategic management foundations. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | PASS condition is met: assessment explicitly requires complex strategic and operational trade-off decisions under market uncertainty. In the compulsory capstone MGMT90146 Strategic Management, 'In a business strategy simulation students are required to make decisions, assess outcomes, and compete with other management teams for resources, opportunities and markets', assessed through a group Capstone Simulation and a 5000-word Capstone Board Report. | Interventions must maintain authentic, complex strategic decisions and business trade-offs rather than shifting to standardized multiple-choice testing. | [16] |
...
|---|---|---|---|---|---|---|
| P1 | C1 | 2 | 3 | +1 adaptive | 9 / 15 | 5 / 9 |
| P2 | C2 | 2 | 3 | +1 adaptive | 10 / 15 | 5 / 9 |
| P3 | C3 | 1 | 3 | +2 adaptive | 12 / 15 | 5 / 9 |
| P4 | W1 | 2 | 3 | +1 workplace | 12 / 15 | 6 / 9 |
