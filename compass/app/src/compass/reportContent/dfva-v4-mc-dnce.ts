...
const content = {
  title: "Master of Dance (MC-DNCE) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Dance (MC-DNCE)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/mc-dnce (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 17 pages captured
**Course Director:** Derrick Brown-Appenzeller (Coordinator)
...
> **This program is outside the v3.1 registry, but not outside Panel A.** Master of Dance
...
> a field grain basis (JSA HEO · 100105 Dance). What such a
...
| --- | --- | --- |
| C1 Distributed cognition & relational capability [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) | 2 | At least one core unit assesses collaborative practice with individual accountability, satisfying level 2 (e.g. DNCE90015's group choreography performance paired with an individual reflective statement). Level 3 additionally requires an assessment where coordination of work across people AND tools/AI systems is itself assessed — no AI or tool-coordination content appears anywhere in the extract (confirmed by search), so level 3 was not awarded. |
| C2 Hybrid metacognition & evaluative judgement [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) | 1 | Reflection and self-assessment appear in outcomes and reflective statements/reports carry assessment weight in several subjects, but no line documents criterion-referenced appraisal of quality (peer review, structured critique, marking against exemplars, portfolio standards) required for level 2. Ambiguous between level 1 and 2; took the LOWER level. |
| C3 Digital & AI literacy, including governance [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) | 1 | Digital tools appear in core units only at the level of tool/method operation (documentation, notation, video capture, digital analysis tools), with no discussion of capabilities, limitations, ethics or governance. No AI content of any kind appears anywhere in the extract (verified by keyword search), so level 2 cannot be reached. |
| C4 Life-long learning & transfer [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) | 3 | DNCE90019 Research Project is a required 50-point capstone described as a self-scoped independent research project on a topic of the student's own choosing, directly matching level 3's 'self-scoped capstone or research project' route. |
| C5 Inquiry & evidence generation [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) | 2 | DNCE90019 Research Project is a required, substantial inquiry requiring methodology selection and primary evidence generation, assessed via Creative portfolio (50%) and Exegesis (50%) — clearing level 2. Level 3 additionally requires methodology 'defended under scrutiny (viva, defence, or staged supervised review)'; no such format appears anywhere in the extract, so took the LOWER level. |
| **Adaptive capabilities** | **9 / 15** | |
| W1 Professional communication & conduct [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) | 1 | DEMOTED from 2 to 1 on verify pass. Level 2 requires 'an audience beyond the teaching team ... judged against criteria drawn from professional practice.' The only evidence offered — DNCE90017's Professional Placement plus Professional Placement Report — is undercut by the same quoted line used (correctly) to deny level 3: 'All assessment is conducted by the subject coordinator.' Grading authority stays internal to the subject coordinator, so the placement report's audience is the teaching team, not an external professional judge — matching level 1 ('core assessment adds presentation to peers/staff, but no professional genre and no audience beyond the teaching team'). Nothing in the extract identifies 'Professional Placement Report' as a recognised professional genre (client brief, consultancy advice, clinical handover, pitch, public artefact) rather than an internally-submitted placement report. Per the rubric's ambiguity rule, ambiguous evidence takes the LOWER level. |
| W2 Authentic task design [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) | 2 | Multiple core units require producing the artefact a practitioner would actually produce in a real or realistic context (live performance in situ, choreography performances, placement), meeting level 2. These recur across most core units and the placement supplies a genuine external constraint, suggestive of level 3's 'assessment spine', but no line explicitly documents judgement against criteria drawn from professional practice — took the LOWER level given the ambiguity. |
| W3 Work-situated learning [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) | 2 | DNCE90017's Professional Placement is a core, compulsory unit with practitioner supervision and formal assessment, meeting level 2's placement-with-supervision bar. At 40 hours it is a single, short placement rather than an extended placement or sequence, so level 3's 'substantial' requirement is not met on the evidence. |
...
> Inter-disciplinary, site-responsive, digitally enabled, somaticised and archived dance meets the world through critical and creative processes of making, writing, articulating and performing.
>
...
>
> It promotes independent thinking and originality in the application of new paradigms and existing knowledge.
...
- **G1 Disciplinary foundation:** PASS — The program is documented as an all-compulsory specialist core (seven compulsory dance subjects, 200 points) with a staged progression requirement between Year 1 and Year 2.
- **G2 Decision-making under uncertainty:** PASS — The program documents live, in-situ performance work, a real professional placement, and a capstone research project — formats carrying genuine uncertainty and accountability rather than recall or scripted response.

## 4. MARKET EVIDENCE — Basis: reported

The tables condense [the market report](dfva-market-mc-dnce.md); they report what the market says and do not argue a score.
...
**What the §1 exposure value is.** 68.44. Rests on a **field-of-education** basis (JSA HEO · 100105 Dance) — graduates of the whole field, not this program. 2 of 5 titles carry only medium mapping confidence. It sits **at or below** the field median of 83.21.

| Signal or shift | Direction | Bearing on the scored items |
| --- | --- | --- |
| AI-integrated lesson planning and assessment design | **↑ Rising** | Bears on C3 (Digital & AI literacy, including governance): the shift toward AI-assisted lesson and assessment drafting is exactly the AI content this item scores, and the program has none in its core. Bears on C2 (Hybrid metacognition & evaluative judgement): as drafting work moves to AI tools, judging and defending what the tool produced becomes the construct this item measures. Bears on C1 (Distributed cognition & relational capability) only indirectly, through the Secondary School Teacher pathway most graduates enter rather than through any dance-specific tool-coordination the extract documents. |

**Confidence, restated from the market report.** Its discussion signals are stated at HIGH confidence. Its declared gaps: Destination basis (LOW — Field-of-education grain (100105 Dance): the destinations are the field's, not this program's.); Secondary School Teachers, Except Special and Vocational Education — regulatory and statutory instruments (HIGH — 1 recorded claim(s); retrieved 2026-08-24.); Secondary School Teachers, Except Special and Vocational Education — scholarly and grey-literature studies (HIGH — 2 recorded claim(s); retrieved 2026-08-24.); Secondary School Teachers, Except Special and Vocational Education — trade and professional press (HIGH — 3 recorded claim(s); retrieved 2026-08-24.); Secondary School Teachers, Except Special and Vocational Education — job-advertisement signals (HIGH — 10 recorded claim(s); retrieved 2026-08-24.); Secondary School Teachers, Except Special and Vocational Education — practitioner discourse (HIGH — 94 recorded claim(s); retrieved 2026-08-24.); Secondary School Teachers, Except Special and Vocational Education — L3 via factiva (LOW — Search returned nothing (auth_expired, 2026-08-30): OpenAthens SSO session expired; re-run factiva_reauth.py then factiva_backfill.py. L3 covered this pass via web trade-press (Framework, ABC, Responsible AI Australia) instead.); Secondary School Teachers, Except Special and Vocational Education — record caveat (HIGH — L1/L2/L3 added 2026-08-30 (autoloop): AITSL registration/accreditation, JSA/Felten exposure index 91.99, AI-in-schools trade press. Factiva L3 gap logged (auth_expired).); Self-Enrichment Education Teachers (LOW — record is not empirical-five-lane-v1; no claim from this occupation is used in this report.); Retail Salespersons (LOW — record is not empirical-five-lane-v1; no claim from this occupation is used in this report.); Waiters and Waitresses (LOW — record is not empirical-five-lane-v1; no claim from this occupation is used in this report.); Actors (LOW — record is not empirical-five-lane-v1; no claim from this occupation is used in this report.).
...
and the score deltas are in the [improvement plan](dfva-v4-recommend-mc-dnce.md); rows
below are ordered by headroom, which is not the plan's P-lever order.

| Item | Score | Implication | Cost | Sources |
| --- | --- | --- | --- | --- |
| C2 Hybrid metacognition & evaluative judgement | 1/3 | As lesson and assessment drafting shifts toward AI assistance, a graduate's standing increasingly rests on judging what the tool produced rather than on drafting it manually — but the program currently assesses reflection on progression, not criterion-referenced appraisal of quality against a standard. | A rubric update to an existing reflective statement (low effort), then a further assessment-brief update once that step lands (medium effort). | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1/3 | The skill shift's finding that lesson planning and assessment drafting are readily AI-supported lands directly here: the program has no AI content of any kind in its core, so it does not yet prepare graduates to work with, or govern, the tools the shift describes. | A syllabus and rubric addition to an existing core subject (low–medium effort), then a further assessment redesign for governance critique (medium effort). | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W1 Professional communication & conduct | 1/3 | This item bears more directly on the independent- and faith-school hiring pattern in the job-advertisement sample than on the AI skill shift, but the shift compounds it: as AI content covers routine teaching-task drafting, hiring practice at those schools weights communication and conduct evidence the program does not yet supply beyond the teaching team. | A grading-authority change to the placement report, adding a host or external assessor (low–medium effort), then a second externally judged assessment (medium–high effort). | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| C1 Distributed cognition & relational capability | 2/3 | The program clears collaborative practice with individual accountability (group choreography plus a reflective statement), but nothing in its assessed evidence has students coordinate work between people and digital or AI tools — the coordination the skill shift's AI-assisted lesson planning increasingly asks of the teaching pathway most graduates enter. | An assessment-criteria update to an existing group choreography assessment, documenting tool allocation alongside role allocation (low effort, no new task). | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C5 Inquiry & evidence generation | 2/3 | The skill shift documents pressure on classroom-facing drafting tasks, not on research methodology; this item's headroom is instrument-driven rather than shift-driven, and its gap would remain whichever way the shift resolves. | A staged supervised review added to the existing capstone assessment (medium effort, contingent on assessor capacity). | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W2 Authentic task design | 2/3 | Not directly touched by the AI-integrated skill shift; the gap is that the program's existing real and realistic tasks are not documented against practice-drawn criteria, an instrument requirement independent of the shift. | A criteria-documentation change only (low effort, no new task). | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| W3 Work-situated learning | 2/3 | The AI-integrated skill shift bears on this item only through the registration pathway it sits beside: AITSL's accreditation expectation, not the AI shift itself, is what makes a longer or repeated placement worth doing. | Extending or sequencing the existing placement (high effort, contingent on host-agreement negotiation). | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C4 Life-long learning & transfer | 3/3 | Already at the ceiling on a self-scoped capstone; the AI-integrated skill shift changes nothing here, because life-long learning and transfer are assessed independent of which tool a student used. | None — no intervention proposed and none needed. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |

## 6. EVIDENCE CONFIDENCE & LIMITATIONS — Basis: reported

**Panel A metadata.** Basis tier **field** (field grain), n = 0, 5 destination titles, 2 at medium mapping confidence. Index variant AIOE-2021; destination titles mapped to the published Felten index. Basis note: field-of-education occupation list (ATO-linked), not this program's own graduates
...
- C1: assessed group/collaborative work recurs across several core units (level 2), but no assessment documents coordination of people AND tools/AI systems, so level 3 was withheld.
- C2: graded reflective statements/reports (DNCE90015, DNCE90018) sit between level 1 (reflection in outcomes, unassessed against criteria) and level 2 (criterion-referenced appraisal of quality); no explicit peer-review/critique/exemplar-marking language appears, so the LOWER level (1) was taken.
- C5: DNCE90019 Research Project meets level 2's methodology-and-evidence-generation bar but the extract documents no viva, defence, or staged supervised review, so level 3 was withheld; took the LOWER level (2).
- W1: verify pass DEMOTED this item from 2 to 1 — DNCE90017's placement produces an industry-partner report that could suggest external judgement (level 3), but the extract explicitly reserves 'All assessment' to the subject coordinator, so the report's audience is the teaching team, matching level 1, not level 2.
- W2: recurring performance/portfolio artefacts across most core units plus the placement's real constraint suggest level 3's 'assessment spine', but no line states these are judged against criteria drawn from professional practice; took the LOWER level (2).
- W3: DNCE90017's placement meets level 2's supervised-core-unit bar but is a single 40-hour placement, not an extended placement or sequence, so level 3 was withheld.
