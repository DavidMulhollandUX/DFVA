...
const content = {
  title: "Doctor of Science (DH-SC) — Research Degree Report",
  institution: "University of Melbourne",
  markdown: `# DFVA RESEARCH DEGREE REPORT: Doctor of Science (DH-SC)
...
Carried from [the v1 assessment](dfva-dh-sc.md) as narrative. The v1 composite, its
