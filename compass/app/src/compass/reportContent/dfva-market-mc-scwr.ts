...
**What these sources are.** Union documents and guild position papers (Writers Guild of
America, Australian Writers' Guild), Australian screen trade press (TV Tonight, ScreenHub,
C21Media, TV Blackbox), ABC News reporting, Screen Australia programme and commissioned
research, and one academic study of Australian writers' rooms. Direct extraction from X or
LinkedIn was **not** performed and no guild forum was sampled — the previous version of this
section described its own basis as "pattern-based from known professional discourse
including WGAW/AWG forums, LinkedIn creator posts", which is a claim about sampling that
was not true. Three earlier themes — authorial voice as the defence against AI,
interactive-narrative career mobility, and diversity commissioning — are **removed** rather
than restated: no source was found for any of them. Dates are given where the source
carries one.

### Theme 1 — one guild won contract terms; the other published a position, and the difference matters

The Writers Guild of America's 2023 Minimum Basic Agreement contains enforceable AI terms:
[GAI-produced written material is not literary material](https://www.wga.org/contracts/know-your-rights/artificial-intelligence),
material generated by AI does not count as assigned or source material for credit and
compensation purposes, a company cannot require a writer to use AI, and the company must
disclose AI-generated material given to a writer.

The Australian position is **not** equivalent, and an earlier draft of this report was wrong
to say the AWG "struck provisions". The Australian Writers' Guild
[published a position paper rejecting unregulated AI in the creative sector](https://awg.com.au/australian-writers-guild-rejects-unregulated-ai-in-the-creative-sector/),
reported by [TV Tonight](https://tvtonight.com.au/2023/10/australian-writers-guild-outlines-position-on-ai.html)
in October 2023 and by [ScreenHub](https://www.screenhub.com.au/news/news/australian-writers-guild-says-no-thanks-to-ai-2626049/),
built on three principles — **consent, credit and compensation**. A position paper is
advocacy, not a bargained protection.

**Bearing:** W1 and C3. Graduates entering the Australian industry work under advocacy and
policy argument, not under the US contractual floor.

### Theme 2 — the writers' room is where the training gap is documented

[*So Much Drama, So Little Time: Writers' Rooms in Australian Television Drama Production*](https://link.springer.com/chapter/10.1007/978-3-030-48713-3_12)
(Springer, 2020) studies the Australian room as a production form rather than assuming the
US model. [ABC News](https://www.abc.net.au/news/2023-09-19/us-actors-writers-strike-australian-screen-industry/102677654)
(19 September 2023), reporting on how the Australian industry compared during the US
strikes, records the specific structural concern: writers hired for short stints in
"mini-rooms" are not given the on-set training that longer engagements once provided, which
practitioners quoted there frame as a problem for training the next generation.

**Bearing:** C1 and W3. The gap named in the sources is room practice and on-set exposure,
not solo craft.

### Theme 3 — the showrunner shortage is real enough that an intervention exists for it

The clearest evidence that Australia has a mid-career showrunner gap is that Screen
Australia, the AWG and Scripted Ink fund
[The Creators](https://awg.com.au/the-creators/), a programme explicitly for mid-career
screenwriters developing into showrunners, selecting six writers a year;
[C21Media](https://www.c21media.net/news/screen-australia-awg-and-scripted-ink-launch-third-year-of-showrunner-initiative-the-creators/)
reports its third year. Separately, the Olsberg SPI *Production Infrastructure and Capacity
Analysis* commissioned by Screen Australia flags skills gaps and scalability constraints, as
[TV Blackbox](https://tvblackbox.com.au/page/2026/04/09/growth-at-risk-as-screen-australia-report-flags-industry-capacity-crunch/)
reported in April 2026.

Scope: a funded intervention and a capacity report evidence a recognised gap. Neither
quantifies how many showrunner roles go unfilled.
