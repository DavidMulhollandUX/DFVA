...
const content = {
  title: "Doctor of Philosophy - Arts (DR-PHILART) — Research Degree Report",
  institution: "University of Melbourne",
  markdown: `# DFVA RESEARCH DEGREE REPORT: Doctor of Philosophy - Arts (DR-PHILART)
...
Carried from [the v1 assessment](dfva-dr-philart.md) as narrative. The v1 composite, its
...
Market intelligence for this program is in [the market report](dfva-market-dr-philart.md). **Its §3 discussion-signal section is unsourced** — it predates the sourcing
