...
const content = {
  title: "Master of Professional Psychology (MC-PROPSYC) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Professional Psychology (MC-PROPSYC)
...
**Assessment date:** 2026-08-15 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-propsyc.md
**Position basis:** Destination AI Exposure 44.92 (exact basis) × Curriculum Adaptiveness 10/15 (v4.2 draft, sub-scale A) · Workplace practice 7/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
Operating in a low AI exposure domain (**44.92**, well below the portfolio median of 90.9), the program demonstrates exceptional clinical task fidelity and independent research rigor, achieving maximum scores in **C4: 3 / 3** (a compulsory 25cp year-long minor research thesis opened by a hurdle proposal and culminating in a 6,000-word independent inquiry) and **W2: 3 / 3** (a comprehensive authentic task spine across all stages featuring hurdle clinical interview role-plays, mental state examinations, risk assessment reports, and single-case study formulations aligned to the PsyBA National Psychology Examination). However, Adaptiveness sits at **10 / 15** and Workplace Practice at **7 / 9** because digital tools focus on software operation and telehealth essays without assessed clinical AI governance (**C3: 1 / 3**), collaborative practice lacks human-plus-AI role allocation (**C1: 2 / 3**), critical appraisal lacks longitudinal reliance-or-override logs (**C2: 2 / 3**), minor research allows secondary datasets alongside primary empirical investigation (**C5: 2 / 3**), oral clinical demonstrations are delivered internally without external practitioner marker panels (**W1: 2 / 3**), and core placement hours combine simulation and actual client contact without disaggregated host accountability (**W3: 2 / 3**).

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 2 | Direct — Market §2 Signal 2 and §3 Theme 1 emphasize clinical AI documentation tools and telehealth governance; core treats digital tools operationally. | 1 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Direct — Psychologists coordinate care with medical GPs and digital triage platforms; core interprofessional reflection lacks human-plus-AI role allocation. | 2 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Direct — Clinicians evaluate automated psychometric scoring against clinical observation; core lacks reliance logs. | 3 |
| C5 Inquiry & evidence generation | Adaptive | 2 / 3 | 1 | Direct — Professional psychologists lead clinical practice evaluations; minor thesis allows secondary data route. | 4 |
| W1 Professional communication & conduct | Workplace | 2 / 3 | 1 | Direct — Provisional psychologists present cases to external clinical supervisors; core lacks published professional conduct marking criteria. | 5 |
| W3 Work-situated learning | Workplace | 2 / 3 | 1 | Direct — 300 placement hours blend simulation and actual patient contact without distinct external host reflection hurdles. | 6 |
...
|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Introduce an assessed module in core professional practice on clinical AI documentation tools, telehealth video-therapy ethics, and automated psychometric testing limits. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Introduce an assessed clinical AI governance audit: candidates critique automated psychological assessment and documentation tools against APS ethical guidelines and Privacy Act requirements. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | In clinical case management seminars, require candidate teams to develop an interprofessional care plan explicitly allocating tasks between clinical team members and digital triage/monitoring systems. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | Require candidates to maintain an assessed clinical decision log documenting and justifying decisions to override automated psychometric scoring algorithms or AI draft notes. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C5 Inquiry & evidence generation | 2 → 3 | "A substantial project generating primary evidence is REQUIRED (not one route among several), with methodology defended under scrutiny (viva, defence, or staged supervised review)." | Require all candidates in the minor research thesis to conduct a primary empirical clinical investigation with methodology defended in a formal oral thesis defence. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2 → 3 | "Professional communication is assessed repeatedly and progressively across the program AND at least one core assessment is delivered to, or judged by, a real external audience or practitioner (industry panel, client, patient or simulated patient, public exhibition), with professional conduct or accountability explicitly among the assessed criteria." | Mandate that the final diagnostic interview demonstration is judged by external PsyBA registered clinical supervisors with explicit professional conduct marking rubrics. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W3 Work-situated learning | 2 → 3 | "Substantial required work-situated learning: an extended placement or practicum, or a sequence of them, in the core, supervised by a practitioner, assessed, with accountability to the host and structured reflection on professional practice — OR, for a cohort documented as already practising, a required sequence of assessed own-practice activity with structured reflection and documented accountability to workplace stakeholders (trainees, patients, clients or employer)." | Disaggregate and extend direct workplace client contact hours with required host supervisor reports and assessed structured reflection on professional practice. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C3 | Mental health clinics deploy telehealth platforms and digital documentation tools; psychologists need assessed ethical AI literacy. | §2 Signal 2; §3 Theme 1 | HIGH (APS practice codes) |
| P2 | C1 | Psychologists collaborate across multidisciplinary care teams coordinating human clinicians and digital intake tools. | §1 Job Family 2; §3 Theme 2 | HIGH (APAC standards) |
| P3 | C2 | Clinicians evaluate psychometric data and AI note drafts against empirical evidence and clinical observation. | §1 Job Family 1; §3 Theme 1 | HIGH (PsyBA standards) |
| P4 | C5 | Professional psychologists conduct clinical service audits and evidence-based practice research. | §1 Job Family 1; §3 Theme 3 | HIGH (Research benchmarks) |
| P5 | W1 | Provisional psychologists present diagnostic work-ups to registered clinical supervisors. | §2 Signal 3; §3 Theme 3 | HIGH (PsyBA exam standards) |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C3 | Add an assessed module evaluating clinical AI documentation tools, telehealth ethics, and testing limits | C3 level 2 (capabilities and limits discussed/assessed) | Low | Year 1 Term 1; syllabus update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P2 | W1 | Mandate external PsyBA registered clinical supervisors on final diagnostic interview panels with explicit conduct criteria | W1 level 3 (judged by external audience with conduct criteria) | Low | Year 1 Term 2; assessment brief update | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| P3 | C5 | Require primary empirical inquiry and formal oral thesis defence in the minor research thesis | C5 level 3 (primary evidence project with defended methodology) | Low | Year 1 Term 2; thesis rubric update | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| P4 | W3 | Disaggregate direct client placement hours and introduce an assessed structured reflection hurdle | W3 level 3 (extended placement with host accountability & reflection) | Medium | Year 1 Term 2; placement syllabus update | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | All-compulsory specialist core in professional psychology taken in mandated sequence with staged progression rules, accredited by APAC. | Redesign must preserve the APAC accredited core curriculum and prerequisite sequence with zero elective dilution. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | Clinical trade-off decisions evaluated through case formulations, suicide risk assessment rationales, and patient casework under genuine uncertainty. | Redesign must maintain unscripted clinical problem-solving and rigorous case defence. | [16] |
...
| P2 | W1 | 2 | 3 | +1 workplace | 11 / 15 | 8 / 9 |
| P3 | C5 | 2 | 3 | +1 adaptive | 12 / 15 | 8 / 9 |
| P4 | W3 | 2 | 3 | +1 workplace | 12 / 15 | 9 / 9 |
