...
const content = {
  title: "Master of Health and Medical Law (507AA) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Health and Medical Law (507AA)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/507aa (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 35 pages captured
**Course Director:** Ian Freckleton (Director of Studies); Paula O'Brien (Director of Studies); Michelle Taylor-Sands (Director of Studies)
...
> **This program is outside the v3.1 registry, but not outside Panel A.** Master of Health and Medical Law
...
The market intelligence gathered for this program indicates expanding demand across health regulatory authorities (TGA, AHPRA), major metropolitan hospital networks (Royal Melbourne Hospital, Alfred Health, Monash Health), and medical defence organisations, accompanied by rapid adoption of clinical AI and electronic health data platforms where informed consent governance, coronial inquest representation, and complex bioethical adjudication remain non-delegable human legal responsibilities under Australian Health Practitioner Regulation Agency (AHPRA) and Australasian Association of Bioethics and Health Law (AABHL) standards.

### Destination Job Families

| Job family | Entry titles | AI substitution pressure | Skills rising in that family |
| --- | --- | --- | --- |
| Health Regulatory & Compliance Counsel | Health Law Associate, Regulatory Officer; later Senior Regulatory Counsel, General Counsel (Health Network) | HIGH | AI clinical trial compliance, Health Practitioner Regulation National Law, TGA law |
| Medical Negligence & Clinical Risk Defence | Medical Litigation Associate, Risk Solicitor; later Partner (Medical Defence), Special Counsel (Coronial Inquests) | HIGH | AI e-discovery, expert medical testimony critique, coronial inquest advocacy |
| Bioethics & Healthcare Policy Advisory | Health Policy Analyst, Bioethics Consultant; later Director of Clinical Governance, Chief Policy Advisor | MEDIUM | AI algorithmic accountability in healthcare, genomic data privacy, pandemic policy |
| Hospital & Health Service In-House Legal | Hospital In-House Counsel, Medico-Legal Advisor; later Executive Director of Legal & Risk, Health Ombudsman Counsel | HIGH | Consent frameworks, statutory mandatory reporting, digital health data governance |

**Exposure basis declaration.** Destination AI exposure is **94.27** (exact basis derived from Health / Medical Legal destinations), sitting well **above** the portfolio median of 90.9.
...
and the score deltas are in the [improvement plan](dfva-v4-recommend-507aa.md); rows
below are ordered by headroom, which is not the plan's P-lever order.

| Item | Score | Implication | Cost | Sources |
| --- | --- | --- | --- | --- |
| C1 Distributed cognition & relational capability | 1/3 | Establish a compulsory core subject in Medico-Legal Practice assessing an interprofessional bioethics committee simulation with individual accountability; require student legal teams to document human-plus-AI role allocation. | Interprofessional bioethics seminar moderation time. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 1/3 | Introduce a structured peer critique task in the core where students evaluate draft clinical risk advices against AHPRA regulatory standards; require candidates to maintain an assessed legal decision log documenting overrides of clinical AI tools. | Peer review rubric design and calibration. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1/3 | Introduce an assessed module in core health law on clinical AI diagnostic algorithms, SaMD regulation, data privacy breaches, and ethical limits; introduce an assessed clinical AI governance audit. | Software tool licensing and syllabus updates. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C4 Life-long learning & transfer | 1/3 | In core health law assessments, evaluate candidate legal advice across novel cross-jurisdictional biotech regulations; establish a required self-scoped health and medical law capstone research project. | Capstone project supervision and syllabus redesign. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 1/3 | Introduce an assessed health law inquiry unit requiring students to select comparative medico-legal methodologies; require all candidates to complete a primary empirical health law inquiry or policy reform thesis. | Thesis viva scheduling and academic supervision. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 1/3 | Introduce a mandatory core medico-legal advice memorandum and clinical risk briefing task; mandate that oral coronial inquest submissions and hospital board briefings are judged by external health regulatory counsel and coroners. | External practitioner honoraria and scheduling. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 1/3 | Introduce an authentic medico-legal task reproducing a hospital adverse event investigation and coronial advice end to end; establish an authentic task spine across all stages. | Course assessment spine redesign. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| W3 Work-situated learning | 1/3 | Convert the legal internship into a required core placement in hospital legal counsel offices, medical defence organisations, or health regulatory bodies; establish an assessed own-practice clinical governance portfolio. | Placement coordination and host organisation liaison. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |

## 6. EVIDENCE CONFIDENCE & LIMITATIONS — Basis: reported

**Panel A metadata.** Basis tier **partial** (related program), n = 676, 15 destination titles, 6 at medium mapping confidence. Index variant AIOE-2021; destination titles mapped to the published Felten index. Basis note: Health and Medical Law is a Melbourne Law Masters specialisation; the Master of Laws record (n=676) is the program-family record, as the reconciliation package did for specialisation streams.
...
**Ambiguities and construct-boundary notes** (11):
