...
const content = {
  title: "Doctor of Dental Surgery (MC-DDENSUR) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Doctor of Dental Surgery (MC-DDENSUR)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/mc-ddensur (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 29 pages captured
**Course Director:** Khaled Ahmed
...
**Destination AI Exposure: 63.31.** Destination titles are mapped to the published Felten AI Occupational Exposure (AIOE) index and rescaled 0–100 by the Panel A procedure used for every other program. Basis: measured on the program's own alumni destination record (n = 194). The portfolio median is 90.9, so this program sits **at or below** it.
...
- **G1 Disciplinary foundation:** PASS — An all-compulsory specialist core with an enforced staged progression chain and external accreditation: 400 credit points of compulsory subjects, every subject in a year required before progression to the next, and the sequence externally accredited by the Australian Dental Council. Technical depth is progressive across the named subject chain (preclinical practice, then Dental Practice 2, 3 and Comprehensive Dental Practice). Nothing generic or interchangeable.
- **G2 Decision-making under uncertainty:** PASS — Assessments require defended trade-off decisions under real uncertainty and accountability: a viva of an unknown patient and standardised case-based discussions on unknown cases in years 2, 3 and 4, plus assessed treatment planning that requires proposing options and arriving with the patient at a treatment of choice for simple and complex conditions, and comprehensive planning that weighs prognosis and individual patient context. This is not recall or scripted response.

## 4. MARKET EVIDENCE — Basis: reported

The market intelligence gathered for this program indicates chronic shortages across private dental practices, corporate networks (Bupa Dental, Pacific Smiles), and public health agencies (Dental Health Services Victoria, RDHM), accompanied by emerging integration of computer vision AI tools (Pearl, Overjet) for caries and bone loss detection where clinician oversight and ethical accountability remain mandatory under Dental Board of Australia registration standards.

### Destination Job Families

| Job family | Entry titles | AI substitution pressure | Skills rising in that family |
| --- | --- | --- | --- |
| General Dental Practice | Associate Dentist, General Dentist; later Senior Dentist, Practice Partner | LOW | AI-assisted radiograph diagnosis (Overjet/Pearl), complex restorative treatment planning |
| Public & Community Dental Health | Community Dentist, Public Dental Officer; later Senior Dental Officer, Clinic Supervisor (DHSV) | LOW | Person-centred care for high-needs cohorts, triage efficiency, trauma-informed care |
| Hospital-Based & Special Needs Dentistry | Resident Dental Officer, Hospital Dentist; later Senior Hospital Dental Officer | LOW | Multidisciplinary surgical coordination, medically compromised patient management |
| Specialist Dental Pathways | Specialist Registrar (Orthodontics, Perio, Endo); later Registered Dental Specialist | LOW | Advanced procedural microsurgery, complex orthodontic mechanics, clinical trials |
| Practice Ownership & Clinical Leadership | Associate Dentist (Equity Track); later Practice Principal, Managing Clinical Director | LOW (clinical) / MEDIUM (admin) | Practice management software, clinical governance, multi-practitioner clinic leadership |

**Exposure basis declaration.** Destination AI exposure is **45.02** (exact basis derived from Dentistry graduate destinations), sitting **far below** the portfolio median of 90.9.
...
and the score deltas are in the [improvement plan](dfva-v4-recommend-mc-ddensur.md); rows
below are ordered by headroom, which is not the plan's P-lever order.

| Item | Score | Implication | Cost | Sources |
| --- | --- | --- | --- | --- |
| C3 Digital & AI literacy, including governance | 1/3 | Introduce an assessed module in Dental Practice 3 on AI diagnostic imaging tools (caries and periodontal bone loss detection), system limitations, and clinician liability; introduce an assessed clinical AI governance audit. | Software licensing for dental AI imaging platforms and staff calibration. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C1 Distributed cognition & relational capability | 2/3 | In Comprehensive Dental Practice, require student clinical pairs to document a protocol allocating procedural tasks between operator, chairside assistant, and AI diagnostic aids. | Faculty moderation time during clinical operatory sessions. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2/3 | In the Year 4 Portfolio of Ongoing Patient Care, require students to document and justify clinician override decisions when evaluating AI-flagged radiographic lesions. | Portfolio rubric development for diagnostic verification logs. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C5 Inquiry & evidence generation | 2/3 | Formalize an oral viva defence of research methodology and evidence generation before an external examiner panel in Dental Research Project 2. | Scheduling viva examiner panels across the cohort. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
...
**Panel A metadata.** Basis tier **exact** (measured), n = 194. Index variant AIOE-2021; destination titles mapped to the published Felten index.

**Panel C provenance.** Scored from the 2026 handbook capture (29 pages) and verified on 2026-08-14: adversarial refutation of every level-3 score and every gate PASS (run), verbatim evidence check (run), and the construct-boundary pass.
