...
Impact Investing Australia, Social Ventures Australia and the Centre for Social Impact are all running professional development programs to address blended finance literacy gaps in the sector. Three sector bodies independently funding the same remediation is the signal here. The skills involved — outcomes-based contracts, impact bonds, concessional capital — have historically sat in investment banking rather than social sector training. Masters programs that address this gap are positioned well.
