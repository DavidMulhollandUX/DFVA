...
const content = {
  title: "Master of Physiotherapy (Pelvic Health) (MC-PHTYPH) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Physiotherapy (Pelvic Health) (MC-PHTYPH)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/mc-phtyph (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 35 pages captured
**Course Director:** Elise Fraser
...
**Destination AI Exposure: 71.03.** Destination titles are mapped to the published Felten AI Occupational Exposure (AIOE) index and rescaled 0–100 by the Panel A procedure used for every other program. Basis: borrowed from a related program's alumni record — Doctor of Physiotherapy (n = 448); an estimate, not this program's own graduates. The portfolio median is 90.9, so this program sits **at or below** it.
...
- **G1 Disciplinary foundation:** PASS — Meets the PASS condition on two of the three named routes: an all-compulsory specialist core (six compulsory subjects, 75 of 150 credit points, all in pelvic-health physiotherapy or rehabilitation research method) and a staged prerequisite chain, since the whole compulsory core must be completed before the capstone. Content is discipline-specific rather than interchangeable, and the course documents alignment to the profession's own competency and standards frameworks and to professional titling.
- **G2 Decision-making under uncertainty:** PASS — Assessment requires defended trade-off decisions rather than recall or scripted responses. The compulsory PHTY90003 requires weighing risks and benefits to select optimal interventions and responding where values or bias threaten care quality, assessed through a hurdle practical skills examination and a 2500-word written assignment; PHTY90097 assesses a 2500-word case study built on differential diagnosis; REHB90003 requires a defended evaluation design for a real service; and the capstone requires identifying a service gap and defending a project judged on feasibility and stakeholder value — a live project with real uncertainty and accountability.

## 4. MARKET EVIDENCE — Basis: reported

The market intelligence gathered for this program indicates strong demand across Australian Physiotherapy Association (APA) titled clinical registers, major public hospital networks (Royal Women's Hospital, Monash Health, Alfred Health), and private pelvic health practices across ANZ, accompanied by growing clinical integration of real-time ultrasound (RTUS) and digital biofeedback platforms (Elvie, Perifit) where intimate manual palpation, trauma-informed clinical care, and complex multi-disciplinary rehabilitation decisions remain exclusive human practitioner responsibilities under APA and Physiotherapy Board of Australia (AHPRA) titling standards.

### Destination Job Families

| Job family | Entry titles | AI substitution pressure | Skills rising in that family |
| --- | --- | --- | --- |
| Specialist Pelvic Floor Physiotherapy | Pelvic Health Physiotherapist, Women's Health Physio; later Titled Pelvic Health Physio (APA), Practice Director | LOW | Real-time ultrasound biofeedback, trauma-informed pelvic care, prolapse management |
| Continence & Bladder / Bowel Rehabilitation | Continence Advisor, Pelvic Rehabilitation Physio; later Senior Hospital Continence Lead, Clinical Specialist | LOW | Urodynamic analysis, anorectal manometry, interdisciplinary team case conferencing |
| Men's Pelvic Health & Oncology Rehab | Men's Health Physiotherapist, Oncology Physio; later Lead Clinician (Prostate Cancer Rehab), Clinic Partner | LOW | Post-prostatectomy rehabilitation, male chronic pelvic pain, erectile dysfunction care |
| Clinical Physiotherapy Education & Research | Clinical Educator (Pelvic Health), Tutor; later Clinical Associate Professor, Director of Clinical Training | LOW | Objective structured clinical exams, clinical supervision, translational clinical trials |

**Exposure basis declaration.** Destination AI exposure is **44.92** (exact basis derived from Medical / Specialist Physiotherapy destinations), sitting well **below** the portfolio median of 90.9.
...
and the score deltas are in the [improvement plan](dfva-v4-recommend-mc-phtyph.md); rows
below are ordered by headroom, which is not the plan's P-lever order.

| Item | Score | Implication | Cost | Sources |
| --- | --- | --- | --- | --- |
| C1 Distributed cognition & relational capability | 1/3 | In core pelvic health coursework, introduce an assessed collaborative multidisciplinary case management project (e.g. gynaecology/urology MDT case plan) with individual accountability; require candidate teams to document human-plus-AI task allocation. | Interprofessional clinical seminar moderation time. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C3 Digital & AI literacy, including governance | 1/3 | Introduce an assessed module in core coursework on digital health tools in pelvic physiotherapy: app-based biofeedback, wearable sensors, and clinical validation limits; introduce an assessed clinical AI governance audit. | Software tool licensing and syllabus updates. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C2 Hybrid metacognition & evaluative judgement | 2/3 | Require candidates to maintain an assessed clinical decision log documenting and justifying decisions to override automated biofeedback algorithms and real-time ultrasound interpretations. | Clinical logbook rubric calibration. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C5 Inquiry & evidence generation | 2/3 | Require all capstone candidates to complete a primary empirical clinical inquiry or practice-based data collection project with methodology defended in a formal oral viva examination. | Oral viva examination scheduling and examiner time. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2/3 | Mandate that the final capstone project presentation is judged by external APA titled clinicians and health network leads with assessed professional conduct criteria. | External examiner honoraria and scheduling. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W3 Work-situated learning | 2/3 | For this in-practice clinical cohort, require a multi-stage sequence of assessed own-practice clinical interventions with structured reflection and supervisor verification. | Practicum rubric design and clinical mentor liaison. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
...
**Panel A metadata.** Basis tier **cognate** (cognate program), n = 448. Index variant AIOE-2021; destination titles mapped to the published Felten index. Basis note: Reconciliation package tier cognate.
