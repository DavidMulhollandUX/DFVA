...
const content = {
  title: "Doctor of Dental Surgery (MC-DDENSUR) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Doctor of Dental Surgery (MC-DDENSUR)
...
**Assessment date:** 2026-08-14 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-ddensur.md
**Position basis:** Destination AI Exposure 45.02 (exact basis) × Curriculum Adaptiveness 10/15 (v4.2 draft, sub-scale A) · Workplace practice 9/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
Operating in a very low AI exposure domain (**45.02**, far below the portfolio median of 90.9), the program achieves a **perfect score across Workplace Practice (9 / 9)**, driven by real patient care, multi-source feedback, viva voce examinations on unknown patients (W1: 3/3), a practice-reproducing assessment spine from preclinical simulation to mini-CEXs and OSCEs (W2: 3/3), and an extended core placement spanning the Royal Dental Hospital of Melbourne and rural clinics (W3: 3/3). Adaptiveness is robust at **10 / 15**, led by a maximum score in **C4: 3 / 3** (compulsory two-year self-scoped research project). The only headroom in the entire instrument lies in C3 (1/3, lack of assessed clinical AI imaging modules), and C1, C2, and C5 (all at 2/3).

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 2 | Direct — Market §2 Signal 2 and §3 Theme 1 emphasize that dentists must audit AI diagnostic imaging (Pearl/Overjet) for false positives under DBA liability; core lacks assessed AI modules. | 1 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Direct — Modern chairside workflows coordinate dentists, dental assistants, hygienists, and real-time AI computer vision tools. | 2 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Direct — Program includes programmatic portfolios, but lacks assessed reliance/override logs over automated caries and bone loss detection tools. | 3 |
| C5 Inquiry & evidence generation | Adaptive | 2 / 3 | 1 | Direct — Research strand produces primary evidence, but methodology is not defended in a formal oral viva before external examiners. | 4 |
...
|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Introduce an assessed module in Dental Practice 3 on AI diagnostic imaging tools (caries and periodontal bone loss detection), system limitations, and clinician liability. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Introduce an assessed clinical AI governance audit: students critique automated treatment-planning algorithms against DBA statutory duty of care and patient consent frameworks. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | In Comprehensive Dental Practice, require student clinical pairs to document a protocol allocating procedural tasks between operator, chairside assistant, and AI diagnostic aids. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | In the Year 4 Portfolio of Ongoing Patient Care, require students to document and justify clinician override decisions when evaluating AI-flagged radiographic lesions. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C5 Inquiry & evidence generation | 2 → 3 | "A substantial project generating primary evidence is REQUIRED (not one route among several), with methodology defended under scrutiny (viva, defence, or staged supervised review)." | Formalize an oral viva defence of research methodology and evidence generation before an external examiner panel in Dental Research Project 2. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C3 | Dental practices deploy AI diagnostic radiograph software; clinicians carry legal liability for false positive overrides. | §2 Signal 2; §3 Theme 1 | HIGH (ADA & Australian Dental Journal) |
| P2 | C2 | Overriding automated diagnostic suggestions requires documented evidence to justify clinical intervention. | §1 Job Family 1; §3 Theme 1 | HIGH (Dental Board of Australia standards) |
| P3 | C1 | Efficient clinical practice requires real-time coordination between dentists, assistants, and digital CAD/CAM tools. | §1 Job Family 1; §3 Theme 2 | HIGH (ADC competency framework) |
| P4 | C5 | Evidence-based dentistry requires practitioners to appraise emerging biomaterials and defend clinical research findings. | §1 Job Family 4; §3 Theme 3 | HIGH (DBA continuing competence rules) |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C3 | Add an assessed module on AI diagnostic radiograph auditing and clinician liability | C3 level 2 (capabilities and limits discussed/assessed) | Low | Year 3 Term 1; syllabus update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P2 | C2 | Require an assessed AI reliance and override log in the Year 4 Portfolio of Ongoing Patient Care | C2 level 3 (reliance decisions documented) | Low | Year 4 Term 1; portfolio rubric update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P3 | C5 | Add an examined oral viva defence of methodology in Dental Research Project 2 | C5 level 3 (required project with viva defence) | Low–Medium | Year 3 Term 2; assessment brief update | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | 400 credit points of compulsory subjects accredited by the Australian Dental Council, with mandatory completion of each 100-point year required for progression. | Redesign must preserve the ADC statutory accreditation and strict prerequisite progression. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | Viva voce oral exams on unknown patients, standardized case discussions on unknown cases, and comprehensive person-centred treatment planning weighing patient prognosis and preferences. | Redesign must retain unscripted unknown-patient examinations and authentic clinical treatment trade-offs. | [16] |
...
| P3 | C5 | 2 | 3 | +1 adaptive | 13 / 15 | 9 / 9 |
