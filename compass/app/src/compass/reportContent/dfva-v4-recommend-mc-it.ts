...
const content = {
  title: "Master of Information Technology (MC-IT) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Information Technology (MC-IT)
...
**Assessment date:** 2026-08-24 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-it.md
**Position basis:** Destination AI Exposure 92.91 (exact basis) × Curriculum Adaptiveness 10/15 (v4.2 draft, sub-scale A) · Workplace practice 5/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
|---|---|---|---|---|---|
| W3 Work-situated learning | Workplace | 1 / 3 | 2 | Top tech enterprises and consultancies prioritize graduates with guaranteed workplace immersion and production deployment experience | 1 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Modern software engineering teams coordinate tasks explicitly across human engineers and autonomous AI coding agents | 2 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Software engineers must systematically audit and document overrides of AI-generated code, security vulnerabilities, and package hallucinations | 3 |
| C3 Digital & AI literacy, including governance | Adaptive | 2 / 3 | 1 | ACS and national frameworks mandate systemic understanding of AI safety, algorithmic fairness, and software IP governance | 4 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Rapid tool turnover in tech requires structured self-capability gap tracking and lifelong upskilling strategies | 5 |
| C5 Inquiry & evidence generation | Adaptive | 2 / 3 | 1 | Advanced systems development requires empirical benchmarking defended under formal oral examination | 6 |
| W1 Professional communication & conduct | Workplace | 2 / 3 | 1 | IT professionals must pitch and defend technical architectures before external client and industry panels | 7 |
| W2 Authentic task design | Workplace | 2 / 3 | 1 | Real-world software engineering carries live production latency, legacy codebases, and commercial client constraints | 8 |
...
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | Require capstone teams in SWEN90016 to submit an assessed Human-AI Developer Charter specifying task divisions between human engineers and AI code assistants | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | Implement an assessed 'AI Code Reliance and Security Override Log' in SWEN90016/COMP90018 where students justify overrides of AI-generated code and test cases | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Introduce an assessed AI Safety, Licensing & Systems Governance Audit in core SWEN90016/COMP90051 examining statutory accountability and IP compliance | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C4 Life-long learning & transfer | 2 → 3 | "The program documents structured progression toward independent learning: a self-scoped capstone or research project, or assessed identification of one's own knowledge gaps together with the plan to close them." | Embed an assessed technical capability gap analysis and independent lifelong learning plan across the core software sequence | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 2 → 3 | "A substantial project generating primary evidence is REQUIRED (not one route among several), with methodology defended under scrutiny (viva, defence, or staged supervised review)." | Structure the final capstone project demonstration in SWEN90016 as a formal oral viva defense of system architecture and benchmarking methodology | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2 → 3 | "Professional communication is assessed repeatedly and progressively across the program AND at least one core assessment is delivered to, or judged by, a real external audience or practitioner (industry panel, client, patient or simulated patient, public exhibition), with professional conduct or accountability explicitly among the assessed criteria." | Mandate external industry panels comprising software engineering leads and CTOs to evaluate final software demonstrations in SWEN90016 | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2 → 3 | "Such tasks are the program's assessment spine rather than a single instance (a capstone plus earlier scaffolding, or at least one per stage) AND at least one carries a genuine constraint of practice — an ambiguous or externally supplied problem, real resource/time limits, a consequential audience, or the profession's own standards of performance." | Partner with technology enterprises to supply live, ambiguous software engineering project briefs with real deployment constraints | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | W3 | Premier tech companies prioritize graduates who demonstrate verified production code deployment in authentic workplaces | Section 2, Section 4 (ACS / QILT) | HIGH |
| P2 | C1 | Industry standards (IEEE CS / ACS) mandate structured collaboration between software developers and autonomous AI coding agents | Section 1, Section 3 (*IEEE Software*) | HIGH |
| P3 | C2 | Peer-reviewed research (*ACM TOSEM* Jan 2025) demonstrates evaluative judgement is critical to detect subtle AI code security flaws | Section 3, Section 4 | HIGH |
| P4 | C3 | National AI frameworks (CSIRO Data61 / ACSC) require software engineers to implement AI governance, safety, and data privacy safeguards | Section 1, Section 3 | HIGH |
| P5 | W1 | Software employers demand engineering graduates capable of pitching complex systems architectures before external industry panels | Section 2, Section 4 | HIGH |
| P6 | W2 | Live software projects with authentic enterprise constraints reflect the true operational environment of production software engineering | Section 2, Section 4 | HIGH |
| P7 | C5 | Academic and industry standards require empirical systems benchmarking defended under rigorous viva examination | Section 3, Section 4 | HIGH |
| P8 | C4 | Rapid continuous evolution of programming frameworks demands assessed metacognitive gap analysis and lifelong learning plans | Section 2, Section 4 | HIGH |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C1 | Require teams in SWEN90016 to submit an assessed Human-AI Developer Workflow Charter | C1 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022) |
| P2 | C2 | Implement an assessed AI Code Reliance and Security Override Log in SWEN90016 Software Processes and Management | C2 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P3 | C3 | Embed an assessed AI Safety, Licensing & Systems Governance Audit assignment in core SWEN90016 | C3 Level 3 | Medium | Term 2 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P4 | W1 | Mandate external industry panels of senior software architects to evaluate final project demonstrations in SWEN90016 | W1 Level 3 | Medium | Term 2 | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined) |
| P5 | W2 | Partner with technology companies to supply live, ambiguous software development briefs with real production constraints | W2 Level 3 | Medium | Term 2 | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| P6 | C4 | Embed an assessed technical capability gap analysis and lifelong professional development portfolio across the core | C4 Level 3 | Medium | Term 2 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2) |
| P7 | C5 | Implement a formal oral viva defense for the final software architecture and empirical benchmarking in SWEN90016 | C5 Level 3 | Medium | Term 2 | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| P8 | W3 | Embed live externally mentored client projects into core coursework for all degree specialisations | W3 Level 2 | High | Term 3 | [[19]](https://www.legislation.gov.au/F2021L00488)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | PASS condition is met: the program documents a comprehensive 100-to-200 point specialist graduate curriculum in computer science, software engineering, distributed systems, machine learning, and cybersecurity accredited by the Australian Computer Society (ACS). Rigorous, coherent disciplinary computing core. | Any curriculum redesign must preserve the rigorous algorithmic, mathematical, and architectural foundations mandated by ACS accreditation standards. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | PASS condition is met: assessment explicitly requires complex architectural and algorithmic trade-off decisions under technical uncertainty — including engineering fault-tolerant distributed systems under network partitions and latency in COMP90024, optimizing bias-variance trade-offs under noisy data in COMP90051, and balancing scope, technical debt, and concurrency safety under fixed sprint deadlines in SWEN90016. | Interventions must maintain authentic, complex software design decisions and systems trade-offs rather than shifting to standardized multiple-choice testing. | [16] |
