...
const content = {
  title: "Master of Artificial Intelligence (MC-AIMO) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Artificial Intelligence (MC-AIMO)
...
**Assessment date:** 2026-08-29 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-aimo.md
**Position basis:** Destination AI Exposure 92.80 (cognate basis) × Curriculum Adaptiveness 12/15 (v4.2 draft, sub-scale A) · Workplace practice 4/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
> the body.
>
> The exposure value is an **estimate**: it rests on a cognate basis (Master of Computer Science), not on this program's own graduates. It is sound enough to say the destinations are highly exposed and not sound enough to rank this program against a peer on exposure alone — see [the estimated-basis methods note](../docs/dfva-panela-estimated-basis-methods.md).
...
The program's primary improvement opportunities reside in collaborative practice (C1 = 1/3) and work-situated learning (W3 = 0/3). Because the program is delivered wholly online and geared toward accelerated modular learning, every core assessment task is currently specified as an individual deliverable. While generic skills reference collaboration, no core unit assesses group coordination or human-plus-AI team allocation. Similarly, while professional communication (W1 = 2/3) and task authenticity (W2 = 2/3) are well-developed through scoping reports and oral defenses, the curriculum lacks direct external client judging or work-situated placement. Both gates pass cleanly: G1 on a 100-credit-point specialist AI core, and G2 on extensive algorithmic and multi-objective trade-off analysis under uncertainty.

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| W3 Work-situated learning | Workplace | 0 / 3 | 3 | Direct — enterprise tech employers prioritize candidates with verified production deployment experience under real stakeholder and infrastructure constraints | 1 |
| C1 Distributed cognition & relational capability | Adaptive | 1 / 3 | 2 | Direct — ACS and NAIC reports emphasize that enterprise AI adoption requires human-in-the-loop coordination and cross-functional team workflows | 2 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Direct — emerging AI assurance standards mandate auditable human reliance records when evaluating foundation model outputs | 3 |
| W1 Professional communication & conduct | Workplace | 2 / 3 | 1 | Direct — tech leadership roles require defending complex algorithmic architectures and ethical risk trade-offs before non-technical executive panels | 4 |
| W2 Authentic task design | Workplace | 2 / 3 | 1 | Direct — shifting industry demand from isolated model training to live API deployment under production latency and security constraints | 5 |
| C3 Digital & AI literacy, including governance | Adaptive | 3 / 3 | 0 | At maximum — COMP90104, COMP90106, and COMP90109 establish comprehensive technical and ethical governance in core | 6 |
| C4 Life-long learning & transfer | Adaptive | 3 / 3 | 0 | At maximum — 25cp mandatory capstone sequence enforces self-scoped independent learning | 7 |
| C5 Inquiry & evidence generation | Adaptive | 3 / 3 | 0 | At maximum — empirical research/R&D capstone requires primary evidence generation with oral defense | 8 |
| **Adaptive capabilities** | **Adaptive** | **12 / 15** | **3** | — | — |
...
|---|---|---|---|---|
| W3 Work-situated learning | 0 → 1 | "Work-situated learning exists only as an elective, an optional internship, or an unassessed extracurricular or careers activity." | Introduce an optional online industry practicum or virtual internship elective into the program elective band | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| W3 Work-situated learning | 1 → 2 | "A core unit places students in a real workplace or professional-community setting with practitioner supervision and assessment — placement, practicum, live client project, community-based project — OR, for a cohort documented as already practising in the profession, a core unit assesses activity conducted in the student's own professional practice with real recipients and a documented outcome measure — but it is short or stands alone." | Embed an assessed live industry client project or assessed own-practice AI deployment within COMP90111 AI Implementation and Deployment | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| W3 Work-situated learning | 2 → 3 | "Substantial required work-situated learning: an extended placement or practicum, or a sequence of them, in the core, supervised by a practitioner, assessed, with accountability to the host and structured reflection on professional practice — OR, for a cohort documented as already practising, a required sequence of assessed own-practice activity with structured reflection and documented accountability to workplace stakeholders (trainees, patients, clients or employer)." | Structure a compulsory two-subject sequence across COMP90110 and COMP90111 requiring industry-hosted supervision and workplace outcome metrics | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C1 Distributed cognition & relational capability | 1 → 2 | "At least one core unit assesses collaborative practice — group projects with individual accountability, client or stakeholder work, interprofessional activity." | Introduce an assessed collaborative engineering sprint into COMP90102 or INFO90015 with individual contribution weighting | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | Require team capstone projects in COMP90110/COMP90111 with explicit assessment of human-AI labor allocation and multi-agent coordination | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | Embed a mandatory reliance journal in COMP90104 and COMP90111 assessing when students chose to accept, modify, or override LLM/foundation model outputs | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| W1 Professional communication & conduct | 2 → 3 | "Professional communication is assessed repeatedly and progressively across the program AND at least one core assessment is delivered to, or judged by, a real external audience or practitioner (industry panel, client, patient or simulated patient, public exhibition), with professional conduct or accountability explicitly among the assessed criteria." | Mandate that COMP90111 capstone presentations are defended before an external panel of industry AI practitioners and corporate stakeholders | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2 → 3 | "Such tasks are the program's assessment spine rather than a single instance (a capstone plus earlier scaffolding, or at least one per stage) AND at least one carries a genuine constraint of practice — an ambiguous or externally supplied problem, real resource/time limits, a consequential audience, or the profession's own standards of performance." | Require COMP90111 capstone projects to solve externally supplied enterprise AI briefs with production latency, security, and data governance constraints | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C1 | Industry surveys from ACS and NAIC emphasize that commercial AI development requires team-based agile sprints and multi-agent coordination | §3 theme 3; §1 job family 1 | HIGH |
| P2 | C2 | IEEE and CSIRO trustworthy AI frameworks require engineers to audit, document, and defend human oversight decisions over foundation model outputs | §3 theme 2; §4 rising demand | HIGH |
| P3 | W1 | High demand for technical translators who can present complex AI model risks and deployment trade-offs to executive boards | §2 signal 4; §4 rising demand | HIGH |
| P4 | W2 | Tech employers prioritize candidates with verified experience taking AI models from experimental prototypes to scalable cloud deployments | §2 signal 4; §1 job family 4 | HIGH |
| P5 | W3 | Enterprise tech firms (Atlassian, Canva, CSIRO) strongly favour graduates with hands-on workplace or client-partnered project experience | §2 signal 1; §1 job family 1 | HIGH |
| P6 | C1 | Deploying autonomous decision agents requires human-AI interaction design and multi-agent consensus protocols | §3 theme 3; §1 job family 2 | HIGH |
| P7 | W1 | External practitioner evaluation bridges academic grading with industry deployment readiness | §3 theme 2; §5 implication CI-4 | MEDIUM |
| P8 | W3 | Industry capstone co-supervision provides authentic professional identity formation and employment networks | §5 implication CI-5 | HIGH |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C1 | Introduce an assessed collaborative engineering sprint into COMP90102 Machine Learning with individual accountability rubrics | C1 level 2 | Low–medium | Term 1; subject assessment rubric update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| P2 | C2 | Embed a structured reliance journal into COMP90104 Deep Learning requiring students to justify when they accepted or overrode foundation model suggestions | C2 level 3 | Low | Term 1; assessment brief modification | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P3 | W1 | Establish an external practitioner review panel to evaluate final capstone presentations in COMP90111 | W1 level 3 | Medium | Term 2; external panel coordination | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| P4 | W2 | Partner with industry sponsors to provide real-world production datasets and latency/security constraints for COMP90111 deployment briefs | W2 level 3 | Medium | Term 2; industry brief sourcing | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| P5 | W3 | Establish a virtual industry practicum stream or client-hosted capstone project option in COMP90110/COMP90111 | W3 level 2 | Medium–high | Next annual review cycle; industry partnership formalisation | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| P6 | C1 | Mandate team-based software engineering sprints in COMP90110/COMP90111 with explicit assessment of human-plus-AI task distribution | C1 level 3 | Medium–high | Next annual review cycle | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| P7 | W3 | Implement a two-subject sequenced own-practice / industry-supervised placement spine across the capstone | W3 level 3 | High | Future curriculum re-accreditation | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | The program documents a rigorous, coherent specialist core in Artificial Intelligence comprising 100 credit points of compulsory units covering AI programming, algorithmic thinking, machine learning, deep learning and foundation models, AI planning for autonomy, multimodal learning, and AI ethics/society, followed by advanced electives and a 25-credit-point capstone sequence. | Retain the compulsory sequence of foundational algorithms, machine learning, and AI ethics units; ensure collaborative sprints do not displace technical computing rigor. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | Assessments across the curriculum require defended trade-off analysis under uncertainty, including algorithmic complexity trade-offs (COMP90101), model architecture and hyperparameter evaluation (COMP90102, COMP90104), probabilistic decision processes and planning under uncertainty (COMP90105), ethical and societal trade-offs (COMP90106), and unscripted capstone project scoping (COMP90110/COMP90111). | Maintain unscripted problem formulation and open-ended project scoping in capstone assessment briefs; avoid pre-packaged or scripted coding assignments. | [16] |
...
|---|---|---|---|---|---|---|
| P1 | C1 | 1 | 2 | +1 adaptive | 13 / 15 | 4 / 9 |
| P2 | C2 | 2 | 3 | +1 adaptive | 14 / 15 | 4 / 9 |
| P3 | W1 | 2 | 3 | +1 workplace | 14 / 15 | 5 / 9 |
| P4 | W2 | 2 | 3 | +1 workplace | 14 / 15 | 6 / 9 |
| P5 | W3 | 0 | 2 | +2 workplace | 14 / 15 | 8 / 9 |
| P6 | C1 | 2 | 3 | +1 adaptive | 15 / 15 | 8 / 9 |
| P7 | W3 | 2 | 3 | +1 workplace | 15 / 15 | 9 / 9 |
