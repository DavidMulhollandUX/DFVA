...
const content = {
  title: "Master of Urban Design (MC-URBDES) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Urban Design (MC-URBDES)
...
**Assessment date:** 2026-08-15 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-urbdes.md
**Position basis:** Destination AI Exposure 83.74 (exact basis) × Curriculum Adaptiveness 9/15 (v4.2 draft, sub-scale A) · Workplace practice 6/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
Operating in a moderately exposed domain (**83.74**, below the portfolio median of 90.9), the program demonstrates strong studio practice, achieving a maximum score in **W2: 3 / 3** (a progressive authentic task spine across three core design studios and a capstone thesis assessed by oral jury review and constrained by Victorian statutory planning provisions). However, Adaptiveness sits at **9 / 15** and Workplace Practice at **6 / 9** because AI computational design tools sit only in electives (**C3: 1 / 3**), work-situated placements are non-compulsory (**W3: 1 / 3**), assessed group collaboration occurs in only one core subject (**C1: 2 / 3**), appraisal tasks lack process-focused reliance logs (**C2: 2 / 3**), capstone projects are bounded by studio briefs rather than universally self-scoped (**C4: 2 / 3**), research methodology defence is not universally examined (**C5: 2 / 3**), and studio jury panels are internally constituted without verified external industry markers (**W1: 2 / 3**).

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 2 | Direct — Market §2 Signal 4 and §3 Theme 1 note that consultancies mandate Autodesk Forma and AI massing tools; core contains big data but lacks assessed AI governance/evaluation. | 1 |
| W3 Work-situated learning | Workplace | 1 / 3 | 2 | Direct — Professional practice requires real-world precinct experience; vocational placement sits in elective pool rather than core. | 2 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Direct — Precinct design requires multidisciplinary coordination with transport engineers and AI simulation tools; group work sits in only one subject. | 3 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Direct — Urban designers must audit generative massing iterations against planning bylaws; core lacks longitudinal reliance logs. | 4 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Direct — Practicing urban designers formulate independent design research questions; capstone is set within autonomous studio briefs. | 5 |
| C5 Inquiry & evidence generation | Adaptive | 2 / 3 | 1 | Direct — Studio research projects lack oral viva defence or supervised primary data methodology examination. | 6 |
| W1 Professional communication & conduct | Workplace | 2 / 3 | 1 | Direct — Design pitches must be delivered to external municipal clients and community panels with assessed conduct criteria. | 7 |
...
|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Introduce an assessed module in core studios on generative urban form algorithms (Autodesk Forma, TestFit), solar/wind simulation, and micro-climate validation limits. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Introduce an assessed urban AI governance audit: students critique algorithmic zoning and automated feasibility models against PIA ethical standards and municipal heritage overlays. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W3 Work-situated learning | 1 → 2 | "A core unit places students in a real workplace or professional-community setting with practitioner supervision and assessment — placement, practicum, live client project, community-based project — OR, for a cohort documented as already practising in the profession, a core unit assesses activity conducted in the student's own professional practice with real recipients and a documented outcome measure — but it is short or stands alone." | Embed a compulsory live-client precinct studio or supervised vocational placement into the degree core. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| W3 Work-situated learning | 2 → 3 | "Substantial required work-situated learning: an extended placement or practicum, or a sequence of them, in the core, supervised by a practitioner, assessed, with accountability to the host and structured reflection on professional practice — OR, for a cohort documented as already practising, a required sequence of assessed own-practice activity with structured reflection and documented accountability to workplace stakeholders (trainees, patients, clients or employer)." | Formalize an extended multi-stage workplace internship with municipal planning departments or private design consultancies with structured host accountability. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | In core design studios, require multidisciplinary student teams to document a protocol allocating tasks between urban designers, GIS analysts, and generative massing algorithms. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | Require students in the capstone thesis to maintain an assessed design journal justifying decisions to adopt, modify, or reject AI-generated massing options and parametric environmental simulations. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C4 Life-long learning & transfer | 2 → 3 | "The program documents structured progression toward independent learning: a self-scoped capstone or research project, or assessed identification of one's own knowledge gaps together with the plan to close them." | Restructure the capstone thesis so that all students independently scope their own urban design research problem and site investigation rather than selecting from pre-set studio briefs. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 2 → 3 | "A substantial project generating primary evidence is REQUIRED (not one route among several), with methodology defended under scrutiny (viva, defence, or staged supervised review)." | Require all students to complete an empirical urban design thesis with primary site fieldwork and defend design methodology in an oral viva examination. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2 → 3 | "Professional communication is assessed repeatedly and progressively across the program AND at least one core assessment is delivered to, or judged by, a real external audience or practitioner (industry panel, client, patient or simulated patient, public exhibition), with professional conduct or accountability explicitly among the assessed criteria." | Formalize capstone exhibition juries to include external municipal planning officers and PIA practitioners with assessed professional conduct criteria. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C3 | Consultancies mandate Autodesk Forma and generative massing tools; urban designers need assessed AI capabilities and limits. | §2 Signal 4; §3 Theme 1 | HIGH (PIA guidelines) |
| P2 | W3 | Public sector and private design firms seek practice-ready graduates with live precinct delivery experience. | §2 Signal 1; §3 Theme 2 | HIGH (DTP hiring data) |
| P3 | C1 | Precinct masterplans require integrated collaboration across planners, engineers, and digital spatial modellers. | §1 Job Family 1; §3 Theme 2 | HIGH (AILA & PIA standards) |
| P4 | C2 | Urban designers must critically audit automated generative massing iterations against micro-climate and heritage constraints. | §2 Signal 7; §3 Theme 1 | HIGH (Journal of Urban Design) |
| P5 | W1 | Urban designers present masterplans to municipal planning committees, client boards, and public inquiry panels. | §1 Job Family 2; §3 Theme 3 | HIGH (Planning law practice) |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C3 | Add an assessed module evaluating AI-assisted generative urban form tools, parametric simulation, and validation limits | C3 level 2 (capabilities and limits discussed/assessed) | Low | Year 1 Term 1; syllabus update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P2 | W3 | Embed a compulsory live-client precinct project or supervised workplace placement into the core | W3 level 2 (core workplace/client project) | Medium | Year 2 Term 1; curriculum restructuring | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| P3 | C4 | Restructure capstone thesis to require independent student self-scoping of urban design research brief | C4 level 3 (self-scoped capstone project) | Low | Year 2 Term 2; capstone brief update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P4 | W1 | Mandate external municipal and private industry practitioners on capstone exhibition juries with assessed professional conduct | W1 level 3 (judged by external audience with conduct criteria) | Low | Year 2 Term 2; jury assessment rubric | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | 125 points of named compulsory subjects plus 25 points of capstone carrying a staged studio progression (Studio A → B → C → Thesis) accredited by PIA. | Redesign must preserve the accredited progressive studio sequence and specialist urban morphology core. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | Studio jury reviews requiring defended spatial propositions and planning law analyses under complex metropolitan development constraints. | Redesign must maintain unscripted design propositions defended against competing economic and social demands. | [16] |
...
| P2 | W3 | 1 | 2 | +1 workplace | 10 / 15 | 7 / 9 |
| P3 | C4 | 2 | 3 | +1 adaptive | 11 / 15 | 7 / 9 |
| P4 | W1 | 2 | 3 | +1 workplace | 11 / 15 | 8 / 9 |
