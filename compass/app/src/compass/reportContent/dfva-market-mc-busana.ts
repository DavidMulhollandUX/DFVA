...
"Analytics engineering" has settled as the term for building clean, modular, tested data transformation layers — primarily using dbt — between raw data and business intelligence. Graduate analysts who lack understanding of how data pipelines are structured are increasingly seen as incomplete hires. This is generating debate about whether business analytics programs should teach more data engineering fundamentals.
