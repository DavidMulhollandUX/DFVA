...
const content = {
  title: "Doctor of Philosophy - Education (DR-PHILEDU) — Research Degree Report",
  institution: "University of Melbourne",
  markdown: `# DFVA RESEARCH DEGREE REPORT: Doctor of Philosophy - Education (DR-PHILEDU)
...
Carried from [the v1 assessment](dfva-dr-philedu.md) as narrative. The v1 composite, its
