...
const content = {
  title: "Master of Translation and Interpreting (MC-TRANINT) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Translation and Interpreting (MC-TRANINT)
...
**Assessment date:** 2026-09-01 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-tranint.md
**Position basis:** Destination AI Exposure 89.57 (field basis) × Curriculum Adaptiveness 10/15 (v4.2 draft, sub-scale A) · Workplace practice 6/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
Market evidence in \`reports/dfva-market-mc-tranint.md\` bears directly on five of the eight items — C1, C2, C3, W1 and W3 — via named regulatory, econometric or journalistic sources. It does not bear on C4, C5 or W2; per the market-warranted rule, this plan recommends no lever for those three and flags the gap as unaddressed rather than inventing a rationale the report does not supply.

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | Adaptive | 2 / 3 | 1 | Direct — NAATI's 2025-03-31 position statement and AUSIT's Code-of-Ethics review push toward AI governance content the item's level-3 anchor requires (§3 theme 2) | 1 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Direct — Microsoft Research and Oxford Martin task-overlap/adoption studies locate the retained human function in judging AI-output quality, which is what level 3 requires be graded (§3 theme 1) | 2 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Indirect — practitioner-testimony income/workload accounts point at the human-plus-AI task-division gap the evidence file names in TRAN90022 (§3 theme 3) | 3 |
| W1 Professional communication & conduct | Workplace | 2 / 3 | 1 | Indirect — a vendor-reported adoption claim for AI-interpreting tools raises the value of professional-audience assessment beyond the program's single route (§3 theme 4) | 4 |
| W3 Work-situated learning | Workplace | 2 / 3 | 1 | Indirect — the same vendor-reported adoption claim, plus NAATI's supervision requirement for high-risk work, raise the value of guaranteed workplace exposure (§3 theme 2 and theme 4) | 5 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | None in this report — no lever recommended | — |
| C5 Inquiry & evidence generation | Adaptive | 2 / 3 | 1 | None in this report — no lever recommended | — |
| W2 Authentic task design | Workplace | 2 / 3 | 1 | None in this report — no lever recommended | — |
| **Adaptive capabilities** | **Adaptive** | **10 / 15** | **5** | — | — |
| **Workplace practice** | **Workplace** | **6 / 9** | **3** | — | — |

Priority orders items by market-evidence strength among the five items a lever is
recommended for. The P-numbers in the tables that follow are a different ordering —
sequenced by effort and dependency — so an item's priority and its P-number do not
correspond.
...
|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Rewrite TRAN90011's two assignment rubrics to name bias, accountability, transparency or data-governance explicitly as graded criteria — the evidence file finds these concepts only at course-overview level, not in the assessed items | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | Name reliance-decision justification as a graded criterion in TRAN90007's translation-and-peer-review task, requiring students to document when they relied on or overrode AI-generated output | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | Add a graded human-AI task-division criterion to TRAN90022's team-project rubric (currently graded on delivery only), and extend an assessed collaborative-practice element into a second compulsory subject so it recurs beyond the single capstone instance | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2 → 3 | "Professional communication is assessed repeatedly and progressively across the program AND at least one core assessment is delivered to, or judged by, a real external audience or practitioner (industry panel, client, patient or simulated patient, public exhibition), with professional conduct or accountability explicitly among the assessed criteria." | Extend assessed professional-audience communication — currently only TRAN90010's industry-partner evaluation — into a second capstone route or a compulsory-core subject judged by an external practitioner panel | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W3 Work-situated learning | 2 → 3 | "Substantial required work-situated learning: an extended placement or practicum, or a sequence of them, in the core, supervised by a practitioner, assessed, with accountability to the host and structured reflection on professional practice — OR, for a cohort documented as already practising, a required sequence of assessed own-practice activity with structured reflection and documented accountability to workplace stakeholders (trainees, patients, clients or employer)." | Make workplace placement (TRAN90010 or TRAN90027) a required component of every capstone route — including the on-campus Stream 1 pairing and the Stream 2 thesis — rather than one option among several | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C3 | NAATI's position statement (AI must not be used in high-risk assignments without certified-practitioner supervision) and AUSIT's Code-of-Ethics review both push toward governance content beyond tool operation | §3 theme 2 | HIGH |
| P2 | C2 | Microsoft Research's Copilot-conversation study and the Oxford Martin/CEPR machine-translation-adoption study both locate the retained human function in judging AI-output quality and reliability | §3 theme 1 | MEDIUM-HIGH |
| P3 | C1 | Practitioner-testimony accounts of income and workload contraction attributed to AI post-editing point at the human-plus-AI division-of-labour gap TRAN90022 does not currently assess | §3 theme 3 | LOW-MEDIUM |
| P4 | W1 | A vendor-reported webinar poll claims rising AI-interpreting evaluation and adoption among language-service integrators, raising the value of professional-audience assessment beyond the sole TRAN90010 route | §3 theme 4 | LOW |
| P5 | W3 | The same vendor-reported adoption claim, read alongside NAATI's certified-practitioner-supervision requirement for high-risk work, raises the value of guaranteed workplace exposure to real AI-tooling deployment | §3 theme 2; §3 theme 4 | LOW |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C3 | Rewrite TRAN90011's two assignment rubrics to name bias, accountability, transparency or data-governance explicitly as graded criteria | C3 level 3 | Low | Term 1; rubric update only | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P2 | C2 | Add a graded reliance-decision-justification component to TRAN90007's peer-review task | C2 level 3 | Low | Term 1; assessment brief modification | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P3 | C1 | Add a graded human-AI task-division criterion to TRAN90022, and extend assessed collaborative practice into a second compulsory subject | C1 level 3 | Medium | Term 2; subject assessment redesign | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| P4 | W1 | Extend assessed professional-audience communication into a second capstone route or a compulsory subject judged by an external practitioner panel | W1 level 3 | Medium | Term 2; external-panel coordination | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| P5 | W3 | Make workplace placement a required component of every capstone route, not one option among several | W3 level 3 | High | Future curriculum re-accreditation; needs industry-partner placement capacity for the full cohort | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | The program documents a coherent specialist translation/interpreting core — six compulsory subjects (75 points) covering theory and practice, Australian- and Chinese-context translation, bidirectional translation, and AI/intercultural communication — and is an accredited sequence, NAATI-endorsed at multiple certification levels (Certified Translator, Certified Advanced Translator, Certified Provisional Interpreter, Certified Interpreter, Certified Specialist Legal Interpreter). | Retain the six-subject compulsory core and its NAATI accreditation as the redesign proceeds; any lever that dilutes disciplinary depth to make room for governance or collaboration content risks the accreditation basis this gate rests on. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | Capstone options carry real uncertainty and accountability: TRAN90022 has students deliver actual client translation projects under real deadlines, judged to publication quality, and TRAN90010 places students in an industry partner's workplace (~340 hours) with an external evaluation report. | Preserve the live-client and placement stakes in TRAN90022 and TRAN90010 as their rubrics are extended (P1–P5); do not substitute scripted or simulated tasks for genuine client and workplace accountability. | [16] |
...
sub-scales tracked separately, never summed. C4, C5 and W2 carry no lever in this
plan (§1) and stay at their current level throughout, which is why the adaptive
column plateaus at 13/15 rather than reaching 15/15, and the workplace column
plateaus at 8/9 rather than reaching 9/9.

| Lever | Item | From | To | Change | Cumulative adaptive | Cumulative workplace |
|---|---|---|---|---|---|---|
| P1 | C3 | 2 | 3 | +1 adaptive | 11 / 15 | 6 / 9 |
| P2 | C2 | 2 | 3 | +1 adaptive | 12 / 15 | 6 / 9 |
| P3 | C1 | 2 | 3 | +1 adaptive | 13 / 15 | 6 / 9 |
| P4 | W1 | 2 | 3 | +1 workplace | 13 / 15 | 7 / 9 |
| P5 | W3 | 2 | 3 | +1 workplace | 13 / 15 | 8 / 9 |
...
| Citing evidence from one elective capstone route (the Stream 2 thesis, or TRAN90010/TRAN90027 placement) as if it applied to the whole cohort | The score reflects what every student in the core is guaranteed; route-dependent evidence defaults to the lower level under the scoring-direction rule, which is exactly why C4, C5 and W2 sit at level 2 in the verified record despite each having a route that reaches level 3 | Scoring-direction/ambiguity rule, as applied in the verified panelCv4 record's C4/C5/W2 rationales | n/a — internal verification note, not a REFERENCES citation |
