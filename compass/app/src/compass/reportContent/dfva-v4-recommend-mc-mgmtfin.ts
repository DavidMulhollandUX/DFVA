...
const content = {
  title: "Master of Management (Finance) (MC-MGMTFIN) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Management (Finance) (MC-MGMTFIN)
...
**Assessment date:** 2026-08-24 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-mgmtfin.md
**Position basis:** Destination AI Exposure 97.83 (exact basis) × Curriculum Adaptiveness 9/15 (v4.2 draft, sub-scale A) · Workplace practice 5/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
The Master of Management (Finance) is a specialist postgraduate coursework degree preparing graduates for professional roles across investment banking, asset management, corporate treasury, and commercial banking (AI Occupational Exposure (AIOE) 97.83). The program establishes rigorous technical foundations across derivative pricing, corporate finance policy, investment management, and quantitative methods (C1: 2/3, C2: 2/3, C5: 2/3, G1 PASS, G2 PASS) with 5000-word team capstone projects and oral presentations in FNCE90062. However, the financial services sector is undergoing profound automation of routine DCF modeling, financial statement spreading, and formulaic quantitative screening. The degree's primary headroom lies in formalizing human-AI workflow allocation charters (C1), introducing assessed reliance and verification logs for AI financial analysis and algorithmic valuation outputs (C2), closing the core AI-literacy gap — the capture documents software operation only and no AI content at all — before embedding systemic AI market governance and APRA/ASIC compliance (C3: 1/3), and transitioning optional finance internships into guaranteed core client engagements (W1, W3).

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 2 | CFA Institute, FINSIA, and APRA/ASIC mandate algorithmic model transparency, market conduct, and data governance | 1 |
| W3 Work-situated learning | Workplace | 1 / 3 | 2 | Tier-1 investment banks and asset managers prioritize graduates with verified live financial project experience | 2 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Corporate finance teams must explicitly coordinate tasks between financial analysts and automated AI modeling agents | 3 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Financial analysts must systematically audit and document overrides of AI valuation and quantitative trading signals | 4 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Rapid evolution of quantitative financial models and ESG regulations requires assessed lifelong learning plans | 5 |
| C5 Inquiry & evidence generation | Adaptive | 2 / 3 | 1 | Complex corporate finance and valuation investigations require primary evidence defended under oral examination | 6 |
| W1 Professional communication & conduct | Workplace | 2 / 3 | 1 | Financial analysts must defend complex investment pitches before external investment committees and fund managers | 7 |
| W2 Authentic task design | Workplace | 2 / 3 | 1 | Real-world corporate finance carries volatile market regimes, incomplete deal data, and live client constraints | 8 |
...
|---|---|---|---|---|
| W3 Work-situated learning | 1 → 2 | "A core unit places students in a real workplace or professional-community setting with practitioner supervision and assessment — placement, practicum, live client project, community-based project..." | Integrate live corporate client financial analysis and valuation projects from partner firms across core coursework for all degree streams | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| W3 Work-situated learning | 2 → 3 | "Substantial required work-situated learning: an extended placement or practicum, or a sequence of them, in the core, supervised by a practitioner, assessed, with accountability to the host and structured reflection on professional practice..." | Expand finance internships into a guaranteed core requirement or mandatory industry-hosted practicum for the entire cohort | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | Require teams in FNCE90062 to submit an assessed Human-AI Financial Modeling & Valuation Charter dividing tasks between analysts and AI agents | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | Implement an assessed 'AI Financial Valuation & Risk Override Log' in FNCE90056/FNCE90062 where students justify overrides of AI-generated valuation models | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Introduce an assessed treatment of AI capabilities and their limits into a compulsory core subject (ACCT90004 or ECOM90009), which currently document software operation only | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Embed an assessed module in core FNCE90018/FNCE90056 evaluating algorithmic credit bias, market manipulation risks, and APRA/ASIC AI compliance | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C4 Life-long learning & transfer | 2 → 3 | "The program documents structured progression toward independent learning: a self-scoped capstone or research project, or assessed identification of one's own knowledge gaps together with the plan to close them." | Embed an assessed finance capability gap analysis and lifelong professional development portfolio across the core sequence | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 2 → 3 | "A substantial project generating primary evidence is REQUIRED (not one route among several), with methodology defended under scrutiny (viva, defence, or staged supervised review)." | Structure the final capstone project in FNCE90062 as a formal oral viva defense of corporate valuation and investment evidence | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2 → 3 | "Professional communication is assessed repeatedly and progressively across the program AND at least one core assessment is delivered to, or judged by, a real external audience or practitioner (industry panel, client, patient or simulated patient, public exhibition), with professional conduct or accountability explicitly among the assessed criteria." | Mandate external industry panels of chartered financial analysts (CFA), investment bankers, and fund managers to evaluate Capstone pitches in FNCE90062 | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2 → 3 | "Such tasks are the program's assessment spine rather than a single instance (a capstone plus earlier scaffolding, or at least one per stage) AND at least one carries a genuine constraint of practice — an ambiguous or externally supplied problem, real resource/time limits, a consequential audience, or the profession's own standards of performance." | Partner with financial institutions to supply live, ambiguous corporate finance and valuation briefs carrying real commercial constraints | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | W3 | Investment banks and asset managers prioritize graduates with verified live commercial deal experience | Section 2, Section 4 (FINSIA / QILT) | HIGH |
| P2 | C1 | Industry standards (CFA / FINSIA) mandate structured collaboration between financial analysts and automated financial AI agents | Section 1, Section 3 (*Journal of Finance*) | HIGH |
| P3 | C2 | Peer-reviewed research (*JFE* 2025) demonstrates evaluative judgement is critical to override flawed AI valuation and algorithmic signals | Section 3, Section 4 | HIGH |
| P4 | C3 | ASIC and APRA prudential standards require institutions to enforce algorithmic explainability and model risk governance | Section 1, Section 3 | HIGH |
| P5 | W1 | Financial employers demand graduates capable of defending complex valuation and investment pitches before external investment committees | Section 2, Section 4 | HIGH |
| P6 | W2 | Live corporate finance and valuation projects with authentic market constraints reflect the true operational environment of professional practice | Section 2, Section 4 | HIGH |
| P7 | C5 | Academic and professional standards require empirical financial inquiry defended under rigorous oral examination | Section 3, Section 4 | HIGH |
| P8 | C4 | Rapid evolution of quantitative financial models and ESG regulations requires assessed lifelong learning plans | Section 2, Section 4 | HIGH |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C1 | Require teams in FNCE90062 to submit an assessed Human-AI Financial Modeling & Valuation Charter | C1 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022) |
| P2 | C2 | Implement an assessed AI Financial Valuation & Risk Override Log in FNCE90056/FNCE90062 | C2 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P3 | C3 | Introduce an assessed AI capabilities-and-limits component into core ACCT90004/ECOM90009 | C3 Level 2 | Medium | Term 2 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P4 | W1 | Mandate external industry panels of chartered financial analysts (CFA) and fund managers to evaluate Capstone pitches in FNCE90062 | W1 Level 3 | Medium | Term 2 | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined) |
| P5 | W2 | Partner with financial institutions to supply live, ambiguous corporate finance and valuation briefs | W2 Level 3 | Medium | Term 2 | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| P6 | C4 | Embed an assessed finance capability gap analysis and lifelong professional development portfolio across the core | C4 Level 3 | Medium | Term 2 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2) |
| P7 | C5 | Implement a formal oral viva defense for the final Capstone project in FNCE90062 | C5 Level 3 | Medium | Term 2 | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| P8 | W3 | Embed live externally mentored client financial analysis and valuation projects into core coursework for all degree specialisations | W3 Level 2 | High | Term 3 | [[19]](https://www.legislation.gov.au/F2021L00488)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | PASS condition is met: the program documents a comprehensive 200-point curriculum covering corporate financial policy, derivative securities, investment management, accounting for decision making, quantitative methods, and managerial economics. Rigorous, coherent postgraduate finance core. | Any curriculum redesign must preserve the rigorous corporate financial policy, derivative valuation, and quantitative-methods foundations. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | PASS condition is met: assessment explicitly requires complex financial decision-making under severe market volatility, macroeconomic uncertainty, and incomplete information — including pricing exotic options under stochastic volatility in FNCE90011, restructuring corporate capital structure under bankruptcy risks in FNCE90018, and constructing optimal portfolios under dynamic covariance regimes in FNCE90056/FNCE90062. | Interventions must maintain authentic, complex financial trade-offs and valuation judgements under volatility rather than simplifying to deterministic formulas. | [16] |
...
|---|---|---|---|---|---|---|
| P1 | C1 | 2 | 3 | +1 adaptive | 10 / 15 | 5 / 9 |
...
| P8 | W3 | 1 | 2 | +1 workplace | 14 / 15 | 8 / 9 |
