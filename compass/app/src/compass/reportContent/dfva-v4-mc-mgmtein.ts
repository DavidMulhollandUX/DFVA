...
const content = {
  title: "Master of Management (Entrepreneurship and Innovation) (MC-MGMTEIN) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Management (Entrepreneurship and Innovation) (MC-MGMTEIN)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/mc-mgmtein (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 38 pages captured
**Course Director:** Gerda Gemser (Principal Coordinator)
...
> **This program is outside the v3.1 registry, but not outside Panel A.** Master of Management (Entrepreneurship and Innovation)
...
| C3 Digital & AI literacy, including governance [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) | 1 | Level 1 (‘AI or digital tools appear only as electives or as tool operation/training’): the only AI-specific subject documented in the extract, MGMT90267 'Artificial Intelligence in Organisations', is listed solely under Elective subjects in both the 200pt and 150pt structures. No Foundation, Core or Capstone subject addresses AI capabilities and limitations/ethics as required for level 2. |
...
| --- | --- | --- |
| Audit sampling | **↑ Rising** | Bears on C5 and C3. Audit sampling is the methodology-selection skill C5's higher levels require — a designed, defended sampling approach is evidence-generation work, not secondary synthesis — and it is the operational context for the Theme 1 requirement that auditors verify AI-flagged anomalies (C3). |
| Financial statement analysis | **→ Stable** | Bears on C2. Appraising a financial statement's quality — plausibility, consistency, red flags — is the criterion-referenced judgement C2 already credits at level 2 (BUSA90529's peer review); a stable skill demand keeps this item's current level warranted rather than urgent. |
| ASRS sustainability assurance | **↑↑ Rising sharply** | Bears on C5 and W2. Producing a sustainability or climate-risk assurance opinion is itself the primary-evidence project C5 lacks, and delivering it against the profession's own ASRS criteria is the genuine constraint of practice W2's level 3 requires. |
| Tax compliance | **→ Stable** | Bears on W1. Tax compliance advice is delivered to a client or regulator under professional-conduct obligations — the same accountability-to-a-real-audience gap that keeps W1 at level 2; a stable skill demand does not raise its priority relative to C5, C3 or W3. |
| Internal controls | **↑ Rising** | Bears on C2 and C3. Internal-controls work is the reliance-and-override judgement C2's level 3 anchor names directly, and it sits inside the same APESB audit-trail requirement (Theme 1) that keeps C3 below the AI-governance level. |
| administration | **↓ Falling** | Bears on C4. A falling demand for administration is the market-side half of the C4 gap: this program's own entry destinations include Office Clerks, General, so the program needs to demonstrate transfer beyond routine administration, not assume graduates will avoid it. |
...
and the score deltas are in the [improvement plan](dfva-v4-recommend-mc-mgmtein.md); rows
below are ordered by headroom, which is not the plan's P-lever order.

| Item | Score | Implication | Cost | Sources |
| --- | --- | --- | --- | --- |
| C5 Inquiry & evidence generation | 0/3 | No Foundation, Core or Capstone subject documents an assessed research-methods task at all; that is the widest gap on the instrument, and it sits directly under the mandatory ASRS obligation creating an acute shortage of accounting graduates who can generate primary assurance evidence, not just synthesise existing reporting. | A three-step ladder: an assessed literature review (low effort, P1), then a methodology-and-primary-data task inside an existing project brief (medium effort, P6), then making that project the required capstone route with a staged methodology defence (high effort, P11). | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C3 Digital & AI literacy, including governance | 1/3 | The one AI-named subject in the extract sits in Electives, so no graduate is guaranteed AI-capability-and-limitations content, let alone the AI-governance critique level 3 requires — while the profession's own regulator now requires auditors to verify AI-flagged anomalies and keep documented trails. | Reclassifying the AI elective as core plus one assessment redesign to reach level 2 (medium effort, per the plan's P2); a further governance-critique task to reach level 3 (medium effort, per the plan's P9). | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W3 Work-situated learning | 1/3 | The three work-integrated-learning subjects documented are all electives, so no graduate is guaranteed supervised, assessed practice in a real workplace — a gap that matters here because Sales Managers and General and Operations Managers, the two largest-volume destinations in the sample, are exactly the operationally intensive roles supervised placement is meant to prepare graduates for. | Reclassifying one placement elective as core (high effort, per the plan's P7), then extending it into a required sequence with structured reflection (high effort, per the plan's P12). | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C1 Distributed cognition & relational capability | 2/3 | At level 2, MGMT90227's group work already gives every graduate collaborative, individually accountable practice; what is missing is evidence that this program's own graduates can divide a task between people and AI tooling — precisely the coordination "ai" leads keyword-wise for General and Operations Managers, this program's second-largest sampled destination. | One assessment redesign to MGMT90227's existing group report, no new unit or additional credit points (low effort, per the improvement plan's P4). | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2/3 | Level 2's peer review already exists in BUSA90529; the level-3 gap is that no assessment requires the graduate to justify a reliance or override decision — the same documented-audit-trail obligation now placed on this program's own auditor destinations by APESB. | One assessment redesign to BUSA90529's peer-review task, no new unit (low effort, per the plan's P3). | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C4 Life-long learning & transfer | 2/3 | MGMT90201's own-innovation task shows one subject's transfer, not a program-wide structured progression toward independent learning; that gap matters here because administration — one of this program's own entry destinations — is a falling skill, so graduates need demonstrated transfer beyond it, not an assumption of it. | One assessment redesign within the existing capstone, no new unit (low effort, per the plan's P5). | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W1 Professional communication & conduct | 2/3 | MGMT90201's group business plan is a recognised professional genre, but only MGMT90165's Shark Tank pitch — one of five capstone routes, and not offered in 2026 — reaches a real external audience; that leaves professional communication judged by a real client or counterpart, the same accountability Sales Managers require in commercial negotiation, undelivered for most of the cohort. | Making the panel-pitch route required plus one earlier scaffolded communication assessment (high effort, per the plan's P10, since it removes choice among the existing five capstone options). | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2/3 | MGMT90201's own-innovation task already reproduces a professional task end to end, but it is one subject, not the program's assessment spine, and its 'high uncertainty' framing sits in the subject overview rather than an explicitly assessed constraint — the same gap that keeps General and Operations Managers' rising "ai" keyword and the ASRS assurance shortage from reaching level 3. | One earlier-stage scaffolded assessment plus one capstone criteria revision, no new unit (medium effort, per the plan's P8). | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
...
**Panel C provenance.** Scored from the 2026 handbook capture (38 pages) and verified on 2026-08-30: adversarial refutation of every level-3 score and every gate PASS (run), verbatim evidence check (run), and the construct-boundary pass.
