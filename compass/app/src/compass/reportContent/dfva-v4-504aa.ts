...
const content = {
  title: "Master of Commercial Law (504AA) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Commercial Law (504AA)
...
**Course Director:** Rosemary Langford (Director of Studies)
...
> **This program is outside the v3.1 registry, but not outside Panel A.** Master of Commercial Law
...
| C3 Digital & AI literacy, including governance [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) | 1 | Level 1's anchor — 'AI or digital tools appear only as electives or as tool operation/training' — describes this program exactly. Every AI and digital subject in the extract is a prescribed-list option (an 'Artificial Intelligence and the Law' subject, a 'Regulating AI' subject marked not available in 2026, an 'AI and Justice' subject, and a whole 'Digital Law and Technological Innovation' grouping), so none is core. The only program-level digital claim is a graduate attribute about technology skills whose supporting text is IT infrastructure availability — the operational, non-durable level TEQSA identifies. Level 2 requires 'Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed', and there are no core units in which that could be documented; level 3's core assessment of AI critique or governance is likewise absent. |
| C4 Life-long learning & transfer [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) | 1 | Level 1's anchor — transfer claimed in outcomes but not assessed — is met: the course outcomes claim application of knowledge and skills 'as a practitioner and learner' with 'adaptability and responsibility', and a graduate attribute claims knowledge is 'adapted to current circumstances'. Level 2 requires 'At least one core assessment requires application to novel or unfamiliar problems', and no compulsory unit is documented, so no core assessment can be cited. Level 3 requires 'structured progression toward independent learning: a self-scoped capstone or research project' — the self-scoped research papers here are explicitly one route among several, each offered as an alternative to a take-home examination under a note that students must choose between options, and the structure expressly excludes the Minor Thesis. No progression, no assessed identification of one's own knowledge gaps with a plan to close them. |
...
- **G1 Disciplinary foundation:** FAIL — The PASS condition requires a documented 'coherent specialist core with progressive technical or methodological depth: an all-compulsory specialist core, an accredited sequence, or a staged prerequisite chain'. The structure documents none of the three. Of 100 credit points, 87.5 are chosen by the student from a prescribed list; the only compulsory subject applies to one subgroup (students without a common-law degree); and the remaining 12.5 points may be drawn from any Master of Laws subject. No prerequisite chain, staged sequence or accreditation is documented anywhere in the extract, and the prescribed list itself ranges well beyond commercial law into human rights, health and medical, environmental and comparative criminal justice subjects — so the specialist depth is elective-contingent and the units are substitutable for one another.
...
The market intelligence gathered for this program indicates intense transformation across corporate law firms, multinational enterprises, and regulatory agencies, accompanied by rapid adoption of generative AI legal tools (Harvey, CoCounsel, Lexis+ AI) where complex multi-jurisdictional M&A negotiation, fiduciary risk architecture, and courtroom advocacy remain non-delegable human legal responsibilities under Law Council of Australia (LCA) and professional admissions benchmarks.
...
| --- | --- | --- | --- | --- |
| C1 Distributed cognition & relational capability | 1/3 | Establish a compulsory core subject in Commercial Transactions assessing a collaborative cross-functional deal negotiation project with individual accountability; require student legal teams to document human-plus-AI role allocation. | Clinical legal seminar moderation time. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 1/3 | Introduce a structured peer critique task in the core where students evaluate draft contract terms against commercial drafting standards; require candidates to maintain an assessed legal decision log documenting overrides of AI outputs. | Peer review rubric design and calibration. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1/3 | Introduce an assessed module in core commercial law on legal AI technologies (Harvey, Lexis+ AI), hallucinations, confidentiality risks, and ethical limits; introduce an assessed legal AI governance audit. | Software tool licensing and syllabus updates. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C4 Life-long learning & transfer | 1/3 | In core commercial assessments, evaluate candidate legal advice across novel cross-border regulatory scenarios; establish a required self-scoped commercial law capstone research project. | Capstone project supervision and syllabus redesign. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 1/3 | Introduce an assessed commercial law inquiry unit requiring students to select comparative legal methodologies; require all candidates to complete a primary empirical legal inquiry or policy reform thesis. | Thesis viva scheduling and academic supervision. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 1/3 | Introduce a mandatory core legal memorandum and executive client briefing task; mandate that oral deal negotiations and board presentations are judged by external senior commercial practitioners. | External practitioner honoraria and scheduling. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 1/3 | Introduce an authentic commercial transaction task reproducing an M&A due diligence report and contract negotiation end to end; establish an authentic task spine across all stages. | Course assessment spine redesign. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| W3 Work-situated learning | 1/3 | Convert the legal internship into a required core placement in commercial law firms, in-house legal departments, or commercial regulatory agencies; establish an assessed own-practice transaction portfolio. | Placement coordination and host organisation liaison. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
