...
const content = {
  title: "Master of Environment (MC-ENV) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Environment (MC-ENV)
...
**Assessment date:** 2026-08-24 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-env.md
**Position basis:** Destination AI Exposure 89.88 (exact basis) × Curriculum Adaptiveness 9/15 (v4.2 draft, sub-scale A) · Workplace practice 5/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
The Master of Environment is a 200-point multidisciplinary postgraduate degree spanning 11 specialisations across 10 University faculties, preparing graduates for sustainability consulting, corporate ESG strategy, climate risk management, and environmental policy roles (AIOE 89.88). The curriculum establishes solid foundational breadth (**9 / 15** on Sub-scale A), anchored by Level 2 scores in collaborative teamwork across the core (\`MULT90004\` and \`MULT90005\`), evaluative judgement across sustainability policy briefs, contextual transfer across interdisciplinary environmental domains, and a flexible capstone menu (\`ENST90006\`, \`ENST90007\`, \`ENST90025\`, \`SCIE90017\`). Digital and AI literacy is scored at Level 1 (**C3: 1/3**) because computational environmental modelling and AI data governance are not systematically assessed in the universal core. On the workplace practice sub-scale (**5 / 9**), the degree demonstrates solid multi-stakeholder authentic task design (**W2: 2/3**) and professional communication (**W1: 2/3**), with optional 80-hour internship placement routes (**W3: 1/3**). Strategic curriculum headroom focuses on introducing assessed Environmental AI and Data Governance modules (C3), Human-AI interdisciplinary workflow charters (C1), automated ESG/climate model override logs (C2), EIANZ Certified Environmental Practitioner capability gap tracking (C4), universal primary inquiry defence (C5), external industry panel evaluation (W1), and core work-integrated environmental practicum placements (W3).

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 2 | Accelerating corporate demand for remote sensing analytics, automated ESG data governance, and AI greenwashing critique | 1 |
| W3 Work-situated learning | Workplace | 1 / 3 | 2 | Environmental consultancies and government agencies strongly favour candidates with supervised workplace experience | 2 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Interdisciplinary environmental teams increasingly operate alongside generative sustainability tools requiring workflow division | 3 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Environmental specialists must audit and override algorithmic carbon accounting and climate risk models | 4 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Dynamic environmental legislation (AASB/EPBC) demands structured continuing professional development | 5 |
| C5 Inquiry & evidence generation | Adaptive | 2 / 3 | 1 | Literature-only capstone options dilute universal primary empirical research capability | 6 |
| W1 Professional communication & conduct | Workplace | 2 / 3 | 1 | High-stakes environmental impact hearings require communication judged against industry practitioner standards | 7 |
| W2 Authentic task design | Workplace | 2 / 3 | 1 | Core tasks simulate multi-stakeholder policy contexts but lack unyielding statutory environmental compliance constraints | 8 |
...
|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Introduce assessed computational environmental tools and AI data ethics modules in MULT90004 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Embed an assessed Environmental AI & Data Governance module in MULT90004 covering remote sensing analytics, algorithmic greenwashing, and Indigenous data sovereignty | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | Require students in MULT90004/MULT90005 to submit an assessed Collaborative Human-AI Workflow Charter | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | Introduce an assessed 'AI Climate Model & ESG Override Log' in MULT90004 where students critique and override AI-generated policy briefs | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C4 Life-long learning & transfer | 2 → 3 | "The program documents structured progression toward independent learning: a self-scoped capstone or research project, or assessed identification of one's own knowledge gaps together with the plan to close them." | Embed an assessed environmental professional capability gap analysis and EIANZ certified environmental practitioner (CEnvP) development plan in MULT90005 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 2 → 3 | "A substantial project generating primary evidence is REQUIRED (not one route among several), with methodology defended under scrutiny (viva, defence, or staged supervised review)." | Require all students in the 200pt pathway to complete a compulsory primary empirical evidence capstone project defended under oral examination | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2 → 3 | "Professional communication is assessed repeatedly and progressively across the program AND at least one core assessment is delivered to, or judged by, a real external audience or practitioner (industry panel, client, patient or simulated patient, public exhibition), with professional conduct or accountability explicitly among the assessed criteria." | Partner with external environmental practitioners (EIANZ / government agencies) to judge final stakeholder policy briefings in MULT90005 | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2 → 3 | "Such tasks are the program's assessment spine rather than a single instance (a capstone plus earlier scaffolding, or at least one per stage) AND at least one carries a genuine constraint of practice — an ambiguous or externally supplied problem, real resource/time limits, a consequential audience, or the profession's own standards of performance." | Integrate unyielding statutory environmental compliance constraints (e.g. Victorian EPA guidelines and live planning timelines) into core briefing assessments | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| W3 Work-situated learning | 1 → 2 | "A core unit places students in a real workplace or professional-community setting with practitioner supervision and assessment — placement, practicum, live client project, community-based project." | Introduce a required 40-hour live client environmental practicum or industry-partnered project into the core curriculum | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C3 | Mandatory corporate climate disclosures and remote sensing demand AI data literacy and greenwashing critique | Section 1, Section 3 (*Environmental Science & Policy*) | HIGH |
| P2 | C1 | Interdisciplinary environmental consultancies integrate generative AI tools into team workflows | Section 2, Section 3 (*Nature Climate Change* 2025) | HIGH |
| P3 | C2 | Critical need for environmental professionals to audit and override automated ESG and carbon accounting tools | Section 2, Section 3 | HIGH |
| P4 | C4 | Rapidly changing environmental legislation (AASB, EPBC) requires formalised continuing professional development | Section 2, Section 4 | HIGH |
| P5 | C5 | Environmental consultancies prioritize graduates with proven primary empirical research investigation skills | Section 1, Section 6 | HIGH |
| P6 | W1 | High demand for practitioners capable of defending environmental findings before external client/regulatory panels | Section 1, Section 4 | HIGH |
| P7 | W3 | Environmental employers seek graduates with documented workplace practicum experience | Section 1, Section 2 | HIGH |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C1 | Require students in MULT90004/MULT90005 to submit an assessed Collaborative Human-AI Workflow Charter | C1 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022) |
| P2 | C2 | Introduce an assessed AI Climate Model & ESG Override Log in MULT90004 | C2 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P3 | C3 | Embed an assessed Environmental AI & Data Governance module in MULT90004 | C3 Level 3 | Medium | Term 2 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P4 | C4 | Embed an assessed capability gap analysis and EIANZ CEnvP development plan in MULT90005 | C4 Level 3 | Low | Term 2 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2) |
| P5 | C5 | Mandate primary empirical research project defense across all 200pt capstones | C5 Level 3 | Medium | Term 2 | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| P6 | W1 | Partner with external environmental practitioners (EIANZ / government) to evaluate final policy briefings in MULT90005 | W1 Level 3 | Medium | Term 2 | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29) |
| P7 | W2 | Integrate unyielding statutory environmental compliance constraints into core briefing assessments | W2 Level 3 | Medium | Term 3 | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396) |
| P8 | W3 | Introduce a required 40-hour live client environmental practicum into the core curriculum | W3 Level 2 | High | Term 3 | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | PASS condition is met: comprehensive 200-point multidisciplinary postgraduate qualification spanning environmental sustainability, stakeholder governance, climate change, conservation, waste management, environmental science, and specialized capstone projects across 10 University faculties. | Any curriculum redesign must preserve multidisciplinary breadth, core sustainability foundations, and flexible specialised stream choices. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | PASS condition is met: core assessment explicitly requires navigating high-stakes socio-ecological dilemmas, conflicting community/commercial stakeholder interests, and uncertain climate scenarios (MULT90004, MULT90005). | Assessments must preserve authentic socio-ecological ambiguity and multi-stakeholder tension rather than simplified deterministic compliance exercises. | [16] |
...
| P3 | C3 | 1 | 3 | +2 adaptive | 13 / 15 | 5 / 9 |
| P4 | C4 | 2 | 3 | +1 adaptive | 14 / 15 | 5 / 9 |
| P5 | C5 | 2 | 3 | +1 adaptive | 15 / 15 | 5 / 9 |
| P6 | W1 | 2 | 3 | +1 workplace | 15 / 15 | 6 / 9 |
| P7 | W2 | 2 | 3 | +1 workplace | 15 / 15 | 7 / 9 |
