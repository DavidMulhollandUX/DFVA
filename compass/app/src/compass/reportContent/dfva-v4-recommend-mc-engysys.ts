...
const content = {
  title: "Master of Energy Systems (MC-ENGYSYS) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Energy Systems (MC-ENGYSYS)
...
**Assessment date:** 2026-08-24 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-engysys.md
**Position basis:** Destination AI Exposure 91.16 (exact basis) × Curriculum Adaptiveness 8/15 (v4.2 draft, sub-scale A) · Workplace practice 5/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
|---|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 2 | Market §2 Signal 2 and §3 Theme 1 show automated power dispatch and AI grid forecasting require explicit algorithmic limitation audits in core units | 1 |
| C5 Inquiry & evidence generation | Adaptive | 1 / 3 | 2 | Market §4 indicates complex renewable integration requires student-designed primary empirical investigations with methodology selection rather than GPA-restricted projects | 2 |
| W3 Work-situated learning | Workplace | 1 / 3 | 2 | Market §1 and §2 show energy consultancies and market operators prioritize candidates with verified hands-on practicum experience; WIL is currently absent from the core | 3 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Market §3 Theme 2 emphasizes energy transition delivery requires coordinating human teams integrated with automated power simulation platforms | 4 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Market §3 Theme 1 notes energy systems engineers must document reliance and override decisions when auditing AI-generated power flow models | 5 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Market §4 indicates rapid decarbonisation mandates demand independent learning transfer to novel microgrid topologies | 6 |
| **Adaptive capabilities** | **Adaptive** | **8 / 15** | **7** | — | — |
| W1 Professional communication & conduct | Workplace | 2 / 3 | 1 | Market §3 Theme 2 shows energy transition strategies must be defended before external AEMO / AER / industry review panels | 7 |
| W2 Authentic task design | Workplace | 2 / 3 | 1 | Market §2 Signal 1 notes energy feasibility studies must navigate live NEM regulatory constraints and grid connection rules | 8 |
...
|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Introduce an assessed module in core unit ENGR90029 Analysing Energy Systems analyzing machine learning renewable forecasting tools and algorithmic dispatch limits | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Mandate an assessed energy data governance and AI grid ethics critique in ENGR90030 evaluating cybersecurity and algorithmic bias in autonomous dispatch systems | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 1 → 2 | "Students design and conduct an inquiry with methodology selection and data collection, assessed." | Restructure core energy analysis coursework into a student-designed empirical inquiry on renewable integration or microgrids with methodology selection and data collection | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C5 Inquiry & evidence generation | 2 → 3 | "A substantial project generating primary evidence is REQUIRED (not one route among several), with methodology defended under scrutiny (viva, defence, or staged supervised review)." | Make the 25-point Energy Systems Project (ENGR90031) compulsory for all graduating students with methodology defended in a formal oral viva examination before an industry/academic panel | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W3 Work-situated learning | 1 → 2 | "A core unit places students in a real workplace or professional-community setting with practitioner supervision and assessment — placement, practicum, live client project, community-based project — OR, for a cohort documented as already practising in the profession, a core unit assesses activity conducted in the student's own professional practice with real recipients and a documented outcome measure — but it is short or stands alone." | Formalize an assessed credit-bearing energy consulting practicum or live industry project with clean energy hosts in the core curriculum | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2011.642845)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| W3 Work-situated learning | 2 → 3 | "Substantial required work-situated learning: an extended placement or practicum, or a sequence of them, in the core, supervised by a practitioner, assessed, with accountability to the host and structured reflection on professional practice — OR, for a cohort documented as already practising, a required sequence of assessed own-practice activity with structured reflection and documented accountability to workplace stakeholders (trainees, patients, clients or employer)." | Embed an extended 200-hour supervised clean energy industry placement with formal host assessment and structured reflective professional journaling | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2011.642845)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | Require student teams in ENGR90028/ENGR90030 to submit an assessed collaboration charter and tool-human work allocation agreement documenting the division of work between human analysts and power simulation software | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | Introduce an assessed 'Reliance and Override Log' in ENGR90029 where students document and justify overrides of automated power system modeling packages | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C4 Life-long learning & transfer | 2 → 3 | "The program documents structured progression toward independent learning: a self-scoped capstone or research project, or assessed identification of one's own knowledge gaps together with the plan to close them." | Require an assessed personal learning gap analysis and research strategy plan within a universally compulsory capstone sequence | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W1 Professional communication & conduct | 2 → 3 | "Professional communication is assessed repeatedly and progressively across the program AND at least one core assessment is delivered to, or judged by, a real external audience or practitioner (industry panel, client, patient or simulated patient, public exhibition), with professional conduct or accountability explicitly among the assessed criteria." | Mandate that energy strategy presentations in ENGR90030/ENGR90032 are judged by an external panel of practicing energy executives from AEMO, AER, and clean energy developers | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2 → 3 | "Such tasks are the program's assessment spine rather than a single instance (a capstone plus earlier scaffolding, or at least one per stage) AND at least one carries a genuine constraint of practice — an ambiguous or externally supplied problem, real resource/time limits, a consequential audience, or the profession's own standards of performance." | Frame core energy feasibility tasks around externally supplied live developer briefs with strict grid connection limits and capital cost constraints | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C3 | Clean Energy Council and AEMO guidelines highlight the necessity of understanding machine learning power dispatch and forecasting error bounds | §3 Theme 1 | HIGH |
| P2 | C3 | Energy market operators require power systems engineers capable of auditing algorithmic dispatch and cybersecurity risks | §2 Signal 2, §3 Theme 1 | HIGH |
| P3 | C5 | Inverter-based resource grid stability and low system strength require student-designed primary empirical investigations | §2 Signal 4, §4 Rising Demand | HIGH |
| P4 | C5 | Energy Policy scholarship demonstrates empirical microgrid testing under real-world weather and demand volatility | §3 Theme 3 | HIGH |
| P5 | W3 | Renewable developers and consultancies actively recruit candidates with verified on-site grid connection experience | §1 Job Family 1 & 3, §2 Signal 1 | HIGH |
| P6 | W3 | Energy transition agencies require structured workplace engineering practice under practitioner mentorship | §1 Job Family 2 | HIGH |
| P7 | C1 | Large-scale clean energy delivery requires multidisciplinary coordination across electrical engineers, economists, and planners | §1 Job Family 1, §3 Theme 2 | HIGH |
| P8 | C2 | Non-delegable engineering liability requires energy analysts to document independent audits of automated power flow software | §3 Theme 1 | HIGH |
| P9 | C4 | Rapid energy market transformation requires independent learning transfer to emerging storage and offshore wind technologies | §4 Rising Demand | MEDIUM |
| P10 | W1 | Energy professionals must conduct spoken presentations and defend project economics before executive investment committees | §3 Theme 2 | HIGH |
| P11 | W2 | Clean energy consultancies must deliver grid connection studies compliant with National Electricity Rules (Clause 5.3.4A) | §1 Job Family 1, §3 Theme 1 | HIGH |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C3 | Add an assessed module on machine learning renewable forecasting and AI dispatch limits in ENGR90029 | Level 2 | Low | Year 1 Semester 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13] |
| P2 | C2 | Implement an assessed 'Reliance and Override Log' in ENGR90029 where students document and justify overrides of automated simulation tools | Level 3 | Low | Year 1 Semester 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3) |
| P3 | C1 | Require student teams in ENGR90028 to submit an assessed collaboration charter and tool-human work allocation agreement | Level 3 | Low | Year 1 Semester 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022) |
| P4 | W1 | Mandate that energy strategy presentations in ENGR90030 are judged by practicing executives from AEMO, AER, and renewable consultancies | Level 3 | Medium | Year 1 Semester 2 | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29) |
| P5 | C5 | Restructure core energy analysis coursework into a student-designed empirical inquiry on microgrids with methodology selection | Level 2 | Medium | Year 1 Semester 2 | [14][15] |
| P6 | W2 | Frame core energy feasibility tasks around externally supplied live developer briefs with real grid connection constraints | Level 3 | Medium | Year 1 Semester 2 | [[22]](https://doi.org/10.1007/BF02504676)[[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| P7 | W3 | Formalize an assessed credit-bearing energy consulting practicum or live industry project with clean energy hosts in the core sequence | Level 2 | Medium | Year 2 Semester 1 | [[19]](https://www.legislation.gov.au/F2021L00488)[[29]](https://doi.org/10.1080/07294360.2011.642845) |
| P8 | C4 | Require an assessed personal learning gap analysis and research strategy plan within a universally compulsory capstone sequence | Level 3 | Medium | Year 2 Semester 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2) |
| P9 | C3 | Introduce an assessed energy data governance and AI grid ethics critique in ENGR90030 | Level 3 | Medium | Year 2 Semester 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P10 | C5 | Make the 25-point Energy Systems Project compulsory for all students, defended in an oral viva examination before an industry panel | Level 3 | High | Year 2 Semester 1 | [14][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| P11 | W3 | Establish an extended 200-hour supervised clean energy industry placement with structured employer assessment | Level 3 | High | Year 2 Summer/Term | [[19]](https://www.legislation.gov.au/F2021L00488)[[28]](https://doi.org/10.1007/s10734-017-0216-z) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | PASS condition is met: the program documents an extensive compulsory 100-point specialist core establishing technical and multidisciplinary depth across Introduction to Energy Systems (ENGR90028), Analysing Energy Systems (ENGR90029), Electrical Power Systems (ELEN90069), Financial Management / Managerial Economics / Business Decision Analysis (FNCE90060/ECON90015/MGMT90141), Managing Energy Systems (ENGR90030), and Energy Systems in Low Carbon Futures (ENGR90032). Coherent technical and interdisciplinary engineering sequence. | Curriculum redesign must preserve multidisciplinary depth across thermodynamics, electrical power systems, and energy economics, avoiding conversion into a generic management degree | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | PASS condition is met: assessment goes well beyond formulaic calculations to require complex trade-off decisions under technological, financial, and policy uncertainty — including balancing grid stability against intermittent renewable generation in ELEN90069 and ENGR90029, capital investment trade-offs under volatile wholesale electricity pricing in FNCE90060 and ENGR90030, and decarbonisation pathway selection under regulatory uncertainty in ENGR90032. | All assessments must preserve unscripted multi-criteria trade-off decisions under regulatory, market, and renewable intermittency uncertainty | [16] |
