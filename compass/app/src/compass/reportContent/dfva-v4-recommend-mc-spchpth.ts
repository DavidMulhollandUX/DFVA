...
**Position basis:** Destination AI Exposure 89.56 (exact basis) × Curriculum Adaptiveness 10/15 (v4.2 draft, sub-scale A) · Workplace practice 9/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
The Master of Speech Pathology is a 200-point entry-level professional qualification accredited by Speech Pathology Australia (SPA), preparing graduates for clinical practice across hospital neurorehabilitation, paediatric language, acute dysphagia, and voice disorders (AIOE 89.56). The program demonstrates a flawless benchmark across workplace practice (**9 / 9** on Sub-scale W: W1: 3/3, W2: 3/3, W3: 3/3, G1 PASS, G2 PASS), anchored by extensive clinical placement blocks (AUDI90032, AUDI90033, AUDI90039) evaluated via the validated national COMPASS® competency framework under certified clinical educators, alongside rigorous OSCE hurdles across every semester. On the adaptive capabilities sub-scale (**10 / 15**), the curriculum achieves Level 2 across all dimensions (acoustics practicals in AUDI90002, clinical evaluative judgement in OSCE hurdles, lifespan transfer in complex cases in AUDI90041). The primary curriculum headroom focuses on establishing human-AI clinical transcription and workflow charters (C1), introducing assessed reliance and override logs for automated acoustic voice analysis and automatic speech recognition tools (C2), embedding systemic critique of speech recognition algorithmic bias against non-standard dialects and paediatric voices (C3), and formalizing oral viva defenses for clinical evidence-based inquiry projects (C5).

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Clinical workflows increasingly pair speech pathologists with automated speech-to-text and language profiling systems | 1 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Clinicians must systematically audit and override AI acoustic analysis and automated language transcription tools | 2 |
| C3 Digital & AI literacy, including governance | Adaptive | 2 / 3 | 1 | SPA and healthcare regulators highlight severe algorithmic bias in speech recognition against atypical voices and dialects | 3 |
...
| W1 Professional communication & conduct | Workplace | 3 / 3 | 0 | Flawless benchmark — assessed by certified clinical educators via national COMPASS® instruments | 6 |
| W2 Authentic task design | Workplace | 3 / 3 | 0 | Flawless benchmark — live OSCE hurdles, acute dysphagia cases, and paediatric assessments across stages | 7 |
| W3 Work-situated learning | Workplace | 3 / 3 | 0 | Flawless benchmark — extensive mandatory placement blocks in hospitals, rehabilitation centres, and schools | 8 |
...
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Embed an assessed module in core AUDI90002/AUDI90030 evaluating ASR algorithmic bias, AAC data privacy, and clinical AI governance | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
...
|---|---|---|---|---|---|---|
| P1 | C1 | 2 | 3 | +1 adaptive | 11 / 15 | 9 / 9 |
| P2 | C2 | 2 | 3 | +1 adaptive | 12 / 15 | 9 / 9 |
| P3 | C3 | 2 | 3 | +1 adaptive | 13 / 15 | 9 / 9 |
| P4 | C4 | 2 | 3 | +1 adaptive | 14 / 15 | 9 / 9 |
