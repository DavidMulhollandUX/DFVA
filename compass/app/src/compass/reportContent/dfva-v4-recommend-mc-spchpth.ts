...
const content = {
  title: "Master of Speech Pathology (MC-SPCHPTH) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Speech Pathology (MC-SPCHPTH)
...
**Assessment date:** 2026-08-24 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-spchpth.md
**Position basis:** Destination AI Exposure 89.56 (exact basis) × Curriculum Adaptiveness 9/15 (v4.2 draft, sub-scale A) · Workplace practice 9/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
The Master of Speech Pathology is a 200-point entry-level professional qualification accredited by Speech Pathology Australia (SPA), preparing graduates for clinical practice across hospital neurorehabilitation, paediatric language, acute dysphagia, and voice disorders (AI Occupational Exposure (AIOE) 89.56). The program demonstrates a flawless benchmark across workplace practice (**9 / 9** on Sub-scale W: W1: 3/3, W2: 3/3, W3: 3/3, G1 PASS, G2 PASS), anchored by extensive clinical placement blocks (AUDI90032, AUDI90033, AUDI90039) — approximately 400 hours of supervised clinical work — evaluated via the COMPASS® competency assessment, alongside rigorous OSCE hurdles across every semester. On the adaptive capabilities sub-scale (**9 / 15**), the curriculum reaches Level 2 on four of the five items (computer-based statistical practicals in AUDI90002, clinical evaluative judgement in OSCE hurdles, lifespan transfer in complex cases in AUDI90041) and Level 1 on C3, where the capture records no AI content of any kind and the digital content it does record sits in unassessed intended learning outcomes. The largest curriculum headroom is C3, two levels below the maximum: core assessment of what automated speech and language tools can do and where their limits lie. The remaining headroom is establishing human-AI clinical transcription and workflow charters (C1), introducing assessed reliance and override logs for automated acoustic voice analysis and speech recognition tools (C2), and documenting the AUDI90040 research project's methodology defence (C5).

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 2 | SPA and healthcare regulators highlight severe algorithmic bias in speech recognition against atypical voices and dialects; the core assesses no AI or digital tool use at all | 1 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Clinical workflows increasingly pair speech pathologists with automated speech-to-text and language profiling systems | 2 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Clinicians must systematically audit and override AI acoustic analysis and automated language transcription tools | 3 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Expanding neurorehabilitation and dysphagia modalities require formalised continuing professional development planning | 4 |
| C5 Inquiry & evidence generation | Adaptive | 2 / 3 | 1 | Evidence-based clinical practice standards demand primary clinical inquiry defended under rigorous oral examination | 5 |
| **Adaptive capabilities** | **Adaptive** | **9 / 15** | **6** | — | — |
| W1 Professional communication & conduct | Workplace | 3 / 3 | 0 | Flawless benchmark — assessed by clinical supervisors at placement sites via the COMPASS® instrument | 6 |
| W2 Authentic task design | Workplace | 3 / 3 | 0 | Flawless benchmark — timed OSCE hurdles and complex multifaceted case tasks across stages | 7 |
| W3 Work-situated learning | Workplace | 3 / 3 | 0 | Flawless benchmark — extensive mandatory placement blocks in hospitals, community clinics, schools and residential aged care facilities | 8 |
...
|---|---|---|---|---|
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | Require students in AUDI90027/AUDI90032 to submit an assessed Human-AI Clinical Transcription & Acoustic Processing Protocol | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | Implement an assessed 'AI Acoustic Biomarker & Speech Recognition Override Log' in AUDI90036/AUDI90041 where students justify departures from automated speech analysis tools | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Add an assessed module in core AUDI90002/AUDI90030 covering automated speech recognition and language-sample analysis — what the tools do, where they fail on atypical speech and non-standard dialects, and the ethical limits on their clinical use | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C4 Life-long learning & transfer | 2 → 3 | "The program documents structured progression toward independent learning: a self-scoped capstone or research project, or assessed identification of one's own knowledge gaps together with the plan to close them." | Embed an assessed speech pathology clinical capability gap analysis and continuing professional development (CPD) plan in AUDI90039/AUDI90041 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 2 → 3 | "A substantial project generating primary evidence is REQUIRED (not one route among several), with methodology defended under scrutiny (viva, defence, or staged supervised review)." | Implement a formal staged supervised defense for evidence-based practice inquiries in AUDI90025/AUDI90041 | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C1 | Clinical environments integrate AI speech transcription while maintaining human clinician diagnostic ownership | Section 1, Section 3 (*American Journal of Speech-Language Pathology*) | HIGH |
| P2 | C2 | Critical need for speech clinicians to audit and override automated acoustic analysis and automatic speech recognition outputs | Section 2, Section 3 (*International Journal of Speech-Language Pathology* 2025) | HIGH |
| P3 | C3 | SPA and health safety guidelines mandate understanding ASR dialectal bias, AAC cloud security, and health privacy | Section 3, Section 4 | HIGH |
| P4 | C4 | Evolving dysphagia instrumental modalities and assistive communication tech demand formalised CPD plans | Section 2, Section 4 | HIGH |
| P5 | C5 | Professional evidence-based practice standards require clinical speech inquiries defended under rigorous oral examination | Section 3, Section 4 | HIGH |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C1 | Require students in AUDI90027/AUDI90032 to submit an assessed Human-AI Clinical Transcription & Acoustic Processing Protocol | C1 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022) |
| P2 | C2 | Implement an assessed AI Acoustic Biomarker & Speech Recognition Override Log in AUDI90036/AUDI90041 | C2 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P3 | C3 | Add an assessed module in core AUDI90002/AUDI90030 on automated speech and language tools, their limits on atypical speech, and the ethical limits on their clinical use | C3 Level 2 | Medium | Term 2 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P4 | C4 | Embed an assessed clinical capability gap analysis and CPD plan in AUDI90039/AUDI90041 | C4 Level 3 | Low | Term 2 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2) |
| P5 | C5 | Implement a formal staged supervised defense for evidence-based practice inquiries in AUDI90025/AUDI90041 | C5 Level 3 | Medium | Term 2 | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | PASS condition is met: accredited by Speech Pathology Australia (SPA) as a 200-point entry-level professional master's degree meeting all national competency standards. Comprehensive foundation spanning speech anatomy/physiology, acoustics, phonetics, linguistics, child language development, dysphagia, adult neurogenic disorders, voice/fluency, and clinical practice. | Any curriculum modifications must preserve SPA accreditation compliance, extensive clinical placement hours, and comprehensive coverage across all communication disorder domains. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | PASS condition is met: assessment explicitly requires high-stakes diagnostic and clinical decision-making on complex, multifaceted clinical cases assessed under hurdle conditions — including live OSCE hurdles across AUDI90029 (OSCE or video observation examination), AUDI90033, AUDI90036, AUDI90039, and AUDI90041 and direct clinical decision-making during COMPASS®-assessed placements. | Assessments must preserve live clinical ambiguity and bedside decision-making under time pressure, preventing over-reliance on standardized algorithmic symptom checkers. | [16] |
...
|---|---|---|---|---|---|---|
| P1 | C1 | 2 | 3 | +1 adaptive | 10 / 15 | 9 / 9 |
| P2 | C2 | 2 | 3 | +1 adaptive | 11 / 15 | 9 / 9 |
| P3 | C3 | 1 | 2 | +1 adaptive | 12 / 15 | 9 / 9 |
| P4 | C4 | 2 | 3 | +1 adaptive | 13 / 15 | 9 / 9 |
| P5 | C5 | 2 | 3 | +1 adaptive | 14 / 15 | 9 / 9 |
