...
const content = {
  title: "Master of Social Work (MC-SOCW) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Social Work (MC-SOCW)
...
**Assessment date:** 2026-08-24 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-socw.md
**Position basis:** Destination AI Exposure 86.73 (exact basis) × Curriculum Adaptiveness 8/15 (v4.2 draft, sub-scale A) · Workplace practice 9/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
The Master of Social Work is an AASW-accredited professional entry qualification (225 credit points) meeting Australian Social Work Education and Accreditation Standards (ASWEAS), preparing graduates for clinical, hospital, statutory child protection, and mental health practice (AI Occupational Exposure (AIOE) 86.73). The program achieves a flawless benchmark across workplace practice (**9 / 9** on Sub-scale W: W1: 3/3, W2: 3/3, W3: 3/3, G1 PASS, G2 PASS), anchored by two required supervised field placements — the first documented as 500 hours across SCWK90048 and SCWK90049, with SCWK90050 and SCWK90051 also compulsory in Year 2 — supervised in the placement agency and judged pass/fail against the placement learning and assessment plan. On the adaptive capabilities sub-scale (**8 / 15**), the degree reaches Level 2 on three items (the assessed group presentation in SCWK90063, criterion-referenced peer review and self-assessment in SCWK90056/SCWK90065/SCWK90053, and transfer across the practice areas the core names in SCWK90066/SCWK90057/SCWK90059) and Level 1 on two: no core unit addresses AI capabilities and their limits or ethics (C3), and core research assessment stops at proposals, plans and a scoping review of existing literature (C5). Strategic curriculum headroom focuses on formalizing human-AI clinical workflow charters for intake and documentation (C1), introducing assessed reliance and override logs for AI-assisted risk screening algorithms and diagnostic triage tools (C2), embedding systemic critique of algorithmic bias in welfare systems (Robodebt lessons) and Indigenous data sovereignty under CARE principles (C3), and establishing formal oral viva defense for practice research projects (C5).

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Clinical workflows increasingly pair social workers with AI-assisted transcription and case management tools | 3 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Human services professionals must systematically audit and override automated risk-prediction algorithms | 4 |
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 2 | AASW and royal commission inquiries mandate rigorous critique of algorithmic bias, surveillance, and CARE principles | 1 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Evolving statutory child safety and mental health frameworks demand formalised continuing professional development planning | 5 |
| C5 Inquiry & evidence generation | Adaptive | 1 / 3 | 2 | Advanced clinical leadership requires practice-based inquiry defended under rigorous oral examination | 2 |
| **Adaptive capabilities** | **Adaptive** | **8 / 15** | **7** | — | — |
| W1 Professional communication & conduct | Workplace | 3 / 3 | 0 | Flawless benchmark — professional conduct judged pass/fail in the placement agency against the learning and assessment plan | 6 |
| W2 Authentic task design | Workplace | 3 / 3 | 0 | Flawless benchmark — an authentic-task spine carrying the profession's own standards of performance | 7 |
| W3 Work-situated learning | Workplace | 3 / 3 | 0 | Flawless benchmark — two required supervised field placements, the first documented as 500 hours | 8 |
...
|---|---|---|---|---|
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | Require students in SCWK90053/SCWK90057 to submit an assessed Human-AI Clinical Workflow & Transcription Protocol | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | Implement an assessed 'AI Clinical Risk Score & Triage Override Log' in SCWK90054/SCWK90055 where students justify departures from algorithmic suggestions | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Embed an assessed module in core SCWK90065/SCWK90063 evaluating algorithmic bias in human services, Robodebt administrative justice, and CARE principles | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C4 Life-long learning & transfer | 2 → 3 | "The program documents structured progression toward independent learning: a self-scoped capstone or research project, or assessed identification of one's own knowledge gaps together with the plan to close them." | Embed an assessed professional practice capability gap analysis and continuing professional development (CPD) plan in SCWK90072/SCWK90073 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 1 → 3 | "A substantial project generating primary evidence is REQUIRED (not one route among several), with methodology defended under scrutiny (viva, defence, or staged supervised review)." | Implement a formal staged supervised defense for practice research projects in SCWK90069/SCWK90058 | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C1 | Clinical environments integrate AI transcription while maintaining human practitioner relational ownership | Section 1, Section 3 (*British Journal of Social Work*) | HIGH |
| P2 | C2 | Critical need for practitioners to audit and override automated child protection risk-scoring and triage algorithms | Section 2, Section 3 (*Australian Social Work* 2025) | HIGH |
| P3 | C3 | AASW and Royal Commission standards mandate understanding algorithmic welfare bias, administrative justice, and CARE data principles | Section 3, Section 4 | HIGH |
| P4 | C4 | Evolving statutory child safety and mental health frameworks require formalised continuing professional development planning | Section 2, Section 4 | HIGH |
| P5 | C5 | Academic and evidence-based practice standards require social work research defended under rigorous oral examination | Section 3, Section 4 | HIGH |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C1 | Require students in SCWK90053/SCWK90057 to submit an assessed Human-AI Clinical Workflow & Transcription Protocol | C1 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022) |
| P2 | C2 | Implement an assessed AI Clinical Risk Score & Triage Override Log in SCWK90054/SCWK90055 | C2 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P3 | C3 | Embed an assessed Algorithmic Welfare Bias & CARE Principles module in core SCWK90065/SCWK90063 | C3 Level 3 | Medium | Term 2 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P4 | C4 | Embed an assessed professional practice capability gap analysis and CPD plan in SCWK90072/SCWK90073 | C4 Level 3 | Low | Term 2 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2) |
| P5 | C5 | Implement a formal staged supervised defense for practice research projects in SCWK90069/SCWK90058 | C5 Level 3 | Medium | Term 2 | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | PASS condition is met: AASW-accredited 225-credit-point professional entry qualification fully meeting Australian Social Work Education and Accreditation Standards (ASWEAS). Rigorous, comprehensive foundation spanning social work theory, human development, counselling skills, law and ethics, Indigenous practice, social policy, research methodology, and 500 documented hours in the first supervised field placement, plus two further compulsory placement subjects in Year 2. | Redesign must strictly maintain ASWEAS accreditation compliance, the required supervised field placement sequence, and core coverage of social justice, mental health, and child welfare. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | PASS condition is met: assessment explicitly requires high-stakes clinical and psychosocial decision-making under severe uncertainty, acute crisis, trauma, child protection vulnerability, and ambiguous family/community dynamics — including risk and vulnerability appraisal in SCWK90054, legal and ethical dilemma resolution in SCWK90055, and supervised field practice assessed through performance tasks completed throughout the placement (SCWK90048/SCWK90049). | Case assessments must preserve authentic clinical ambiguity and acute psychosocial uncertainty, avoiding deterministic algorithmic risk scoring checklists. | [16] |
...
|---|---|---|---|---|---|---|
| P1 | C1 | 2 | 3 | +1 adaptive | 9 / 15 | 9 / 9 |
| P2 | C2 | 2 | 3 | +1 adaptive | 10 / 15 | 9 / 9 |
| P3 | C3 | 1 | 3 | +2 adaptive | 12 / 15 | 9 / 9 |
| P4 | C4 | 2 | 3 | +1 adaptive | 13 / 15 | 9 / 9 |
| P5 | C5 | 1 | 3 | +2 adaptive | 15 / 15 | 9 / 9 |
