...
**Position basis:** Destination AI Exposure 86.73 (exact basis) × Curriculum Adaptiveness 10/15 (v4.2 draft, sub-scale A) · Workplace practice 9/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
The Master of Social Work is an AASW-accredited professional entry qualification (225 credit points) meeting Australian Social Work Education and Accreditation Standards (ASWEAS), preparing graduates for clinical, hospital, statutory child protection, and mental health practice (AIOE 86.73). The program achieves a flawless benchmark across workplace practice (**9 / 9** on Sub-scale W: W1: 3/3, W2: 3/3, W3: 3/3, G1 PASS, G2 PASS), anchored by 1,000 hours of mandatory supervised field placement across two stages, evaluated by registered social work field educators under direct statutory and AASW ethical accountability. On the adaptive capabilities sub-scale (**10 / 15**), the degree demonstrates solid Level 2 attainment across all dimensions (relational simulated practice in SCWK90053, clinical risk evaluative judgement in SCWK90054/SCWK90055, research proposal presentation in SCWK90069, and reflective professional identity portfolios in SCWK90072/SCWK90073). Strategic curriculum headroom focuses on formalizing human-AI clinical workflow charters for intake and documentation (C1), introducing assessed reliance and override logs for AI-assisted risk screening algorithms and diagnostic triage tools (C2), embedding systemic critique of algorithmic bias in welfare systems (Robodebt lessons) and Indigenous data sovereignty under CARE principles (C3), and establishing formal oral viva defense for practice research projects (C5).

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Clinical workflows increasingly pair social workers with AI-assisted transcription and case management tools | 1 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Human services professionals must systematically audit and override automated risk-prediction algorithms | 2 |
| C3 Digital & AI literacy, including governance | Adaptive | 2 / 3 | 1 | AASW and royal commission inquiries mandate rigorous critique of algorithmic bias, surveillance, and CARE principles | 3 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Evolving statutory child safety and mental health frameworks demand formalised continuing professional development planning | 4 |
| C5 Inquiry & evidence generation | Adaptive | 2 / 3 | 1 | Advanced clinical leadership requires practice-based inquiry defended under rigorous oral examination | 5 |
| **Adaptive capabilities** | **Adaptive** | **10 / 15** | **5** | — | — |
| W1 Professional communication & conduct | Workplace | 3 / 3 | 0 | Flawless benchmark — assessed by external registered practitioners across 1,000 placement hours | 6 |
| W2 Authentic task design | Workplace | 3 / 3 | 0 | Flawless benchmark — live clinical practice, statutory child safety assessments, and crisis counselling | 7 |
| W3 Work-situated learning | Workplace | 3 / 3 | 0 | Flawless benchmark — 1,000 hours mandatory supervised field placement across health and community hosts | 8 |
