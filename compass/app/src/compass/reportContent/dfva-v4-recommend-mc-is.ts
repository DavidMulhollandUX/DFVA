...
const content = {
  title: "Master of Information Systems (MC-IS) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Information Systems (MC-IS)
...
**Assessment date:** 2026-08-15 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-is.md
**Position basis:** Destination AI Exposure 95.64 (exact basis) × Curriculum Adaptiveness 9/15 (v4.2 draft, sub-scale A) · Workplace practice 5/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
Operating in a very high AI exposure domain (**95.64**, well above the portfolio median of 90.9), the program exhibits moderate Adaptiveness (**9 / 15**) and Workplace Practice (**5 / 9**). The curriculum possesses strong ICT governance frameworks, recurring group projects, and practitioner artefact design (W2: 2/3, W1: 2/3, C1: 2/3, C2: 2/3). However, digital & AI literacy sits at level 1 because all AI and machine learning subjects sit exclusively in elective lists (**C3: 1 / 3**), while work-situated learning is an optional internship rather than a universal requirement (**W3: 1 / 3**).

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 2 | Direct — Market §2 Signal 2 and §3 Theme 2 emphasize that enterprise AI adoption requires ISO 42001 / NIST AI RMF governance; AI currently appears only as electives in core IS. | 1 |
| W3 Work-situated learning | Workplace | 1 / 3 | 2 | Direct — Consultancies and tech employers prioritize graduates with proven client delivery experience; internships are currently optional across four capstone routes. | 2 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Direct — Digital transformations require coordinating human engineering teams, business stakeholders, and generative AI workflow tools. | 3 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Direct — Business analysts must audit AI-generated requirements and justify override decisions against corporate architecture and risk. | 4 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Direct — The 25-point capstone includes client-supplied and research options, but structured self-directed learning plans are not universal. | 5 |
| C5 Inquiry & evidence generation | Adaptive | 2 / 3 | 1 | Direct — The research project route generates primary evidence with staged supervision, but is one of four selective pathways. | 6 |
| W1 Professional communication & conduct | Workplace | 2 / 3 | 1 | Direct — Core includes consulting reports and pitches to hypothetical stakeholders, but lacks assessed delivery before live external executives. | 7 |
| W2 Authentic task design | Workplace | 2 / 3 | 1 | Direct — Core produces practitioner artefacts (governance plans, Gantt charts), but tasks lack externally supplied constraints of practice across all stages. | 8 |
...
|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Introduce an assessed module in core ICT Governance on enterprise AI capabilities, NIST AI Risk Management Framework, and algorithmic bias. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Introduce an assessed enterprise AI governance audit: students evaluate generative AI tool deployments against ISO 42001 and EU AI Act compliance standards. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W3 Work-situated learning | 1 → 2 | "A core unit places students in a real workplace or professional-community setting with practitioner supervision and assessment — placement, practicum, live client project, community-based project — OR, for a cohort documented as already practising in the profession, a core unit assesses activity conducted in the student's own professional practice with real recipients and a documented outcome measure — but it is short or stands alone." | Make the live client industry project or workplace internship mandatory for all non-research track candidates with practitioner supervision. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| W3 Work-situated learning | 2 → 3 | "Substantial required work-situated learning: an extended placement or practicum, or a sequence of them, in the core, supervised by a practitioner, assessed, with accountability to the host and structured reflection on professional practice — OR, for a cohort documented as already practising, a required sequence of assessed own-practice activity with structured reflection and documented accountability to workplace stakeholders (trainees, patients, clients or employer)." | Implement an extended required 200-hour host-organisation placement with host accountability and structured reflection on IS professional practice. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | In the ICT Governance Plan group assignment, require student teams to document a protocol allocating tasks between human analysts, engineering teams, and AI workflow tools. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | In the reflective research journal and case analyses, require students to document and defend reliance decisions when evaluating AI-generated system architectures or code. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C4 Life-long learning & transfer | 2 → 3 | "The program documents structured progression toward independent learning: a self-scoped capstone or research project, or assessed identification of one's own knowledge gaps together with the plan to close them." | In Research Methods / Project Planning, require an assessed professional learning contract identifying personal technical skill gaps and concrete closing strategies. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 2 → 3 | "A substantial project generating primary evidence is REQUIRED (not one route among several), with methodology defended under scrutiny (viva, defence, or staged supervised review)." | Make the empirical primary research project universal for all M.IS candidates with an examined oral viva defence before an industry research panel. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2 → 3 | "Professional communication is assessed repeatedly and progressively across the program AND at least one core assessment is delivered to, or judged by, a real external audience or practitioner (industry panel, client, patient or simulated patient, public exhibition), with professional conduct or accountability explicitly among the assessed criteria." | Formalize the proposal pitch presentation to be delivered before an external industry client panel with explicit professional conduct rubrics. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2 → 3 | "Such tasks are the program's assessment spine rather than a single instance (a capstone plus earlier scaffolding, or at least one per stage) AND at least one carries a genuine constraint of practice — an ambiguous or externally supplied problem, real resource/time limits, a consequential audience, or the profession's own standards of performance." | Establish an authentic task spine across both years using externally supplied live organisation briefs judged against BABOK and ISO 42001 performance criteria. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C3 | Enterprise AI pilots face severe governance and compliance risks; employers require ISO 42001 and NIST AI RMF auditing skills. | §2 Signal 2; §3 Theme 2 | HIGH (ISACA & ACS reports) |
| P2 | W3 | Consultancies and technology companies require graduates with proven experience delivering real client IT solutions. | §1 Job Family 3; §3 Theme 5 | HIGH (Big 4 graduate hiring criteria) |
| P3 | C1 | Enterprise systems analysts coordinate complex multidisciplinary workflows between human teams and AI agents. | §1 Job Family 1; §3 Theme 3 | HIGH (LinkedIn workforce data) |
| P4 | C2 | Traditional requirements drafting is automated; analysts must critically evaluate and override AI-generated functional specs. | §1 Job Family 1; §3 Theme 1 | HIGH (IIBA & MIS Quarterly) |
| P5 | W1 | Technology consultants and business analysts present IT strategies and business cases directly to C-suite clients. | §1 Job Family 3; §2 Signal 3 | HIGH (Deloitte / PwC hiring briefs) |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C3 | Add an assessed module on enterprise AI governance, NIST AI RMF, and ISO 42001 | C3 level 2 (capabilities and limits discussed/assessed) | Low | Year 1 Term 2; syllabus update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P2 | W1 | Formalize the proposal pitch presentation before an external industry panel | W1 level 3 (external audience & conduct criteria) | Low | Year 1 Term 2; pitch brief update | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| P3 | C2 | Require an assessed reliance and override log in the reflective journal | C2 level 3 (reliance decisions documented) | Low | Year 1 Term 1; journal brief update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P4 | W3 | Make the live client project or workplace internship mandatory for all coursework candidates | W3 level 2 (core live client project) | Medium | Year 2 Term 2; capstone restructure | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | 125 of 200 credit points are compulsory Information Systems subjects (87.5 in Year 1, 37.5 in Year 2) plus a required 25-point capstone, accredited by the Australian Computer Society with structured progression from foundations to Year 2 strategy and enterprise architecture. | Redesign must preserve the ACS-accredited 125-point compulsory core sequence. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | Compulsory ISYS90038 requires diagnosing a case organisation's governance gaps and defending multi-stage implementation plans; ISYS90050 assesses project risk evaluation; ISYS90026 requires weighing business problems and defending credible solutions under examination conditions. | Redesign must retain multi-stakeholder trade-off evaluations and unseen problem solving. | [16] |
...
| P2 | W1 | 2 | 3 | +1 workplace | 10 / 15 | 6 / 9 |
| P3 | C2 | 2 | 3 | +1 adaptive | 11 / 15 | 6 / 9 |
| P4 | W3 | 1 | 2 | +1 workplace | 11 / 15 | 7 / 9 |
