...
const content = {
  title: "Master of Surgical Education (MC-SURGED) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Surgical Education (MC-SURGED)
...
> a related program basis (Master of Education). What such a
...
| C4 Life-long learning & transfer [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) | 3 | Level 3 anchor: 'The program documents structured progression toward independent learning: a self-scoped capstone or research project'. Every student completes exactly such a project in the final year regardless of pathway — either the Minor Thesis, where the student develops and investigates their own research question and defines research questions based on their own practice, or the capstone, where the student designs a new curriculum for their own practice. Both are self-scoped by design and both are assessed by weighted, substantial written artefacts (thesis report; written presentation of curriculum), satisfying R2's requirement of assessment evidence rather than an outcome statement. Progression is documented structurally by the prerequisite chain requiring at least 75 points of coursework including Research Methods before the thesis may commence, and by the capstone's stated function of integrating learning from the earlier Graduate Certificate and Diploma content. This exceeds level 2 (a single core assessment applying methods to a novel problem) because the independence is program-structural, not task-local. |
...
- **G1 Disciplinary foundation:** PASS — The handbook documents a coherent specialist core with progressive methodological depth: four compulsory subjects plus a compulsory research-methods subject, all specific to surgical education, followed by a staged prerequisite chain requiring at least 75 points of coursework including Research Methods before the minor thesis may commence. Depth is progressive and explicitly cross-referenced — the curriculum-design assessment states it escalates the skills assessed in Subject 2 to the program level, and the capstone integrates learning from the earlier Graduate Certificate and Diploma stages. The content is not generic or interchangeable: it is anchored on the specific discipline of surgical education and its clinical settings.
- **G2 Decision-making under uncertainty:** PASS — Assessments require defended trade-off decisions rather than recall or scripted responses. The capstone requires justification for curriculum decisions across learning outcomes, lesson plans, assessment and evaluation strategies and governance; MEDS90007's reflection requires an evidence-based rationale for the selection of objectives and methods and how they will be changed; MEDS90011 requires selection and defence of research methods within a theoretical framework and schedule; and MEDS90009's assessment essay is framed around genuinely consequential uncertainty, with the handbook stating that assessment in surgical practice carries high stakes for the trainee and for patients. The program-level outcome likewise names the exercise of professional judgment.

## 4. MARKET EVIDENCE — Basis: reported

The market intelligence gathered for this program indicates strong demand across major hospital networks (Melbourne Health, Monash Health, NSW Health), dedicated surgical simulation centres (St Vincent's, Peter MacCallum), and Royal Australasian College of Surgeons (RACS) training boards, accompanied by early adoption of VR surgical simulation platforms (Touch Surgery Enterprise, Fundamental Surgery) and AI kinematic motion trackers where procedural supervision, workplace entrustment decisions (EPAs), and trainee psychological safety remain non-delegable clinical leadership responsibilities under RACS and Australian Medical Council (AMC) specialist training standards.
...
| --- | --- | --- | --- | --- |
| C1 Distributed cognition & relational capability | 1/3 | In a required core subject, introduce an assessed collaborative surgical curriculum design task or interprofessional simulation debriefing with individual accountability; require student teams to document human-plus-AI task allocation. | Workshop moderation time for collaborative curriculum tasks. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C3 Digital & AI literacy, including governance | 1/3 | Introduce an assessed module in core coursework on AI surgical simulation tutors, automated kinematic tracking (OSATS), and clinical validation limits; introduce an assessed surgical AI education governance audit. | Software licensing for simulation analytics and syllabus updates. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W1 Professional communication & conduct | 1/3 | Replace internal presentations with an assessed hospital board briefing or surgical curriculum business case judged by health service executives against industry standards. | External health executive marker recruitment and scheduling. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| C2 Hybrid metacognition & evaluative judgement | 2/3 | Require students in the capstone curriculum project to maintain an assessed reliance log justifying decisions to adopt or override automated simulation metrics and peer feedback across multiple iterations. | Reliance log rubric calibration and moderation time. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C5 Inquiry & evidence generation | 2/3 | Require all students to complete an empirical educational research project or defended scholarship-of-teaching inquiry with oral viva defence. | Research supervision resourcing and oral examination scheduling. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W3 Work-situated learning | 2/3 | Require a two-stage sequence of assessed own-practice teaching sessions with structured reflection and documented evaluation data collected from surgical trainee cohorts. | Assessment rubric expansion across multiple clinical teaching stages. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C4 Life-long learning & transfer | 3/3 | None — no intervention proposed and none needed. | None. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W2 Authentic task design | 3/3 | None — no intervention proposed and none needed. | None. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
