...
const content = {
  title: "Master of Psychology (Clinical Neuropsychology)/Doctor of Philosophy (080CN) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Psychology (Clinical Neuropsychology)/Doctor of Philosophy (080CN)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/080cn (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 41 pages captured
...
> **This program is outside the v3.1 registry, but not outside Panel A.** Master of Psychology (Clinical Neuropsychology)/Doctor of Philosophy
...
**Workplace Practice: 9 / 9.** Scored on sub-scale W [[19]](https://www.legislation.gov.au/F2021L00488) in the same pass, from the same extract. The position axis remains adaptiveness alone; the workplace sub-score is reported beside it, not folded into the axis, and the two are never added together.
...
| C4 Life-long learning & transfer [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) | 3 | Level 3's anchor — 'The program documents structured progression toward independent learning: a self-scoped capstone or research project, or assessed identification of one's own knowledge gaps together with the plan to close them' — is documented as a staged coursework sequence, not merely asserted: PSYC90003 assesses the student in locating a gap in the literature and converting it into their own research question, and PSYC90029 assesses the resulting self-scoped research proposal twice (20-minute oral, 40%; 3000-word report, 60%), feeding PSYC80004 whose stated purpose is the capacity to carry out independent research. Level 2's floor is independently met by case-based assessments applied to externally supplied, previously unseen case material. Placement evidence is excluded from this item by the v4.1 migration rule and scores in W3 instead; the thesis examination and viva are held in C5 so no evidence is counted twice. |
...
- **G1 Disciplinary foundation:** PASS — The G1 PASS condition — 'a coherent specialist core with progressive technical or methodological depth: an all-compulsory specialist core, an accredited sequence, or a staged prerequisite chain' — is satisfied on all three routes at once. The handbook states outright that all subjects are compulsory; the sequence is the one APAC accredits for registration; and the 13 classroom-based subjects are staged across the first three years with placements escalating from observational in year 1 to supervised independent in years 2 and 3. Nothing in the extract is generic or interchangeable — every core subject is neuropsychology-specific or its methodological support.
- **G2 Decision-making under uncertainty:** PASS — The G2 PASS condition — 'Assessments require defended trade-off decisions, or simulations/capstones/live projects with real uncertainty and accountability' — is met rather than the FAIL condition of 'recall or scripted responses only'. Assessed work requires students to justify a chosen therapeutic approach among alternatives, to resolve an ethical dilemma in a marked report, and to confront and manage unfamiliar problems in live clinical settings across varied services. Exams and quizzes exist in the core but are not the whole assessment picture.

## 4. MARKET EVIDENCE — Basis: reported

Condensed from [the market intelligence report](dfva-market-080cn.md).

**Destination job families.**

| Job family | Entry titles | AI substitution pressure | Skills rising in that family |
| --- | --- | --- | --- |
| Clinical Neuropsychology (hospital / rehab) | Provisional Psychologist (Neuropsychology), Clinical Neuropsychologist | Low | Digital-biomarker interpretation, tele-neuropsychology, multidisciplinary case leadership |
| Private practice / community neuropsychology | Neuropsychologist (private practice) | Low | Forensic report writing, AI-tool-supervised documentation, private-billing digital health literacy |
| Forensic / medico-legal neuropsychology | Forensic Neuropsychologist, Expert Witness | Very low — inherently AI-resistant | Cross-examination-defensible reasoning, legal-standard documentation |
| Academic / clinical research | Postdoctoral Research Fellow, Lecturer (Psychology/Neuroscience) | Low | AI-assisted literature synthesis, large-dataset and neuroimaging analysis, grant writing |
| Paediatric neuropsychology | Paediatric Neuropsychologist | Low | NDIS system navigation, family-centred communication, digital assessment tools |
| Aged care / dementia services | Clinical Neuropsychologist (Aged Care) | Low | Digital cognitive-monitoring interpretation, early-detection biomarker literacy |

> **The exposure figure and this table disagree, and the table is the better guide.** §1 reports 95.57, borrowed from the Master of Applied Psychology alumni record — a *partial* basis covering a broader and less regulated set of psychology destinations than this program feeds. Every family the market report identifies here carries **low** substitution pressure, and the forensic and medico-legal family is described as *very low* and inherently AI-resistant. Two structural tailwinds run the other way from the index as well: an ageing population driving dementia and capacity caseload, and NDIS growth driving paediatric assessment demand. Read 95.57 as an artefact of the borrowed basis, per the estimated-basis methods note.

**Signals and skill shifts.**

| Signal or shift | Direction | Bearing on the scored items |
| --- | --- | --- |
| Ageing population and TBI/stroke incidence driving hospital and rehabilitation caseload | Structural tailwind | W3 |
| Long national wait-lists for neuropsychological assessment | Sustained demand | W2, W3 |
| Personal injury and aged-care litigation growing the medico-legal pathway | Rising | W1 |
| NDIS growth and developmental-diagnosis rates driving paediatric demand | Rising | W1, C4 |
| Manual test scoring and norm lookup; unstructured clinical note-taking; manual literature review | Declining fast | C3, C2 |
| AI-assisted report drafting *supervision* | Rising fast | C3, C2 |
| Tele-neuropsychology and remote assessment delivery; hybrid service design | Rising fast | C4, C3 |
| NDIS and funding-system navigation literacy | Rising fast | C4, W1 |
| Digital cognitive-biomarker interpretation | Rising | C3, C5 |
| Medico-legal and forensic report defensibility | Rising | C2, W1 |
| Multidisciplinary and multimodal case integration, against standalone single-modality assessment | Rising | C1 |
| Large-dataset and neuroimaging analysis competence | Rising | C5, C3 |

**Confidence, restated from the market report.** As with the clinical psychology sibling program, the job-ad signals rest on structural labour-market knowledge — registration gating, demographic caseload drivers, NDIS and litigation growth — rather than a live job-ad scrape. The structural claims are the durable part; nothing here supports a quantitative statement about posting volumes or salaries.
...
and the score deltas are in the [improvement plan](dfva-v4-recommend-080cn.md); rows
below are ordered by headroom, which is not the plan's P-lever order.

| Item | Score | Implication | Cost | Sources |
| --- | --- | --- | --- | --- |
| C2 Hybrid metacognition & evaluative judgement | 1/3 | The single gap in an otherwise near-ceiling profile. Criterion-referenced appraisal of the quality of work is not assessed in any core unit — demoted from 2 on adversarial verification — while the market's fastest-rising skill is *supervision* of AI-assisted report drafting, and medico-legal report defensibility is rising in a family whose entire value is that a reasoning chain survives cross-examination | Low to medium. Supervised report writing is already the spine of this program; adding published criteria and an assessed appraisal of a draft — a peer's, or a tool's — against the clinical record uses machinery that already exists | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1/3 | Digital tool content reaches tool-operation level and no further, which is the highest level the evidence supports. Meanwhile manual test scoring and norm lookup are declining Fast, AI-assisted report drafting supervision is rising Fast, and digital cognitive-biomarker interpretation is named as a rising skill in three of the six destination families | Low for an assessed component on what these tools get wrong — scoring errors, norm mismatch, fabricated summary content — together with the privacy and professional-responsibility obligations of using them in a clinical record. High for the governance step | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C1 Distributed cognition & relational capability | 2/3 | Assessed collaborative practice is documented in core, which meets the anchor, and multidisciplinary and multimodal case integration is rising against standalone single-modality assessment. The step to 3 requires recurrence plus a task assessing the division of work across people *and* tools — which is what supervising an AI-drafted report inside a multidisciplinary team actually is | Medium — placements already embed students in multidisciplinary teams; the addition is assessing the coordination rather than the clinical work | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C4 Life-long learning & transfer | 3/3 | At the ceiling on documented progression toward independent learning through a required self-scoped research project. The tele-neuropsychology and NDIS-navigation shifts are exactly the unfamiliar-context demands this capability is meant to cover | None | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 3/3 | At the ceiling: a required substantial primary-evidence project with methodology defended under scrutiny — the capability underwriting both the academic pathway and the large-dataset and neuroimaging analysis named as rising | None | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 3/3 | At the ceiling, on both limbs: professional communication assessed repeatedly and progressively, in genres addressed to real clinical and medico-legal audiences. This is the capability the forensic family is built on | None | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 3/3 | At the ceiling. Authentic practitioner tasks are the assessment spine across stages, not a single capstone instance — in a destination set where the artefact *is* the assessment report | None | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| W3 Work-situated learning | 3/3 | At the ceiling on the placement route: extended required supervised placement in the core, with host accountability and structured reflection. Combined with W1 and W2 this program reaches 9/9 on workplace practice — the only program in the twelve-program extension cohort to do so | None. A high W3 describes curriculum design rather than student welfare, and the equity constraint on how extended placement is resourced still applies [[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
...
**Panel C provenance.** Scored from the 2026 handbook capture (41 pages) and verified on 2026-08-23: adversarial refutation of every level-3 score and every gate PASS (run), verbatim evidence check (run), and the construct-boundary pass.
...
- The award is a combined coursework masters and research doctorate (Australian Qualifications Framework (AQF) level 10, 'Doctorate by Research', five years), so the coursework-program framing of several anchors sits awkwardly on it; the two sub-scales were nonetheless scored from documented curriculum evidence only, with no adjustment for award type.
