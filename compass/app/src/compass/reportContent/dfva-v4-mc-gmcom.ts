...
const content = {
  title: "Master of Global Media Communication (MC-GMCOM) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Global Media Communication (MC-GMCOM)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/mc-gmcom (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 39 pages captured
**Course Director:** Professor Ingrid Volkmer
...
> **This program is outside the v3.1 registry, but not outside Panel A.** Master of Global Media Communication
...
**Destination AI Exposure: 94.80.** Destination titles are crosswalked to the published Felten AIOE index and rescaled 0–100 by the Panel A procedure used for every other program; 5 of 15 titles carry medium mapping confidence. Basis: measured on the program's own alumni destination record (n = 67, 15 titles). The portfolio median is 90.9, so this program sits **above** it.
...
| --- | --- | --- |
| C1 Distributed cognition & relational capability [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) | 2 | Level 2 anchor is satisfied: at least one core unit assesses collaborative practice. In core subject MECM90031 Audiovisual Communication, students collaborate in production crews on video project development and production journals (75%); in JOUR90027 Global Crisis Reporting, students complete practical crisis simulation reporting tasks; and across media writing and data policy units, structured in-class collaborative debates and group presentations recur (MECM90002, MECM90003, MECM90007). Level 3 is not met: no core assessment requires coordinating work across people AND tools/AI systems with documented role-and-tool allocation or an assessed division of work between communicators and generative AI systems. |
| C2 Hybrid metacognition & evaluative judgement [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) | 2 | Level 2 anchor is satisfied: core assessment includes criterion-referenced appraisal of quality. In MECM90002 Global Data Policy & Governance, students critically appraise data privacy frameworks, algorithmic governance standards, and platform regulation models; in MECM90017 Media Writing: Rhetoric and Practice, students evaluate rhetorical strategies, framing biases, and discourse construction across three assessed professional media writing portfolios (30%, 30%, 40%); and in MECM90031, students complete reflective production journals appraising aesthetic, narrative, and technical editing choices. Level 3 is not met: no core assessment requires students to document and justify reliance decisions (deciding when to rely on or override generative AI text generators, automated sentiment analysis, or machine translation tools), defend judgements of AI-generated journalistic copy, or evidence strategy adjustment over time. |
| C3 Digital & AI literacy, including governance [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) | 3 | Level 3 anchor is satisfied: core assessment requires critique or governance of AI and algorithmic systems in the discipline's own context — bias, accountability, transparency, regulation, and data governance — well beyond tool operation. In compulsory core subject MECM90002 Global Data Policy & Governance, students complete an assessed essay (50%), oral presentation (25%), and formal policy brief (25%) specifically examining platform data regulation, algorithmic accountability, digital surveillance, and data justice; and in MECM90015 Perspectives on Digital Platforms and MECM90041 Political Economy of Digital Life, students critique algorithmic content distribution, automated moderation, and artificial intelligence policy. |
| C4 Life-long learning & transfer [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) | 2 | Level 2 anchor is satisfied: at least one core assessment requires application to novel or unfamiliar problems through unscripted global media crisis simulations (JOUR90027), unscripted digital platform policy controversies (MECM90002), and novel creative audiovisual communication briefs (MECM90031). Level 3 is not met: while a self-scoped 12,000-word research thesis (MECM90029/MECM90030) is offered as a capstone pathway, it is an elective stream alongside standard coursework (MECM90043) and internship (MULT90019) routes, and therefore does not represent the guaranteed path for all graduating students (R1). |
| C5 Inquiry & evidence generation [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) | 2 | Level 2 anchor is satisfied: students design and conduct an inquiry with methodology selection and data collection, assessed. In capstone subject MECM90043 Global Communication: Theory & Research, students complete a self-designed 5000-word written project-oriented case study and oral presentation with qualitative or quantitative methodology selection and empirical media data collection; and in core MECM90007 Media Convergence and Digital Culture, students complete an assessed 3000-word research essay with primary media content analysis. Level 3 is not met: while the 12,000-word thesis option (MECM90029/30) requires an extended empirical study, it is an elective route (R1), and the standard capstone (MECM90043) is not defended under formal oral viva scrutiny. |
| **Adaptive capabilities** | **11 / 15** | |
| W1 Professional communication & conduct [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) | 2 | Level 2 anchor is satisfied: at least one core assessment requires a recognised professional genre judged against criteria drawn from professional practice. Across the core, students produce formal 1500-word regulatory policy briefs (MECM90002), professional media releases and news features (MECM90017), broadcast-quality audiovisual media packages (MECM90031), and investigative crisis reporting dispatches (JOUR90027). Level 3 is not met: while professional media and policy genres recur, no core assessment is documented as delivered to, or judged by, a real external media organization, government policy body (e.g. ACMA, eSafety Commissioner), or commercial communications agency with professional conduct explicitly among the assessed criteria. |
| W2 Authentic task design [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) | 2 | Level 2 anchor is satisfied: core assessment reproduces professional tasks end-to-end for communication directors, media policy advisors, and digital content producers. Students produce full-cycle policy analysis (MECM90002), multimedia journalism portfolios (MECM90017), and broadcast video packages (MECM90031). Resolved downward from level 3 on adversarial verification: tasks are submitted to academic instructors without externally supplied live media briefs, breaking newsroom time pressures, or consequential external stakeholders documented in the assessment tables (R4). |
| W3 Work-situated learning [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) | 1 | Level 1 anchor is met: work-situated learning is not compulsory within the core curriculum. While MULT90019 Internship II (Semester Long) is offered as a 25-point capstone option, the Master of Global Media Communication does not mandate an assessed, credit-bearing, practitioner-supervised workplace placement within its compulsory sequence (students can graduate via the coursework capstone MECM90043 or thesis route). |
| **Workplace practice** | **5 / 9** | |

**C1 Distributed cognition & relational capability — 2/3**

> Final project: 4 minute video and production journal (60% video, 15% journal) ... Audiovisual Communication
>
> A class presentation and site analysis essay ... Mobility, Culture and Communication
>
> Class presentation ... Media Convergence and Digital Culture
>
> Oral presentation ... Global Data Policy & Governance
...
**C3 Digital & AI literacy, including governance — 3/3**

> Global Data Policy & Governance (MECM90002) ... An essay (2500 words, 50%) ... Oral presentation (25%) ... Policy brief (1500 words, 25%)
>
> Perspectives on Digital Platforms (MECM90015) ... Class presentation (30%) ... Research project (40%)
>
> Political Economy of Digital Life (MECM90041) ... An essay (40%) ... An essay (50%)

**C4 Life-long learning & transfer — 2/3**

> Global Crisis Reporting (JOUR90027) ... Crisis simulation / practical task
>
> Media Writing: Rhetoric and Practice (MECM90017) ... Three professional media portfolios
>
> Students must choose one of the following capstone options: Capstone option 1 (Thesis) ... Capstone option 2 (Internship) ... Capstone option 3 (MECM90043)
...
>
> Media Convergence and Digital Culture (MECM90007) ... A research essay (3000 words, 55%)
>
> Media & Communications Research Methods (MECM90042) ... Research design assignments

**W1 Professional communication & conduct — 2/3**

> Global Data Policy & Governance (MECM90002) ... Policy brief (1500 words, 25%)
>
> Media Writing: Rhetoric and Practice (MECM90017) ... Three professional media writing tasks
>
> Audiovisual Communication (MECM90031) ... Final project: video and production journal
>
> Global Crisis Reporting (JOUR90027) ... Crisis reporting exercise

**W2 Authentic task design — 2/3**

> Global Data Policy & Governance (MECM90002) ... Policy brief
>
> Media Writing: Rhetoric and Practice (MECM90017) ... Professional media writing portfolio
>
> Audiovisual Communication (MECM90031) ... Video project and journal

**W3 Work-situated learning — 1/3**

> The Master of Global Media Communication (MGMC) equips graduates to work in media and communication sectors...
>
> Capstone option 2: MULT90019 Internship II (Semester Long) (25 points)

## 3. GATES — Basis: scored

- **G1 Disciplinary foundation:** PASS — PASS condition is met: the program documents a comprehensive 200-point graduate curriculum including compulsory foundation units in media theory and research methodology (MECM90039, MECM90038), followed by a 75-point core sequence in data policy, digital culture, media writing, and audiovisual production. Coherent, rigorous disciplinary media and communications sequence.
...
The market context is condensed from [\`reports/dfva-market-mc-gmcom.md\`](dfva-market-mc-gmcom.md), which synthesises published industry standards, ethical frameworks, and research from the Public Relations Institute of Australia ([PRIA](https://www.pria.com.au/)), Media, Entertainment & Arts Alliance ([MEAA](https://www.meaa.org/)), Australian Communications and Media Authority ([ACMA](https://www.acma.gov.au/)), International Communication Association ([ICA](https://www.icahdq.org/)), and peer-reviewed studies in *Media, Culture & Society* and *New Media & Society*.
...
| --- | --- | --- | --- | --- | --- |
| Strategic Communication & Public Affairs Advisory | Communications Advisor, Media Relations Officer | Senior Media Manager, Head of Public Affairs | 95.00 | VERY HIGH | Crisis communication under mis/disinformation, cross-platform stakeholder negotiation, executive message framing |
| Digital Platform Policy & Trust Governance | Media Policy Analyst, Content Policy Specialist | Senior Policy Lead, Director of Trust & Safety | 95.80 | HIGH | Algorithmic transparency compliance, EU AI Act & ACMA digital platform codes, online harms regulation |
| Global Journalism & Multimedia Production | Multimedia Journalist, Digital Content Producer | Senior Investigative Reporter, Editorial Lead | 94.20 | VERY HIGH | Verification of synthetic/deepfake media, data-driven investigative journalism, multi-format storytelling |
| Corporate Media Strategy & Brand Advocacy | Digital Campaign Strategist, Public Relations Specialist | Communications Director, Vice President (Corporate Communications) | 94.20 | HIGH | Algorithmic SEO & social distribution audit, corporate ESG narrative framing, brand reputation defense |
...
| --- | --- | --- |
| Pervasive automation of routine press release drafting, transcript summaries, and basic video editing | Rising | C2, W2 |
| Stringent platform governance, synthetic media detection, and regulatory compliance (ACMA, eSafety) | Rising | C3, G2 |
| Multi-stakeholder crisis communication under coordinated mis/disinformation and social platform volatility | Rising | C1, W1, G2 |
| Independent empirical media research and audience analytics under changing platform algorithmic curation | Rising | C4, C5 |
| Generic press copywriting and unverified web content aggregation | Declining | C3, C2 |

*Market evidence confidence is rated HIGH across statutory regulators, peak professional media bodies, and peer-reviewed communications research.*
...
and the score deltas are in the [improvement plan](dfva-v4-recommend-mc-gmcom.md); rows
below are ordered by headroom, which is not the plan's P-lever order.

| Item | Score | Implication | Cost | Sources |
| --- | --- | --- | --- | --- |
| W3 Work-situated learning | 1/3 | Formalize an assessed credit-bearing media communications practicum or client-facing advocacy project in the core, or make the 200-hour supervised industry internship (MULT90019) a mandatory requirement | Placement coordination resources; media partner agreement administration | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C1 Distributed cognition & relational capability | 2/3 | Require collaborative video production in MECM90031 to include an assessed Human-AI Collaboration Charter detailing task allocation between human producers and automated editing tools | Minor rubric revision in existing assignments; zero additional credit points | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2/3 | Implement an assessed 'AI Drafting and Narrative Override Log' in MECM90017 where students document and justify overrides of AI-generated story drafts | Low teaching overhead; rubric integration | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C4 Life-long learning & transfer | 2/3 | Require an assessed personal professional development plan and media capability gap analysis in the capstone unit MECM90043 | Modest assignment restructuring in capstone units | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 2/3 | Introduce a required oral viva defense for the 5000-word empirical research capstone (MECM90043) before a faculty and industry panel | Academic staff time for oral defense examination | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2/3 | Mandate that crisis communication simulations in JOUR90027 or policy briefs in MECM90002 are delivered to and judged by external media editors and public affairs directors | Media executive panel coordination; presentation logistics | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2/3 | Structure core media writing portfolios around live, externally supplied breaking news briefs and real-time social campaign constraints | Sourcing live industry media briefs annually | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |

## 6. EVIDENCE CONFIDENCE & LIMITATIONS — Basis: reported

**Panel A metadata.** Basis tier **exact** (measured), n = 67, 15 destination titles, 5 at medium mapping confidence. Index variant AIOE-2021; crosswalk \`data/aioe/v31_extension_crosswalk.csv\`.

**Panel C provenance.** Scored from the 2026 handbook capture (39 pages) and verified on 2026-08-24: adversarial refutation of every level-3 score and every gate PASS (run), verbatim evidence check (run), and the construct-boundary pass.

**Ambiguities and construct-boundary notes** (6):

- C1 straddled 1 and 2: MECM90031 and JOUR90027 assess collaborative video production and crisis simulation exercises, satisfying level 2 collaborative practice. Level 3 is unmet because collaborative human-AI workflow allocation is unevidenced.
...
- C3 scored at 3: MECM90002 Global Data Policy & Governance directly assesses critical governance, algorithmic accountability, regulation, and data ethics in media platforms, satisfying level 3's discipline-specific AI governance anchor.
