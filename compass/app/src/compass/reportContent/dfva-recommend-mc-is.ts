...
* **Lagging indicators (12–24 months):** Adaptiveness re-scored at or above the portfolio threshold (from 8/15) with both gates held · Graduate placement in AI governance or automation roles 20%+ by 2028 · Graduate placement in regulated sector 30%+ by 2028 · Employer satisfaction 75%+ "well prepared" · Exposure re-measured from refreshed alumni destination data.

---

## 10. RISKS, TRADE-OFFS, AND DEPENDENCIES

* **Risk: the position is misread as a verdict.** High exposure with below-median defences is a to-do list, not a death notice — the same market data shows the adjacent governance and analytics tiers growing. *Mitigation:* pair every use of the exposure figure with the growth framing and the named, fixable gaps.
