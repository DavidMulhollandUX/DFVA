...
const content = {
  title: "Master of Commerce (Decision, Risk and Financial Sciences) (MC-COMDRFS) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Commerce (Decision, Risk and Financial Sciences) (MC-COMDRFS)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/mc-comdrfs (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 27 pages captured
**Course Director:** Professor Carsten Murawski
...
> **This program is outside the v3.1 registry, but not outside Panel A.** Master of Commerce (Decision, Risk and Financial Sciences)
...
> a cognate program basis (Master of Management (Finance)). What such a
...
**What the §1 exposure value is.** 97.83. **Borrowed** from Master of Management (Finance) (n = 72, 14 titles) — an estimate for a related population, not a measurement of this cohort. 5 of 14 titles carry only medium mapping confidence. It sits **above** the portfolio median of 90.9.

| Signal or shift | Direction | Bearing on the scored items |
| --- | --- | --- |
| Audit sampling | **↑ Rising** | Bears on C2 and C3 — verifying an automated sampling output before relying on it is the reliance-and-override judgement C2 scores, and documenting the audit trail behind an AI-assisted sample is the governance content C3 currently lacks. |
| Financial statement analysis | **↑ Rising** | Bears on C4 and C5 — the analytical, evidence-generation skills already assessed at level 3 through the required Research Report are the ones sustained demand for this skill rewards. |
| ASRS sustainability assurance | **↑↑ Rising sharply** | Bears on W2 — the acute shortage in this skill is a genuine constraint of practice, the specific clause the item's next level requires and does not yet have. |
| Tax compliance | **↑ Rising** | Bears on W1 — the Tax Practitioners Board's Code of Professional Conduct sets a competence and ethical-conduct standard for registered agents, the professional-conduct construct this item scores. |
| Internal controls | **↑ Rising** | Bears on C2 and C3 — APESB's requirement to verify automated anomaly-detection algorithms and keep documented audit trail logs is the reliance-judgement and governance content these items' next levels require. |
| bookkeeping | **↓ Falling** | Bears on C1 — this program's destinations sit mostly outside bookkeeping, and the finding that automation concentrates in clerical work while augmentation rewards coordination between people and AI systems is the rationale behind the item's next-level anchor. |
...
and the score deltas are in the [improvement plan](dfva-v4-recommend-mc-comdrfs.md); rows
below are ordered by headroom, which is not the plan's P-lever order.

| Item | Score | Implication | Cost | Sources |
| --- | --- | --- | --- | --- |
| C3 Digital & AI literacy, including governance | 1/3 | Internal controls and audit sampling are rising and recur at volume in the advertisement sample for this program's largest destination family (§4), and both are governed by APESB's requirement to verify automated anomaly-detection algorithms and keep documented audit trail logs — governance content this item's current level, which covers technique only, does not assess. | Adding limitations-and-ethics content to the existing machine-learning assessment, then a governance-and-critique task that builds on it (low, then medium effort, plan P1 and P4). | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W1 Professional communication & conduct | 1/3 | Tax compliance is rising (§4) under the Tax Practitioners Board's binding competence and ethical-conduct standard, and personal financial advisers face one of Australia's most regulated professional-conduct regimes; this item's current level — presentation to the teaching team only — does not assess the professional-genre, external-audience communication either destination expects on entry. | Adding a client-brief or advice-memo task judged against practice criteria, then a practitioner-panel-judged instance (medium, then high effort, plan P3 and P7). | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| C1 Distributed cognition & relational capability | 2/3 | This program's destinations sit mostly in accounting and financial-management families with limited exposure to bookkeeping's clerical automation, but the falling direction recorded for bookkeeping (§4) reflects a wider split between augmented and automation-exposed work; the coordination-with-AI-systems clause this item's next level requires is what keeps a graduate's work on the augmented side of that split rather than crediting teamwork alone. | Redesigning the existing hurdle-graded group project's rubric to require a documented allocation of tasks between team members and an AI or analytics tool (medium effort, plan P5). | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2/3 | Internal controls and audit sampling both recur at volume in the advertisement sample and are rising (§4), and APESB's requirement that auditors verify — not accept — automated anomaly-detection output is precisely the reliance-and-override judgement this item's next level scores; without it, this program does not yet assess the critique skill its largest destination family expects. | Adding a reflective justification component to the existing peer-review assessment (low effort, plan P2). | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| W2 Authentic task design | 2/3 | ASRS sustainability assurance is rising sharply (§4) because of an acute shortage of graduates able to work under the profession's own standards of practice; this item's current level already credits authentic, criterion-matched tasks, but none yet carries a genuine constraint of practice — the specific gap that shortage names. | Adding an externally supplied or ambiguous ASRS-style scenario to the existing capstone-style assessment (medium effort, plan P6). | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| W3 Work-situated learning | 2/3 | Financial Managers and Personal Financial Advisors postings recur at volume (§2 of the market report) for roles this program's profession record ties to supervised, accountable practice; the two required lab rotations already place students in a real setting but neither names a supervising practitioner nor documents accountability to the host, which is why the item is capped below level 3. | Naming a supervising practitioner for the existing lab rotations and requiring documented host accountability and structured reflection (high effort, plan P8). | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C4 Life-long learning & transfer | 3/3 | Financial statement analysis is rising (§4), and the required, staged, supervised Research Report already gives every graduate a self-scoped project that transfers beyond any one technique — this item is not where the program's exposure risk sits. | None — no intervention proposed and none needed. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 3/3 | ASRS sustainability assurance is rising sharply (§4) because of an acute shortage of graduates able to generate assurance-grade primary evidence, and the required two-part DRFS Research Report already gives every graduate a staged, examined, primary-evidence-generating project — the general construct that rising demand rewards is assessed, even though the specific ASRS content is not (see W2). | None — no intervention proposed and none needed. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |

## 6. EVIDENCE CONFIDENCE & LIMITATIONS — Basis: reported

**Panel A metadata.** Basis tier **cognate** (cognate program), n = 72, 14 destination titles, 5 at medium mapping confidence. Index variant AIOE-2021; destination titles mapped to the published Felten index. Basis note: Decision, risk and financial sciences — finance discipline.

**Panel C provenance.** Scored from the 2026 handbook capture (27 pages) and verified on 2026-09-01: adversarial refutation of every level-3 score and every gate PASS (run), verbatim evidence check (run), and the construct-boundary pass.
