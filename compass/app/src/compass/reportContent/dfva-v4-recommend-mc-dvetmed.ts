...
const content = {
  title: "Doctor of Veterinary Medicine (MC-DVETMED) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Doctor of Veterinary Medicine (MC-DVETMED)
...
**Assessment date:** 2026-08-14 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-dvetmed.md
**Position basis:** Destination AI Exposure 44.92 (exact basis) × Curriculum Adaptiveness 7/15 (v4.2 draft, sub-scale A) · Workplace practice 6/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
Operating in a very low AI exposure domain (**44.92**, far below the portfolio median of 90.9), the program achieves a maximum score in **W3: 3 / 3** (33 weeks of compulsory extramural placements across companion, equine, and livestock industries with hurdle reports). However, Adaptiveness sits at **7 / 15** and Workplace Practice at **6 / 9** because assessed reflection lacks documented criteria (**C2: 1 / 3**), AI diagnostic imaging tools are absent from the core (**C3: 1 / 3**), research capstones are not evidenced with assessed methodology design in the available extracts (**C5: 1 / 3**), and core communication assessment is submitted to the teaching staff rather than judged by external practitioners (**W1: 1 / 3**).

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 1 / 3 | 2 | Direct — Market §2 Signal 2 and §3 Theme 1 emphasize that vets hold exclusive statutory liability for diagnostic decisions; core lacks criterion-referenced peer review and AI audit logs. | 1 |
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 2 | Direct — Veterinary radiology AI (SignalPET) and ambient scribes are rapidly adopted; core curriculum lacks assessed AI capabilities/limits modules. | 2 |
| C5 Inquiry & evidence generation | Adaptive | 1 / 3 | 2 | Direct — Veterinary biosecurity and evidence-based practice require empirical inquiry; research units lack documented methodology defense. | 3 |
| W1 Professional communication & conduct | Workplace | 1 / 3 | 2 | Direct — Client communication in high-stress clinical handovers and euthanasia consults requires assessed delivery before real practitioners. | 4 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Direct — Modern veterinary practices coordinate clinical teams (veterinarians, vet nurses, handlers) and digital diagnostic aids. | 5 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Direct — Core assesses clinical case variation across systems, but lacks an assessed self-scoped capstone or personal learning plan. | 6 |
| W2 Authentic task design | Workplace | 2 / 3 | 1 | Direct — Core includes animal handling hurdles, but written exams dominate the assessment spine. | 7 |
| W3 Work-situated learning | Workplace | 3 / 3 | 0 | None — no intervention proposed and none needed. | — |
...
|---|---|---|---|---|
| C2 Hybrid metacognition & evaluative judgement | 1 → 2 | "Core assessment includes criterion-referenced appraisal of quality: peer review, structured critique, portfolio with standards, marking against exemplars." | In Veterinary Professional Practice, introduce an assessed peer review of a clinical case management plan against professional AVBC standards. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | In DVM3 clinical pathology, require students to document and justify reliance decisions when evaluating AI-assisted radiograph pre-reads or automated bloodwork classifiers. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Introduce an assessed module in DVM3 on veterinary AI diagnostic imaging overlays (SignalPET), ambient clinical scribing, and statutory veterinary duty of care. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Introduce an assessed veterinary AI governance audit: students critique automated diagnostic software against prescription accountability and biosecurity reporting laws. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 1 → 2 | "Students design and conduct an inquiry with methodology selection and data collection, assessed." | Formalize the Veterinary Research Project A/B assessment briefs to explicitly assess empirical inquiry design, methodology selection, and primary data collection. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C5 Inquiry & evidence generation | 2 → 3 | "A substantial project generating primary evidence is REQUIRED (not one route among several), with methodology defended under scrutiny (viva, defence, or staged supervised review)." | Require an examined oral viva defence of the veterinary research project methodology before an external panel of veterinary practitioners and scientists. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 1 → 2 | "At least one core assessment requires a recognised professional genre or an audience beyond the teaching team — client brief, consultancy or policy advice, clinical handover, pitch, public-facing artefact — judged against criteria drawn from professional practice." | In Veterinary Professional Practice, replace generic video submissions with an assessed clinical discharge summary and client consultation brief judged against AVBC criteria. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W1 Professional communication & conduct | 2 → 3 | "Professional communication is assessed repeatedly and progressively across the program AND at least one core assessment is delivered to, or judged by, a real external audience or practitioner (industry panel, client, patient or simulated patient, public exhibition), with professional conduct or accountability explicitly among the assessed criteria." | Formalize clinical consultation OSCEs delivered before simulated clients and judged by registered veterinary practitioners with explicit professional conduct rubrics. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | In production animal syndicate work, require student teams to document a protocol allocating tasks between veterinary clinicians, field technicians, and automated herd monitoring tools. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C4 Life-long learning & transfer | 2 → 3 | "The program documents structured progression toward independent learning: a self-scoped capstone or research project, or assessed identification of one's own knowledge gaps together with the plan to close them." | In Veterinary Research Project A/B, enable students to independently frame and self-scope their research inquiry within clinical or epidemiological streams. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W2 Authentic task design | 2 → 3 | "Such tasks are the program's assessment spine rather than a single instance (a capstone plus earlier scaffolding, or at least one per stage) AND at least one carries a genuine constraint of practice — an ambiguous or externally supplied problem, real resource/time limits, a consequential audience, or the profession's own standards of performance." | Establish an authentic task spine across all four years with live-animal clinical mini-CEXs and unknown case evaluations replacing traditional written examinations. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C2 | Veterinarians hold non-delegable statutory liability under state veterinary acts for diagnosis; AI outputs must be critically audited. | §2 Signal 2; §3 Theme 1 | HIGH (AVA & Australian Veterinary Journal) |
| P2 | C3 | Veterinary practices deploy SignalPET and ambient scribing; graduates must arrive fluent in AI capabilities and failure modes. | §2 Signal 2; §3 Theme 1 | HIGH (corporate veterinary hiring criteria) |
| P3 | C5 | Biosecurity surveillance and herd health management demand rigorous empirical research and epidemiological inquiry. | §1 Job Family 3; §3 Theme 3 | HIGH (VetBoard Victoria guidelines) |
| P4 | W1 | Client communication during high-stress consultations and euthanasia decisions is a decisive practice-readiness filter. | §1 Job Family 1; §3 Theme 2 | HIGH (AVBC Day One competencies) |
| P5 | C1 | Modern veterinary clinics coordinate multidisciplinary teams of veterinarians, nurses, and automated monitors. | §1 Job Family 1; §3 Theme 2 | HIGH (AVA practice standards) |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C2 | Add an assessed peer review of clinical management plans against AVBC standards | C2 level 2 (criterion-referenced appraisal) | Low | Year 2 Term 1; syllabus update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P2 | C3 | Add an assessed module on veterinary diagnostic AI imaging, ambient scribing, and legal liability | C3 level 2 (capabilities and limits discussed/assessed) | Low | Year 3 Term 1; syllabus update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P3 | W1 | Introduce assessed clinical discharge summaries and consultations judged by external practitioners | W1 level 2 (recognised professional genre) | Low | Year 2 Term 2; assessment brief update | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| P4 | C5 | Formalize empirical research design and data collection assessment in Veterinary Research Project A/B | C5 level 2 (designed inquiry with data collection) | Medium | Year 3 Term 2; curriculum documentation | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | All subjects in the 400-point course are core, accredited internationally by AVBC, RCVS (UK), and AVMA (USA), with staged bioscience, pathology, and clinical discipline progression. | Redesign must preserve international professional accreditations and core prerequisite progression. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | Hurdle extramural placements in commercial production and clinical environments, clinical immersion in working clinics, and case-study exercises requiring trade-off decisions across animal welfare, legal, ethical, and economic factors. | Redesign must retain uncontrolled extramural workplace learning and authentic clinical trade-off evaluations. | [16] |
...
|---|---|---|---|---|---|---|
| P1 | C2 | 1 | 2 | +1 adaptive | 8 / 15 | 6 / 9 |
| P2 | C3 | 1 | 2 | +1 adaptive | 9 / 15 | 6 / 9 |
| P3 | W1 | 1 | 2 | +1 workplace | 9 / 15 | 7 / 9 |
