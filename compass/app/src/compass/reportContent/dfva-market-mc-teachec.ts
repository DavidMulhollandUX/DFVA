...
| Compliance and quality assurance | Quality Improvement Coordinator, Nominated Supervisor (pathway role) | Implementing and evidencing compliance with National Quality Framework obligations, including the incoming child-safety reforms | **LOW** — regulatory accountability sits with a named, qualified person and is not outsourceable | Working knowledge of the 27 February 2026 Strengthened NQF child-safety and protection reforms, including the shortened 24-hour incident-notification timeframe | Grounded in ACECQA's own regulatory instruments (see §3, Theme 1); program evidence documents "safe and ethical use of ICT" only as a learning-outcome statement, not as a graded assessment criterion (curriculum evidence, item C3) |

## 2. RECENT JOB AD SIGNALS

**Confidence: LOW.** No live job-ad corpus was collected for this profession record (ONET-Standard Occupational Classification (SOC) 070101) — No Adzuna or equivalent job-ad data was collected for this occupation. Nothing below substitutes for that gap; treat every signal in this section as demand-side context drawn from regulatory and trade-press sources, not as a measured advertising volume.
...
| Recent job-ad signals for this program | LOW | No live Adzuna or equivalent job-ad corpus exists for this profession record (No Adzuna or equivalent job-ad data exists for this profession). This is the single most significant gap in this report. |
