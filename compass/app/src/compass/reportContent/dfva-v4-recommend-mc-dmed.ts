...
const content = {
  title: "Doctor of Medicine (MC-DMED) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Doctor of Medicine (MC-DMED)
...
**Assessment date:** 2026-08-14 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-dmed.md
**Position basis:** Destination AI Exposure 45.02 (exact basis) × Curriculum Adaptiveness 8/15 (v4.2 draft, sub-scale A) · Workplace practice 7/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
Operating in a low AI exposure domain (**45.02**, far below the portfolio median of 90.9), the program exhibits outstanding Workplace Practice (**7 / 9**) and solid Adaptiveness (**8 / 15**). Workplace practice is led by extensive, longitudinal clinical placements across all 4 years with clinician supervision and regular ePortfolio hurdles, achieving the maximum score for work-situated learning (**W3: 3 / 3**), alongside standard-set OSCEs (W2: 2/3) and assessed professional conduct guidelines (W1: 2/3). However, adaptiveness is constrained because AI/digital literacy (C3: 1/3) appears only as selective electives without core clinical AI governance, primary empirical inquiry (C5: 1/3) is one of two selective pathways, and collaborative/reliance tasks lack explicit human-AI workflow allocation.

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 2 | Direct — Market §2 Signal 3 and §3 Theme 1 emphasize that hospitals are deploying ambient clinical AI scribes and diagnostic CDSS; doctors must audit algorithmic hallucinations and equity bias. | 1 |
| C5 Inquiry & evidence generation | Adaptive | 1 / 3 | 2 | Direct — AMC medical leadership requires evidence-based trial design and data collection; research project is selective (one of two pathways). | 2 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Direct — Modern clinical practice coordinates work across multidisciplinary teams, electronic medical records, and automated diagnostic triage tools. | 3 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Direct — Mini-CEX includes peer review, but lacks documented clinical reliance and override logs over automated diagnostic support tools. | 4 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Direct — Core assesses situational judgement, but self-scoping and CPD gap-closing roadmaps are pathway-dependent. | 5 |
| W1 Professional communication & conduct | Workplace | 2 / 3 | 1 | Direct — Core assesses Mini-CEX with clinician judges, but program-wide progressive recurrence across all 4 years requires explicit rubric documentation. | 6 |
| W2 Authentic task design | Workplace | 2 / 3 | 1 | Direct — OSCE history/exam stations are authentic, but psychometric standard-setting cut scores dominate over workplace constraints in senior years. | 7 |
...
|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Introduce an assessed module in Principles of Clinical Practice on clinical AI decision support, ambient documentation verification, and diagnostic bias. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Introduce an assessed clinical AI governance audit: students critique diagnostic CDSS algorithms against AHPRA professional indemnity and TGA regulatory standards. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 1 → 2 | "Students design and conduct an inquiry with methodology selection and data collection, assessed." | Require all MD students to complete an assessed clinical inquiry or clinical audit involving primary patient data collection in the core. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C5 Inquiry & evidence generation | 2 → 3 | "A substantial project generating primary evidence is REQUIRED (not one route among several), with methodology defended under scrutiny (viva, defence, or staged supervised review)." | Mandate a substantial clinical research project with an examined oral viva defence before hospital consultant examiners. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | In clinical simulation or ward placements, require student teams to document a protocol allocating tasks between medical officers, nursing staff, and automated clinical triage/EMR alerts. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | In the clinical placement ePortfolio, require an assessed clinical reliance log where students defend overriding automated clinical decision-support flags or ambient AI summaries. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C4 Life-long learning & transfer | 2 → 3 | "The program documents structured progression toward independent learning: a self-scoped capstone or research project, or assessed identification of one's own knowledge gaps together with the plan to close them." | In the Year 4 transition-to-practice ePortfolio, require an assessed learning plan identifying personal clinical knowledge gaps and mapping a post-internship CPD roadmap. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W1 Professional communication & conduct | 2 → 3 | "Professional communication is assessed repeatedly and progressively across the program AND at least one core assessment is delivered to, or judged by, a real external audience or practitioner (industry panel, client, patient or simulated patient, public exhibition), with professional conduct or accountability explicitly among the assessed criteria." | Formalize consultant-graded clinical encounters and longitudinal patient communication rubrics across all four years with explicit professional conduct hurdles. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2 → 3 | "Such tasks are the program's assessment spine rather than a single instance (a capstone plus earlier scaffolding, or at least one per stage) AND at least one carries a genuine constraint of practice — an ambiguous or externally supplied problem, real resource/time limits, a consequential audience, or the profession's own standards of performance." | Ensure authentic bedside clinical examinations and emergency simulation stations form the assessed spine across every stage of the 4-year degree. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C3 | Hospital networks are piloting ambient clinical documentation and AI triage; junior doctors must audit algorithmic accuracy and patient safety. | §2 Signal 3; §3 Theme 1 | HIGH (RACP & ADHA position statements) |
| P2 | C5 | Academic health science centres require medical graduates capable of designing and conducting rigorous clinical audits and patient research. | §1 Job Family 7; §3 Theme 3 | HIGH (AMC medical standards) |
| P3 | C2 | Doctors bear non-delegable legal liability for clinical decisions; overriding flawed AI decision support requires explicit justification. | §2 Signal 4; §3 Theme 1 | HIGH (AHPRA and MBA guidelines) |
| P4 | W1 | Medical practitioners must communicate diagnoses and treatment options effectively with distressed patients and interprofessional hospital teams. | §1 Job Family 1; §3 Theme 2 | HIGH (AMC graduate competencies) |
| P5 | W2 | Hospital intern readiness depends on authentic patient assessment under real clinical time constraints. | §1 Job Family 1; §2 Signal 1 | HIGH (PMCV hospital matching benchmarks) |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C3 | Add an assessed clinical AI decision support and ambient scribe module | C3 level 2 (capabilities and limits discussed/assessed) | Low | Year 1 Term 2; syllabus update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P2 | C2 | Attach an assessed clinical reliance log to placement ePortfolios | C2 level 3 (reliance decisions documented) | Low | Year 2 Term 1; ePortfolio prompt update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P3 | W1 | Formalize consultant-graded clinical encounters across all 4 years | W1 level 3 (external audience & conduct criteria) | Low–Medium | Year 2 Term 2; rubric documentation | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| P4 | C5 | Require an assessed clinical audit or primary inquiry for all students | C5 level 2 (methodology selection & data collection) | Medium | Year 4 Term 1; project restructure | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | An all-compulsory specialist core plus an accredited sequence plus a staged progression rule: 312.5 of 400 points are eight compulsory subjects, accredited by the Australian Medical Council leading to AHPRA registration, with 100 points required annually for progression. | Redesign must preserve the AMC-accredited 312.5-point core sequence and biomedical science progression to maintain medical registration eligibility. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | Situational judgement tests and the mini clinical encounter/OSCE hurdle require judgements made under clinical uncertainty with accountability, and the Year 4 placement-based capstone places students in live clinical work as trainee junior doctors. | Assessment must preserve unscripted clinical patient encounters, acute differential diagnosis trade-offs, and hospital ward decision-making. | [16] |
...
|---|---|---|---|---|---|---|
| P1 | C3 | 1 | 2 | +1 adaptive | 9 / 15 | 7 / 9 |
| P2 | C2 | 2 | 3 | +1 adaptive | 10 / 15 | 7 / 9 |
| P3 | W1 | 2 | 3 | +1 workplace | 10 / 15 | 8 / 9 |
| P4 | C5 | 1 | 2 | +1 adaptive | 11 / 15 | 8 / 9 |
