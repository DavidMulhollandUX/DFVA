...
const content = {
  title: "Master of Cultural Materials Conservation (MC-CULMC) — Market Intelligence",
  institution: "University of Melbourne",
  markdown: `# DFVA MARKET INTELLIGENCE: Master of Cultural Materials Conservation (MC-CULMC)
