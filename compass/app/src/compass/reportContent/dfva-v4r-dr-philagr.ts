...
const content = {
  title: "Doctor of Philosophy - Agricultural Sciences (DR-PHILAGR) — Research Degree Report",
  institution: "University of Melbourne",
  markdown: `# DFVA RESEARCH DEGREE REPORT: Doctor of Philosophy - Agricultural Sciences (DR-PHILAGR)
...
Carried from [the v1 assessment](dfva-dr-philagr.md) as narrative. The v1 composite, its
...
Market intelligence for this program is in [the market report](dfva-market-dr-philagr.md). **Its §3 discussion-signal section is unsourced** — it predates the sourcing
