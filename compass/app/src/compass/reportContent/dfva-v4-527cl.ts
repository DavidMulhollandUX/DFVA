...
const content = {
  title: "Master of Clinical Psychology (527CL) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Clinical Psychology (527CL)
...
**Course Director:** Dr Catharine McNab (Course Convenor)
...
| W3 Work-situated learning [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) | 3 | Level 3 anchor is satisfied in every conjunct with quotable assessment evidence: substantial required work-situated learning (125 days of placement across a compulsory sequence of three placement subjects, 300 hours in Clinical Placement 1 and 350 hours each in Clinical Placements 2 and 3, in a real clinic and two external agencies); practitioner supervision (Psychology Board of Australia-approved registered psychologists and PBA-endorsed external supervisors); assessment (competency hurdles, four mental state examinations and five case histories judged to the placement supervisor's standard); accountability to the host (a placement contract, and a logbook checked and endorsed by the primary placement supervisor at least every fortnight, plus mid- and end-placement reviews); and structured reflection on professional practice (a required placement reflection to the satisfaction of the placement coordinator). This is a sequence in the core, not a single short placement, so it is above level 2. |
...
The market intelligence gathered for this program indicates exceptional, non-cyclical employment demand across public mental health networks (Orygen, Royal Melbourne Hospital, The Alfred, CAMHS), private psychology practices, and digital mental health platforms, supported by statutory AHPRA registration protection that strongly insulates clinical psychologists from automated AI displacement in direct care.
...
| --- | --- | --- | --- | --- |
| C2 Hybrid metacognition & evaluative judgement | 1/3 | Introduce criterion-referenced peer review of draft clinical formulations in PSYC90125 Core Skills, and attach an assessed AI reliance and override log to psychometric interpretation tasks where students defend overriding machine test interpretations. | Teaching-team time to moderate peer critiques and calibrate clinical feedback rubrics. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1/3 | Add an assessed module in core clinical practice coursework analyzing AI-assisted mental health triage tools, digital screening limits, and digital privacy ethics; introduce an assessed digital mental health clinical governance audit. | Designing clinical AI case scenarios without eroding core psychopathology hours. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C1 Distributed cognition & relational capability | 2/3 | In the Ways of Knowing interprofessional sequence, assess student clinical teams documenting role and tool allocations between psychologists, multidisciplinary team members, and digital EMR triage systems. | Developing interprofessional and digital workflow assessment tasks. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C5 Inquiry & evidence generation | 2/3 | Mandate an examined oral viva defence before a panel of clinical psychology researchers for the completed minor research thesis. | Viva panel examiner coordination and scheduling. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2/3 | In the coursework case-conference presentation, invite external Psychology Board-approved clinical supervisors to judge student presentations with assessed professional conduct criteria. | External supervisor panel coordination and conduct rubric moderation. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2/3 | Formalize published practice marking rubrics across all coursework case formulation tasks and ensure authentic tasks span both stages of coursework. | Faculty time to document practice-derived assessment criteria. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
