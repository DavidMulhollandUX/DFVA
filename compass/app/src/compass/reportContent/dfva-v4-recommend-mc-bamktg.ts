...
const content = {
  title: "Master of Business Administration (Marketing) (MC-BAMKTG) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Business Administration (Marketing) (MC-BAMKTG)
