...
const content = {
  title: "Master of Business Administration/Master of Marketing (MC-BAMKTG) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Business Administration/Master of Marketing (MC-BAMKTG)
...
participation rather than the quality of work. Meanwhile the market report's §3 theme 1
records AI and data governance being written as a duty of the general manager and the
board — the AICD/HTI eight-element framework and the Allens/AICD/Melbourne Business School
data-governance guidance — and §3 theme 6 dates the statutory automated-decision
transparency obligation to 10 December 2026. The market report's §5 implication CI-1 states
that no compulsory subject across the 187.5 credit points of core assesses AI capability,
limits or governance, which the handbook capture confirms.

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| C3 Digital & AI literacy, incl. governance | Adaptive | 1 / 3 | 2 | Direct — AI and data governance written as a duty of the board and the general manager (AICD/HTI, June 2026); statutory automated-decision transparency from 10 December 2026; no compulsory subject assessing AI capability, limits or governance named as the leading curriculum implication | 1 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 1 / 3 | 2 | Direct — judgement, communication and commerciality named by employers and the AMI as the retained capabilities against execution; claims requiring substantiation at the time they are made; methodology selection framed as the buyer's judgement | 2 |
| C5 Inquiry & evidence generation | Adaptive | 2 / 3 | 1 | Direct — measurement moving from multi-touch attribution to marketing mix modelling and incrementality, with twelve Australian vendors differing on validation practice and the buyer's task being to judge a methodology | 3 |
| W2 Authentic task design | Workplace | 2 / 3 | 1 | Direct — the commercial case put to a CFO and the substantiation file behind a claim are both practitioner artefacts; entry-level execution roles are the ones being automated | 4 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Direct — oversight and accountability named the first element of the AICD/HTI framework, and APP 1.7 attaching a named human to decisions a program substantially assists | 5 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Direct — employers rank communication, problem-solving and adaptability first now but AI-tool skill first on the five-year view, so the capability to be learned is not the one currently rewarded | 6 |
| W1 Professional communication & conduct | Workplace | 2 / 3 | 1 | Direct — Australian marketing leaders reporting that revenue accountability and a commercial argument to the CFO are the condition of the job; general management and marketing leadership are the two job families at LOW substitution pressure | 7 |
| W3 Work-situated learning | Workplace | 2 / 3 | 1 | Weak — the market claim this lever rested on was withdrawn in the 2026-08-25 re-sourcing, and no signal in the re-sourced report speaks to placement duration; no employment-rate claim is made | 8 |
...
Each intervention corresponds to named evidence in the market report, re-sourced on
2026-08-25. Confidence is the market report's own, restated and not re-derived: §3 carries
MEDIUM overall, and §6 records HIGH for the Australian regulatory instruments and the
self-regulatory advertising codes, MEDIUM–HIGH for the IAB Australia measurement landscape,
and MEDIUM for the GMAC employer survey, the Mi3 trade-press reporting and the AMI
competency framework. Destination exposure for this program is borrowed from the parent
Master of Business Administration record rather than measured, so it is rated LOW–MEDIUM
there and no exposure figure enters this table or any other.

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | W1 | Australian marketing leaders reporting that the argument they must win is a commercial one put to a CFO, with revenue accountability and a cross-functional remit described as the condition of the job (Mi3, February and March 2026). General management and marketing leadership are the two job families rated LOW for AI substitution, on the ground that accountability for the decision is the work. | §3 theme 3; §1 job families 1–2 | MEDIUM |
| P2 | C5 | IAB Australia's Ad Effectiveness Council profiling twelve marketing-mix-modelling vendors active in Australia (September 2025, updated December 2025) with an eight-stage buyer checklist, the vendors differing on methodology and validation practice. The buyer's task is judging a methodology, which is what a defence under scrutiny assesses. | §3 theme 2; §4 skill shift; §5 implication CI-3 | MEDIUM–HIGH |
| P3 | C2 | Employers and the Australian Marketing Institute naming judgement, communication and commerciality as the retained capabilities rather than execution, against one in three employers reporting they have already replaced some entry-level positions with AI. The two highest-substitution destination families are the ones where the executable task is the job. | §3 theme 7; §2 signal 1; §1 job families 5–6 | MEDIUM |
| P4 | C4 | GMAC's 2026 employer ranking putting communication, problem-solving and adaptability at the top of current hiring priorities but skill in using AI tools first on the five-year forecast. The capability the near-term signal rewards and the one the medium-term signal rewards are different, and a two-year degree spans both, which places the burden of closing an unnamed gap on the graduate. | §2 signal 3; §4 skill shift | MEDIUM |
| P5 | C3 | AI and data governance written as a board and general-management duty by the AICD and the Human Technology Institute (June 2026) and by Allens, the AICD and Melbourne Business School — this program's own school (May 2025). The absence of any compulsory subject assessing AI capability, limits or governance is the first curriculum implication the report records. | §3 theme 1; §5 implication CI-1 | HIGH |
| P6 | C1 | The AICD/HTI framework naming oversight and accountability as its first element, and APP 1.7 requiring an entity to disclose where a program makes or substantially assists a decision affecting an individual's rights — both attach a named human to work done jointly with an automated system. That is the coordination problem C1 level 3 assesses. | §3 themes 1 and 6 | MEDIUM–HIGH |
| P7 | C2 | Substantiation of claims at the time they are made, and judging a vendor's methodology rather than accepting its output, both named on the rising side — the AANA Environmental Claims Code requiring evidence at the moment of the claim, and IAB Australia's checklist framing MMM selection as a validation judgement. | §4 skill shift; §3 themes 2 and 4 | MEDIUM–HIGH |
| P8 | C3 | Three enforceable Australian instruments with dated start points: the AANA Environmental Claims Code (1 March 2025), the ACCC's influencer-disclosure findings and media-neutral advertising codes, and APP 1.7's automated-decision transparency obligation (10 December 2026). Governance here is statutory rather than aspirational. | §3 themes 4, 5 and 6; §5 implication CI-1 | HIGH |
| P9 | W2 | The commercial case put to a CFO, and the substantiation file behind a claim, are both practitioner artefacts rather than academic genres — and Australian accounting standards treat brand spend as yearly operating expenditure, so the argument has to be made rather than capitalised. Entry-level execution roles are the ones being automated. | §3 theme 3; §2 signal 1; §5 implication CI-5 | MEDIUM |
| P10 | W3 | **The market claim this lever previously rested on has been withdrawn.** The 2026-08-25 re-sourcing of the market report removed the assertion that B2B marketing is an underserved path for MBA graduates in Australia — nothing checkable was found to support it — and no signal in the re-sourced report speaks to placement duration or industry-pipeline breadth. What remains is that destination evidence for this program is field-of-education level and its exposure is borrowed from the parent MBA record, so which destinations graduates reach is inferred. Justified on skill development, employment relevance and professional identity [[29]](https://doi.org/10.1080/07294360.2016.1139551) — never on employment rates, which work-integrated learning was not found to raise [[28]](https://doi.org/10.1007/s10734-017-0216-z). | §2 signal 5; §6; labour-evidence block | LOW |
...
P10 now rests on the instrument and the pedagogical literature alone. The market claim
that previously supported it — that B2B marketing is an underserved path for MBA graduates
in Australia — was withdrawn in the 2026-08-25 re-sourcing of the market report for want of
a checkable source, and it is listed last here on effort and dependency grounds regardless.
It is justified by skill development, employment relevance and professional identity
