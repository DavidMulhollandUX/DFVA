...
const content = {
  title: "Doctor of Philosophy - Business and Economics (DR-PHILBE) — Research Degree Report",
  institution: "University of Melbourne",
  markdown: `# DFVA RESEARCH DEGREE REPORT: Doctor of Philosophy - Business and Economics (DR-PHILBE)
...
Carried from [the v1 assessment](dfva-dr-philbe.md) as narrative. The v1 composite, its
...
Market intelligence for this program is in [the market report](dfva-market-dr-philbe.md). **Its §3 discussion-signal section is unsourced** — it predates the sourcing
