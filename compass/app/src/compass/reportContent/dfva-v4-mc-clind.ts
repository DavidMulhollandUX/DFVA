...
const content = {
  title: "Master of Clinical Dentistry (MC-CLIND) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Clinical Dentistry (MC-CLIND)
...
- **G1 Disciplinary foundation:** PASS — An all-compulsory specialist core with staged depth: 100 credit points comprising a single 75cp advanced clinical subject in the chosen specialisation plus a 25cp research subject, with no elective space documented, and an internal prerequisite gate — the pre-clinical practical assessment must be passed before patient care may begin. Content is unambiguously disciplinary (prosthodontics: occlusion, fixed/removable/implant prosthodontics, laboratory skills), not generic or interchangeable.
- **G2 Decision-making under uncertainty:** PASS — Assessment requires defended decisions under real clinical uncertainty rather than recall or scripted response: students must defend their management of both an in-progress and a completed clinical case, and must create and develop treatment plans for real patients across 542.5 hours of clinical practice — a live setting with genuine accountability. Diagnosis, treatment planning and rehabilitation across fixed, removable and implant options is trade-off decision-making, and the written exam is only one component (15%) among predominantly case-based assessment.

## 4. MARKET EVIDENCE — Basis: reported

The market intelligence gathered for this program indicates strong demand across Dental Board of Australia (DBA) specialist registers, public hospital dental networks (Dental Health Services Victoria / Royal Dental Hospital of Melbourne), and private specialist prosthodontic practices, accompanied by rapid adoption of digital CAD/CAM design workflows (exocad, 3Shape Trios) and AI-driven radiographic lesion detection software (Pearl, Overjet) where complex intraoral rehabilitation, full-arch occlusal reconstruction, and medico-legal liability remain non-delegable human responsibilities under Australian Dental Council (ADC) and DBA specialist accreditation standards.
...
| --- | --- | --- | --- | --- |
| C1 Distributed cognition & relational capability | 1/3 | In core prosthodontic coursework, introduce an assessed interprofessional treatment planning project requiring collaborative design between prosthodontists, periodontists, and dental laboratory technicians with individual accountability; require candidate teams to document human-plus-AI task allocation. | Interprofessional clinical seminar moderation time. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C3 Digital & AI literacy, including governance | 1/3 | Introduce an assessed module in core clinical coursework on AI dental diagnostic software (Pearl, Overjet), automated margin detection in CAD/CAM, and clinical validation limits; introduce an assessed prosthodontic AI governance audit. | Software access licensing and syllabus updates. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 1/3 | Require students in DENT90108 to design and conduct a primary clinical inquiry with empirical data collection (e.g. clinical audit, biomaterial test) rather than submitting a proposal alone; require defended research inquiry. | Research ethics and data collection governance resourcing. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2/3 | Require candidates to maintain an assessed clinical reliance log documenting and justifying decisions to override automated CAD/CAM design suggestions and diagnostic imaging annotations across patient cases. | Clinical logbook rubric calibration. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C4 Life-long learning & transfer | 2/3 | Convert the research subject into a required self-scoped clinical research capstone completed by all candidates before graduation. | Research project supervision and mentoring allocation. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W1 Professional communication & conduct | 2/3 | Mandate that the end-of-year clinical case defence is judged by external RACDS/ADC specialist examiners with assessed professional conduct and ethics rubrics. | External specialist examiner honoraria and scheduling. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W3 Work-situated learning | 2/3 | Formally incorporate structured reflection hurdles and documented clinical supervisor sign-offs into the 542.5-hour Clinical Portfolio assessment description. | Documentation updates in handbook subject descriptors. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
