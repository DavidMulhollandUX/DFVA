...
const content = {
  title: "Master of Nursing Science (MC-NURSC) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Nursing Science (MC-NURSC)
...
**Course Director:** Sacha Petersen (Principal Coordinator)
...
- **G2 Decision-making under uncertainty:** PASS — Assessment goes well beyond recall or scripted response. Core assessment requires defended clinical trade-off decisions — prioritising nursing problems and planning interventions under a Clinical Decision Making Framework, individualising the decision-making process to a practice context, and modifying practice where clinically indicated — and is delivered through open-book take-home case analyses rather than closed recall. Real uncertainty with accountability is present in the capstone's complex-patient scenarios and in supervised placement practice.

## 4. MARKET EVIDENCE — Basis: reported

The market intelligence gathered for this program indicates acute, structural workforce shortages across all public health services (Royal Melbourne, The Alfred, Austin Health, Monash Health), intensive care units, and community health networks, alongside the deployment of Electronic Medical Records (Epic/Cerner) and Clinical Decision Support Systems (CDSS) that assist triage but leave bedside nursing practice and statutory care accountability entirely insulated from automation.
...
| --- | --- | --- | --- | --- |
| C3 Digital & AI literacy, including governance | 1/3 | Add an assessed module in core acute nursing coursework analyzing AI clinical decision support tools, diagnostic alert limits, and digital patient privacy ethics; introduce an assessed clinical AI governance audit against NMBA standards. | Developing clinical AI and CDSS simulation scenarios without compromising core clinical hours. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 1/3 | In the research methods subject, require students to conduct a primary clinical audit or ward-based empirical data collection alongside methodology selection, with an examined oral viva defence. | Hospital ward clinical audit access agreements and viva examiner coordination. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C1 Distributed cognition & relational capability | 2/3 | In simulated resuscitation or acute care tasks, assess student clinical teams documenting role and tool allocations between nurses, doctors, allied health, and digital EMR/CDSS systems. | Developing interprofessional and digital workflow assessment tasks. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2/3 | Attach an assessed Clinical Decision Support reliance and override log to acute simulation tasks where students defend overriding automated clinical alerts. | Faculty time to evaluate student CDSS override justifications against pathophysiological evidence. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C4 Life-long learning & transfer | 2/3 | In the capstone e-portfolio, require an assessed continuing professional development plan identifying clinical specialty gaps and mapping a structured post-registration learning pathway. | Structured CPD planning rubrics. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W1 Professional communication & conduct | 2/3 | In the clinical communication OSCE, formalize the inclusion of simulated patient actors and external clinical nurse educators with assessed professional conduct criteria. | Simulated patient actor scheduling and external educator coordination. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
