...
const content = {
  title: "Master of Property (MC-PROP) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Property (MC-PROP)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/mc-prop (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 38 pages captured
**Course Director:** Raghu Dharmapuri Tirumala
...
| C3 Digital & AI literacy, including governance [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) | 1 | Level 1 anchor — digital tools appear as tool operation/training, the level TEQSA identifies as non-durable — is exactly what the extract documents: ARGUS applied to the development process, SPSS/RStudio as prescribed software, spreadsheet financial modelling, and generic-skill statements about computer and information technologies and word-processing/graphics packages. Level 0 is excluded because digital content is plainly present in core units. Level 2 fails: no core unit in the extract addresses AI capabilities AND limitations or ethics, and no gen-AI content appears anywhere; level 3's requirement for assessed critique or governance of AI systems (bias, accountability, transparency, regulation, data governance) has no counterpart in the text. |
| C4 Life-long learning & transfer [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) | 3 | Level 3 anchor — the program documents structured progression toward independent learning via a self-scoped research project — is satisfied with assessment evidence, not an outcome claim (R2): the core subject Property Research and Analysis assesses, at 70%, a scholarly report on a topic defined by the student in consultation with the coordinator, and that work is the documented prerequisite input to the required research subject in the following stage. The progression is structural (90363 feeds 90362) rather than asserted. Level 2 is also independently met — Property Investment and Finance assesses four separate case analyses requiring decisions in unfamiliar investment contexts — but the self-scoped, staged route lifts the item above it. Scored on transfer and self-directed learning only; the work-integrated route that formerly sat here is scored in W3. |
...
- **G1 Disciplinary foundation:** PASS — The program documents a coherent specialist core with progressive depth on all three of the gate's alternative routes. The core is large and compulsory (225 of 300 points, or 125 of 200), and the core list is almost entirely discipline-specific property subjects (valuation, property law, development, securitisation, property economics). It is staged, with Year 1 core separated from Year 2 and 3 core in the 300-point entry, and it carries a prerequisite chain from Property Research and Analysis into the research subject. It is also an accredited sequence, recognised by two property-profession bodies. Nothing here reads as generic or interchangeable content.
- **G2 Decision-making under uncertainty:** PASS — Core assessment requires defended trade-off decisions under genuine uncertainty rather than recall or scripted response. Property Investment and Finance assesses four successive case analyses each framed as a decision — portfolio repositioning, portfolio construction, an investment decision on a proposed development, and a choice among financing options — and Property Development assesses development appraisal against viability, risk and return, with the outcome expressed as evaluating the viability of proposals. The program's own outcome statement frames property projects as evaluated in terms of risk allocations and viability, and the assessed cases operationalise that. This clears the v1 D4 >= 2 equivalent.

## 4. MARKET EVIDENCE — Basis: reported

The market intelligence gathered for this program indicates strong demand across Australian Property Institute (API) Certified Practising Valuer (CPV) registers, top-tier commercial real estate consultancies (CBRE, JLL, Colliers, Knight Frank), listed real estate investment trusts (REITs), and major development companies, accompanied by rapid adoption of automated valuation models (AVMs) and ARGUS EstateMaster financial feasibility platforms where physical asset due diligence, mock courtroom expert witness testimony, and complex planning negotiation remain exclusive human professional responsibilities under API and Royal Institution of Chartered Surveyors (RICS) standards.
...
| --- | --- | --- | --- | --- |
| C3 Digital & AI literacy, including governance | 1/3 | Introduce an assessed module in core property analysis on AI automated valuation models (CoreLogic, Valocity), PropTech data analytics, and algorithmic error limits; introduce an assessed PropTech AI governance audit. | Software tool licensing and syllabus updates. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W3 Work-situated learning | 1/3 | Convert the industry-based research project into a required core placement component in commercial property development, valuation, or funds management; establish an extended required practicum sequence. | Host organization placement coordination and liaison resourcing. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| C1 Distributed cognition & relational capability | 2/3 | In Property Development syndicate projects, require candidate teams to document a protocol allocating feasibility tasks between analysts, planners, and ARGUS/AI modeling platforms. | Syndicate workshop moderation time. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2/3 | Require candidates to maintain an assessed valuation decision log documenting and justifying decisions to override automated AVM valuations and ARGUS financial projections. | Assessment rubric calibration for valuation logbooks. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C5 Inquiry & evidence generation | 2/3 | Require all candidates to complete a primary empirical property research thesis generating primary market evidence with methodology defended in a formal oral viva examination. | Oral examination scheduling and examiner time. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2/3 | Mandate that the mock courtroom valuation defence and oral business cases are judged by external API/RICS practitioners and legal counsel with assessed conduct rubrics. | External valuer/examiner honoraria and scheduling. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2/3 | Establish an authentic task spine across all stages by replacing written exams in early subjects with authentic feasibility submissions and commercial lease negotiations. | Assessment spine redesign across Year 1 and 2 units. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
