...
const content = {
  title: "Doctor of Philosophy - Veterinary Science (DR-PHILVET) — Research Degree Report",
  institution: "University of Melbourne",
  markdown: `# DFVA RESEARCH DEGREE REPORT: Doctor of Philosophy - Veterinary Science (DR-PHILVET)
...
Carried from [the v1 assessment](dfva-dr-philvet.md) as narrative. The v1 composite, its
