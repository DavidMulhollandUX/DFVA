...
const content = {
  title: "Master of Genetic Counselling (MC-GENCOUN) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Genetic Counselling (MC-GENCOUN)
...
**Assessment date:** 2026-08-15 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-gencoun.md
**Position basis:** Destination AI Exposure 64.91 (exact basis) × Curriculum Adaptiveness 10/15 (v4.2 draft, sub-scale A) · Workplace practice 8/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
Operating in a moderate AI exposure domain (**64.91**, below the portfolio median of 90.9), the program exhibits exceptional research and practice fidelity, achieving maximum scores across four items: **C4: 3 / 3** (compulsory student-scoped original research project with staged HREC application), **C5: 3 / 3** (required primary empirical data collection, 5,000-word monograph, and viva examination before senior faculty), **W2: 3 / 3** (an authentic task spine of pedigree risk analyses, videoed counselling sessions, long case reports, and 50-case logbooks), and **W3: 3 / 3** (48 days of practitioner-supervised clinical genetics placements with host accountability and a 70% fitness-to-practise hurdle). However, Adaptiveness sits at **10 / 15** because AI variant tools are absent from the core (**C3: 0 / 3**), and C1, C2, and W1 sit at 2/3.

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | Adaptive | 0 / 3 | 3 | Direct — Market §2 Signal 4 and §3 Theme 1 emphasize that genetic counsellors must audit AI variant curation platforms (Fabric Genomics, Franklin by Genoox) under HGSA accountability; core lacks assessed AI modules. | 1 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Direct — Clinical genetics requires coordinating multidisciplinary teams of clinical geneticists, oncologists, bioinformaticians, and automated genomic pipelines. | 2 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Direct — Core assesses structured critique and HGSA portfolios, but lacks assessed reliance/override logs over automated variant classification suggestions. | 3 |
| W1 Professional communication & conduct | Workplace | 2 / 3 | 1 | Direct — Core assesses lay communication, but lacks clinical counselling OSCEs judged by external HGSA practitioners with explicit conduct rubrics. | 4 |
...
|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | 0 → 1 | "AI or digital tools appear only as electives or as tool operation/training — the operational level TEQSA identifies as non-durable." | Introduce training on digital pedigree software and online genomic variant curation databases into foundational genomics units. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Introduce an assessed module in Advanced Clinical Genomics on AI-assisted variant classification platforms, algorithmic error modes in VUS interpretation, and HGSA ethical standards. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Introduce an assessed genomic AI governance audit: students critique commercial variant prioritization algorithms against ACMG/AMP standards, secondary finding disclosure rules, and Privacy Act genetic data frameworks. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | In the multidisciplinary case conference assessment, require student teams to document a protocol allocating clinical tasks between genetic counsellor, medical geneticist, and automated variant curation pipelines. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | In the Clinical Practice placement portfolio, require students to document and defend reliance decisions when overriding AI-suggested variant pathogenicities or automated pedigree risk classifications. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| W1 Professional communication & conduct | 2 → 3 | "Professional communication is assessed repeatedly and progressively across the program AND at least one core assessment is delivered to, or judged by, a real external audience or practitioner (industry panel, client, patient or simulated patient, public exhibition), with professional conduct or accountability explicitly among the assessed criteria." | Formalize the simulated counselling session in WELF90004/WELF90010 to be delivered before simulated patients and evaluated by practising HGSA genetic counsellors with explicit conduct rubrics. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C3 | Clinical genomics labs deploy AI variant curation tools; genetic counsellors must audit automated predictions under HGSA codes. | §2 Signal 4; §3 Theme 1 | HIGH (HGSA & Journal of Genetic Counseling) |
| P2 | C2 | Translating variants of uncertain significance (VUS) requires justified clinical override of algorithmic pathogenicity scores. | §1 Job Family 1; §3 Theme 1 | HIGH (ACMG/AMP guidelines) |
| P3 | W1 | Complex hereditary cancer and prenatal counselling requires advanced empathic communication judged by experienced practitioners. | §1 Job Family 2; §3 Theme 2 | HIGH (HGSA Board of Censors standards) |
| P4 | C1 | Familial cancer and rare disease clinics operate via multidisciplinary teams coordinating counsellors, geneticists, and AI systems. | §1 Job Family 3; §3 Theme 2 | HIGH (Australian Genomics reports) |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C3 | Add an assessed module on AI genomic variant curation platforms, algorithmic limits, and HGSA ethics | C3 level 2 (capabilities and limits discussed/assessed) | Low | Year 1 Term 2; syllabus update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P2 | C2 | Require an assessed AI reliance and override log in the Clinical Practice placement portfolio | C2 level 3 (reliance decisions documented) | Low | Year 2 Term 1; portfolio rubric update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P3 | W1 | Formalize simulated counselling sessions delivered before simulated patients and evaluated by HGSA practitioners | W1 level 3 (external practitioner judge & conduct criteria) | Low–Medium | Year 1 Term 2; assessment brief update | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | 200 credit points of compulsory subjects accredited by the HGSA Board of Censors, with staged progression from basic genomics and counselling to advanced clinical genetics and research. | Redesign must preserve the HGSA statutory accreditation and strict prerequisite progression. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | Assessed clinical placement management of complex genomic reports, variant interpretation uncertainties, and emotionally charged multi-party counselling sessions. | Redesign must maintain unscripted clinical placements and authentic counselling uncertainty. | [16] |
...
|---|---|---|---|---|---|---|
| P1 | C3 | 0 | 2 | +2 adaptive | 12 / 15 | 8 / 9 |
| P2 | C2 | 2 | 3 | +1 adaptive | 13 / 15 | 8 / 9 |
| P3 | W1 | 2 | 3 | +1 workplace | 13 / 15 | 9 / 9 |
