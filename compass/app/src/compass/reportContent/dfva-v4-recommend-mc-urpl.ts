...
**Position basis:** Destination AI Exposure 92.85 (exact basis) × Curriculum Adaptiveness 11/15 (v4.2 draft, sub-scale A) · Workplace practice 5/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
The Master of Urban Planning is a 200-point professional degree accredited by the Planning Institute of Australia (PIA), preparing graduates for statutory planning, strategic spatial policy, climate resilience, and urban design careers (AIOE 92.85). The curriculum exhibits strong academic depth (**11 / 15** on Sub-scale A), anchored by a flawless Level 3 score in primary inquiry and evidence generation (**C5: 3/3**) via the compulsory 25-point MSD Minor Thesis sequence (\`ABPL90396\`/\`ABPL90397\`, 10,000 words with oral proposal defense), alongside solid Level 2 foundation across collaborative policy studio work (\`ABPL90064\`, \`ABPL90131\`), statutory application evaluations (\`ABPL90130\`), and analytical research methods (\`ABPL90135\`). On the workplace practice sub-scale (**5 / 9**), the degree demonstrates authentic task design (**W2: 3/3**) via real-world statutory permit assessments and public consultation hearings, but lacks mandatory work-situated placement in the core (**W3: 0/3**, internships are elective-only) and external practitioner grading on professional communication (**W1: 2/3**). Strategic curriculum headroom focuses on introducing assessed Human-AI spatial workflows (C1), parametric zoning and digital twin override logs (C2), algorithmic zoning and spatial data justice ethics (C3), PIA capability gap analysis (C4), external industry panel defense (W1), and a core work-integrated planning studio placement (W3).
...
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Spatial planning consultancies increasingly integrate generative AI and digital twin workflows with human oversight | 2 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Planners must systematically audit and override automated site yield and parametric zoning calculations | 3 |
| C3 Digital & AI literacy, including governance | Adaptive | 2 / 3 | 1 | Emerging smart city surveillance, algorithmic redlining, and spatial data justice demand critical governance | 4 |
...
| W2 Authentic task design | Workplace | 3 / 3 | 0 | Flawless benchmark — real-world statutory permits, Victoria Planning Provisions, and public consultation | 8 |
...
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Embed an assessed module in core ABPL90135/ABPL90134 evaluating spatial AI ethics, digital twin governance, and spatial data justice | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
...
| P3 | C3 | 2 | 3 | +1 adaptive | 14 / 15 | 5 / 9 |
