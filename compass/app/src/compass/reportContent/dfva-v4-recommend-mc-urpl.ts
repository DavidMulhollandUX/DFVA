...
const content = {
  title: "Master of Urban Planning (MC-URPL) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Master of Urban Planning (MC-URPL)
...
**Assessment date:** 2026-08-24 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-urpl.md
**Position basis:** Destination AI Exposure 92.85 (exact basis) × Curriculum Adaptiveness 10/15 (v4.2 draft, sub-scale A) · Workplace practice 5/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
The Master of Urban Planning is a 200-point professional degree accredited by the Planning Institute of Australia (PIA), preparing graduates for statutory planning, strategic spatial policy, climate resilience, and urban design careers (AI Occupational Exposure (AIOE) 92.85). The curriculum exhibits solid academic depth (**10 / 15** on Sub-scale A), anchored by a flawless Level 3 score in primary inquiry and evidence generation (**C5: 3/3**) via the compulsory 25-point MSD Minor Thesis sequence (\`ABPL90396\`/\`ABPL90397\`, 10,000 words with oral proposal defense), alongside solid Level 2 foundation across collaborative policy studio work (\`ABPL90064\`, \`ABPL90131\`), statutory application evaluations (\`ABPL90130\`), and analytical research methods (\`ABPL90135\`), but no core subject or program-level outcome names AI or any digital tool (**C3: 1/3**). On the workplace practice sub-scale (**5 / 9**), the degree demonstrates authentic task design (**W2: 3/3**) via real-world statutory permit assessments and public consultation hearings, but lacks mandatory work-situated placement in the core (**W3: 0/3** — no internship, placement or practicum subject appears anywhere in the course structure, core or elective) and external practitioner grading on professional communication (**W1: 2/3**). Strategic curriculum headroom focuses on introducing assessed Human-AI spatial workflows (C1), parametric zoning and digital twin override logs (C2), first AI content and then algorithmic zoning and spatial data justice ethics in the core (C3), PIA capability gap analysis (C4), external industry panel defense (W1), and a core work-integrated planning studio placement (W3).

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| W3 Work-situated learning | Workplace | 0 / 3 | 3 | Planning employers and PIA heavily prioritize supervised municipal or consultancy placement experience | 1 |
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 2 | Emerging smart city surveillance, algorithmic redlining, and spatial data justice demand critical governance | 2 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Spatial planning consultancies increasingly integrate generative AI and digital twin workflows with human oversight | 3 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Planners must systematically audit and override automated site yield and parametric zoning calculations | 4 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Rapidly shifting state planning provisions and climate mandates require formalised continuing professional development | 5 |
| W1 Professional communication & conduct | Workplace | 2 / 3 | 1 | Planning panels and VCAT appeal hearings require rigorous professional communication judged against industry standards | 6 |
| **Adaptive capabilities** | **Adaptive** | **10 / 15** | **5** | — | — |
| C5 Inquiry & evidence generation | Adaptive | 3 / 3 | 0 | Flawless benchmark — compulsory 10,000-word MSD Minor Thesis with oral proposal defense and supervision | 7 |
| W2 Authentic task design | Workplace | 3 / 3 | 0 | Flawless benchmark — real planning applications, site-specific Victorian planning provisions, and a real public consultation event | 8 |
...
|---|---|---|---|---|
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | Require students in ABPL90064/ABPL90131 to submit an assessed Human-AI Spatial Workflow & Generative Tool Allocation Charter | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | Implement an assessed 'AI Parametric Zoning & Yield Override Log' in ABPL90130/ABPL90132 where students justify departures from generative urban design outputs | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Introduce AI capabilities and their limits into core ABPL90135/ABPL90134, then assess a critique of spatial AI ethics, digital twin governance, and spatial data justice there — the subject currently names no digital tool at all | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C4 Life-long learning & transfer | 2 → 3 | "The program documents structured progression toward independent learning: a self-scoped capstone or research project, or assessed identification of one's own knowledge gaps together with the plan to close them." | Embed an assessed planning capability gap analysis and PIA continuing professional development (CPD) plan in ABPL90396/ABPL90397 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| W1 Professional communication & conduct | 2 → 3 | "Professional communication is assessed repeatedly and progressively across the program AND at least one core assessment is delivered to, or judged by, a real external audience or practitioner (industry panel, client, patient or simulated patient, public exhibition), with professional conduct or accountability explicitly among the assessed criteria." | Partner with local council / PIA industry panels to assess student strategic plans and mock VCAT permit hearings in ABPL90130/ABPL90131 | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W3 Work-situated learning | 0 → 2 | "A core unit places students in a real workplace or professional-community setting with practitioner supervision and assessment — placement, practicum, live client project, community-based project." | Introduce a required 50-hour live client planning practicum or municipal industry-partnered studio in the core | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C1 | Planning consultancies adopt generative spatial design tools requiring human-AI project allocation | Section 1, Section 3 (*Journal of the American Planning Association*) | HIGH |
| P2 | C2 | Critical need for planners to audit and override automated site yield and parametric zoning calculations | Section 2, Section 3 (*Planning Theory & Practice* 2025) | HIGH |
| P3 | C3 | PIA and statutory authorities mandate understanding smart city surveillance, algorithmic zoning, and spatial data justice | Section 3, Section 4 | HIGH |
| P4 | C4 | Rapidly evolving state planning schemes and climate adaptation policies demand structured CPD planning | Section 2, Section 4 | HIGH |
| P5 | W1 | High demand for planners capable of defending statutory decisions before external industry panels and VCAT | Section 1, Section 4 | HIGH |
| P6 | W3 | Municipal employers seek graduates with authentic workplace planning experience in local councils | Section 1, Section 2 | HIGH |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C1 | Require students in ABPL90064/ABPL90131 to submit an assessed Human-AI Spatial Workflow & Tool Allocation Charter | C1 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022) |
| P2 | C2 | Implement an assessed AI Parametric Zoning & Yield Override Log in ABPL90130/ABPL90132 | C2 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P3 | C3 | Introduce AI capabilities and their limits into core ABPL90135/ABPL90134 and assess a Spatial AI Ethics & Digital Twin Governance critique there | C3 Level 3 (from level 1) | High | Term 2 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P4 | C4 | Embed an assessed planning capability gap analysis and PIA CPD plan in ABPL90396/ABPL90397 | C4 Level 3 | Low | Term 2 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2) |
| P5 | W1 | Partner with local council / PIA industry panels to assess student strategic plans and mock VCAT permit hearings in ABPL90130/ABPL90131 | W1 Level 3 | Medium | Term 2 | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29) |
| P6 | W3 | Introduce a required 50-hour live client planning practicum or municipal industry-partnered studio in the core | W3 Level 2 | High | Term 3 | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | PASS condition is met: accredited by the Planning Institute of Australia (PIA) as a 200-point professional graduate qualification. Comprehensive foundation spanning planning theory and history, planning law and statutory planning, urban economics, strategic plan making, climate change and sustainability, urban coding and design, participatory planning, analytical methods, and the 25-point minor thesis. | Any redesign must preserve PIA accreditation requirements, core coverage of statutory planning law, and the compulsory capstone minor thesis research structure. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | PASS condition is met: assessment explicitly requires high-stakes decision-making under severe socio-political uncertainty, conflicting community stakeholder values, climate resilience imperatives, and ambiguous development proposals — including statutory permit assessments in ABPL90130, strategic plan formulations in ABPL90131, and public consultation negotiation in ABPL90315. | Assessments must preserve authentic planning ambiguity, contested community dynamics, and discretionary statutory judgements rather than automated checklist scoring. | [16] |
...
| P3 | C3 | 1 | 3 | +2 adaptive | 14 / 15 | 5 / 9 |
| P4 | C4 | 2 | 3 | +1 adaptive | 15 / 15 | 5 / 9 |
| P5 | W1 | 2 | 3 | +1 workplace | 15 / 15 | 6 / 9 |
| P6 | W3 | 0 | 2 | +2 workplace | 15 / 15 | 8 / 9 |
