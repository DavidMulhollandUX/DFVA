...
const content = {
  title: "Bachelor of Oral Health (841AC) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Bachelor of Oral Health (841AC)
...
**Course Director:** Roisin McGrath (Principal Coordinator)
...
> **This program is outside the v3.1 registry, but not outside Panel A.** Bachelor of Oral Health
...
| C3 Digital & AI literacy, including governance [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) | 1 | The extract contains no occurrence of AI, artificial intelligence or generative tools anywhere — not in a course outcome, a subject description or an assessment. Level 0's anchor ('no digital/AI content in any core unit or program-level outcome') is nevertheless not quite met, because digital content is present at exactly the operational level level 1 describes: information-technology and academic-database skills, educational technology and aids, multimedia, communication systems and clinical photography, all stated as tool skills. Level 2 requires core units to address AI capabilities AND limitations/ethics with use-with-limits assessed; nothing of the kind is documented, so level 3's governance/critique requirement is unreachable. Scored at the tool-operation level, 1. |
| C4 Life-long learning & transfer [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) | 3 | Level 3's anchor — 'the program documents structured progression toward independent learning: a self-scoped capstone or research project' — is met by ORAL30001, a year-long final-year core subject in which the research area is the student's own choice and the deliverable is an individual proposal. R2 is satisfied by assessment evidence, not outcome statements: the progression is itself assessed and staged (Literature review 25% → Presentation - Proposed research methods 15% → Research proposal 30%), with a supervisor supporting each student's individual proposal. This sits above level 1 (transfer merely claimed in outcomes such as 'the skills to acquire, synthesize and adapt knowledge to a variety of situations') and above level 2. Per v4.1 the work-integrated-learning route to level 3 is not used here — that evidence scores in W3. |
...
The market intelligence gathered for this program indicates acute workforce shortages across Victorian public dental health services (Dental Health Services Victoria, Victorian Aboriginal Health Service), regional dental clinics, and private multidisciplinary dental practices, accompanied by the rapid adoption of digital intraoral scanners and AI-assisted radiographic caries detection where clinical operative dexterity, live patient diagnosis, and empathetic communication remain non-delegable human responsibilities under Australian Dental Council (ADC) and Dental Board of Australia (DBA) standards.
...
| --- | --- | --- | --- | --- |
| C3 Digital & AI literacy, including governance | 1/3 | Introduce an assessed module in core oral health practice on AI radiographic diagnostics, CAD/CAM scanning boundaries, and clinical patient data ethics; introduce an assessed dental AI governance audit. | Software tool licensing and syllabus updates. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 1/3 | Expand ORAL30001 to require students to collect primary oral health promotion data or community clinical survey data, assessed; require all candidates to defend empirical inquiry in an oral viva. | Clinical survey coordination and academic supervision. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C1 Distributed cognition & relational capability | 2/3 | In clinical simulation pairs, require students to submit an assessed protocol defining role allocation across the operator, assistant, and automated chairside charting/diagnostic tools. | Clinical lab moderation time. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2/3 | Require candidates to maintain an assessed clinical decision log in their year-long portfolio documenting and justifying decisions to override automated caries detection flags or computerized charting. | Portfolio rubric design and calibration. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| W1 Professional communication & conduct | 2/3 | Mandate that the final-year viva voce and community health promotion presentations are judged by external registered dental practitioners with assessed professional conduct rubrics. | External practitioner honoraria and scheduling. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2/3 | Introduce an authentic emergency dental triage simulation with externally supplied, time-constrained clinical data and immediate treatment handover under DBA standards; establish an authentic task spine. | Clinical simulation design and coordination. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
