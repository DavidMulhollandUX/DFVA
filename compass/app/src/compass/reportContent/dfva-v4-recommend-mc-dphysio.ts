...
const content = {
  title: "Doctor of Physiotherapy (MC-DPHYSIO) — Improvement Plan (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 IMPROVEMENT PLAN: Doctor of Physiotherapy (MC-DPHYSIO)
...
**Assessment date:** 2026-08-14 · **Derived from:** the verified panelCv4 scoring + reports/dfva-market-mc-dphysio.md
**Position basis:** Destination AI Exposure 45.02 (exact basis) × Curriculum Adaptiveness 9/15 (v4.2 draft, sub-scale A) · Workplace practice 9/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
Operating in a low AI exposure domain (**45.02**, far below the portfolio median of 90.9), the program achieves an exceptional result across Workplace Practice, scoring a perfect **9 / 9** with maximum scores across all three workplace dimensions: **W1: 3 / 3** (progressive multi-station OSCEs, continuous placement assessment, and assessed professional conduct grading forms), **W2: 3 / 3** (four-stage OSCE spine, logic-model health promotion proposals, and community project reports), and **W3: 3 / 3** (hundreds of hours of continuous clinical placements across acute, rehabilitation, and community settings with supervisor accountability and ePortfolios). Adaptiveness sits at **9 / 15**, where C3 is level 1 because AI appears only as basic tool usage without assessed clinical AI governance, while C1, C2, C4, and C5 sit at level 2 with headroom for formal human-AI coordination protocols and viva defences.

| Item | Sub-scale | Score | Levels below maximum | Market evidence for the gap | Priority |
|---|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | Adaptive | 1 / 3 | 2 | Direct — Market §2 Signal 3 and §3 Theme 1 emphasize that private clinics and hospitals are deploying ambient clinical AI scribes (Heidi Health) and wearable motion sensors; physiotherapists must audit algorithmic outputs against tactile clinical findings. | 1 |
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Direct — Modern rehabilitation coordinates care across physiotherapists, allied health assistants, and automated motion-tracking tools; human-tool work division is not yet formally assessed. | 2 |
| C2 Hybrid metacognition & evaluative judgement | Adaptive | 2 / 3 | 1 | Direct — Critical appraisal essays assess evidence validity, but ePortfolios lack explicit reliance and override logs over ambient AI scribe suggestions. | 3 |
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Direct — Placement requires supervisor learning-needs discussions, but an assessed CPD plan closing identified knowledge gaps is not yet documented. | 4 |
| C5 Inquiry & evidence generation | Adaptive | 2 / 3 | 1 | Direct — Qualitative interviews and community needs analyses are assessed, but the Research Capstone lacks an examined viva defending research methodology. | 5 |
...
|---|---|---|---|---|
| C3 Digital & AI literacy, including governance | 1 → 2 | "Core units address AI capabilities AND limitations/ethics; use with limits discussed and assessed." | Introduce an assessed module in core clinical practice analyzing ambient AI scribes, wearable biomechanical sensors, and AHPRA data privacy standards. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C3 Digital & AI literacy, including governance | 2 → 3 | "Core assessment requires critique or governance of AI systems in the discipline's own context — bias, accountability, transparency, regulation or data governance — beyond tool operation." | Introduce an assessed clinical AI governance audit: students evaluate algorithmic bias, diagnostic hallucination risks, and legal liability under Physiotherapy Board of Australia regulations. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C1 Distributed cognition & relational capability | 2 → 3 | "Assessed collaborative practice recurs across the program AND at least one assessment requires coordinating work across people AND tools/AI systems — e.g. a team capstone with documented role and tool allocation, or a task where the division of work between people and systems is itself assessed." | In Health Care in Context or Advanced Practice, require student teams to document a protocol allocating rehabilitation tasks between clinicians, allied health assistants, and AI exercise monitoring tools. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2 → 3 | "Assessment requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator; defend judgements of AI-output quality; or evidence strategy adjustment over time (process-focused assessment)." | In clinical placement ePortfolios, require an assessed clinical reliance log where students justify overriding automated ambient scribe notes or digital sensor movement classifications. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C4 Life-long learning & transfer | 2 → 3 | "The program documents structured progression toward independent learning: a self-scoped capstone or research project, or assessed identification of one's own knowledge gaps together with the plan to close them." | Expand the supervisor learning-needs discussion into an assessed professional development plan mapping specific clinical knowledge gaps and actions to close them. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 2 → 3 | "A substantial project generating primary evidence is REQUIRED (not one route among several), with methodology defended under scrutiny (viva, defence, or staged supervised review)." | Require an examined oral viva defence of clinical research methodology and primary data analysis before a panel of senior clinical researchers for the Research Capstone. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |

## 3. MARKET ALIGNMENT — Basis: reported → inferred

| Lever | Item | Market evidence | Location in market report | Confidence |
|---|---|---|---|---|
| P1 | C3 | Allied health clinics and hospitals are adopting ambient AI scribes (Heidi Health); physiotherapists must audit clinical notes for diagnostic accuracy. | §2 Signal 3; §3 Theme 1 | HIGH (APA practice notes) |
| P2 | C2 | Physiotherapists carry statutory legal liability under AHPRA; overriding flawed digital sensor readings or automated notes requires defended justification. | §2 Signal 4; §3 Theme 1 | HIGH (APC practice thresholds) |
| P3 | C1 | Rehabilitation care teams coordinate work across senior clinicians, assistants, and digital movement sensors. | §1 Job Family 5; §3 Theme 2 | HIGH (hospital multidisciplinary guidelines) |
| P4 | C5 | Clinical leadership requires defending primary clinical research and community health data under rigorous peer review. | §1 Job Family 1; §3 Theme 3 | HIGH (APC research standards) |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C3 | Add an assessed module on ambient AI scribes and wearable biomechanical sensors | C3 level 2 (capabilities and limits discussed/assessed) | Low | Year 1 Term 2; syllabus update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P2 | C2 | Require an assessed clinical reliance log in placement ePortfolios | C2 level 3 (reliance decisions documented) | Low | Year 2 Term 1; ePortfolio brief update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| P3 | C4 | Extend learning needs declaration to include an assessed gap-closure plan | C4 level 3 (knowledge gaps + plan to close them) | Low | Year 2 Term 2; placement task update | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| P4 | C5 | Require an examined oral viva defence for the Research Capstone | C5 level 3 (primary evidence defended under scrutiny) | Low–Medium | Year 3 Term 2; capstone rubric update | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | An all-compulsory specialist core in an externally accredited sequence: 300 credit points must be completed, accredited by the Australian Physiotherapy Council leading to AHPRA registration, structured in staged foundational sciences, condition streams, and placements. | Redesign must preserve the APC-accredited 300-point core sequence and condition streams to maintain registration eligibility. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
| G2 Decision-making under uncertainty | PASS | Assessment requires defended trade-off decisions in live patient settings with real uncertainty: selection and justification of physiotherapy interventions on placement, differential assessment in complex scenarios, hurdle OSCEs under time limits, and continuous clinical assessment. | Assessment must maintain live patient clinical encounters and timed multi-station OSCEs under acute clinical uncertainty. | [16] |
...
|---|---|---|---|---|---|---|
| P1 | C3 | 1 | 2 | +1 adaptive | 10 / 15 | 9 / 9 |
| P2 | C2 | 2 | 3 | +1 adaptive | 11 / 15 | 9 / 9 |
| P3 | C4 | 2 | 3 | +1 adaptive | 12 / 15 | 9 / 9 |
| P4 | C5 | 2 | 3 | +1 adaptive | 13 / 15 | 9 / 9 |
