...
const content = {
  title: "Doctor of Philosophy - Engineering and IT (DR-PHILEIT) — Research Degree Report",
  institution: "University of Melbourne",
  markdown: `# DFVA RESEARCH DEGREE REPORT: Doctor of Philosophy - Engineering and IT (DR-PHILEIT)
...
Carried from [the v1 assessment](dfva-dr-phileit.md) as narrative. The v1 composite, its
...
Market intelligence for this program is in [the market report](dfva-market-dr-phileit.md). **Its §3 discussion-signal section is unsourced** — it predates the sourcing
