...
const content = {
  title: "Master of Business Analytics (MC-BUSANA) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Business Analytics (MC-BUSANA)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/mc-busana (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 33 pages captured
**Course Director:** Simon Holcombe
...
The market intelligence gathered for this program indicates strong commercial demand across major retail banks (CBA, ANZ, NAB, Westpac), management consulting firms, tech enterprises, and retail logistics leaders, alongside widespread automation of routine exploratory scripting and data cleaning through LLMs and automated analytics engines.

### Destination Job Families

| Job family | Entry titles | AI substitution pressure | Skills rising in that family |
| --- | --- | --- | --- |
| Commercial Business Intelligence & Analytics | BI Analyst, Commercial Analytics Specialist; later Senior Business Analytics Lead, Head of Commercial BI | HIGH | Automated BI dashboard audit, causal impact inference, executive narrative framing |
| Machine Learning & Predictive Analytics | Applied ML Analyst, Predictive Modeller; later Lead ML Engineer, Data Science Delivery Manager | HIGH | LLM pipeline orchestration, feature store governance, MLOps model monitoring |
...
| Operations Research, Supply Chain & Risk | Supply Chain Analytics Specialist, Risk Analyst; later Supply Chain Optimization Director, Enterprise Risk Lead | MEDIUM | Mathematical integer programming (Gurobi), dynamic pricing auditing, simulation |
| Enterprise AI Governance & Model Risk Auditing | AI Assurance Analyst, Model Risk Consultant; later Head of Responsible AI, Model Risk Director (Banking/APRA) | LOW–MEDIUM | Algorithmic bias mitigation, CPS 234/230 prudential compliance, AI transparency verification |
...
and the score deltas are in the [improvement plan](dfva-v4-recommend-mc-busana.md); rows
below are ordered by headroom, which is not the plan's P-lever order.

| Item | Score | Implication | Cost | Sources |
| --- | --- | --- | --- | --- |
| C2 Hybrid metacognition & evaluative judgement | 1/3 | Introduce criterion-referenced peer review of draft analytical models in Machine Learning & AI for Business, and attach an assessed AI reliance and override log to the industry project where students defend overriding automated code or hyperparameters. | Teaching-team time to moderate peer critiques and review student AI reliance justifications against econometric principles. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C3 Digital & AI literacy, including governance | 1/3 | Add an assessed module in core ML/AI coursework evaluating AI system limits, privacy ethics, and APRA CPS 234/230 prudential compliance; introduce an assessed enterprise AI governance audit. | Case material development for APRA and statutory AI compliance. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C4 Life-long learning & transfer | 1/3 | In Predictive Analytics or Statistical Learning, introduce an assessed hackathon-style task analyzing an unseen, ambiguous enterprise dataset; require an assessed CPD plan in Professional Development II. | Designing unseen enterprise problem scenarios and structured CPD rubrics. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C5 Inquiry & evidence generation | 1/3 | In Causal Analytics, require student teams to design and conduct a primary empirical data collection inquiry (e.g. live A/B trial or web experiment) alongside methodology selection, with an examined oral viva defence. | Experimental trial infrastructure and viva examiner panel scheduling. | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C1 Distributed cognition & relational capability | 2/3 | In the industry project, require student teams to document a protocol allocating tasks between analysts, data engineers, and AI coding tools. | Designing human-and-AI collaboration rubrics. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2/3 | In the final industry presentation, formalize external client executives as official marking panellists with assessed professional conduct criteria. | External industry panellist coordination and rubric calibration. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2/3 | Establish an authentic analytics deliverable spine across all study periods, reducing written examination weights. | Reframing assessment briefs to produce industry-grade deployment packages. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| W3 Work-situated learning | 2/3 | Extend the required industry placement from 5 weeks to an extended 10–12 week immersion with structured reflection and host assessment. | Securing expanded industry host commitments and placement quality assurance. | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[35]](https://doi.org/10.1080/03075070903216635)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
...
**Panel C provenance.** Scored from the 2026 handbook capture (33 pages) and verified on 2026-08-14: adversarial refutation of every level-3 score and every gate PASS (run), verbatim evidence check (run), and the construct-boundary pass.
