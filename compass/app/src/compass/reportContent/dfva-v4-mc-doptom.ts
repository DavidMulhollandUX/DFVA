...
const content = {
  title: "Doctor of Optometry (MC-DOPTOM) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Doctor of Optometry (MC-DOPTOM)
...
- **G1 Disciplinary foundation:** PASS — The gate's PASS condition names 'an all-compulsory specialist core, an accredited sequence, or a staged prerequisite chain' — this program satisfies all three. Every one of the 400 credit points is compulsory, the sequence moves from basic vision sciences and pre-clinical training in year 1, to applied clinical sciences and research in year 2, to clinical practice in year 3, to advanced practice in year 4, and the whole is externally accredited for registration. No generic or interchangeable content appears anywhere in the structure.
- **G2 Decision-making under uncertainty:** PASS — The gate passes on the 'simulations/capstones/live projects with real uncertainty and accountability' limb and on defended trade-off decisions. Assessed clinical performance and case reports require students to develop AND justify a management plan by weighing research evidence, clinical expertise, the individual patient and the practice context — a defended trade-off under diagnostic uncertainty, with real patients supplying the accountability. Year-1 assessment already requires proposing evidence-based management strategies from interpreted findings, and the year-2 capstone adds a live research project. This is not recall or scripted response, though written examinations still carry 80% of the marks in years 2 and 3.

## 4. MARKET EVIDENCE — Basis: reported

The market intelligence gathered for this program indicates robust demand across primary optometry practices (Specsavers, OPSM, Bailey Nelson), public hospitals (Royal Victorian Eye and Ear Hospital), and specialized low-vision and contact lens clinics, alongside rapid adoption of autonomous AI retinal screening tools (LumineticsCore, ARDA) and deep-learning OCT algorithms where clinician oversight, therapeutic prescribing, and physical biomicroscopy remain non-delegable clinical duties under Optometry Board of Australia registration standards.
...
| --- | --- | --- | --- | --- |
| C3 Digital & AI literacy, including governance | 0/3 | Introduce an assessed module in Year 3 Clinical Optometry on autonomous retinal screening AI (diabetic retinopathy and macular degeneration), OCT algorithms, system limits, and clinician legal liability; introduce an assessed clinical AI governance audit. | Software licensing for ophthalmic AI simulation suites and syllabus development. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C1 Distributed cognition & relational capability | 2/3 | In the Year 3 clinical training subject, require student clinical pairs to document a protocol allocating diagnostic tasks between optometrist, optical dispenser, and automated refraction/OCT screening systems. | Faculty moderation time during clinical simulation workshops. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| C2 Hybrid metacognition & evaluative judgement | 2/3 | In the Year 4 Optometry Internship portfolio, require students to document and justify clinician override decisions when evaluating AI-flagged retinal pathology or automated OCT segmentation errors. | Rubric development for clinical AI verification and override logs. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C4 Life-long learning & transfer | 2/3 | In the Year 2 capstone research project, require students to independently frame and self-scope their own clinical research questions and experimental protocols under faculty mentorship. | Faculty supervision calibration for student-scoped inquiry projects. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[9]](https://www.nationalacademies.org/read/13398/chapter/2)[[10]](https://doi.org/10.1007/s10459-025-10413-y)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
