...
**Position basis:** Destination AI Exposure 94.80 (exact basis) × Curriculum Adaptiveness 11/15 (v4.2 draft, sub-scale A) · Workplace practice 5/9 (sub-scale W, reported beside the axis, not in it) — no v1 composite
...
The Master of Global Media Communication prepares graduates for high-exposure strategic communications, media management, and digital policy roles (AIOE 94.80). The program demonstrates outstanding adaptive capability in AI literacy and data governance (C3: 3/3), driven by assessed policy briefs and platform regulation critique in MECM90002. However, routine media drafting and basic content synthesis face pervasive automation across the media sector. The program's developmental headroom centers on establishing mandatory work-situated placements (W3), formalizing human-AI collaborative workflows (C1), introducing evaluative override logs for generative AI text production (C2), guaranteeing self-scoped transfer (C4), and integrating external industry panels for public affairs defense (W1, W2).
...
| C1 Distributed cognition & relational capability | Adaptive | 2 / 3 | 1 | Contemporary media operations require structured task division between human editors and AI content generation/analytics tools | 2 |
...
| C4 Life-long learning & transfer | Adaptive | 2 / 3 | 1 | Continuous shifts in synthetic media technologies and platform distribution algorithms demand self-directed skill acquisition | 4 |
| C5 Inquiry & evidence generation | Adaptive | 2 / 3 | 1 | Academic and professional media research requires rigorous primary empirical inquiry with oral defense under scrutiny | 5 |
| W1 Professional communication & conduct | Workplace | 2 / 3 | 1 | Public affairs directors and crisis spokespersons require oral presentation skills judged against real-world media scrutiny | 6 |
| W2 Authentic task design | Workplace | 2 / 3 | 1 | Live crisis reporting and PR campaigns carry unscripted breaking news constraints and external stakeholder accountability | 7 |
| C3 Digital & AI literacy, including governance | Adaptive | 3 / 3 | 0 | Meets maximum anchor through compulsory assessed algorithmic governance and platform regulation in MECM90002 | 8 |
...
|---|---|---|---|---|
| P1 | W3 | Employers in corporate communications and public affairs prioritize candidates with demonstrated workplace and newsroom experience | Section 2, Section 4 | HIGH |
| P2 | W3 | Supervised internships accelerate transition into senior communications management and media advisory positions | Section 2, Section 4 | HIGH |
| P3 | C1 | Industry standards (MEAA / PRIA 2024) mandate structured collaborative workflows dividing tasks between human communicators and generative AI tools | Section 1, Section 3 | HIGH |
| P4 | C2 | Peer-reviewed research (*Media, Culture & Society* Jan 2025) demonstrates evaluative judgement is critical to detect and override synthetic media hallucinations | Section 3, Section 4 | HIGH |
...
| P6 | C5 | Graduate recruiters in communications research and media intelligence demand empirical inquiry capability with oral defense | Section 2, Section 4 | HIGH |
| P7 | W1 | Public affairs employers demand executive-level presentation skills evaluated against professional broadcast and media standards | Section 2, Section 4 | HIGH |
| P8 | W2 | Authentic crisis communication tasks with breaking news constraints reflect the live operating realities of modern media rooms | Section 2, Section 4 | HIGH |

## 4. PRIORITISED INTERVENTIONS — Basis: inferred

| # | Item | Action | Anchor satisfied | Effort | Sequence | Sources |
|---|---|---|---|---|---|---|
| P1 | C1 | Add an assessed Human-AI Collaborative Workflow Charter to video production in MECM90031 | C1 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022) |
| P2 | C2 | Implement an assessed AI Drafting and Narrative Override Log in MECM90017 Media Writing | C2 Level 3 | Low | Term 1 | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
...
| P4 | W1 | Mandate external industry media executives to evaluate crisis press conferences in JOUR90027 or policy briefs in MECM90002 | W1 Level 3 | Medium | Term 2 | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined) |
| P5 | W2 | Partner with media and public affairs agencies to supply live breaking news scenarios with real-time constraints | W2 Level 3 | Medium | Term 2 | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[24]](https://doi.org/10.1080/02602938.2024.2404634) |
| P6 | C5 | Implement a mandatory oral viva defense for the 5000-word empirical capstone project in MECM90043 | C5 Level 3 | Medium | Term 3 | [14][15][[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| P7 | W3 | Formalize a required credit-bearing media communications practicum or client-facing advocacy project into the core curriculum | W3 Level 2 | High | Term 3 | [[19]](https://www.legislation.gov.au/F2021L00488)[27][[29]](https://doi.org/10.1080/07294360.2016.1139551)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |
| P8 | W3 | Establish an extended 200-hour supervised media industry internship (MULT90019) as a mandatory degree requirement | W3 Level 3 | High | Term 3 | [[19]](https://www.legislation.gov.au/F2021L00488)[[28]](https://doi.org/10.1007/s10734-017-0216-z)[[30]](https://www.education.gov.au/australian-universities-accord/resources/final-report) |

## 5. GATE GUARDRAILS — Basis: scored

| Gate | Status | Evidence carrying the gate | Constraint on redesign | Sources |
|---|---|---|---|---|
| G1 Disciplinary foundation | PASS | PASS condition is met: the program documents a comprehensive 200-point graduate curriculum including compulsory foundation units in media theory and research methodology (MECM90039, MECM90038), followed by a 75-point core sequence in data policy, digital culture, media writing, and audiovisual production. Coherent, rigorous disciplinary media and communications sequence. | Any curriculum redesign must preserve the core theoretical foundations in political economy, media effects, and communication research methodology. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[6]](https://doi.org/10.1093/qje/qjaa021) |
...
|---|---|---|---|---|---|---|
| P1 | C1 | 2 | 3 | +1 adaptive | 12 / 15 | 5 / 9 |
| P2 | C2 | 2 | 3 | +1 adaptive | 13 / 15 | 5 / 9 |
| P3 | C4 | 2 | 3 | +1 adaptive | 14 / 15 | 5 / 9 |
| P4 | W1 | 2 | 3 | +1 workplace | 14 / 15 | 6 / 9 |
| P5 | W2 | 2 | 3 | +1 workplace | 14 / 15 | 7 / 9 |
| P6 | C5 | 2 | 3 | +1 adaptive | 15 / 15 | 7 / 9 |
| P7 | W3 | 1 | 2 | +1 workplace | 15 / 15 | 8 / 9 |
