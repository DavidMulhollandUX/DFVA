...
const content = {
  title: "Master of Psychology (Clinical Neuropsychology) (527CN) — Durability Report (v4 draft)",
  institution: "University of Melbourne",
  markdown: `# DFVA v4 DURABILITY REPORT: Master of Psychology (Clinical Neuropsychology) (527CN)
...
**Handbook vintage:** 2026 · **Source URL(s):** https://handbook.unimelb.edu.au/2026/courses/527cn (course, attributes, structure) plus the overview and assessment pages of the compulsory subjects — 35 pages captured
**Course Director:** Jacqueline Anderson
...
> **This program is outside the v3.1 registry, but not outside Panel A.** Master of Psychology (Clinical Neuropsychology)
...
- **G1 Disciplinary foundation:** PASS — The gate's PASS condition is met on two of its three named routes: an all-compulsory specialist core ('All subjects are compulsory.') and an accredited sequence (APAC accreditation supplying the required sequence of subjects for registration, recognised by AHPRA). Depth is progressive and disciplinary rather than generic: first year builds foundations (Neuroanatomy for Neuropsychologists, Principles of Psychological Assessment, Adult Neuropsychological Disorders, Clinical Skills in Neuropsychology) alongside a 43-day placement, and second year moves to specialised and lifespan content (Developmental Neuropsychology, Neuropsychological Rehabilitation, Child Psychopathology), two 48-day external field placements and the thesis. Nothing here is interchangeable across disciplines.
- **G2 Decision-making under uncertainty:** PASS — The gate's PASS condition — assessments requiring defended trade-off decisions, or live projects with real uncertainty and accountability — is met on both limbs. Core assessment requires students to choose and justify a course of action under clinical uncertainty: intervention plans developed from a case formulation, judgements about when brief interventions suffice and when more complex ones are appropriate, monitoring of outcomes and modification of interventions on an evolving formulation, and a report resolving an ethical dilemma. Separately, the placement subjects are live practice with real patients and accountability to field supervisors, explicitly designed to develop the capacity to confront and manage unfamiliar problems. This is not recall or scripted response, although two subjects (Adult Psychopathology, Neuroanatomy) are examined largely by quiz and examination.

## 4. MARKET EVIDENCE — Basis: reported

The market intelligence gathered for this program indicates strong and growing demand across public healthcare networks (Royal Melbourne Hospital, Alfred Health, Austin Health), paediatric tertiary hospitals, and specialist neurorehabilitation clinics, accompanied by the gradual integration of digital cognitive testing platforms where complex differential diagnosis, qualitative behavioural observation, and performance validity evaluation remain non-delegable human clinical responsibilities under Australian Psychology Accreditation Council (APAC) and Psychology Board of Australia (PsyBA) standards.

### Destination Job Families

| Job family | Entry titles | AI substitution pressure | Skills rising in that family |
| --- | --- | --- | --- |
| Hospital & Acute Clinical Neuropsychology | Clinical Neuropsychology Registrar, Hospital Neuropsychologist; later Senior Clinical Neuropsychologist, Head of Neuropsychology Unit | LOW | AI cognitive screener validation, stroke/TBI diagnostic formulation, acute rehab |
| Paediatric & Developmental Neuropsychology | Paediatric Neuropsychology Registrar; later Senior Specialist (Paediatric Neurology), Private Practice Director | LOW | Neurodevelopmental assessment, ADHD/ASD differential diagnosis, school plans |
| Forensic & Medico-Legal Neuropsychology | Medico-Legal Neuropsychologist, Expert Witness Associate; later Senior Forensic Neuropsychologist, Court-Appointed Expert | LOW | Performance validity testing (PVT), capacity assessment, forensic cross-examination |
| Neurorehabilitation & Cognitive Disability | Rehabilitation Neuropsychologist, NDIS Assessor; later Clinical Director (Neurotrauma Rehab), Specialist Consultant | LOW | Cognitive remediation, behavioural management plans, assistive tech integration |

**Exposure basis declaration.** Destination AI exposure is **44.92** (exact basis derived from Clinical Neuropsychology / Psychology destinations), sitting substantially **below** the portfolio median of 90.9.
...
and the score deltas are in the [improvement plan](dfva-v4-recommend-527cn.md); rows
below are ordered by headroom, which is not the plan's P-lever order.

| Item | Score | Implication | Cost | Sources |
| --- | --- | --- | --- | --- |
| C3 Digital & AI literacy, including governance | 0/3 | Introduce an assessed module in core psychological assessment on digital cognitive testing, algorithmic scoring boundaries, psychometric norming assumptions, and clinical AI privacy constraints; introduce an assessed AI governance audit. | Software tool licensing and syllabus updates. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[13][[11]](https://doi.org/10.1145/3313831.3376727)[[12]](https://unesdoc.unesco.org/ark:/48223/pf0000391105)[[2]](https://www.acses.edu.au/publication/australian-framework-for-artificial-intelligence-in-higher-education/) |
| C2 Hybrid metacognition & evaluative judgement | 1/3 | Introduce a structured peer critique task in PSYC90030 where students evaluate peer diagnostic formulation reports against formal APAC psychometric quality criteria; require candidates to maintain an assessed clinical decision log documenting overrides of computerized psychometric test scoring. | Peer review rubric design and calibration. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[4]](https://doi.org/10.1007/s10734-017-0220-3)[[3]](https://www.teqsa.gov.au/sites/default/files/2023-09/assessment-reform-age-artificial-intelligence-discussion-paper.pdf) |
| C1 Distributed cognition & relational capability | 2/3 | In simulated memory clinic multidisciplinary meetings, require student teams to submit an assessed protocol defining role allocation across neuropsychologists, neurologists, and computerized psychometric batteries. | Clinical seminar moderation time. | [[1]](https://www.teqsa.gov.au/guides-resources/resources/corporate-publications/assuring-quality-learning-gen-ai-integrated-future-role-adaptive-capabilities)[[5]](https://doi.org/10.1093/qje/qjx022)[[7]](https://doi.org/10.1016/j.techfore.2016.08.019) |
| W1 Professional communication & conduct | 2/3 | Mandate that oral case conference presentations and diagnostic handover briefs are evaluated by external consultant clinical neuropsychologists with assessed conduct rubrics. | External practitioner honoraria and scheduling. | [[19]](https://www.legislation.gov.au/F2021L00488)[[20]](https://www.qilt.edu.au/surveys/employer-satisfaction-survey-%28ess%29)[[21]](https://www.dewr.gov.au/skills-information-training-providers/resources/core-skills-work-developmental-framework)[[31]](https://www.naceweb.org/career-readiness/competencies/career-readiness-defined)[[5]](https://doi.org/10.1093/qje/qjx022)[[32]](https://doi.org/10.1086/504455) |
| W2 Authentic task design | 2/3 | Introduce an authentic acute neurotrauma assessment simulation with externally supplied, time-constrained diagnostic data and immediate multi-disciplinary handover under CCN standards. | Clinical simulation design and coordination. | [[22]](https://doi.org/10.1007/BF02504676)[[23]](https://doi.org/10.1080/02602938.2017.1412396)[[25]](https://doi.org/10.1016/j.stueduc.2021.101030)[26][[24]](https://doi.org/10.1080/02602938.2024.2404634) |
