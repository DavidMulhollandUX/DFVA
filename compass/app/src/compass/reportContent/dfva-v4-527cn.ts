...
|---|---|---|---|---|---|
| 1 | Hospital & Acute Clinical Neuropsychology | Clinical Neuropsychology Registrar, Hospital Neuropsychologist | Senior Clinical Neuropsychologist, Head of Neuropsychology Unit | LOW | AI cognitive screener validation, stroke/TBI diagnostic formulation, acute rehab |
| 2 | Paediatric & Developmental Neuropsychology | Paediatric Neuropsychology Registrar | Senior Specialist (Paediatric Neurology), Private Practice Director | LOW | Neurodevelopmental assessment, ADHD/ASD differential diagnosis, school plans |
| 3 | Forensic & Medico-Legal Neuropsychology | Medico-Legal Neuropsychologist, Expert Witness Associate | Senior Forensic Neuropsychologist, Court-Appointed Expert | LOW | Performance validity testing (PVT), capacity assessment, forensic cross-examination |
| 4 | Neurorehabilitation & Cognitive Disability | Rehabilitation Neuropsychologist, NDIS Assessor | Clinical Director (Neurotrauma Rehab), Specialist Consultant | LOW | Cognitive remediation, behavioural management plans, assistive tech integration |
