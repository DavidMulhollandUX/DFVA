...
const MC_CS: V2ReportDetail = {
  ...
  v1Comparison: [
    { dimension: "D1 Automation Exposure", v1Score: 2, disposition: "→ Panel A (measured)", rationale: "Labour-market claim; moved from scoring to measurement" },
    { dimension: "D2 Systems Thinking", v1Score: 2, disposition: "→ Panel C (scored)", rationale: "Retained; evidence from handbook curriculum" },
    { dimension: "D3 Technical Depth", v1Score: 3, disposition: "→ Panel C (scored)", rationale: "Retained; strong technical core" },
    { dimension: "D4 Decision-making", v1Score: 3, disposition: "→ Gate (binary)", rationale: ">70% of programs use same level; gate, not measure" },
    { dimension: "D5 AI Literacy", v1Score: 3, disposition: "→ Panel C (scored)", rationale: "Retained with guardrail anchors; rare 3/3 in v1" },
    { dimension: "D6 Domain Depth", v1Score: 3, disposition: "→ Gate (binary)", rationale: ">83% modal; gate, not measure" },
    { dimension: "D7 Research Methods", v1Score: 3, disposition: "→ Panel C (scored)", rationale: "Retained; thesis/research project evidence" },
    { dimension: "D8 Human/Relational", v1Score: 2, disposition: "→ Panel A (measured)", rationale: "Property of destination, not curriculum" },
    { dimension: "D9 Curriculum Currency", v1Score: 2, disposition: "→ Dropped", rationale: "Item-total correlation 0.06; unscorable from handbook" },
    { dimension: "D10 Outcome Evidence", v1Score: 3, disposition: "→ Panel D (metadata)", rationale: "Measured publishing practice, not quality — moved to evidence confidence" },
    { dimension: "B Irreplaceability", v1Score: 3, disposition: "→ Panel C (scored)", rationale: "Retained; highest v1 dimension coherence (r=0.65)" },
  ],
