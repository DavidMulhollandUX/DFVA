...
export const V4_PANEL_C: Record<string, V4PanelC> = {
  ...
  "mc-prop": {
    ...
    "C1": {
      ...
      "evidenceLines": [
        "Assignment 1: One group presentation, (equivalent to 500 words per student)",
        "Assignment 3: group assignment",
        "Group Case Study Project 1, totalling 1500 words per student",
    ...
    "C2": {
      "score": 2,
      "rationale": "Level 2 anchor — core assessment includes structured critique of the quality of work — is met by the Mock Court Room Presentation in Statutory Valuation (PG), a core subject, where the student must act as cross examiner of a compensation valuation and satisfactorily complete it as a hurdle; cross-examination of a valuation is a structured critique of work quality, not merely producing work. Level 3 fails: nothing in the extract requires students to document and justify reliance decisions — when they relied on or overrode a tool, source or collaborator — to defend judgements of AI-output quality, or to evidence strategy adjustment over time. 'Evaluate, reflect and report critically on the research work carried out' is a learning outcome, and R2 bars scoring outcomes.",
      "evidenceLines": [
        ...
        "Evaluate, reflect and report critically on the research work carried out."
      ]
    },
    "C3": {
      "score": 1,
      "rationale": "Level 1 anchor — digital tools appear as tool operation/training, the level TEQSA identifies as non-durable — is exactly what the extract documents: ARGUS applied to the development process, SPSS/RStudio as prescribed software, spreadsheet financial modelling, and generic-skill statements about computer and information technologies and word-processing/graphics packages. Level 0 is excluded because digital content is plainly present in core units. Level 2 fails: no core unit in the extract addresses AI capabilities AND limitations or ethics, and no gen-AI content appears anywhere; level 3's requirement for assessed critique or governance of AI systems (bias, accountability, transparency, regulation, data governance) has no counterpart in the text.",
      "evidenceLines": [
    ...
    "C4": {
      "score": 3,
      "rationale": "Level 3 anchor — the program documents structured progression toward independent learning via a self-scoped research project — is satisfied with assessment evidence, not an outcome claim (R2): the core subject Property Research and Analysis assesses, at 70%, a scholarly report on a topic defined by the student in consultation with the coordinator, and that work is the documented prerequisite input to the required research subject in the following stage. The progression is structural (90363 feeds 90362) rather than asserted. Level 2 is also independently met — Property Investment and Finance assesses four separate case analyses requiring decisions in unfamiliar investment contexts — but the self-scoped, staged route lifts the item above it. Scored on transfer and self-directed learning only; the work-integrated route that formerly sat here is scored in W3.",
      "evidenceLines": [
        "A scholarly report containing research problem definition, development proposal and literature review on a topic defined by the student in consultation with the subject coordinator, and establishing the basis for the empirical work that will be carried out in ABPL90362 Research Thesis - Property",
    ...
    "C5": {
      "score": 2,
      "rationale": "Level 2 anchor — students design and conduct an inquiry with methodology selection and data collection, assessed — is met in the core: Property Research and Analysis carries a discrete assessed data-collection and analysis task plus a 4000-word scholarly report defining the research problem, and a research subject is compulsory (one of the two selectives must be taken). Level 3 is not awarded because its first clause requires a substantial project GENERATING PRIMARY EVIDENCE, and the handbook explicitly leaves the data secondary-permissible ('primary or secondary') in both the outcome and the assessment line; the extract nowhere requires primary evidence. The level-3 scrutiny clause is arguably met (hurdle research development presentation, supervisor seminars), but the conjunction fails, and the ambiguity is resolved downward per the scoring direction.",
      "evidenceLines": [
        "Data collection (primary or secondary) and analysis assignment",
        "Be able to plan and collect primary and secondary data for analysis of specific research problem;",
        "Apply contemporary research methods in a property research project.",
        "Note: Students should take and complete only one of the above two research subjects in their entire study time in the course.",
    ...
    "W1": {
      "score": 2,
      "rationale": "Level 2 anchor — at least one core assessment requires a recognised professional genre judged against criteria drawn from professional practice — is met squarely: Statutory Valuation (PG) assesses a full professional standard compensation valuation report, a statutory-valuation genre with the profession's own standard named as the criterion, and Property Securitisation assesses an individual oral business case. Level 3 fails on both of its clauses. No core assessment in the extract is delivered to, or judged by, a real external audience or practitioner — the moot court is a simulation, and the host-organisation presentation belongs to the work-situated selective and is scored in W3. Nor is professional conduct or accountability documented among the assessed criteria, and no progressive sequencing of communication assessment is documented across stages.",
      "evidenceLines": [
    ...
    "W2": {
      "score": 2,
      "rationale": "Level 2 anchor — at least one core assessment reproduces a professional task end to end, producing the artefact a practitioner would produce — is met several times over: a multiple-regression mass valuation of 6,000 properties submitted as an Excel worksheet and Word report, staged case analyses producing investment and financing decisions, and a securitisation portfolio paper. Level 3 is withheld because its first clause requires such tasks to be the assessment spine, tested as a capstone plus earlier scaffolding or at least one per stage, and that cannot be established from this extract: several core subjects remain examination- or essay-dominated (Land and Property Economics is a multiple-choice test plus two essays; Advanced Property Analysis, Property Development, Property Law and International Real Estate Economics each carry a 50–60% examination), and none of the 300-point Year 1 core subject pages are present, so the first stage is unverifiable. Per R4, no score was taken from the course overview's 'real-world projects' framing — only from documented task features.",
      "evidenceLines": [
        "Assignment 1 - Multiple Regression Analysis estimating the value of 6,000 properties. Excel worksheet & Word report required to be submitted",
    ...
    "W3": {
      "score": 1,
      "rationale": "Level 1 anchor — work-situated learning exists only as an elective or optional internship — is what the structure documents. Industry Based Research - Property does place students with a host organisation under a designated host supervisor and is assessed, but it sits in the selective block as one of two alternatives, the other being a desk-based research thesis, and it is quota-limited; the course overview itself hedges that professional experience 'can be' part of the program. Level 2 requires A CORE UNIT to place students in a real workplace, which is not the case here, so the evidence is ambiguous between 1 and 2 and resolves downward. Level 3 fails additionally on extent: participation is capped at no more than 12 days, which is neither extended nor a sequence.",
      "evidenceLines": [
        ...
        "Selective subjects (12.5 points)",
        "Note: Students should take and complete only one of the above two research subjects in their entire study time in the course.",
        "(Quotas apply)",
        "A work-plan developed in consultation with the host organisation and the Subject Coordinator",
    ...
    "gates": {
      "G1": {
        "result": "PASS",
        "rationale": "The program documents a coherent specialist core with progressive depth on all three of the gate's alternative routes. The core is large and compulsory (225 of 300 points, or 125 of 200), and the core list is almost entirely discipline-specific property subjects (valuation, property law, development, securitisation, property economics). It is staged, with Year 1 core separated from Year 2 and 3 core in the 300-point entry, and it carries a prerequisite chain from Property Research and Analysis into the research subject. It is also an accredited sequence, recognised by two property-profession bodies. Nothing here reads as generic or interchangeable content.",
        "evidenceLines": [
          "225 points of core subjects",
          "100 credit points of Year 1 core subjects",
          "125 credit points of Year 2 and 3 core subjects",
      ...
      "G2": {
        "result": "PASS",
        "rationale": "Core assessment requires defended trade-off decisions under genuine uncertainty rather than recall or scripted response. Property Investment and Finance assesses four successive case analyses each framed as a decision — portfolio repositioning, portfolio construction, an investment decision on a proposed development, and a choice among financing options — and Property Development assesses development appraisal against viability, risk and return, with the outcome expressed as evaluating the viability of proposals. The program's own outcome statement frames property projects as evaluated in terms of risk allocations and viability, and the assessed cases operationalise that. This clears the v1 D4 >= 2 equivalent.",
        "evidenceLines": [
          "Assignment 1: Analysis of a case requiring decision related to repositioning of an investment portfolio",
    ...
    "ambiguities": [
      "C2 straddled 1 and 2. The Mock Court Room cross-examination is documented assessment in a core unit and is a hurdle, but the handbook does not state the criteria it is judged against, so 'criterion-referenced' is inferred from the moot-court form rather than quoted. Scored 2 on the anchor's own exemplar 'structured critique'; a reviewer who requires explicit criteria would score 1.",
      "C4 and C5 both draw on the ABPL90363/ABPL90362 research sequence. Under one-construct-one-home, the self-scoped topic and the documented progression toward autonomous work score in C4 (transfer and self-directed learning); the data collection, methods and supervised review score in C5 (inquiry and evidence generation). No line is used in both items.",
      "C5 straddled 2 and 3. A substantial research project is compulsory (one of two selectives must be taken, and both are research subjects) and it carries staged supervised review, which satisfies the level-3 scrutiny clause. But the level-3 primary-evidence clause is contradicted by the handbook's own wording, 'primary or secondary'. The scoring direction resolved this to 2.",
      "W2 straddled 2 and 3. Professional-artefact tasks recur across at least four core subjects, and 'full professional standard' supplies the profession's own standard of performance that level 3's second clause wants. The first clause failed: the assessment spine cannot be demonstrated when several core subjects are examination- or essay-dominated and the 300-point Year 1 stage is missing from the extract. Resolved downward to 2.",
      "W3 straddled 1 and 2. The Industry Based Research subject has every feature of a level-2 placement except the one the anchor makes decisive — it is not a core unit. It is a quota-limited selective alternative to a desk-based thesis. Resolved downward to 1.",
      "W1 level 3 would have been reachable if the host-organisation oral presentation in Industry Based Research counted as delivery to an external practitioner audience. It was excluded from W1 under one-construct-one-home, since placement evidence scores in W3, and it is in any case not core."
    ],
    "notScoreable": [
      "The 300-point entry's Year 1 core subjects (ABPL90290, ABPL90274, ABPL90275, ACCT90041, ABPL90130, ABPL90029, FNCE90060, ECON90015) appear in the course structure but none of their subject or assessment pages are in the extract. The first stage of the 300-point program is therefore unscored, which specifically bounds W2's 'at least one per stage' test and any claim of progressive sequencing in W1. All items were scored on the core shared by both entry points.",
      "Advanced Property Analysis (ABPL90011, core) lists 'Assignment one' and 'Assignment two' with word counts only and no task description, so its two 25% assessments could not be characterised for C1, C2, W1 or W2.",
      "No gen-AI content of any kind appears in the extract — no core unit, elective or program-level outcome mentions artificial intelligence — so C3's levels 2 and 3 had no evidence to weigh rather than evidence that failed."
    ],
    "verified": {
      "adversarial": true,
      "mechanical": true,
  ...
  "mc-sciche": {
    ...
    "C2": {
      "score": 1,
      "rationale": "Anchor 1 is met exactly: 'Reflection or self-assessment appears in outcomes or graduate attributes, but no core unit assesses it against criteria.' Reflection is stated at course level in an intended learning outcome, in the generic skill of self-awareness and in a graduate attribute. Level 2 requires core assessment containing criterion-referenced appraisal of quality; the extract's assessment tables give only undescribed genres ('Written assignment', 'Examination', 'oral presentation of a literature article') with no criteria, no peer review, no exemplars and no portfolio standards, and the subjects carrying literature-appraisal outcomes are options from a menu rather than required units. Level 3 would additionally require documented reliance decisions or defended judgements of tool/AI output quality, which appear nowhere. R2 binds: appraisal of literature is claimed in outcomes, not shown to be assessed against criteria.",
      "evidenceLines": [
        "Reflect an extended understanding of about the process and practice of chemical research;",
        "Self-awareness: The ability to be aware of oneself and reflect on one's actions",
        "Have the ability to demonstrate advanced independent critical enquiry, analysis and reflection;",
        "Investigate peer-reviewed literature to determine the strengths, limitations, and relevance.",
    ...
    "C3": {
      "score": 1,
      "rationale": "Anchor 1 is met: 'AI or digital tools appear only as electives or as tool operation/training — the operational level TEQSA identifies as non-durable.' The only AI-titled subject in the whole structure sits in the optional Professional Skills lists and is marked not available in 2026; computing, programming and data subjects are likewise selections from those option lists; and where digital content reaches discipline subjects it is tool operation (applying software packages to data, using bioinformatic tools). Level 0 is contradicted because digital content demonstrably appears. Level 2 is not reached: no unit is documented as addressing AI capabilities AND limitations/ethics with use-with-limits assessed, and no program-level outcome mentions digital or AI capability at all. Level 3 (assessed critique or governance of AI systems in the discipline's context) has no evidence.",
      "evidenceLines": [
        ...
        "Students will apply current software packages to real data to determine the structures of chemical complexes and proteins.",
        "Explain the various sequencing techniques and bioinformatic tools to analyse and interpret genomic data."
      ]
    },
    "C4": {
      "score": 3,
      "rationale": "Anchor 3 is met on its own terms: 'The program documents structured progression toward independent learning: a self-scoped capstone or research project.' The research project is required of every student (125 of 200 credit points), is scoped by the student ('in a field of choice'), runs over four consecutive semesters, and the handbook documents the progression as staged and gated. The R2 assessment requirement is satisfied by quotable assessment facts rather than an outcome statement: progression through the four parts is contingent on successful completion of the earlier component (a hurdle), and the project is submitted for the formal examination period. This exceeds level 2's single novel-problem assessment because the progression toward independent learning is structural and compulsory, not a one-off task.",
      "evidenceLines": [
    ...
    "C5": {
      "score": 2,
      "rationale": "Anchor 2 is met: 'Students design and conduct an inquiry with methodology selection and data collection, assessed' — a 125-credit-point research project is required of all students, planned and executed independently, and submitted for the formal examination period. Level 3 additionally demands that methodology be 'defended under scrutiny (viva, defence, or staged supervised review)'. The extract contains no subject page or assessment table for any of the Chemistry Research Project subjects, so no viva, defence or methodology-scrutiny task can be quoted; the only candidate is the progression clause, which documents completion gating rather than a defence of method. Per the scoring-direction rule the straddle resolves DOWN to 2, with the ambiguity recorded.",
      "evidenceLines": [
        "Students enrolled in the Master of Science (Chemistry) program are required to complete a 125 credit points Research Project.",
    ...
    "W1": {
      "score": 1,
      "rationale": "Anchor 1 is met precisely: communication appears in the course generic skills and graduate attributes, and core-adjacent assessment 'adds presentation to peers/staff, but no professional genre and no audience beyond the teaching team'. The documented spoken tasks are an oral presentation of a literature article and a class presentation based upon a written report — academic genres delivered inside the teaching setting. Level 0 is contradicted because spoken communication is assessed. Level 2 is not reached: no assessment in the extract requires a recognised professional genre (client brief, consultancy or policy advice, handover, pitch, public artefact) or an audience beyond the teaching team, and none is judged against criteria drawn from professional practice. The Communication Skills subjects are options whose pages are absent, so nothing further is quotable. Per Barrie and R2, the stated attributes on writing, communication and ethics of scholarship cannot lift the score.",
      "evidenceLines": [
        "Communication: The ability to communicate effectively in writing and orally",
    ...
    "W2": {
      "score": 1,
      "rationale": "Anchor 1 is met: 'Contextualised or scenario-framed tasks appear (case studies, worked scenarios), but the artefact produced and the criteria applied remain academic.' Case-study framing is documented in several subject overviews and one subject frames its outcome around defensible risk assessment for public health and regulation, yet the artefacts every assessment table actually names are written assignments of 1000–1500 words, written reports, class presentations and 1.5-hour examinations, with no criteria drawn from practice recorded anywhere. Level 0 is contradicted by that scenario framing. Level 2 would require at least one core assessment reproducing a professional task end to end with practice-derived criteria; per R4 the case-study and 'real data' framing cannot be read up into that without documented task features. The required research project is the strongest candidate, but the extract carries no subject page, task description or criteria for it, so its fidelity is unevidenced — the straddle resolves DOWN.",
      "evidenceLines": [
        "Case studies will be used to highlight the discovery and development of important drug classes.",
    ...
    "W3": {
      "score": 1,
      "rationale": "Anchor 1 is met: 'Work-situated learning exists only as an elective, an optional internship'. The single work-situated offering in the entire structure is an internship subject listed among roughly twenty options in the Science Skills professional-skills list, from which students choose 12.5–25 credit points; no student is required to take it. Level 0 is contradicted because the internship does appear in the course structure. Level 2 requires a CORE unit placing students in a real workplace with practitioner supervision and assessment — the internship is selectable, not core, and its subject page and assessment table are absent from the extract, so neither supervision nor assessment can be quoted. Level 3 (extended required placement with host accountability and structured reflection) has no evidence. The required research project is laboratory-based university study, not participation in a real workplace or external professional community, so it does not score here.",
      "evidenceLines": [
        "Students must select 12.5 to 25 credit points of subjects from the following Professional Skills subject lists.",
    ...
    "gates": {
      "G1": {
        "result": "PASS",
        "rationale": "The gate's PASS condition — 'a coherent specialist core with progressive technical or methodological depth… or a staged prerequisite chain' — is documented twice over. A compulsory 125-credit-point Chemistry research project forms a staged chain of four (or five) parts in which progression is conditional on successful completion of the earlier component, and on top of that every student must take 37.5–62.5 credit points from a closed list of advanced CHEM-coded discipline subjects. The content is unmistakably disciplinary rather than generic or interchangeable.",
        "evidenceLines": [
          "Students enrolled in the Master of Science (Chemistry) program are required to complete a 125 credit points Research Project.",
      ...
      "G2": {
        "result": "PASS",
        "rationale": "The gate passes on the capstone route: a compulsory, self-scoped, four-semester research project that the student must plan and execute independently and submit for formal examination carries genuine methodological uncertainty and personal accountability for the result — this is not recall or scripted response. Discipline coursework reinforces it with outcomes requiring plausible syntheses to be proposed and defensible risk assessments to be produced from evidence. Noted against the PASS: the project's own assessment page is absent from the extract, so the gate rests on the course-structure requirement and the course-level outcome rather than a task description.",
        "evidenceLines": [
          "Apply individual investigative skills and critical thought to plan and execute an independent piece of research",
          "The Master of Science gives students the opportunity to undertake a substantive research project in a field of choice as well as a broad range of coursework subjects including a professional skills component, as a pathway to PhD study or to the workforce.",
          "The Research Project will be due for submission by the end of the formal examination period of the fourth semester (or fifth for part-time) of enrolment if an earlier date is not specified.",
    ...
    "ambiguities": [
      "C5 straddled 2 and 3. The required substantial primary-evidence project satisfies the first half of anchor 3, and the clause 'Students may only progress through Chemistry Sciences Research Project subjects upon successful completion of the earlier project component' read against supervisor negotiation could be argued as 'staged supervised review'. But no viva, defence or methodology-scrutiny task is quotable — the Chemistry Research Project subject pages are absent from the extract — so the scoring-direction rule (never resolve ambiguity upward) fixed it at 2.",
      "C2 straddled 1 and 2. 'oral presentation of a literature article' plus the outcome 'Investigate peer-reviewed literature to determine the strengths, limitations, and relevance' could read as structured critique. Resolved to 1 because no criteria, exemplars or peer-review process are documented, the assessment entries carrying those outcomes are undescribed written assignments, and the subjects concerned are menu selections rather than required units (R2).",
      "C1 considered for level 1 on the graduate attribute 'Be able to initiate and implement constructive change in their communities, including professions and workplaces.' Rejected: the line names communities and workplaces, not collaboration, teamwork or stakeholder work, and level 1 requires collaboration to appear in outcomes. Scored 0.",
      "C3 considered for level 0 (strictly, no required unit and no program-level outcome carries digital or AI content). Not taken, because anchor 1 literally describes the observed state — digital and AI content present only as option-list selections and as tool operation — and levels 0 and 1 describe different facts rather than different intensities of the same fact.",
      "W2 straddled 1 and 2 on the research project: a 125-credit-point bench project arguably reproduces the criterion situation of a research chemist end to end. Resolved to 1 under R4, which forbids scoring up from an unevidenced label or inference — the extract documents no task description, artefact or criteria for any research project subject.",
      "C4 and C5 both draw on the same required research project. Scored in the item whose construct names the feature: structured progression toward independent, self-scoped learning is C4's level-3 anchor; the generation of primary evidence and its methodological defence is C5's. The project's staged-progression clause is cited in both because it evidences progression in C4 and was weighed and rejected as methodology defence in C5.",
      "W3 vs C1/C4: the internship was scored only in W3 per the one-construct-one-home rule, and contributed nothing to C1 or C4."
    ],
    "notScoreable": [
      "No subject page or assessment table for ANY Chemistry Research Project subject (CHEM90023–CHEM90038, CHEM90056–CHEM90063) is present in the extract, although the project is the only compulsory component and 125 of the program's 200 credit points. This bounded C5 at 2 (no quotable methodology defence), W2 at 1 (no quotable task design or criteria) and left G2 resting on course-structure and outcome statements rather than an assessment task.",
      "No subject page for SCIE90017 Science and Technology Internship, so its supervision, assessment and duration could not be examined; W3 was scored solely from its position as one selectable option in the Science Skills list.",
      "No subject pages for the Communication Skills subjects (SCIE90012 Science Communication, SCIE90013 Communication for Research Scientists) or the other professional-skills options, so no professional-genre or external-audience assessment could be checked for W1.",
      "No subject page for LAWS90203 Science & AI: Legal & Ethical Challenges (in any case marked not available in 2026) or CHEM90055 Chemical Regulations and Safety, so no AI-governance or regulatory assessment evidence was available to C3.",
      "CHEM90068 Theoretical Chemistry is listed in the discipline-subject table but its subject and assessment pages are absent from the extract.",
      "The program has no individually compulsory coursework subject — discipline, professional-skills and elective subjects are all chosen from menus — so 'core unit' in the C1–C3, W1 and W2 anchors could only be applied to the required research project, whose pages are missing. Every coursework-derived score is therefore based on the modal assessment pattern documented across the discipline subjects supplied."
    ],
    "verified": {
      "adversarial": true,
      "mechanical": true,
  ...
  "mc-sciear": {
    ...
    "C1": {
      ...
      "evidenceLines": [
        ...
        "Presentation in a group of 4 (description of one key outcrop)",
        "Note: The assignments should be solved in teams of two to three students.",
        "Debate in teams when analysing and interpreting geophysical data.",
        "work in a small team"
      ]
    },
    "C2": {
      "score": 1,
      "rationale": "Matches the level-1 anchor exactly: reflection and critical enquiry appear in the course graduate attributes, but no core unit documents assessment of appraisal against criteria. Level 2 requires core assessment to include criterion-referenced appraisal of quality — peer review, structured critique, portfolio with standards or marking against exemplars — and none is documented: the appraisal-shaped statements (criticising active research, assessing climate models, critically analysing literature, judging the limitations of statistical approaches) are all intended learning outcomes, while the corresponding assessment entries are undifferentiated ('Essay', 'Oral Exam', 'Written Assignment', 'Report 1/2') with no appraisal criteria stated. R2 therefore caps this at 1. No assessment anywhere requires documenting or justifying reliance decisions on a tool, source or collaborator, so level 3 is not in reach.",
      "evidenceLines": [
        "Have the ability to demonstrate advanced independent critical enquiry, analysis and reflection;",
        ...
        "Apply statistical techniques to the analysis of extremes, with an understanding of the strengths and limitations of different approaches;"
      ]
    },
    "C3": {
      "score": 1,
      "rationale": "Matches the level-1 anchor 'AI or digital tools appear only as electives or as tool operation/training'. Core computational content is real but operational — MATLAB computation in assignments, Python for building a simple climate model, programming skills listed as a generic skill. The only AI-specific content in the extract, LAWS90203 'Science & AI: Legal & Ethical Challenges', sits in the Professional Skills selection menu (12.5–25 points chosen from twelve options) and is marked not available, so it is an elective, not core. Level 2 requires core units to address AI capabilities AND limitations/ethics with use-with-limits assessed; the documented limitation content concerns numerical climate and data-assimilation models, not AI systems, so the anchor is not satisfied and the ambiguity resolves downward.",
      "evidenceLines": [
        "Science & AI: Legal & Ethical Challenges",
        "Students must take 12.5 to 25 points of the following subjects:",
        "Note: The assignments should be solved in teams of two to three students.",
        "Existing knowledge in python programming is recommended but can be acquired throughout the course.",
        "Developing computer programming skills transferable to other applications;",
        "It covers aspects of uncertainty and chaos to understand why climate models are imperfect but invaluable tools."
      ]
    },
    "C4": {
      "score": 3,
      "rationale": "Satisfies the level-3 anchor 'the program documents structured progression toward independent learning: a self-scoped capstone or research project'. The 125-point Research Project is required of every student, is scoped by the student ('main field of interest' / 'a field of choice'), begins in the first semester and runs continuously, and is staged Pt1–Pt5 with a documented progression gate. R2 is met by assessment evidence rather than outcome statement: a 25,000-word thesis at 85% and semesterly hurdle reviews. The course-level transfer claims ('problem-solving approach to new and unfamiliar tasks', 'aptitude for continued self-directed learning') are outcome statements only and are not what carries the score.",
      "evidenceLines": [
        "Students enrolled in this program are required to complete a 125 point Research Project.",
        "Students will gain research experience in Earth Sciences by completing an original research project in their main field of interest.",
        "Students must commence the Research Project in their first semester of study and the project will continue until the 125 points are achieved.",
        ...
        "a concise thesis of no more than 25,000 words (85%) due at the completion of 125 points",
    ...
    "C5": {
      "score": 3,
      "rationale": "Satisfies the level-3 anchor on both limbs. The substantial primary-evidence project is REQUIRED rather than one route among several — 125 of the 200 points, an original research project whose thesis is expected to show 'scientific interpretation of results' and be of publishable quality. Methodology is defended under scrutiny by the anchor's own 'staged supervised review' route: research project reviews at the end of each semester are a hurdle, alongside two assessed oral presentations bracketing the project. This is assessment evidence, not an outcome claim, as R2 requires.",
      "evidenceLines": [
        "Students enrolled in this program are required to complete a 125 point Research Project.",
        "the final thesis is expected to be a far more rigorous scientific document, showing an appropriate level of insight and scientific interpretation of results, and be of publishable quality.",
    ...
    "W1": {
      "score": 1,
      "rationale": "Matches the level-1 anchor: communication appears in the graduate attributes, and core assessment adds presentation to peers and staff — ten-minute oral presentations in several core-menu subjects and two assessed presentations inside the Research Project — but no core assessment documents a recognised professional genre judged against criteria drawn from practice, and no audience beyond the teaching team. The ATOC90002 negotiation session is the borderline case, but it is an in-class simulation with no documented external audience and no professional-conduct or accountability criteria, so it does not reach level 2. Publication is 'encouraged', not assessed. Dedicated communication subjects sit in the elective Professional Skills menu. Per the one-construct-one-home rule, the geological reports and maps are scored as artefact fidelity in W2, not here.",
      "evidenceLines": [
        "Reach a high level of achievement in writing, research or project activities, problem-solving and communication;",
        "Individual presentations (10 min) in class on proposed study",
        "a project-related oral presentation within two months of the completion of 125 points, i.e. the conclusion of the project (7%);",
        "Participation in a negotiation session and submitted written assessment",
    ...
    "W2": {
      "score": 2,
      "rationale": "Meets the level-2 anchor 'at least one core assessment reproduces a professional task end to end': GEOL90027 has students map a real, structurally complex field area and submit the practitioner's own artefacts — a structural map and a cross-section; ERTH90033 requires a processed-and-interpreted geophysical report; GEOL90005 requires field sampling and a field report off a hurdle-attended one-week excursion. Scored on documented task features, not on any 'real-world' label (R4). Held at 2 rather than 3: level 3 needs such tasks to be the assessment spine, and the field-based practitioner tasks all sit in stream-specific selection menus rather than being required of every student, while the Atmospheric-stream core assessments documented here are predominantly written assignments, essays and closed exams. The ambiguity (the required 125-point project as a spine of publishable-standard work) is resolved downward per the scoring-direction rule.",
      "evidenceLines": [
        "Report (structural map of Pt. Dickinson)",
        "Demonstrate and apply 3D geological skills by producing a structural cross-section.",
        "Report with interpretation of geophysical images produced by the students including lithologies, structures and overprinting relationship.",
        "Field report",
        "Demonstrate sampling of water bores and water analysis in the field;",
    ...
    "W3": {
      "score": 1,
      "rationale": "Matches the level-1 anchor 'work-situated learning exists only as an elective, an optional internship': the sole workplace-participation subject in the whole structure, SCIE90017 Science and Technology Internship, is one of twelve options in the Professional Skills menu from which students choose 12.5–25 points, and it is also reachable as a discipline elective. Level 2 would require a core unit that places students in a real workplace or professional-community setting with practitioner supervision and assessment; no such core unit is documented. Field excursions and the VIEPS cross-institution teaching arrangement are university teaching activities, not workplace placement — and per the construct note, simulation and fieldwork score in W2, not here.",
      "evidenceLines": [
        "Science and Technology Internship",
        "Students must take 12.5 to 25 points of the following subjects:",
        "Students must choose a further 12.5 points from level 9 Earth Sciences subjects, Professional Skills subjects or 300-level Science subjects."
      ]
    },
    "workplace": 4,
    "gates": {
      "G1": {
        "result": "PASS",
        "rationale": "The program documents a coherent specialist core with progressive methodological depth: 50 points of stream-specific level-9 Earth Sciences core (with 25 of those points required to correspond to the thesis topic, tying coursework to the research specialisation) plus a 125-point Research Project sequenced Pt1–Pt5 with an explicit staged progression gate. This is a disciplinary identity with a staged chain, not generic or interchangeable content.",
        "evidenceLines": [
      ...
      "G2": {
        "result": "PASS",
        "rationale": "Assessment goes well beyond recall or scripted response. ATOC90002 assesses participation in a negotiation simulation in which students defend a national position under competing policy options, against outcomes explicitly about uncertainty in decision-making; and the required 125-point original research project is a capstone with genuine uncertainty and accountability, gated by semesterly hurdle reviews and a thesis judged at publishable standard.",
        "evidenceLines": [
          "Participation in a negotiation session and submitted written assessment",
    ...
    "ambiguities": [
      "C1 straddled 2 and 3: ATOC90010's team assignments are solved in teams of two to three AND 'involve computations with MATLAB', which reads as coordinating work across people and a tool. Resolved down because the division of work between people and systems is not itself assessed and no role/tool allocation is documented — the level-3 anchor requires that, not merely tool use inside a team task.",
      "C2 straddled 1 and 2: several core-menu subjects carry appraisal-shaped outcomes (criticising active research, assessing climate models and their uncertainty, judging the strengths and limitations of statistical approaches). Resolved down under R2 — every one is an intended learning outcome and none of the matching assessment entries documents criterion-referenced appraisal.",
      "C3 straddled 1 and 2: ERTH90026 documents that climate models are 'imperfect but invaluable tools' and ATOC90015 outcomes concern the limitations of assimilation schemes, which resembles 'capabilities AND limitations'. Resolved down because the level-2 anchor names AI, the systems in question are numerical physical models rather than AI systems, and the only AI-governance subject is an unavailable elective.",
      "C4 and C5 both draw on the same 125-point Research Project, which the one-construct-one-home rule flags. Kept in both because each anchor names that route independently and the facets are disjoint: C4 scores self-scoping plus the staged Pt1–Pt5 progression gate toward independent learning; C5 scores the required generation of original primary evidence and the semesterly hurdle reviews as staged supervised methodological scrutiny.",
      "W1 straddled 1 and 2: the ATOC90002 UNFCCC negotiation role-play is a professional/diplomatic genre in the discipline's policy-facing criterion situation. Resolved down — the audience is the class, no external audience or practitioner judge is documented, and no professional-conduct or accountability criterion appears among the assessed criteria (R4 bars scoring the framing rather than the documented features).",
      "W2 straddled 2 and 3: the required 125-point project runs from first semester to completion at 'publishable quality', which is arguably a spine carrying the profession's own standard of performance. Resolved down because the practitioner-artefact tasks (structural map, geophysical interpretation report, field report) all sit in selection menus rather than being required of every student, so a documented spine cannot be established for the program as a whole.",
      "Structural caveat affecting every item: apart from the Research Project, this program has no compulsory named subject — both stream cores and the Professional Skills component are selection menus ('Students must take 50 points of the following', 'Students must take 12.5 to 25 points of the following subjects'). Menu-listed subjects were treated as core units for the anchors that say 'at least one core unit', but not as evidence of program-wide recurrence for any level-3 anchor.",
  ...
  "mc-surged": {
    ...
    "C1": {
      "score": 1,
      "rationale": "Level 1 anchor: collaboration/teamwork appears in the graduate attributes and in the generic-skills lists of the compulsory core subjects, but no compulsory core unit documents an assessment of collaborative practice. Level 2 requires a core unit to assess collaborative practice (group project with individual accountability, client/stakeholder work, interprofessional activity). The only assessed stakeholder work in the program is the capstone needs assessment (MEDS90033), which the handbook places under the 'Coursework option', not under the 'Core Subjects' heading, and which Research-pathway students never take; per the downward-resolution rule this pathway-conditional subject does not lift the item to 2. The MEDS90006 hurdle requires posting to a discussion board and sharing philosophies with other students, which is peer interaction rather than assessed collaborative practice with individual accountability. Level 3 additionally requires an assessment coordinating work across people AND tools/AI systems; no gen-AI, tool-allocation or human-plus-system division-of-work evidence appears anywhere in the extract.",
      "evidenceLines": [
        ...
        "The aim of the assignment is to complete an online introduction on the Learning Management System (LMS), contribute to the discussion board and to reflect on their own and share educational philosophies with other students."
      ]
    },
    "C2": {
      "score": 2,
      "rationale": "Level 2 anchor is met in compulsory core assessment: MEDS90007's reflection essay (35%) requires appraisal of the quality of the student's own implemented teaching plan against an evidence-based rationale; MEDS90009's hurdle requires critique of an existing curriculum against the subject's theoretical materials; MEDS90011's essay requires critique of a research method against 'best practice'. This is criterion-referenced appraisal of quality, not merely reflection claimed in outcomes (which would be level 1). Level 3 is not taken: no assessment requires students to document and justify reliance decisions on a tool, source or collaborator, and there is no AI-output-quality evidence anywhere in the extract. The MEDS90007 plan-then-reflect pair is the closest candidate for the 'evidence strategy adjustment over time (process-focused assessment)' route, but the adjustment is documented once retrospectively in a single essay rather than tracked across iterations, so the ambiguity between 2 and 3 is resolved downward.",
      "evidenceLines": [
        ...
        "Reflective writing. Students are expected to reflect on an existing curriculum highlighting strengths and areas for development by drawing on the theoretical materials presented in the subject",
        "Essay. The aim of this assessment is to provide students to reflect on a research method for educational research. Students will be expected to draw on 'methodology' research to identify best practice.",
        "Constructively critique educational practices"
      ]
    },
    "C3": {
      "score": 1,
      "rationale": "Level 1 anchor: digital content appears at program-outcome level and, inside the core, only as tool operation. MEDS90006 requires students to use media for managing course materials and its hurdle is LMS operation (navigate, edit profile, upload a photograph) — precisely the operational level the anchor caps at 1. Level 0 is excluded because digital content does appear as a program-level outcome ('Appraise educational technology including e-learning'). Level 2 requires core units to address AI capabilities AND limitations/ethics, used with limits discussed and assessed: the extract contains no reference to artificial intelligence or generative AI in any subject overview, learning outcome, generic-skills list or assessment description, so this anchor cannot be met. Level 3 (critique or governance of AI systems in the discipline's context) is likewise unevidenced. E-learning appears only as one selectable option among many educational methods in the MEDS90007 presentation task, which does not guarantee digital content is assessed for any given student.",
      "evidenceLines": [
    ...
    "C4": {
      "score": 3,
      "rationale": "Level 3 anchor: 'The program documents structured progression toward independent learning: a self-scoped capstone or research project'. Every student completes exactly such a project in the final year regardless of pathway — either the Minor Thesis, where the student develops and investigates their own research question and defines research questions based on their own practice, or the capstone, where the student designs a new curriculum for their own practice. Both are self-scoped by design and both are assessed by weighted, substantial written artefacts (thesis report; written presentation of curriculum), satisfying R2's requirement of assessment evidence rather than an outcome statement. Progression is documented structurally by the prerequisite chain requiring at least 75 points of coursework including Research Methods before the thesis may commence, and by the capstone's stated function of integrating learning from the earlier Graduate Certificate and Diploma content. This exceeds level 2 (a single core assessment applying methods to a novel problem) because the independence is program-structural, not task-local.",
      "evidenceLines": [
    ...
    "C5": {
      "score": 2,
      "rationale": "Level 2 anchor: students design and conduct an inquiry with methodology selection and data collection, assessed. The Minor Thesis documents exactly this — designing and implementing a research project, seeking human research ethics approval where appropriate, designing methodologies, analysing and reporting results, assessed by a thesis draft report and a thesis report. Level 3 is explicitly blocked by its own qualifying clause, 'a substantial project generating primary evidence is REQUIRED (not one route among several)': the handbook states the degree is completed via either the Research or the Coursework pathway, and Coursework-pathway students complete a curriculum-design capstone rather than a primary-evidence project. The universally compulsory methods subject stops short of level 2 on its own — its major assessment is a research proposal (methodology selection and a Gantt chart, but no data collection), and its hurdle is explicitly a simulated exercise rather than real data collection. Level 2 is therefore carried by the thesis route only, and level 3's 'required' test fails.",
      "evidenceLines": [
        ...
        "Research option",
        "Coursework option",
        "Traditional approaches to research projects will be followed including a critical review of relevant literature, writing researchable question/s, designing appropriate methodologies, analysing and reporting results, discussion including framing results in existing literature and drawing conclusion. Participants are also expected to demonstrate effective academic writing skills and present their project in an oral presentation.",
        "Thesis draft report including the introduction, research methods of the project",
    ...
    "W1": {
      "score": 1,
      "rationale": "Level 1 anchor matches precisely: communication appears in the program's intended learning outcomes, and core assessment adds presentation to peers and staff — an online tutorial webinar presentation in MEDS90006 (30%), a tutorial-group presentation in MEDS90007 (25%), an oral presentation in MEDS90008 (30%) — but every one of these is delivered to the tutorial group and teaching team. Level 2 requires a professional genre or an audience beyond the teaching team judged against criteria drawn from professional practice. No core assessment documents an audience beyond fellow students and markers, and the practitioner artefacts that might otherwise supply the professional-genre route (the session teaching plan, the program/curriculum design, the curriculum document) are scored in W2 under 'one construct, one home', since W2's construct names the form of the result. Level 3 is far out of reach: no core assessment is delivered to or judged by an external practitioner panel, client or public audience, and professional conduct or accountability is nowhere named among assessed criteria.",
      "evidenceLines": [
        "Demonstrate effective oral and written communication in a range of educational settings (as learner, peer, teacher, examiner)",
        "Online conference: Create a 10-minute presentation for an online tutorial (webinar) and answer 5 minutes of questions. Students upload their presentation to the LMS in advance of the online conference. The assessment enables judgement on verbal presentation skills while addressing core content in surgical education resources. Students are introduced to scholarly resources in medical and surgical education and share a component of this information with each other through online tutorial presentations.",
        "Oral presentation supported by written material The goal of this assessment is to provide students with an opportunity to study in depth and share with colleagues, a specific educational method (e.g. case-based learning, skills-base teaching, problem-based learning, portfolios, e-learning, peer assisted learning, etc) and it's application in surgical education; In each tutorial group, students will present a different educational method. 10 minutes talk and 5 minutes of questions and answers",
    ...
    "W2": {
      "score": 3,
      "rationale": "Level 3 requires both clauses and the handbook documents both from compulsory core evidence, scored on documented task features only (R4), not on any 'real world' label. Spine, not a single instance: MEDS90007 assesses a session teaching plan aligned with the student's current practice (40%); MEDS90009 explicitly escalates the same artefact from the micro session plan of Subject 2 to the program/curriculum level (50%); MEDS90011 assesses a research proposal with literature critique, theoretical framing, method selection and a scheduled Gantt chart (80%); and the final year is a capstone curriculum or minor thesis that the capstone description states integrates the earlier course content. That is at least one practitioner artefact per stage plus a capstone with earlier scaffolding. Genuine constraint of practice: the MEDS90007 plan is designed, delivered and reflected on in workplace-based activity, so the recipients are real surgical trainees and the task requires a measure of outcome for those recipients — a consequential audience and the profession's own standard of performance; the capstone additionally supplies an externally scoped problem (a stakeholder needs assessment establishing conditions and scope) and real resource limits (faculty requirements, settings, equipment and other resources). Level 2 is exceeded because the artefacts are not one instance, and the tasks are not merely scenario-framed academic work (level 1) — they produce the artefacts a surgical educator produces, judged against instructional-design criteria.",
      "evidenceLines": [
    ...
    "W3": {
      "score": 2,
      "rationale": "Scored on the v4.2 in-practice route. The cohort is documented as already practising: the course is 'designed to support surgeons in developing expertise in teaching' with online delivery for busy professionals undertaking studies in conjunction with clinical commitments, and core assessment is anchored in 'their current practice'. Core unit MEDS90007 meets the in-practice level-2 anchor: participants 'will be required to design, deliver and reflect on their own teaching' in workplace-based activities; the assessed teaching session must be aligned with their current practice and include a 'measure of outcome for students who are recipients of the teaching' — real recipients plus a documented outcome measure — and the implemented delivery is assessed via the 35% reflection essay on the teaching plan they implemented, satisfying R2's assessment-evidence requirement. Level 3 is not reached: it requires a required SEQUENCE of assessed own-practice activity with structured reflection and documented accountability to workplace stakeholders. Only MEDS90007 requires conducted own-practice activity of every student — MEDS90009's alignment with actual practice is merely 'encouraged' and is curriculum design (an artefact, homed in W2), and MEDS90033's stakeholder needs assessment exists only on the Coursework pathway, so it is not required of the cohort. Accountability to workplace stakeholders is gestured at by the recipient outcome measure but never documented as an assessed criterion. The own-practice activity therefore stands alone, and ambiguity resolves downward to 2. One-construct-one-home is respected: the MEDS90007→MEDS90009→MEDS90011 artefact spine stays homed in W2; W3 counts only the work-situated participation element. No placement, practicum or supervised external workplace component appears anywhere in the structure, so the placement route alone would not support level 2.",
      "evidenceLines": [
    ...
    "gates": {
      "G1": {
        "result": "PASS",
        "rationale": "The handbook documents a coherent specialist core with progressive methodological depth: four compulsory subjects plus a compulsory research-methods subject, all specific to surgical education, followed by a staged prerequisite chain requiring at least 75 points of coursework including Research Methods before the minor thesis may commence. Depth is progressive and explicitly cross-referenced — the curriculum-design assessment states it escalates the skills assessed in Subject 2 to the program level, and the capstone integrates learning from the earlier Graduate Certificate and Diploma stages. The content is not generic or interchangeable: it is anchored on the specific discipline of surgical education and its clinical settings.",
        "evidenceLines": [
          "Four compulsory subjects must be completed (total of 50 credit points)",
      ...
      "G2": {
        "result": "PASS",
        "rationale": "Assessments require defended trade-off decisions rather than recall or scripted responses. The capstone requires justification for curriculum decisions across learning outcomes, lesson plans, assessment and evaluation strategies and governance; MEDS90007's reflection requires an evidence-based rationale for the selection of objectives and methods and how they will be changed; MEDS90011 requires selection and defence of research methods within a theoretical framework and schedule; and MEDS90009's assessment essay is framed around genuinely consequential uncertainty, with the handbook stating that assessment in surgical practice carries high stakes for the trainee and for patients. The program-level outcome likewise names the exercise of professional judgment.",
        "evidenceLines": [
          ...
          "Essay reflection on session teaching plan The goal of this assessment is for students to reflect on the strengths and areas for development in the teaching plan they implemented. They will be expected to provide an evidence-based rationale for their selection of objectives and methods, to outline why elements of the session worked effectively and how they can achieve this in other sessions. Similarly, why elements of the session need development and how they will make those improvements.",
          "Research proposal. The aim of this assessment is to provide students with an opportunity to prepare a research proposal on a surgical educational project which will enable judgement of their ability to identify and articulate a research question relevant to surgical education, present a critique of current literature, locate their work in a theoretical framework, select appropriate methods for study, present a Gantt chart or similar representation of a research schedule.",
          "Essay. The aim of this assessment is to explore in detail an element of assessment in surgical education. This is a critical element of professional educational activity and will enable participants to develop a deep understanding of at least one facet of high stakes assessment. Assessment in the context of surgical practice has high stakes for not only the surgical trainee but for patients too. It is essential that surgical educators have a deep understanding of assessment methods for those seeking to work in a high risk environment such as surgery.",
          "Exercise appropriate professional judgment in the area of surgical education"
        ]
      }
    },
    "ambiguities": [
      "C1 (1 vs 2): the capstone MEDS90033 assesses genuine stakeholder work (a needs assessment of stakeholders, 'Written report on needs assessment', 20%), which would satisfy the level-2 anchor's 'client or stakeholder work' clause. It is not scored as level 2 because the handbook lists only four subjects under the heading 'Core Subjects' and places the capstone under the 'Coursework option', so Research-pathway students never take it. Resolved downward per the never-resolve-upward rule. If the pathway-required capstone were treated as core, C1 would be 2.",
      "C1 (1 vs 2, second route): the MEDS90006 hurdle requires contributing to a discussion board and sharing educational philosophies with other students, which is assessed peer interaction but not a group project with individual accountability, client work, or interprofessional activity. Treated as insufficient for level 2.",
      "C2 (2 vs 3): MEDS90007 assesses a teaching plan (40%) and then a reflection on that plan as implemented (35%), requiring students to state why elements need development and how they will make those improvements. This is arguably the level-3 route 'evidence strategy adjustment over time (process-focused assessment)'. Resolved downward because the adjustment is documented once, retrospectively, in a single essay rather than tracked across iterations, and because no reliance-decision or AI-output-appraisal element exists anywhere in the extract.",
      "W1 (1 vs 2) and the W1/W2 boundary: the session teaching plan, the program/curriculum design essay and the capstone curriculum document are plausibly 'recognised professional genres' for a surgical educator, which would satisfy W1 level 2. Per 'one construct, one home' they are scored in W2, whose construct names the form of the result and the fidelity of the task; W1 keeps audience and professional conduct, and no core assessment documents an audience beyond the tutorial group and teaching team. Note also that the handbook labels these design tasks 'Essay', an academic genre wrapper, which reinforces the downward resolution.",
      "W2 (2 vs 3): the strongest constraint-of-practice evidence (stakeholder-scoped conditions; faculty, settings, equipment and resource specification) sits in the pathway-conditional capstone. Level 3 is nevertheless taken because the clause is independently satisfied from compulsory core evidence — the MEDS90007 plan is delivered in workplace-based activity to real trainees and must include a measure of outcome for those recipients, and MEDS90011 requires a scheduled research proposal. The spine clause is also met from core alone (MEDS90007 to MEDS90009 to MEDS90011, plus a final-year capstone or thesis).",
      "W3 cohort-practising status: the 'Entry and participation requirements' page is not captured in the extract (navigation heading only). Practising status was established from the course overview ('designed to support surgeons', 'busy professionals undertaking studies in conjunction with clinical commitments') and assessment text ('aligned with their current practice', 'their own teaching'). Accepted as documented cohort evidence; had it been rejected, ambiguity-down on the placement route alone would have yielded 1.",
      "W3 double-home risk: the MEDS90007 teaching-plan and reflection essays belong to the assessment spine homed in W2. Resolved by one-construct-one-home: W3 scores only the own-practice participation they evidence (required workplace delivery to real recipients with an outcome measure, and the assessed reflection on the implemented session); the authentic-artefact fidelity of plan/curriculum/proposal remains W2 and was not re-counted.",
      "W3 (2 vs 3): 'Students are encouraged to design curriculum aligned with their actual practice' is encouraged, not required, and is artefact design; MEDS90033's stakeholder needs assessment is required only on the Coursework pathway. No required sequence of assessed own-practice activity exists for the whole cohort, and the recipient outcome measure approaches but does not document accountability to workplace stakeholders as an assessed criterion — resolved downward to 2.",
      "[superseded by v4.2 re-score 2026-08-16; retained for the audit trail] W3 (0 vs 1 vs 2): none of the three anchors fits cleanly. Level 0 is excluded because workplace-based activity is documented in a compulsory core subject; level 2 is excluded because no placement, practitioner supervision or host accountability appears anywhere; level 1's exemplars (elective, optional, unassessed) fit imperfectly because the activity is core and feeds assessment. Scored 1 as the lower of the two live readings. The underlying mismatch is cohort-structural: the anchors assume a pre-professional cohort placed into a host workplace, whereas this cohort are practising surgeons learning within their own existing practice, which the program does not supervise.",
      "Elective availability: MEDS90015 Simulation in Surgical Education, MEDS90016 Teaching Surgical Science, MEDS90017 Educational Leadership in Surgery and MEDS90018 Assessment and Evaluation in Surgery are all marked 'Not available in 2026'. Their assessments (including the MEDS90016 hurdle 'design and deliver a teaching session' and the MEDS90017 formal debate) were therefore not used as scoring evidence for the 2026 offering, and in any case are elective, not core."
    ],
    "notScoreable": [
      "The AI-specific clauses of C1 level 3 ('coordinating work across people AND tools/AI systems') and C3 levels 2-3 (core units addressing AI capabilities and limitations/ethics; critique or governance of AI systems) could not be tested: the extract contains no occurrence of artificial intelligence, gen AI, machine learning or any equivalent in any course page, subject overview, learning outcome, generic-skills list or assessment description. Both items were still scoreable on their non-AI evidence (collaboration for C1, digital/e-learning for C3), so neither is left unscored — but the absence, not a judgement about AI content, is what caps them.",
      "Assessment detail for MEDS90030 Minor Thesis Part 2 is not published in its own right; the page states only that assessment refers back to MEDS90029 Minor Thesis Part 1, whose combined assessment table was used for both."
    ],
    "verified": {
      "adversarial": true,
      "mechanical": true,
