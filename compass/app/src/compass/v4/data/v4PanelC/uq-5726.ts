...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Statistical Methods in Business (BSAN7204)",
      "Subject: Business Data Management (BSAN7206)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Social Analytics (BSAN7207)",
      "Subject: Visual Analytics (BSAN7208)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5726",
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Certificate in Business Analytics a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
