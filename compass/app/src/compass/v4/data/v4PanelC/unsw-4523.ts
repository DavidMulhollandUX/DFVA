...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Research Methods in the Built Environment (BENV4000)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Writing the City (BENV7307)",
      "Subject: Digital Cities (BENV7504)",
      "**CRICOS Code**: 089222F"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4523",
      "Subject: Critical Review of the Literature (CODE4100)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Computational Design.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 48",
