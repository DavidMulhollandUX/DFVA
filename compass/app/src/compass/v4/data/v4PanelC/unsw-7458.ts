...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Managing Yourself and Others (ZZBU6001)",
      "Subject: Strategic Consulting Project (ZZBU6008)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Human Resource Policies and Practices (ZZBU6401)",
      "Subject: Employee Wellbeing and Engagement (ZZBU6402)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7458",
      "Subject: Sustainability and Human Resources (ZZBU6403)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Diversity, Equity and Inclusion.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
