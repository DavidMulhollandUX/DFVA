...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: RURAL COMMUNITY ENGAGEMENT (HLT1RCE)",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Social Work (Honours) - Albury.",
      "evidenceLines": [
        "To qualify for the award of Bachelor of Social Work (Honours), students must complete 480 credit points consisting of:",
