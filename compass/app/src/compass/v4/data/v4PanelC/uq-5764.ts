...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Contemporary Financial Modelling and Analytics (FINM7101)",
      "Subject: Asset Pricing and Portfolio Management in Practice (FINM7102)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Derivatives and Applied Risk Management (FINM7103)",
      "Subject: Quantitative Investment Strategies (FINM7104)",
      "**Teaching Location**: Brisbane City"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5764",
      "Subject: Fixed Income and Public Financial Management (FINM7105)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Finance and Investment Management.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Certificate in Finance and Investment Management a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
