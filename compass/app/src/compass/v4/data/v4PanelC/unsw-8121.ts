...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Performance over Time of Building Systems (ARCH7213)",
      "Subject: International Construction Study Trip (BEIL6020)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Programmable Cities (BENV7500)",
      "**CRICOS Code**: 085910C"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8121",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Construction Project Management.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 72",
