...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Cyber Criminology and Global Security (CRIM7080)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Computer Systems Principles and Programming (CSSE7231)",
      "Subject: Fundamentals of Cyber Security (CYBR7001)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5257",
      "Subject: Information Security Essentials (CYBR7002)",
      "- **Faculty**: of Engineering, Architecture and Information Technology"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Cyber Security.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Cyber Security a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
