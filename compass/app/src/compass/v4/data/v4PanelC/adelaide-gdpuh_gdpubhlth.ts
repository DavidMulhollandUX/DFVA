...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gdpuh_gdpubhlth",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gdpuh_gdpubhlth"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "The Graduate Diploma in Public Health consists of core and elective coursework in the areas of epidemiology, biostatistics, health promotion, social science research methods for public health, public health policy and evaluation, health systems and advocacy, occupational, environmental and global health and infectious disease epidemiology and control.",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Public Health.",
      "evidenceLines": [
        "The Graduate Diploma in Public Health consists of core and elective coursework in the areas of epidemiology, biostatistics, health promotion, social science research methods for public health, public health policy and evaluation, health systems and advocacy, occupational, environmental and global health and infectious disease epidemiology and control.",
