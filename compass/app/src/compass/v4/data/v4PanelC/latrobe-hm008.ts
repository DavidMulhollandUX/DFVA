...
const record: V4PanelC = {
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "Critically apply clinical knowledge to demonstrate advanced assessment skills in the perioperative setting",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: PERIOPERATIVE PRACTICES FOUNDATIONS (NSM4010)",
      "Subject: PERIOPERATIVE SPECIALIST PRACTICE (NSM4019)",
      "Critically appraise ethical and professional standards of nursing in the perioperative setting"
    ]
  },
  "W1": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Nursing.",
      "evidenceLines": [
        "To qualify for the award of Master of Nursing, students must complete 240 credit points consisting of:",
