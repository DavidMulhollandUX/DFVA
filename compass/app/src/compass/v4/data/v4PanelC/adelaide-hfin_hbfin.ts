...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: hfin_hbfin",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Research Methodology (H) (ECON4011)",
      "Subject: Advanced Finance (H) (BAFI4002)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/hfin_hbfin"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Qualitative Methods (H) (MATH4049)",
      "Subject: Quantitative Methods (H) (ACCT4004)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Econometrics for Business Research IV(H) (ECON4012)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "The Bachelor of Finance (Honours) is an AQF Level 8 qualification with a standard full-time duration of 1 year.",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "gates": {
