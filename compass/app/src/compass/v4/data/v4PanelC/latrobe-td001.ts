...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "La Trobe’s Diploma of Engineering Technology gives you an immersive introduction to the field of engineering and a pathway to one of two world-class bachelor’s degrees."
    ]
  },
  "C2": {
    "score": 3,
    ...
    "evidenceLines": [
      ...
      "Gain the skills, knowledge, and experience to tackle engineering problems and implement creative solutions."
    ]
  },
  "C3": {
    "score": 3,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Diploma of Engineering Technology, students must complete 120 credit points consisting of:",
      "La Trobe’s Diploma of Engineering Technology gives you an immersive introduction to the field of engineering and a pathway to one of two world-class bachelor’s degrees."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Diploma of Engineering Technology.",
      "evidenceLines": [
        "To qualify for the award of Diploma of Engineering Technology, students must complete 120 credit points consisting of:",
