...
const record: V4PanelC = {
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "Enhance your political expertise by learning how governments manage the economy and achieve important social objectives."
    ]
  },
  "C5": {
    "score": 2,
    ...
    "evidenceLines": [
      "Subject: RECESSIONS, INFLATION AND ECONOMIC GROWTH (ECO1RIG)",
      "Subject: CONSUMERS, FIRMS AND COMPETITION (ECO2CFC)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: PRINCIPLES OF ENVIRONMENTAL AND RESOURCE ECONOMICS (ECO2ERE)",
      "Enhance your political expertise by learning how governments manage the economy and achieve important social objectives."
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Bachelor of Laws(Honours)/Bachelor of Politics, Philosophy and Economics, students must complete a total 600 credit points consisting of:",
      "Combine practical, progressive and multidisciplinary legal skills with a unique social and ethical perspective on how the law works with La Trobe’s Bachelor of Laws (Honours)/Bachelor of Politics, Philosophy and Economics."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Laws (Honours)/Bachelor of Politics, Philosophy and Economics.",
      "evidenceLines": [
        "To qualify for the award of Bachelor of Laws(Honours)/Bachelor of Politics, Philosophy and Economics, students must complete a total 600 credit points consisting of:",
