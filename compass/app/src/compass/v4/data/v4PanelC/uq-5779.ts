...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: The Data-Driven Workforce (MGTS7623)",
      "Subject: Psychological Research Methodology (PSYC7010)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5779",
      "Subject: Business Psychology Capstone Project (PSYC7020)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Business Psychology.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Business Psychology a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
