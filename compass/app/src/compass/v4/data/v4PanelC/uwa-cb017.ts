...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CB017"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Autocracy and Democracy in Asia (ASIA3005)",
      "Bachelor of Philosophy, Politics and Economics"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Foundations of Global Business (BUSN1103)",
      "- **Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CB017"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Philosophy, Politics and Economics and Bachelor of Commerce.",
      "evidenceLines": [
        "(on StudentConnect, minors start with the code MNR), if they meet the pre-requisite requirements of those majors and minors and can complete all majors and minors within the 192 credit points of their combined degree.",
        "(on StudentConnect, minors start with the code MNR), if they meet the pre-requisite requirements of those majors and minors and can complete all majors and minors within the 192 credit points of their combined degree."
      ]
