...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Australia and Asia in the Asian century: Politics, business, media (APG5069)",
      "Subject: International relations field unit: Governing peace and security (APG5093)",
  ...
  "W3": {
    ...
    "evidenceLines": [
      "Part A. Core studies - Public Policy and Management",
      "demonstrate the application of judgement, problem solving, critical thinking and analytical skills."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Public Policy and Management and Master of International Relations.",
      "evidenceLines": [
        "Part A. Core studies - Public Policy and Management",
        "Part C. Core studies - International Relations"
      ]
    },
    "G2": {
      "result": "PASS",
