...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gcpsy_gcpsyol",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Foundations of Psychology (PSYC5027)",
      "Subject: Research Methods, Design and Analysis (PSYC5028)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gcpsy_gcpsyol"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Developmental Psychology (UoA) (PSYC5029)",
      "Subject: Psychological Health & Wellbeing (PSYC5030)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Applying Research Methods in Psychology (PSYC5031)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "NOTE: This Graduate Certificate is an exit award that is only available to students who are enrolled in the Graduate Diploma in Psychology.",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Psychology [Online].",
      "evidenceLines": [
        "NOTE: This Graduate Certificate is an exit award that is only available to students who are enrolled in the Graduate Diploma in Psychology.",
        "The Graduate Certificate in Psychology is an AQF Level 8 qualification with a standard full-time duration of 0.5 years. However, this program is only offered part-time for a duration of 0.8 years."
      ]
    },
    "G2": {
      "result": "PASS",
