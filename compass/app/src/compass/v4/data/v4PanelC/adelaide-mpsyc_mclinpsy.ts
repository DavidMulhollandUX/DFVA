...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: mpsyc_mclinpsy",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Evidence-based Practice (Clinical) (BUSI5163)",
      "Subject: Evidence Based Practice (PSYC5066)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/mpsyc_mclinpsy"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Interviewing and Intervention (PSYC5070)",
      "Subject: Psychopathology and Clinical Practice (PSYC5042)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Health Psychology (Clinical) (BUSI5164)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
