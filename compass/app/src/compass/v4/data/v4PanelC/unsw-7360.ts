...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Health Organisations, Strategy and Change (PHCM9391)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Health Leadership and Workforce Management (PHCM9701)",
      "Subject: Healthcare Governance, Safety and Quality (PHCM9748)",
      "**CRICOS Code**: 015016B"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7360",
      "Subject: Healthcare Governance, Safety and Quality (PHCM9748)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Health Leadership and Management.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
