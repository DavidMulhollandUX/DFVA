...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: mba-leadership-enterprise",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Leading in a Digital World (FMBA5011)",
      "Subject: Leadership Practice and Development (SMBA6001)",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/business-school-pg/coursework/mba-leadership-enterprise.html"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Financial Management (SMBA6004)",
      "Subject: Innovation in Strategic Marketing (SMBA6006)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Individual assignment (continuous week-by-week) Oral journal: 30%: Multiple weeks% (Hurdle: False)",
      "Subject: Innovation in Strategic Marketing (SMBA6006)",
      "- **Faculty**: business-school-pg"
    ]
  },
