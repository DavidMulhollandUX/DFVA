...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CB028"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Business Communication for Change, Influence and Impact (BUSN1104)",
      "Bachelor of Modern Languages"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Data Analytics for Business (BUSN1200)",
      "- **Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CB028"
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "), if they meet the pre-requisite requirements of those majors and minors and can complete all majors and minors within the 192 credit points of their combined degree.",
      "- **Institution**: The University of Western Australia (UWA)"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Modern Languages and Bachelor of Business.",
      "evidenceLines": [
        "), if they meet the pre-requisite requirements of those majors and minors and can complete all majors and minors within the 192 credit points of their combined degree.",
        "), if they meet the pre-requisite requirements of those majors and minors and can complete all majors and minors within the 192 credit points of their combined degree."
      ]
