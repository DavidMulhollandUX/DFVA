...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Engineering Work Related Learning for Postgraduates (GSOE9997)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Digital Engineering Foundation, Theory and Practice (ZCSY8702)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7478",
      "Subject: Digital Engineering Governance (ZCSY8703)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "W3": {
