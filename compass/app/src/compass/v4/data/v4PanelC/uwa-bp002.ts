...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=BP002"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Management Accounting (ACCT2112)",
      "Subject: Corporate Accounting (ACCT2201)",
      "**Academic Year**: 2026"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=BP002",
      "Subject: Accounting Information Systems (ACCT2242)",
      "- **Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=BP002"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "All units have a value of six points unless otherwise stated.",
        "Students must complete all foundation units listed below, except where already completed in satisfaction of the requirements of a major or minor."
      ]
    },
    "G2": {
      "result": "PASS",
