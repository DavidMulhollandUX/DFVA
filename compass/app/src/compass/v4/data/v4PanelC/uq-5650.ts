...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Managerial Accounting Honours A (ACCT6104)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Empirical Finance Honours (FINM6402)",
      "Subject: Critical Issues in Finance (FINM6403)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5650",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Business Research Methods.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Diploma in Business Research Methods a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
