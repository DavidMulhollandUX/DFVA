...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: science-medicine",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
    ...
    "evidenceLines": [
      "**Academic Year**: 2026",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/science/coursework/science-medicine.html",
      "- **Course / Program Identifier**: science-medicine"
    ]
  },
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Human Anatomy and Histology (MEDS2005)",
      "Subject: Key Concepts in Physiology (PHSI2007)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Key Concepts in Physiology (Advanced) (PHSI2907)",
      "Subject: Observational Elective (SMTP3007)",
  ...
  "W3": {
    ...
    "evidenceLines": [
      "The Bachelor of Science and Doctor of Medicine requirements are detailed in the",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Science and Doctor of Medicine.",
      "evidenceLines": [
        "The Bachelor of Science and Doctor of Medicine requirements are detailed in the",
        "Honours is available as an additional year after completion of the Bachelor of Science. It can be completed before starting the Doctor of Medicine.  Admission requirements and unit of study information can be found on the"
      ]
    },
    "G2": {
      "result": "PASS",
