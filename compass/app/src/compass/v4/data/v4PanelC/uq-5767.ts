...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Research Methods (HLTH7317)",
      "Subject: Working with Aboriginal and Torres Strait Islander Peoples, Families and Communities (INDH7107)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Key Elements of Social Work (SWSP7111)",
      "Subject: Field Placement 1 (SWSP7155)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5767",
      "Subject: Field Placement 1: Extended Practice (SWSP7165)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Social Work (Qualifying) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
