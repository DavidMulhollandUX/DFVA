...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Research Lab: Computation and Digitisation (ARCH7075)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5722",
      "Subject: Research Lab: History and Heritage (ARCH7084)",
      "- **Faculty**: of Engineering, Architecture and Information Technology"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Urban Development and Design.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Urban Development and Design a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
