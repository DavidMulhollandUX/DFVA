...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "Computer science provides solutions to the ever-increasing information challenges in the modern world."
    ]
  },
  "C2": {
    "score": 3,
    ...
    "evidenceLines": [
      ...
      "Organisations need people who can extract information from the massive datasets generated by banking, commerce and social networks and analyse it to affect real change."
    ]
  },
  "C3": {
    "score": 3,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "Big data is a new frontier in the commercial world."
    ]
  },
  "C5": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Commerce and Bachelor of Computer Science.",
      "evidenceLines": [
        "Refer to each partner course for the post nominals for the degree awarded",
        "Part A. Core studies"
      ]
