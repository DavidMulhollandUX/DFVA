...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Recovery & Nutrition for Elite Athlete (NUTR7009)",
      "Subject: Sport Science (Anatomy, Biomechanics, Physiology) (PHYL6000)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Movement and Performance Analysis (SPCG6001)",
      "Subject: Applied Sport Psychology for Coaches (SPCG6002)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5725",
      "Subject: Quality Coaching: Understanding, Informing and Advancing Practice (SPCG6027)",
      "- **Faculty**: of Health and Behavioural Sciences"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Sports Coaching.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Sports Coaching a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
