...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: beca_beconadv",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Mathematical Economics (ECON1002)",
      "Subject: International Financial Institutions and Markets (ECON1005)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/beca_beconadv"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: UO Principles of Economics (ECON1010)",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "Learning Journal, Learning Journal, Learning Journal: 45%% (Hurdle: False)",
      "- **Institution**: The University of Adelaide",
      "- **Program Identifier / Slug**: beca_beconadv"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "Multiple Choice Questions: 55%% (Hurdle: False)",
      "Subject: UO Macroeconomics (ECON1011)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Economics.",
      "evidenceLines": [
        "The Bachelor of Economics (Advanced) is a Level 7 AQF qualification with a standard full-time duration of 3 years.",
