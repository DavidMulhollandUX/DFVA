...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Communicating in Engineering (ENGG0360)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Creative Entrepreneurship (GENE1500)",
      "Subject: Introduction to Astronomy (PHYS1160)",
      "**CRICOS Code**: 056835E"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3707",
      "Subject: Introduction to Astronomy (PHYS1160)",
      "- **Total Units / Units of Credit (UOC)**: 192"
    ]
  },
