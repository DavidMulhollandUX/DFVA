...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Applied Policy Project (CRWF8021)",
      "Subject: Communicating for Environment and Climate Policy (EMDV8007)",
      "**Post Nominal**: Nominal MPubAdmin"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Australian Environmental Policy: Problems, Practices, Politics (EMDV8018)",
      "- **Program Duration**: 1.5 year full-time"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Public Administration.",
      "evidenceLines": [
        "- **Program Duration**: 1.5 year full-time",
        "- **Minimum Units Required**: 72 Units"
      ]
