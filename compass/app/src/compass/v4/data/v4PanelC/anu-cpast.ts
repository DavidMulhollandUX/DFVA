...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Archaeology of the Pacific Islanders (ARCH6005)",
      "Subject: Special Topics in Asian and Pacific Studies (ASIA6022)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Archaeology and Cultural Heritage Field Schools (ASIA6220)",
      "Subject: Disasters and Epidemics in Asia and the Pacific (ASIA8048)",
      "**Post Nominal**: Nominal GCertPacSt"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate of Pacific Studies.",
      "evidenceLines": [
        "- **Program Duration**: 0.5 years",
        "- **Minimum Units Required**: 24 Units"
      ]
