...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Data, Insights and Decisions (COMM1190)",
      "Subject: Introduction to Engineering Design and Innovation (DESN1000)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Mathematical Modelling for Real World Systems (MATH3041)",
      "Subject: Mathematical Methods and Partial Differential Equations (MATH3121)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3739",
      "Subject: Linear and Discrete Optimization Modelling (MATH3171)",
      "- **Total Units / Units of Credit (UOC)**: 240"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Advanced Mathematics.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 240",
        "Students must complete 240 Units of Credit (UOC) structured across the following academic components:"
      ]
    },
    "G2": {
      "result": "PASS",
