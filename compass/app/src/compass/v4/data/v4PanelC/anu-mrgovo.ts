...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Water Justice, Management and Governance (EMDV8079)",
      "**Post Nominal**: Nominal MRegGovn"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Field of Education**: of Education Justice and Law Enforcement",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Regulation and Governance.",
      "evidenceLines": [
        "- **Program Duration**: 1 year full-time",
        "- **Minimum Units Required**: 48 Units"
      ]
