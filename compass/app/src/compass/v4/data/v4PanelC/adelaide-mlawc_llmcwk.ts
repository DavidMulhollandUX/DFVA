...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: mlawc_llmcwk",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Australian Law (LAWS5058)",
      "Subject: Anti-discrimination Law: Practice and Theory PG (LAWS5004)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/mlawc_llmcwk"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: International Environmental Law (PG) (LAWS5006)",
      "Subject: AI and Technology: Legal and Security Issues (LAWS5007)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Regulation of Work: Current Issues (LAWS5024)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
