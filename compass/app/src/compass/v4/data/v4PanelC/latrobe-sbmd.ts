...
const record: V4PanelC = {
  ...
  "C2": {
    ...
    "evidenceLines": [
      ...
      "Start with how the body works as you build your fundamental knowledge of chemistry, bioscience and health."
    ]
  },
  "C3": {
    "score": 2,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "You’ll take a close look at infectious diseases, including the factors that drive epidemics and pandemics."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Bachelor of Biomedicine, students must complete 360 credit points consisting of:",
      "From day one, learn from experts and get hands-on experience in the lab with La Trobe’s Bachelor of Biomedicine."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Biomedicine.",
      "evidenceLines": [
        "To qualify for the award of Bachelor of Biomedicine, students must complete 360 credit points consisting of:",
