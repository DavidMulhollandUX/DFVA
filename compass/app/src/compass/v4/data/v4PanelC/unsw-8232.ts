...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: MDIA5021 - Advertising and Creativity",
      "Subject: MDIA5009 - Philosophies of Journalism",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: MDIA5000 - Understanding Contemporary Media",
      "Subject: MDIA5010 - Literary and Narrative Journalism Practice",
      "**CRICOS Code**: 083249K"
    ]
  },
  "W1": {
    ...
    "evidenceLines": [
      "**Academic Organisation**: School of the Arts and Media",
      "- **Institution**: University of New South Wales (UNSW Sydney)",
      "- **Study Level**: Postgraduate"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      ...
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8232",
      "- **Total Units / Units of Credit (UOC)**: 96"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Journalism and Communication.",
      "evidenceLines": [
        "- **Institution**: University of New South Wales (UNSW Sydney)",
        "- **Total Units / Units of Credit (UOC)**: 96"
      ]
