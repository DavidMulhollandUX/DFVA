...
const record: V4PanelC = {
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify with the award of Graduate Diploma in Occupational Health and Safety, students must complete 120 credit points in total consisting of:",
      "Critically analyse the efficacy of workplace interventions integrating evidence-based theoretical knowledge and practical ergonomics assessment skills."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Occupational Health and Safety - On.",
      "evidenceLines": [
        "To qualify with the award of Graduate Diploma in Occupational Health and Safety, students must complete 120 credit points in total consisting of:",
