...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Dynamic Planet (EART1105)",
      "Subject: Environmental Science and Technology (ENVT1104)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CB008"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: The Climate System (ENVT2220)",
      "Subject: Hydrology and Water Resource Management (ENVT2251)",
      "Bachelor of Environmental Science"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Institution**: The University of Western Australia (UWA)",
      "Subject: Coastal Conservation and Management (ENVT3306)",
      "- **Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CB008"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Environmental Science and Bachelor of Arts.",
      "evidenceLines": [
        "(on StudentConnect, minors start with the code MNR), if they meet the pre-requisite requirements of those majors and minors and can complete all majors and minors within the 192 credit points of their combined degree.",
        "(on StudentConnect, minors start with the code MNR), if they meet the pre-requisite requirements of those majors and minors and can complete all majors and minors within the 192 credit points of their combined degree."
      ]
