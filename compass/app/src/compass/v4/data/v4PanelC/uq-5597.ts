...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Major Research Project & Seminars (CONS7004)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Sampling Design & Analysis in Conservation Science (CONS7008)",
      "Subject: Space Invaders: Invasive Species, Field skills & GIS Mapping (CONS7022)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5597",
      "Subject: Marine Conservation (CONS7024)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Conservation Science.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Conservation Science a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
