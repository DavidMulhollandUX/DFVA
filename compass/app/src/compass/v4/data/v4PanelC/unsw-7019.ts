...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Pre-Business Program (Indigenous) (ATSI7001)",
      "Subject: Pre-Law Program (Indigenous) (ATSI7002)",
  ...
  "C4": {
    ...
    "evidenceLines": [
      "**Total Units / Units of Credit (UOC)**: 12",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Pre-Medicine and Health Program (Indigenous) (ATSI7003)",
      "Subject: Pre-Social Work Program (Indigenous) (ATSI7004)",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "**Academic Organisation**: Nura Gili Indigenous Programs",
      "- **Institution**: University of New South Wales (UNSW Sydney)",
      "- **Study Level**: Undergraduate"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/7019",
      "Subject: Pre-Teacher Education Program (Secondary) (Indigenous) (ATSI7006)",
      "- **Total Units / Units of Credit (UOC)**: 12"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Indigenous Preparatory Program.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 12",
