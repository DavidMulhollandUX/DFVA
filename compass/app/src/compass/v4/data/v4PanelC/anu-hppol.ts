...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Research Training: Scope and Methods (POLS4011)",
      "Subject: Thesis (THES4103)",
      "**Post Nominal**: Nominal BPPolStHons"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Public Policy.",
      "evidenceLines": [
        "- **Program Duration**: 1 year full-time",
