...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Understanding Mental Health and Psychotherapeutic Interventions (PXMH7101)",
      "Subject: Ethics and Mental Health Practice (PXMH7102)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Common and Specific Factors in Mental Health Treatments (PXMH7103)",
      "Subject: Advanced Therapy Skills: Working with Complex and Non-traditional Clients (PXMH7105)",
      "**Teaching Location**: Herston"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5151",
      "Subject: Advanced Therapy Skills: Working with Families and Groups (PXMH7106)",
      "- **Teaching Location**: Herston"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Mental Health.",
      "evidenceLines": [
        "- **Duration**: Not specified",
