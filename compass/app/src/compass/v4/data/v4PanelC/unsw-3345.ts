...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3345",
      "Subject: Australian Cinema (ARTS2062)",
      "- **Total Units / Units of Credit (UOC)**: 192"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Media / Social Sciences.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 192",
