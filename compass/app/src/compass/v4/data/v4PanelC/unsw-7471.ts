...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Foundations of Organisational Cyber Security  (ZSPS9000)",
      "Subject: Cyber Security Governance, Risk and Compliance (ZSPS9001)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Cyber Security Data Governance and Privacy (ZSPS9002)",
      "Subject: Cyber Security Leadership and Strategy (ZSPS9003)",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "**Academic Organisation**: Canberra School of Professional Studies",
      "- **Institution**: University of New South Wales (UNSW Sydney)",
      "- **Study Level**: Postgraduate"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7471",
      "Subject: Cyber Security Leadership and Strategy (ZSPS9003)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Cyber Security Leadership.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
