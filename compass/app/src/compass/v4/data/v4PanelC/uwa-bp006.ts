...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Aboriginal Health and Wellbeing (AHEA2201)",
      "Subject: Aboriginal Health Community Organisation Placement (AHEA3200)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=BP006"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Aboriginal Health Research Project (AHEA3300)",
      "Subject: Aboriginal Social and Emotional Wellbeing (AHEA3301)",
      "**Academic Year**: 2026"
    ]
  },
  "W1": {
