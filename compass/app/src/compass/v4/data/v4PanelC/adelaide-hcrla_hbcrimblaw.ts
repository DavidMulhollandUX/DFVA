...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: hcrla_hbcrimblaw",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/hcrla_hbcrimblaw"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: The Social Construction of Ageing and Disability (SOCI2012)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: UO Critical Approaches to Online Learning (SOCI3014)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Criminology with Bachelor of Laws.",
      "evidenceLines": [
        "The Bachelor of Criminology with Bachelor of Laws (Honours) is an AQF Level 8 qualification with a standard full-time duration of 4.5 years.",
