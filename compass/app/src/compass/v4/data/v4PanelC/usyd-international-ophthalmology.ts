...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: international-ophthalmology",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Ophthalmic Optics (OPSC5003)",
      "Subject: Ophthalmology in Developing Countries 1 (OPSC5013)",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/medicine-health-pg/coursework/international-ophthalmology.html"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Ophthalmology in Developing Countries 2 (OPSC5014)",
      "Subject: Clinical Ophthalmology 1 (OPSC5015)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Clinical Ophthalmology 2 (OPSC5016)",
      "- **Faculty**: medicine-health-pg"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in International Ophthalmology.",
      "evidenceLines": [
        "Students in the Community Ophthalmology stream must complete 48 credit points, including:",
