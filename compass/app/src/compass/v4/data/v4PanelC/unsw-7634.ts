...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Reliability Program Management (ZEIT8152)",
      "Subject: Project Management Body of Knowledge (ZEIT8303)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7634",
      "Subject: Systems Thinking and Modelling (ZEIT8305)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Operations Analysis.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
