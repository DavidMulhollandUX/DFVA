...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Health Sciences Research Discovery I (HRSS3101)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Health Sciences Research Project: Service Development through Action Learning (HRSS4210)",
      "Subject: Health Sciences Research Advanced Project I (HRSS4300)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2368",
      "Subject: Introduction to Professional Skills in Occupational Therapy (OCTY1102)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Occupational Therapy (Honours) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
