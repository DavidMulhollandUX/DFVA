...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Selected Practice Frameworks (SOCF5102)",
      "Subject: Research Issues in Counselling Social Work (SOCF5103)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
    ...
    "evidenceLines": [
      ...
      "**Delivery Mode**: Face-to-face (includes blended), Distance (online with some face-to-face), Fully online",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Counselling Practice (SOCF5104)",
      "Subject: Therapeutic Contexts and Relationships (SOCF5108)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8930",
      "Subject: Family Inclusive Practice (SOCF5109)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Counselling Social Work.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 48",
        "The Master of Counselling Social Work (MCSW) is a 2-year part-time, 48 UOC program offered through the School of Social Sciences. This program is provided flexibly in Face-to-Face/Blended mode; with an option to complete each course in the program fully online."
      ]
    },
    "G2": {
      "result": "PASS",
