...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Lean Start up for Entrepreneurship and Innovation (EIBS7311)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Advanced Food Materials Science (FOOD7000)",
      "Subject: Food Sensory and Physical Assessment (FOOD7016)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5753",
      "Subject: Food Product Development (FOOD7019)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Food Science and Technology Research Extensive.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Food Science and Technology Research Extensive a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
