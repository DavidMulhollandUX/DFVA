...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: HONOURS IN AGRICULTURE B (AGR401B)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Develop knowledge in crop science and/or plant science when devising experiments, analysing results, and drawing conclusions.",
      "Subject: HONOURS IN AGRICULTURE D (AGR401D)",
      "Recall important details regarding the history, culture, customs and people of Indigenous Australia"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "* Completion requirements",
        "_This degree is being phased out. No new enrolments will be permitted from 2025. Prospective students should see_ _the requirements for the SHS Bachelor of Science (Honours)._"
      ]
    },
    "G2": {
      "result": "PASS",
