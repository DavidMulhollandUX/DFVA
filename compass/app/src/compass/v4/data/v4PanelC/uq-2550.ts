...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Interdisciplinary Studio (ADPS3000)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2550",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Architectural Design.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Architectural Design a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
