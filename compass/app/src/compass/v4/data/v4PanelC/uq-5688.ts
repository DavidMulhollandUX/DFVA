...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Globalisation, International Political Economy and Development (POLS7107)",
      "Subject: Politics of Environmental Change (POLS7115)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Indigenous Politics within and beyond the state (POLS7190)",
      "Subject: Independent Study (POLS7207)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5688",
      "Subject: International Relations of the Asia- Pacific (POLS7208)",
      "- **AQF Level**: Refer to your component degrees for AQF level."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Masters of International Relations / Peace and Conflict Studies.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Masters of International Relations / Peace and Conflict Studies a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
