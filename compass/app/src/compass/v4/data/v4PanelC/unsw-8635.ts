...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Foundations of Business Research (COMM8100)",
      "Subject: Statistical Methods for Business Research (COMM8101)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Econometric Analysis (COMM8102)",
      "Subject: Business Research Project Seminar (COMM8103)",
      "**CRICOS Code**: 096892J"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8635",
      "Subject: Business Research Project Seminar (COMM8103)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Pre.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 48",
