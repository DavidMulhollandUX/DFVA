...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Principles of Optics 1 (OPTM4101)",
      "Subject: Structure and Function of the Eye (OPTM4102)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=91590"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Research Fundamentals and Methodology 1 (OPTM4103)",
      "Subject: Foundations of Optometry (OPTM4104)",
      "**Academic Year**: 2026"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=91590",
      "Subject: Principles of Optics 2 (OPTM4105)",
      "- **Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=91590"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Doctor of Optometry.",
      "evidenceLines": [
        "website for details on admission requirements, intake periods, fees, availability to international students, careers information etc.",
