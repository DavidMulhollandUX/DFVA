...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Truth and Human Existence: Introduction to Philosophy (ARTS1360)",
      "Subject: Mind, Ethics, and Freedom: Introduction to Philosophy (ARTS1361)",
  ...
  "C4": {
    ...
    "evidenceLines": [
      "**Total Units / Units of Credit (UOC)**: 288",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Critical Thinking for Today's World (ARTS1362)",
      "Subject: Foundations of Politics and International Relations (ARTS1810)",
      "**CRICOS Code**: 099869F"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4797",
      "Subject: Contemporary Issues in Government and Global Politics (ARTS1811)",
      "- **Total Units / Units of Credit (UOC)**: 288"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Politics, Philosophy and Economics / Law.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 288",
