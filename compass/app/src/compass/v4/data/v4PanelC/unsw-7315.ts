...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Project Management (AGSM9101)",
      "Subject: Corporate Innovation (AGSM9132)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
    ...
    "evidenceLines": [
      ...
      "**Delivery Mode**: Face-to-face (includes blended), Fully online",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Implementing Strategy (AGSM9153)",
      "Subject: Entrepreneurship and Innovation (AGSM9156)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7315",
      "Subject: Approaches to Change (AGSM9271)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Change Management.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
        "Please note that the program requirements may be subject to change. Students are advised to follow requirements according to the year they commenced. Please visit the previous editions of the Online Handbook for pre-2019 program requirements."
      ]
    },
    "G2": {
      "result": "PASS",
