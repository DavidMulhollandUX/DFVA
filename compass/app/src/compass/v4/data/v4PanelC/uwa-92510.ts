...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Clinical Pathology Practicum 2 (PATH5194)",
      "Subject: Biostatistics I (PUBH4401)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=92510"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Clinical Pathology.",
      "evidenceLines": [
        "website for details on admission requirements, intake periods, fees, availability to international students, careers information etc.",
