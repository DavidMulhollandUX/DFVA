...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "In the age of disruption, strategic managers face relentless pressure to keep pace with an increasingly digital and dynamic business environment."
    ]
  },
  "C2": {
    "score": 2,
    ...
    "evidenceLines": [
      ...
      "The Master of Business Administration (Digital) provides the knowledge and skills you need now, coupled with the strategies and methods you need to stay informed, relevant and current as an uncertain future unfolds."
    ]
  },
  "C3": {
    "score": 2,
    ...
    "evidenceLines": [
      "Subject: Consumers, brands and marketing management (MBO5001)",
      "Subject: Control, performance and accounting management (MBO5002)",
  ...
  "C4": {
    ...
    "evidenceLines": [
      "demonstrate understanding and application of contemporary accounting theory, models and frameworks to work effectively with an organisation’s accounting professionals",
      "examine the potential impact of technological, social, environmental, economic, and geopolitical forces on the future practice of accounting management.",
      "In this degree, you will be equipped to:"
    ]
  },
  "C5": {
    "score": 2,
    ...
    "evidenceLines": [
      "Subject: Operations, logistics and supply chain management (MBO5003)",
      "Subject: Value, risk and financial management (MBO5004)",
      "evaluate the integration of digital advancements within an organisation’s accounting systems and management"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "1 - Written: 50% (Hurdle: None)",
      "Subject: People, culture and change management (MBO5005)",
      "In this degree, you will be equipped to:"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Business Administration (Digital).",
      "evidenceLines": [
        "* If you are admitted at entry level 1 you complete 72 credit points, comprising of Part A, Part B and Part C",
        "* If you are admitted at entry level 2 you complete 48 credit points, comprising 24 credit points from Part A and 12 credit points from both Part B and Part C."
      ]
    },
    "G2": {
      "result": "PASS",
