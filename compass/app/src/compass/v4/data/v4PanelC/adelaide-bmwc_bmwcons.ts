...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: bmwc_bmwcons",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Human Biology 2 (BIOL1002)",
      "Subject: Infection and Immunity 3B (BIOL3010)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/bmwc_bmwcons"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Marine and Wildlife Conservation.",
      "evidenceLines": [
        "The Bachelor of Marine and Wildlife Conservation is an AQF Level 7 qualification with a standard full-time duration of 3 years.",
