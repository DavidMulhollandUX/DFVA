...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Anatomy for Medical Science (ANAT1521)",
      "Subject: Histology: Basic and Systematic (ANAT2241)",
      "**AQF Level**: Level 7"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Visceral Anatomy (ANAT3121)",
      "Subject: Functional Anatomy of the Head, Neck and Back (ANAT3131)",
      "**CRICOS Code**: 030459E"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3991",
      "Subject: Functional Anatomy of the Limbs (ANAT3141)",
      "- **Total Units / Units of Credit (UOC)**: 144"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Medical Science.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 144",
