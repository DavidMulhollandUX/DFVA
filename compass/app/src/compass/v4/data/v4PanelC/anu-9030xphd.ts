...
const record: V4PanelC = {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Doctor of Philosophy, ANU College of Law.",
      "evidenceLines": [
        "- **Program Duration**: 4 year full-time",
        "- **Minimum Units Required**: 192 Units"
      ]
