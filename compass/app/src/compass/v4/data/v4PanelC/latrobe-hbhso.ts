...
const record: V4PanelC = {
  ...
  "C2": {
    ...
    "evidenceLines": [
      ...
      "Examine the way our minds, society, environment and political structures affects the health of individuals, families and communities at local, national and international levels."
    ]
  },
  "C3": {
    "score": 2,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "Broaden your expertise with a choice of nine majors and the option of second majors and minors in health sciences or a range of other disciplines."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "*Please be aware that the digital health, health promotion and public health majors in this course include mandatory in-person placement requirements. Students are expected to complete these placements in Australia.",
        "To qualify for the award of Bachelor of Health Sciences, students must complete 360 credit points as follows:"
      ]
    },
    "G2": {
      "result": "PASS",
