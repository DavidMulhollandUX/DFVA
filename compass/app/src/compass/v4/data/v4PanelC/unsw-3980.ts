...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Aeronautical Knowledge (AVIA1111)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3980",
      "Subject: Commercial Navigation (AVIA2111)",
      "- **Total Units / Units of Credit (UOC)**: 144"
    ]
  },
  "W3": {
