...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Empirical Techniques and Applications in Finance (MFIN6201)",
      "Subject: Financial Risk Management for Financial Institutions (MFIN6205)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Empirical Studies in Finance (MFIN6210)",
      "Subject: Financial Theory and Policy (MFIN6214)",
      "**CRICOS Code**: 038393J"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8406",
      "Subject: Financial Theory and Policy (MFIN6214)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Finance.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 48",
