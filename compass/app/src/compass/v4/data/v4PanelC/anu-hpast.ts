...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Final Honours Grade (HONS4100)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Thesis (THES4502)",
      "Subject: Fundamentals of Research Design in Asia-Pacific Culture, History and Languages (ASIA4001)",
      "**Post Nominal**: Nominal BPacSt Hons"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Pacific Studies.",
      "evidenceLines": [
        "- **Program Duration**: 1 year full-time",
        "- **Minimum Units Required**: 48 Units"
      ]
