...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: commerce-extension",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Advanced International Business Strategy (IBUS6000)",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/business-school-pg/coursework/commerce-extension.html"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: International Business Alliances (IBUS6004)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Social Entrepreneurship (IBUS6016)",
      "- **Faculty**: business-school-pg"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "To qualify for the award of the Master of Commerce (Extension), a candidate must complete 96 credit points, comprising:",
        "(a) 12 credit points of degree core units of study"
      ]
    },
    "G2": {
      "result": "PASS",
