...
const record: V4PanelC = {
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Bachelor of Cybersecurity, students must complete 360 credit points consisting of:",
      "La Trobe’s Bachelor of Cybersecurity offers you the opportunity to step into the rapidly evolving digital world of cybersecurity."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Cybersecurity - On.",
      "evidenceLines": [
        "To qualify for the award of Bachelor of Cybersecurity, students must complete 360 credit points consisting of:",
