...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Environmental Governance (EMDV8104)",
      "Subject: Foundations of Public Law (LAWS8660)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Foundations in Public Policy (POGO8401)",
      "**Post Nominal**: Nominal GCertRegGov"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Restorative Justice in the World (REGN8005)",
      "- **Career / Study Level**: Postgraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate of Regulation and Governance.",
      "evidenceLines": [
        "- **Program Duration**: 0.5 years",
        "- **Minimum Units Required**: 24 Units"
      ]
