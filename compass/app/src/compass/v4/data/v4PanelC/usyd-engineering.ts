...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: engineering",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Civil Engineering in a Changing Climate (CIVL6001)",
      "Subject: Statistical Thinking with Data (MATH1005)",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/engineering-pg/engineering.html"
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      "Eng Mechanics; balance of forces and moments;",
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Mathematics 1B (MATH1062)",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "Mechanical Design 1; approach to design problems and report writing; and preparation of engineering drawing;",
      "- **Institution**: The University of Sydney (USYD)",
      "- **Course / Program Identifier**: engineering"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Mechanical Systems Design 1 (MECH2400)",
      "- **Handbook URL**: https://www.sydney.edu.au/handbooks/engineering-pg/engineering.html"
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "This master's program comprises core units of study, along with electives to broaden your knowledge. A sequence of specialist units is completed that comprise a stream in your chosen field.",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "gates": {
