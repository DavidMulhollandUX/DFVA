...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "The course prepares pharmacists for advanced health care practice roles in acute care, primary care, aged care or research."
    ]
  },
  "C2": {
    "score": 2,
    ...
    "evidenceLines": [
      ...
      "It is designed to develop advanced knowledge and skills in therapeutic decision-making, evidence-based practice and person-centred care to improve the quality use of medicines."
    ]
  },
  "C3": {
    "score": 2,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "This course comprises 12 credit points structured into two parts: Part A. Core studies, Part B. Specified elective studies.",
      "The course prepares pharmacists for advanced health care practice roles in acute care, primary care, aged care or research."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Professional Certificate of Advanced Pharmacy Practice.",
      "evidenceLines": [
        "This course comprises 12 credit points structured into two parts: Part A. Core studies, Part B. Specified elective studies.",
        "Part A. Core studies"
      ]
