...
const record: V4PanelC = {
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Bachelor of Applied Science, students must complete 360 credit points consisting of:",
      "Reflect critically on your own cultural attitudes, values and beliefs"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Applied Science.",
      "evidenceLines": [
        "To qualify for the award of Bachelor of Applied Science, students must complete 360 credit points consisting of:",
