...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "**Teaching Location**: External, Herston, St Lucia"
    ]
  },
  "W1": {
    "score": 3,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5704",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Environmental Health Sciences.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Environmental Health Sciences a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
