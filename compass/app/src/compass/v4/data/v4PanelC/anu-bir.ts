...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Mainland Southeast Asia: Colonial and Postcolonial Predicaments (ASIA2041)",
      "Subject: Asian Economies (ASIA2067)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Natural Resource Conflicts in Asia and the Pacific (ASIA2093)",
      "Subject: Human Migration and Expansion in the Rise of the Asia-Pacific (ASIA2301)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**UAC Code**: code 131153 (B International Relations)",
      "Subject: Migration in the Modern World (DEMO2003)",
      "- **Program Duration**: 3 year full-time"
    ]
  },
  "W3": {
