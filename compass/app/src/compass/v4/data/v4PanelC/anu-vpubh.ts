...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Fundamentals of Epidemiology (POPH8100)",
      "Subject: Biostatistics in Population Health (POPH8101)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Health Services Research and Policy (POPH8103)",
      "Subject: Public Health Research Project (POPH8106)",
      "**Post Nominal**: Nominal MPubHealthAdv"
    ]
  },
  "W1": {
    "score": 3,
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Research Design and Methods (POPH8315)",
      "- **Career / Study Level**: Postgraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Program Duration**: 2 year full-time",
        "A single two year graduate award offered by theANU College of Law, Governance and Policy"
      ]
    },
    "G2": {
      "result": "PASS",
