...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Ocular Therapy 1 (OPTM7107)",
      "Subject: Ocular Therapy 2 (OPTM7117)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7436",
      "Subject: Ocular Therapy 2 (OPTM7117)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Ocular Therapeutics.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
