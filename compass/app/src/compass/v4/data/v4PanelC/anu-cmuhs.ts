...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Critical Issues in Intangible Heritage (HUMN8035)",
      "Subject: Museums and Collections: Key Concepts and Practices (MUSC8017)",
      "**Post Nominal**: Nominal GCertMusHerSt"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate of Museum and Heritage Studies.",
      "evidenceLines": [
        "- **Program Duration**: 0.5 years",
        "- **Minimum Units Required**: 24 Units"
      ]
