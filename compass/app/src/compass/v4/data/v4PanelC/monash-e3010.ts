...
const record: V4PanelC = {
  ...
  "C2": {
    ...
    "evidenceLines": [
      ...
      "Industries need people who can extract and analyse information from the massive datasets generated by engineering processes and devices."
    ]
  },
  "C3": {
    "score": 3,
    ...
    "evidenceLines": [
      ...
      "Subject: Fundamentals of algorithms for engineers (FIT2085)",
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "Big data presents both a challenge and an opportunity in engineering practice across various industries, ranging from construction and manufacturing, to transport and the energy sector."
    ]
  },
  "C5": {
    "score": 2,
