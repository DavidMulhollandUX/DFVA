...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Organisational Behaviour (Bengaluru) (WCAN1000)",
      "Subject: Business Economics (Bengaluru) (WCAN1001)",
      "**AQF Level**: Level 7"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Accounting (Bengaluru) (WCAN1002)",
      "Subject: Foundations of Management (Bengaluru) (WCAN1003)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4406",
      "Subject: Fundamentals of Data Analysis (Bengaluru) (WCAN1100)",
      "- **Total Units / Units of Credit (UOC)**: 144"
    ]
  },
  "W3": {
