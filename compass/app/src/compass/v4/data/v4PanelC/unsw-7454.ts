...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Financial Management (ZZBU6002)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7454",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Leadership and Organisational Development.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
