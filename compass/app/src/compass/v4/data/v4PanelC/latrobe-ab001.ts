...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "La Trobe’s Bachelor of Global Studies gives you a strong grounding in the issues facing key regions and countries around the world."
    ]
  },
  "C2": {
    "score": 2,
    ...
    "evidenceLines": [
      ...
      "We’ve designed this degree to introduce you to global problems and their policy responses, so you’ll develop the tools to tackle the challenges of the future."
    ]
  },
  "C3": {
    "score": 2,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: INTRODUCTION TO GLOBAL STUDIES (POL1ISP)",
      "Subject: STATES, SECURITY AND INTERNATIONAL RELATIONS (POL1SNS)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: INTERNATIONAL LAW AND ORGANISATIONS (POL2IOL)",
      "Study core subjects examining the history of international relations and geopolitics, contemporary security issues – such as American power, the rise of China, contemporary armed conflict and terrorism – and the emerging challenges of human and environmental security."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Global Studies.",
      "evidenceLines": [
        "Study core subjects examining the history of international relations and geopolitics, contemporary security issues – such as American power, the rise of China, contemporary armed conflict and terrorism – and the emerging challenges of human and environmental security.",
        "To qualify for the award of Bachelor of Global Studies, students must complete 360 credit points consisting of:"
      ]
    },
    "G2": {
      "result": "PASS",
