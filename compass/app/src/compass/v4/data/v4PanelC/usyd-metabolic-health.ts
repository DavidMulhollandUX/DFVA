...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: metabolic-health",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/medicine-health-pg/coursework/metabolic-health.html"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Advanced Diabetes Management (MBHT5002)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Obesity and Pre-diabetes: Prevention and Care (MBHT5003)",
      "- **Faculty**: medicine-health-pg"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Metabolic Health.",
      "evidenceLines": [
        "Students must complete 48 credit points, including:",
