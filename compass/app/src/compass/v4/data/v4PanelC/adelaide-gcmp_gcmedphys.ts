...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gcmp_gcmedphys",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Human Biology for Medical Physics (BIOL5019)",
      "Subject: Physics of Medical Imaging (PHYS5003)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gcmp_gcmedphys"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Radiotherapy Physics (RADI5001)",
      "Subject: Human Biology for Medical Physics (BIOL5019)",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Medical Physics.",
      "evidenceLines": [
        "This program provides students with the opportunity to complete the coursework required by the Australasian College of Physical Scientists and Engineers in Medicine (ACPSEM) for accreditation as a medical physicist. All students should be aware that this program has non-standard admission requirements and they should contact the School of Physical Sciences for further information.",
