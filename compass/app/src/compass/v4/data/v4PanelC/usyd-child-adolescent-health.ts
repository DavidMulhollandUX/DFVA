...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: child-adolescent-health",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Clinical Psychiatry I (BMRI5003)",
      "Subject: Project (Advanced Masters) (MEDF5301)",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/medicine-health-pg/coursework/child-adolescent-health.html"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Neonatal Medicine (PAED5000)",
      "- **Faculty**: medicine-health-pg"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Child and Adolescent Health.",
      "evidenceLines": [
        "Students must complete 48 credit points, including:",
