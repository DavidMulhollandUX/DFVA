...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Masters Research Project in Geoscience Part 1 (GEOS5011)",
      "Subject: Masters Research Project in Geoscience Part 2 (GEOS5012)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=70590"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Masters Research Project in Geoscience Part 3 (GEOS5013)",
      "Subject: Masters Research Project in Geoscience Part 4 (GEOS5014)",
      "**Academic Year**: 2026"
    ]
  },
  "W1": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Ore Deposit Geology.",
      "evidenceLines": [
        "website for details on admission requirements, intake periods, fees, availability to international students, careers information etc.",
