...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Coaching and Mentoring in Educational Leadership (EDST5127)",
      "Subject: Evaluation of Educational Programs (EDST5436)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Leadership Theory, Research and Practice (EDST5438)",
      "Subject: Literature Review in Education (EDST5457)",
      "**CRICOS Code**: 068874K"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7960",
      "Subject: Teacher Leadership (EDST5462)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Educational Leadership.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
