...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/5876",
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 48",
        "Through a combination of core and elective courses, the program emphasises real-world application, preparing you to lead change, integrate ESG principles, and harness digital transformation. You will develop the capabilities to manage schedules, budgets and risks while aligning projects with broader organisational objectives."
      ]
    },
    "G2": {
      "result": "PASS",
