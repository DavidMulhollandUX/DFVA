...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Society and Environmental Change (ENVS6013)",
      "Subject: Human Ecology (ENVS6020)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Participatory Resource Management: Working with Communities and Stakeholders (ENVS6021)",
      "Subject: Biodiversity Conservation (ENVS6024)",
      "**Post Nominal**: Nominal GCertEnv"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate of Environment.",
      "evidenceLines": [
        "- **Program Duration**: 0.5 years",
        "- **Minimum Units Required**: 24 Units"
      ]
