...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "This double degree course in engineering and biomedical science can lead to a rewarding career designing medical technology to improve human lives."
    ]
  },
  "C2": {
    "score": 3,
    ...
    "evidenceLines": [
      ...
      "Applied class quizzes: 10% (Hurdle: None)",
      "Advances in biological sciences and demand for technological solutions are creating new opportunities for engineers."
    ]
  },
  "C3": {
    "score": 3,
    ...
    "evidenceLines": [
      ...
      "Semester 1 - Seminar quizzes: 10% (Hurdle: Competency)"
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      "Mid-term test: 20% (Hurdle: None)",
      "Assignments: 10% (Hurdle: None)",
      "In the next 25 years, engineering will be transformed as it fuses with developments in biomedical science."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "W1": {
    ...
    "evidenceLines": [
      "Semester 2, Oct - Competency hurdle quizzes: 10% (Hurdle: Competency)",
      "This double degree course in engineering and biomedical science can lead to a rewarding career designing medical technology to improve human lives.",
      "Advances in biological sciences and demand for technological solutions are creating new opportunities for engineers."
    ]
  },
