...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Advanced Research Methods and Statistics (PSYC5201)",
      "Subject: History and Professional Ethics in Psychology  (PSYC5202)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Application of Psychological Practice  (PSYC5203)",
      "Subject: Behavioural Neuroscience (PSYC5204)",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "**Academic Organisation**: School of Psychology",
      "- **Institution**: University of New South Wales (UNSW Sydney)",
      "- **Study Level**: Postgraduate"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/5332",
      "Subject: Mental Health and Illness (PSYC5205)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "W3": {
