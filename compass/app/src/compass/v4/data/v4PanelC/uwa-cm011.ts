...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CM011"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of  Marine Science and Master of Environmental Science.",
      "evidenceLines": [
        "Students completing this double packaged award course will graduate with both a Bachelor of Marine Science Science majoring in Marine Science, and a Master of Environmental Science, Marine and Coastal Management.",
