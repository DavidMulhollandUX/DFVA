...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: bengh_behass1",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Design Studio I (ARCH1022)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/bengh_behass1"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Representation I (ARCH1015)",
      "Subject: Construction I (BLDG1014)",
