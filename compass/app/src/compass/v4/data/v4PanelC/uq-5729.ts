...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Digital Health in Action (CIDH7302)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Data, Analytics and AI for Healthcare (CIDH7303)",
      "Subject: Re-imagining Healthcare (CIDH7304)",
      "**Teaching Location**: External"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5729",
      "Subject: Re-imagining Healthcare (CIDH7304)",
      "- **Teaching Location**: External"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Clinical Informatics and Digital Health.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Certificate in Clinical Informatics and Digital Health a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
