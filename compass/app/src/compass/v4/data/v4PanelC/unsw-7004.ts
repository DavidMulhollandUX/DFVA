...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: myBCom Blueprint (COMM0999)",
      "Subject: myBCom First Year Portfolio (COMM1999)",
      "**AQF Level**: Level 5"
    ]
  },
  "C4": {
    ...
    "evidenceLines": [
      "**Total Units / Units of Credit (UOC)**: 54",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Managing Organisations and People (DPBS1001)",
      "Subject: Global Business Environment (DPBS1002)",
      "**CRICOS Code**: 102394F"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/7004",
      "Subject: Marketing Fundamentals (DPBS1012)",
      "- **Total Units / Units of Credit (UOC)**: 54"
    ]
  },
  "W3": {
