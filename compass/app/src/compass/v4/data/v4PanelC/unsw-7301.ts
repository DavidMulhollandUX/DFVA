...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Employment Law (ZZBU6414)",
      "Subject: Law, Regulation and Ethics (ZZLJ8100)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Corporate Governance and Leadership (ZZLJ8211)",
      "Subject: Commercial Contract Law (ZZLJ8212)",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "**Academic Organisation**: School of Private and Commercial Law",
      "- **Institution**: University of New South Wales (UNSW Sydney)",
      "- **Study Level**: Postgraduate"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7301",
      "Subject: Cyber and the Law (ZZLJ9223)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Business Law.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
