...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gdcum_gdcmusst",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Making a museum (LIBR5003)",
      "Subject: The Secret Life of Objects: Museums in Practice (LIBR5005)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gdcum_gdcmusst"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Digital Exhibition Project: Art History (PG) (HIST5001)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: OL Digital Exhibition Project: Art History (PG) (HIST5008)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Curatorial and Museum Studies.",
      "evidenceLines": [
        "This program in Curatorial and Museum Studies offers students core courses in museology and practice in conjunction with academic extension through the choice of elective courses. Students may also take a Work Integrated Learning course.",
