...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Economics in Management Practice (AGSM9122)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
    ...
    "evidenceLines": [
      "**Total Units / Units of Credit (UOC)**: 120",
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Advanced Finance (AGSM9137)",
      "**CRICOS Code**: 109016J"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8359",
      "Subject: Financial Analysis (AGSM9138)",
      "- **Total Units / Units of Credit (UOC)**: 120"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 120",
        "Students must complete 120 Units of Credit (UOC) structured across the following academic components:"
      ]
    },
    "G2": {
      "result": "PASS",
