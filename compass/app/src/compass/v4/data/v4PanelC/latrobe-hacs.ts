...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: SOCIOLOGY OF EMOTIONS (SOC2SEM)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: FAMILIES, INTIMACY AND SOCIAL CHANGE: THE SOCIOLOGY OF RELATIONSHIPS (SOC2SOR)",
      "Recall important details regarding the history, culture, customs and people of Indigenous Australia"
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Associate Degree of Community Services, students must complete 240 credit points consisting of:",
      "Reflect critically on your own cultural attitudes, values and beliefs"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Associate Degree of Community Services.",
      "evidenceLines": [
        "To qualify for the award of Associate Degree of Community Services, students must complete 240 credit points consisting of:",
        "120 credit points block credit awarded upon admission to the Bachelor of Community Services"
      ]
    },
    "G2": {
      "result": "PASS",
