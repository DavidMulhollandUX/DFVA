...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Research Integrated Learning  (FADA3900)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: ADA Professional Placement (FADA6700)",
      "Subject: Personalised English Language Enhancement (HUMS1005)",
      "**CRICOS Code**: 052229D"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3783",
      "Subject: Presentation and Communication Skills (HUMS1006)",
      "- **Total Units / Units of Credit (UOC)**: 192"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Computer Science / Arts.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 192",
        "The double degree BSc (Computer Science) BA enables students to complete the requirements of the BSc (Computer Science) and a Bachelor of Arts program from the Faculty of Arts, Design and Architecture."
      ]
    },
    "G2": {
      "result": "PASS",
