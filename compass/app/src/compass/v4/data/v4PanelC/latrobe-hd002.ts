...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: FROM BAD SCIENCE TO GOOD HEALTH (HLT1001)",
      "This course is an exit only award."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Diploma in Health and Human Bioscience.",
      "evidenceLines": [
        "This course is an exit only award.",
        "To qualify for the award of Diploma in Health and Human Bioscience, students must complete 120 credit points consisting of:"
      ]
    },
    "G2": {
      "result": "PASS",
