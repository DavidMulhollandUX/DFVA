...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Foundations of Marketing (ZZBU6004)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8513",
      "Subject: Attracting, Evaluating and Retaining Talent (ZZBU6405)",
      "- **Total Units / Units of Credit (UOC)**: 72"
    ]
  },
  "W3": {
