...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Space Operations (ZEIT8007)",
      "Subject: Space Systems Design (ZEIT8008)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Global Navigation Satellite Systems (GNSS) (ZEIT8009)",
      "Subject: Space Systems Engineering Management (ZEIT8012)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7346",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Space Engineering.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
