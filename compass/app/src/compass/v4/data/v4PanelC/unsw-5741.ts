...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Law and Regulations in Aviation (AVIA5001)",
      "Subject: Aviation and Security (AVIA5003)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Airline Resource Management (AVIA5005)",
      "Subject: Airport Planning (AVIA5006)",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "**Academic Organisation**: School of Aviation",
      "- **Institution**: University of New South Wales (UNSW Sydney)",
      "- **Study Level**: Postgraduate"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/5741",
      "Subject: Airport Operations Management (AVIA5007)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Aviation Management.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 48",
        "The Graduate Diploma in Aviation Management (GradDipAvMgmt) is a 48 UoC program of study designed to provide professionals with the skills and knowledge to be effective in a contemporary aviation environment. Prospective students do not need to hold a University degree to enrol in the GradDipAvMgmt, but must have a minimum of one (1) year of relevant industry experience. Evidence of industry experience will need to be provided upon application and will be reviewed by the School of Aviation to determine its relevance for program entry."
      ]
    },
    "G2": {
      "result": "PASS",
