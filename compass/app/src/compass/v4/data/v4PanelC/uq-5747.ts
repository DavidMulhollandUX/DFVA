...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Compilers and Interpreters (COMP4403)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5747",
      "Subject: Advanced Algorithms and Data Structures (COMP4500)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Software Engineering.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Software Engineering (Professional) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
