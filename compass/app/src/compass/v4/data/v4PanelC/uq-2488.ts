...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Sustainability Reporting and Assurance (ACCT2103)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2488",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelors of Engineering.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelors of Engineering (Honours) / Commerce a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
