...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4733",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Commerce / Law.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 240",
        "The program is a five year full-time program leading to the award of the two degrees of Bachelor of Commerce and Bachelor of Laws (BCom/LLB)."
      ]
    },
    "G2": {
      "result": "PASS",
