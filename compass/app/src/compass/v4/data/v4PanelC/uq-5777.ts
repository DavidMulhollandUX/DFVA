...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Ethical and Sustainable HR Strategies (MGTS7622)",
      "Subject: Introduction to Psychology: Understanding How People Think, Feel and Act (PSYC7401)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Performance Psychology: Unlocking Human Potential (PSYC7402)",
      "Subject: The Psychology of People at Work (PSYC7403)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5777",
      "Subject: The Psychology of People at Work (PSYC7403)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Business Psychology.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Certificate in Business Psychology a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
