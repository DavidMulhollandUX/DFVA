...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Social Media Communication (COMU3150)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2504",
      "Subject: Writing Creatively (WRIT1200)",
      "- **AQF Level**: Refer to your component degrees for AQF level."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelors of Communication / Arts.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelors of Communication / Arts a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
