...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Lower Limb and Lumbar Region Injuries in Sport Medicine (SPMD7004)",
      "Subject: Special Groups in Sports Medicine (SPMD7002)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5290",
      "Subject: Lower Limb and Lumbar Region Injuries in Sport Medicine (SPMD7004)",
      "- **Faculty**: of Health and Behavioural Sciences"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Sports Medicine.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Certificate in Sports Medicine a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
