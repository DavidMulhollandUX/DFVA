...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Environment and Society (ARTS1240)",
      "Subject: Environmental Advocacy and Activism (ARTS1241)",
  ...
  "C4": {
    ...
    "evidenceLines": [
      "**Total Units / Units of Credit (UOC)**: 216",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Academic Writing for the Humanities (ARTS2050)",
      "Subject: Environment, Sustainability and Development (ARTS2240)",
      "**CRICOS Code**: 081121J"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3955",
      "Subject: The Animal: Worker, Wild, Extinct? (ARTS2244)",
      "- **Total Units / Units of Credit (UOC)**: 216"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Environmental Management / Arts.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 216",
        "The Faculty of Science and the Faculty of Arts, Design and Architecture offer a double degree program which qualifies students for two degrees after the equivalent of four and a half years of successful full-time study leading to the award of the degrees Bachelor of Environmental Management and Bachelor of Arts."
      ]
    },
    "G2": {
      "result": "PASS",
