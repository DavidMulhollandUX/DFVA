...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Reporting for Climate Change and Sustainability (ACCT5961)",
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "**Delivery Mode**: Distance (online with some face-to-face), Face-to-face (includes blended)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: The Science of Science Communication (BEES6800)",
      "**CRICOS Code**: 033884G"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7339",
      "Subject: Geographical Information Systems and Urban Informatics (BENV7728)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Environmental Management.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
