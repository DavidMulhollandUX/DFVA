...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Ventilation and Mine Services (MINE9901)",
      "Subject: Environmental Contaminants (MINE9902)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Heat in Underground Mines (MINE9903)",
      "Subject: Ventilation System Management (MINE9904)",
      "**CRICOS Code**: 117246F"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/5046",
      "Subject: Coal Mine Hazards and Control (MINE9905)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Mine Ventilation.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 48",
