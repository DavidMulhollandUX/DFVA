...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gdwib_gdwinebus",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gdwib_gdwinebus"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Direct Wine Marketing and Cellar Door Management (WINE5009)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Wine Retailing (WINE5012)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Wine Business.",
      "evidenceLines": [
        "The Graduate Diploma in Wine Business is an AQF Level 8 qualification with a standard full-time duration of 1 year.",
