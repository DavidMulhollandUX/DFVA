...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Accounting and Business Analysis (ACCT7804)",
      "Subject: Financial Management (FINM7805)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Strategy: From Design to Practice (MGTS7803)",
      "Subject: Leading People and Teams (MGTS7810)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5769",
      "Subject: Resonant Leadership (MGTS7812)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Business Administration.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Certificate in Business Administration a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
