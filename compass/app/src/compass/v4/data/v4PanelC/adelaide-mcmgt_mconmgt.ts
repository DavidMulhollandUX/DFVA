...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: mcmgt_mconmgt",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Building Services and Environment (BLDG6002)",
      "Subject: Construction Management and Technology 1 (BLDG5000)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/mcmgt_mconmgt"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Cost Planning and Management (BLDG5003)",
      "Subject: Construction Management and Technology 2 (BLDG5004)",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Construction Management.",
      "evidenceLines": [
        "The Master of Construction Management is an AQF Level 9 qualification with a standard full-time duration of 2 years.",
