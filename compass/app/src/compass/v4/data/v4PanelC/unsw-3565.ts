...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Creating Your Career: Employability for the Future (CDEV2000)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3565",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Commerce.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 192",
        "The BCom (Co-op) (Honours) combines the requirements of the degree with 18 months of coordinated industry placement at three different sponsoring organisations. The industry placement extends outside university terms."
      ]
    },
    "G2": {
      "result": "PASS",
