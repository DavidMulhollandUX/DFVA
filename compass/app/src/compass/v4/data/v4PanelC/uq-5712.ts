...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Calculus & Linear Algebra II (MATH7000)",
      "Subject: Applied Mathematical Analysis (MATH7100)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Linear & Abstract Algebra & Number Theory (MATH7307)",
      "Subject: Discrete Mathematics II (MATH7308)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5712",
      "Subject: Mathematical Analysis (MATH7400)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Science.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Science a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
