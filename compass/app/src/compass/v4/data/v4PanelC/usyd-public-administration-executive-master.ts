...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: public-administration-executive-master",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
    ...
    "evidenceLines": [
      "**Academic Year**: 2026",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/arts-pg/coursework-areas/public-administration-executive-master.html",
      "- **Course / Program Identifier**: public-administration-executive-master"
    ]
  },
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: International Business Strategy (IBUS6001)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Computing 1A Professionalism (INFO1111)",
      "Subject: Understanding IT Innovations (INFO5992)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: War Law: Use of Force and Humanitarian Law (LAWS3483)",
      "- **Handbook URL**: https://www.sydney.edu.au/handbooks/arts-pg/coursework-areas/public-administration-executive-master.html"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Executive Master of Public Administration.",
      "evidenceLines": [
        "Students must complete 72 credit points, comprising:",
