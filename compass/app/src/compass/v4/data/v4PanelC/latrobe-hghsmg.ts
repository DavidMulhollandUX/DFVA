...
const record: V4PanelC = {
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Graduate Diploma in Health Services Management, students must complete 120 credit points in total, consisting of:",
      "Assess digital health opportunities to address identified problems of efficiency and effectiveness."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Health Services Management.",
      "evidenceLines": [
        "To qualify for the award of Graduate Diploma in Health Services Management, students must complete 120 credit points in total, consisting of:",
