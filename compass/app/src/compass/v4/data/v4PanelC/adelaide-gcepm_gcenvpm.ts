...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gcepm_gcenvpm",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Environmental Planning and Governance (UoA) (ENVI5015)",
      "Subject: Environmental Planning and Governance (BIOL5018)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gcepm_gcenvpm"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Global Food and Agricultural Policy Analysis (ECON5018)",
      "Subject: Global Food & Agricultural Policy Analysis (AGRI5002)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Environmental and Resource Economics and Applications (ECON6004)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "The Graduate Certificate in Environmental Policy and Management is an AQF Level 8 qualification with a standard full-time duration of 0.5 years.",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Environmental Policy and Management.",
      "evidenceLines": [
        "The Graduate Certificate in Environmental Policy and Management is an AQF Level 8 qualification with a standard full-time duration of 0.5 years.",
