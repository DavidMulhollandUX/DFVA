...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Microeconomic Policy (ECON2030)",
      "Subject: Honours Thesis (ECON6910)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Financial Institutions Management (FINM3414)",
      "Subject: Applied Research Project (RBUS4411)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2140",
      "Subject: Honours Thesis A (RBUS6996)",
      "- **Faculty**: of Business, Economics and Law"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Advanced Finance and Economics.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Advanced Finance and Economics (Honours) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
