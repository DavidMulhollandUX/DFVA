...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Medicinal Chemistry Honours Coursework (CHEM4503)",
      "Subject: Driving Behaviour Change 2 (HLTH3000)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject:  Leading Change in the Health Professions (HLTH3001)",
      "Subject: Identifying and Solving Clinical Problems (HLTH4000)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/9067",
      "Subject: Preparing for a Career in Health and Beyond (HLTH5000)",
      "- **Total Units / Units of Credit (UOC)**: 144"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Pharmacy.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 144",
