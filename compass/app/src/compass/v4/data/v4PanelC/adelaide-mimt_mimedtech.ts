...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: mimt_mimedtech",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Immersive Media Asset Generation (MDIA5012)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/mimt_mimedtech"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Immersive Media Development (MDIA5014)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Media Masters Research Methods (MDIA6004)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "The Master of Immersive Media Technologies is an AQF Level 9 Masters qualification with a standard full-time duration of 2 years. Students may be eligible to complete the program in a full-time standard duration of 1.5 years on the basis of prior learning.",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Immersive Media Technologies.",
      "evidenceLines": [
        "The Master of Immersive Media Technologies is an AQF Level 9 Masters qualification with a standard full-time duration of 2 years. Students may be eligible to complete the program in a full-time standard duration of 1.5 years on the basis of prior learning.",
