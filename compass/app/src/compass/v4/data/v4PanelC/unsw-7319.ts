...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Animation Studio (DART9001)",
      "Subject: VFX Studio (DART9002)",
      "**CRICOS Code**: 113672J"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7319",
      "Subject: Motion Capture Studio (DART9101)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Animation and Visual Effects.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
