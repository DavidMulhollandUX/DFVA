...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Aeronautical Knowledge for Aviation Managers (AVIA1011)",
      "Subject: Airworthiness Management (AVIA1301)",
      "**AQF Level**: Level 7"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Human Factors: The Safety Science of Human Performance (AVIA1401)",
      "Subject: Aviation Transport Economics (AVIA1901)",
      "**CRICOS Code**: 018567B"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3981",
      "Subject: Advanced Human Factors (AVIA2011)",
      "- **Total Units / Units of Credit (UOC)**: 144"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Aviation.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 144",
        "The 3981 Bachelor of Aviation in Management program is a 144 UOC undergraduate program offered by UNSW Aviation through the Faculty of Science and resides within a suite of undergraduate aviation programs under UNSW Aviation, including the Bachelor of Aviation in Flying (3980) and the Bachelor of Aviation in Remotely Piloted Aircraft Systems."
      ]
    },
    "G2": {
      "result": "PASS",
