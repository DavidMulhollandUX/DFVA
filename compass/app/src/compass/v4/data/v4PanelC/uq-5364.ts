...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Cyber Security Governance, Policy, Ethics and Law (CYBR7003)",
      "Subject: Health Economics and Policy (ECON7830)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5364",
      "Subject: Conservation Policy (ENVM7505)",
      "- **Faculty**: of Humanities and Social Sciences"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Governance and Public Policy.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Certificate in Governance and Public Policy a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
