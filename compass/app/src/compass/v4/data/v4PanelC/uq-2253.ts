...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Research and Evidence-Based Practice for Hons (HLTH6010)",
      "Subject: Introduction to Biostatistics for Hons (HLTH6011)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Foundations of Public Health for Hons (HLTH6012)",
      "Subject: Research Thesis (HLTH6014)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2253",
      "Subject: Qualitative Research for Hons (HLTH6015)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Health Sciences (Honours) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
