...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "The La Trobe Professional Certificate in Business Administration is an AI-first, fully online course from La Trobe University designed for professionals who want to build leadership capability for an AI-driven economy."
    ]
  },
  "C2": {
    "score": 2,
    ...
    "evidenceLines": [
      ...
      "Delivered in flexible six-week study blocks, you can study from anywhere while developing practical skills in generative AI, economic analysis and strategic decision-making."
    ]
  },
  "C3": {
    "score": 2,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "This short qualification provides a focused entry point into postgraduate business study."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Professional Certificate in Business Administration, students must complete 30 credit points consisting of:",
      "The La Trobe Professional Certificate in Business Administration is an AI-first, fully online course from La Trobe University designed for professionals who want to build leadership capability for an AI-driven economy."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Professional Certificate in Business Administration.",
      "evidenceLines": [
        "To qualify for the award of Professional Certificate in Business Administration, students must complete 30 credit points consisting of:",
