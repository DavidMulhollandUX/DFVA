...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Foundations in Macroeconomics (ECON7001)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5684",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Sustainable Energy.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Sustainable Energy a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
