...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Asia and the Pacific: Power, diversity and change (ASIA1025)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Asia and the Pacific in Motion (ASIA1030)",
      "Subject: Introduction to Asian Politics (ASIA1035)",
      "**Post Nominal**: Nominal BPSc"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**UAC Code**: code 131162 (Bachelor of Political Science)",
      "Subject: The Origins of Political Order in Asia (ASIA1999)",
      "- **Career / Study Level**: Undergraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Political Science.",
      "evidenceLines": [
        "- **Program Duration**: 3 year full-time",
        "- **Minimum Units Required**: 144 Units"
      ]
