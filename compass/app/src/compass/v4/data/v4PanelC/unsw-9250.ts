...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Taxation of Commercial Transactions (TABL5501)",
      "Subject: Advanced Corporate Tax (TABL5503)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
    ...
    "evidenceLines": [
      ...
      "**Delivery Mode**: Distance (online with some face-to-face), Fully online, Face-to-face (includes blended)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Advanced Taxation of Trusts (TABL5505)",
      "Subject: Tax Administration (TABL5506)",
      "**CRICOS Code**: 015849E"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/9250",
      "Subject: Tax Controversy (TABL5509)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Taxation.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 48",
        "The program consists of three compulsory core courses and a compulsory capstone with the other four courses drawn from electives catering for individual students' career needs, aspirations and interests. These range through personal tax and financial planning, indirect taxes, corporate and commercial tax matters to international tax."
      ]
    },
    "G2": {
      "result": "PASS",
