...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Organisational Behaviour (ZBUS8102)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7595",
      "Subject: Accounting for Management Decisions (ZBUS8108)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
