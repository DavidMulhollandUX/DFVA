...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: environmental-law",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
    ...
    "evidenceLines": [
      "**Academic Year**: 2026",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/law/postgraduate/environmental-law.html",
      "- **Course / Program Identifier**: environmental-law"
    ]
  },
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Law and Economics (LAWS3447)",
      "Subject: Development, Law and Human Rights (LAWS3478)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Environmental Law (LAWS5130)",
      "Subject: Development, Law and Human Rights (LAWS5178)",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "Structured class participation (10%) Class participation: 10%: Ongoing% (Hurdle: False)",
      "- **Institution**: The University of Sydney (USYD)",
      "- **Course / Program Identifier**: environmental-law"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "Early feedback task (0%) Quiz: 0%: Week 03 Due date : 19 Aug 2026 at 23:59% (Hurdle: False)",
      "Subject: Judicial Review-P'ciple, Pol and Procedure (LAWS6068)",
      "- **Handbook URL**: https://www.sydney.edu.au/handbooks/law/postgraduate/environmental-law.html"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Environmental Law.",
      "evidenceLines": [
        "Exemption from core units of study should not be assumed to be automatic. Formal approval must be obtained from the University of Sydney Law School prior to enrolment.",
