...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Leading Change for Sustainability (COMM5205)",
      "Subject: Social Impact (COMM5701)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Social Impact Investment (COMM5703)",
      "Subject: Demonstrating Social Impact (COMM5704)",
      "**CRICOS Code**: 0100131"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7357",
      "Subject: Design for Social Innovation (COMM5706)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Social Impact.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
