...
const record: V4PanelC = {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "* Completion requirements",
        "This course is being phased out. No new enrolments will be permitted from 2022. Prospective students should see the requirements for the Bachelor of Business with a Sport Management Major."
      ]
    },
    "G2": {
      "result": "PASS",
