...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Introductory Biology (BIOL1000)",
      "Subject: Introduction to Environmental Studies (ENVM1501)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Carbon and Energy Management (ENVM1522)",
      "Subject: Marine & Coastal Environmental Protection (ENVM2002)",
      "**Teaching Location**: St Lucia"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2376",
      "Subject: Cultural Heritage Management (ENVM2008)",
      "- **Teaching Location**: St Lucia"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Environmental Management.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Environmental Management (Honours) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
