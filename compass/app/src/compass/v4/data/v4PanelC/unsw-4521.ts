...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Critical Review of Literature (ARCH1481)",
      "Subject: Honours Thesis (ARCH1483)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Architecture and Politics (ARCH7214)",
      "**CRICOS Code**: 088836F"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4521",
      "Subject: Advanced Themes in Australian Architecture (ARCH7215)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Architectural Studies.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 48",
