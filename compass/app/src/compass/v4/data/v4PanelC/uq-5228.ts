...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Anatomy and Neuroanatomy Fundamentals for Speech Pathologists (ANAT7002)",
      "Subject: Health Sciences Research Discovery II (HRSS7101)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Health Sciences Research Evaluation II (HRSS7102)",
      "Subject: Health Sciences Research Advanced Project II (HRSS7300)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5228",
      "Subject: Communication & Feeding Skills in Children I & Professional Practice I (SPCH7111)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Speech Pathology Studies.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Speech Pathology Studies a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
