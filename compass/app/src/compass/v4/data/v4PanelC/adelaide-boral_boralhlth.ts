...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: boral_boralhlth",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Population Health and Professional Practice IIOH (DENT2009)",
      "Subject: Population Health and Professional Practice IIOH (DENT2009)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/boral_boralhlth"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Oral Health.",
      "evidenceLines": [
        "The Bachelor of Oral Health is an AQF Level 7 qualification with a standard full-time duration of 3 years.",
