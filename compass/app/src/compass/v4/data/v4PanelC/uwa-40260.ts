...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Demonstrating Social Impact (MGMT5514)",
      "Subject: Social Impact: Entrepreneurs and Social Innovation (MGMT5516)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=40260"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Leadership for Social Impact (MGMT5517)",
      "Subject: Social Investment and Philanthropy (MGMT5518)",
      "**Academic Year**: 2026"
    ]
  },
  "W1": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Social Impact.",
      "evidenceLines": [
        "This course is designed for senior, middle and emerging management in the not-for-profit or 'community benefit' sector. The units have been formulated specifically for this course.",
