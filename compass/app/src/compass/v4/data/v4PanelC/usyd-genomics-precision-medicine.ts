...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: genomics-precision-medicine",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/medicine-health-pg/coursework/genomics-precision-medicine.html"
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      ...
      "LO2 . Use appropriate strategies to search the published literature, write a thematic literature review and confidently use a referencing management system",
      "- **Faculty**: medicine-health-pg"
    ]
  },
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Pathogen Genomics (PGEN5001)",
      "LO3 . Choose appropriate and ethical methods to address the research question of interest"
    ]
  },
  "W1": {
    "score": 3,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "LO5 . Collect information using appropriate research methods to address study aims",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Genomics and Precision Medicine.",
      "evidenceLines": [
        "Students must complete 48 credit points, including:",
