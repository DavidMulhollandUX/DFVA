...
const record: V4PanelC = {
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Bachelor of Human Services, students must complete 360 credit points consisting of:",
      "Reflect critically on your own cultural attitudes, values and beliefs"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Human Services.",
      "evidenceLines": [
        "To qualify for the award of Bachelor of Human Services, students must complete 360 credit points consisting of:",
