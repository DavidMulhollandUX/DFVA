...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Introduction to Programming (CSSE7030)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Social and Mobile Computing (DECO3500)",
      "Subject: Advanced Human-Computer Interaction (DECO6500)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5369",
      "Subject: Design Thinking (DECO7110)",
      "- **Faculty**: of Engineering, Architecture and Information Technology"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Interaction Design.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Certificate in Interaction Design a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
