...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Music Technology (MUSC1010)",
      "Subject: Western Art Music 1700-1900: Approaches and Concepts (MUSC1050)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Guitar (MUSC1150)",
      "Subject: Practical Studies 2 (MUSC1260)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2545",
      "Subject: Introduction to Music Psychology (MUSC1300)",
      "- **AQF Level**: Refer to your component degrees for AQF level."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Music/Diploma in Languages.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Music/Diploma in Languages a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
