...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Finance and Investment Appraisal (ZBUS8105)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Change Management (ZBUS8203)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8399",
      "Subject: Logistics Management (ZBUS8302)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Capability Management.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 48",
        "The Master of Capability Management is a postgraduate award offered by the School of Business. It is designed for postgraduate scholars and professional managers with appropriate undergraduate qualifications in management or a related discipline and/or extensive relevant professional experience who wish to gain a more detailed understanding of the managerial and technical skills and expertise relevant to planning and acquisition of complex technology and systems."
      ]
    },
    "G2": {
      "result": "PASS",
