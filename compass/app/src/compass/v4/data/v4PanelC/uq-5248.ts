...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Tools and Techniques for Business Analysis (MGTS7301)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Business and Society (MGTS7608)",
      "Subject: Management Communication (MGTS7610)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5248",
      "Subject: Management Communication (MGTS7610)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Certificate in Business a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
