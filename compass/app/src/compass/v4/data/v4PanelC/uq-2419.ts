...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Biodiversity & Systematics (BIOL3209)",
      "Subject: Vertebrate Diversity & Evolution (BIOL3320)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Risk Management (OHSS3002)",
      "Subject: Science Engagement in the Community (SCIE3010)",
      "**Teaching Location**: Gatton"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2419",
      "Subject: Data Science for Life and Environmental Scientists (SCIE3360)",
      "- **Teaching Location**: Gatton"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Wildlife Science.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Wildlife Science (Honours) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
