...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: ANALYSING AND COMBINING WORDS (HCS2ACW)",
      "This course is an exit only award."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Diploma in Allied Health Sciences.",
      "evidenceLines": [
        "This course is an exit only award.",
        "To qualify for the award of Diploma in Allied Health Sciences, students must complete 120 credit points consisting of:"
      ]
    },
    "G2": {
      "result": "PASS",
