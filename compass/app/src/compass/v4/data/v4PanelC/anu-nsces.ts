...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Research Project in Earth Science (EMSC8025)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Natural Hazards (EMSC8706)",
      "Subject: Research Methods for Earth Sciences (EMSC8017)",
      "**Post Nominal**: Nominal MSciEarthSci"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Science in Earth Sciences.",
      "evidenceLines": [
        "- **Program Duration**: 2 year full-time",
