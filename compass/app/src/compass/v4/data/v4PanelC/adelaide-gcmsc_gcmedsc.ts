...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gcmsc_gcmedsc",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Media Relations (MDIA2009)",
      "Subject: Strategic Communication Contexts (MDIA5000)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gcmsc_gcmedsc"
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      "Identify and evaluate the role of media relations techniques in shaping contemporary communication practices across not-for-profit, government and corporate sectors.",
      "Identify the relationship between media relations and media outlets, and how media relations are used to influence an organisation’s positive reputation in the media.",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Risk and Crisis Communication (MDIA5018)",
      "Subject: Leadership in Strategic Communication (MDIA5016)",
      "Apply knowledge of key media relations theories to the development of media relations activities."
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Communicating with Impact (MDIA5017)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Media.",
      "evidenceLines": [
        "The Graduate Certificate in Media (Strategic Communication) is an AQF Level 8 qualification with a standard full-time duration of 0.5 years",
