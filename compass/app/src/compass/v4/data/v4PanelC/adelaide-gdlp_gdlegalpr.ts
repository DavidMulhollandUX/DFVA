...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gdlp_gdlegalpr",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Civil Litigation Practice (LAWS5079)",
      "Subject: OL Civil Litigation Practice (LAWS5092)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gdlp_gdlegalpr"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Commercial and Corporate Practice (LAWS5080)",
      "Subject: OL Commercial and Corporate Practice (LAWS5093)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Property Law Practice (LAWS5088)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Legal Practice.",
      "evidenceLines": [
        "The Graduate Diploma in Legal Practice is an AQF Level 8 qualification with a standard full-time duration of 1 year.",
