...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "The Diploma in Community Healthcare is an exit only award from the Bachelor of Paramedic Practice with Honours."
    ]
  },
  "C2": {
    "score": 3,
    ...
    "evidenceLines": [
      ...
      "This one year course gives you an overview of rural health sciences."
    ]
  },
  "C3": {
    "score": 2,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "You will learn culturally sensitive practices that promote First Nations health, strategies to engage with rural communities and explore the role of the paramedic in the community."
    ]
  },
  "C5": {
    "score": 2,
    ...
    "evidenceLines": [
      ...
      "Subject: COMMUNICATING IN HEALTH SCIENCES (HLT1CHS)",
  ...
  "W3": {
    ...
    "evidenceLines": [
      "The Diploma in Community Healthcare is an exit only award from the Bachelor of Paramedic Practice with Honours. This one year course gives you an overview of rural health sciences. You will learn culturally sensitive practices that promote First Nations health, strategies to engage with rural communities and explore the role of the paramedic in the community.",
      "The Diploma in Community Healthcare is an exit only award from the Bachelor of Paramedic Practice with Honours."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Diploma in Community Healthcare.",
      "evidenceLines": [
        "The Diploma in Community Healthcare is an exit only award from the Bachelor of Paramedic Practice with Honours. This one year course gives you an overview of rural health sciences. You will learn culturally sensitive practices that promote First Nations health, strategies to engage with rural communities and explore the role of the paramedic in the community.",
        "To qualify for the award of Diploma in Community Healthcare, students must complete 120 credit points as follows:"
      ]
    },
    "G2": {
      "result": "PASS",
