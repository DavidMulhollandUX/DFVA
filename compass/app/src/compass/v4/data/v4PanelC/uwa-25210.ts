...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Urban Design Studio 2 (URBD5802)",
      "Subject: Urban Design Studio 1 (URBD5804)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=25210"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Urban Design.",
      "evidenceLines": [
        "website for details on admission requirements, intake periods, fees, availability to international students, careers information etc.",
