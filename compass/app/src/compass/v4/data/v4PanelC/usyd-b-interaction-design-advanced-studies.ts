...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: b-interaction-design-advanced-studies",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: DECO1006 - Design Process and Methods",
      "Subject: DECO1012 - Design Programming",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/architecture/undergraduate/b-interaction-design-advanced-studies.html"
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      "Critically evaluate foundational principles, evidence bases, and contemporary methodologies in design process and methods.",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: DECO1015 - Visual Communication",
      "Subject: DECO1016 - Introduction to Web Design",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: DECO2019 - Qualitative Research in Design",
      "Critically evaluate foundational principles, evidence bases, and contemporary methodologies in design programming.",
      "- **Faculty**: architecture"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Design; Bachelor of Design and Bachelor of Advanced Studies.",
      "evidenceLines": [
        "- **Institution**: The University of Sydney (USYD)",
        "- **Faculty**: architecture"
      ]
