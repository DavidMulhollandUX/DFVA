...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Anthropology of Environmental Disasters (ANTH6064)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Ethnography and Research Ethics Pro-Seminar (ANTH8001)",
      "Subject: Development and Environment: Anthropological Perspectives (ANTH8007)",
      "**Post Nominal**: Nominal MAnthAdv"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Field of Education**: of Education Anthropology",
      "Subject: Doing Ethnography: Research Practicum on Applied Anthropology (ANTH8059)",
      "- **Career / Study Level**: Postgraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Anthropology.",
      "evidenceLines": [
        "- **Program Duration**: 1.5 year full-time",
        "- **Minimum Units Required**: 72 Units"
      ]
