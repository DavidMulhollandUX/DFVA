...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Clinical Reproductive Endocrinology (SWCH9003)",
      "Subject: Female Fertility (SWCH9004)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7379",
      "Subject: Fertility Treatments (SWCH9005)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Reproductive Medicine.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
