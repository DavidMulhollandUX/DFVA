...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gdias_gdintadst",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Biological Basis of Addiction (PHAR5016)",
      "Subject: Public Health Issues and Approaches to Addiction (PHAR5017)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gdias_gdintadst"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Treatment of Addiction: Pharmacotherapies (PHAR5018)",
      "Subject: Treatment of Addiction: Psychosocial Interventions (PHAR5019)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Treatment of Addiction: Critical Issues (PHAR5020)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "The Graduate Diploma in International Addiction Studies is an AQF Level 8 qualification with a standard full-time duration of 1 year or a duration of 2 years part time.",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in International Addiction Studies.",
      "evidenceLines": [
        "The Graduate Diploma in International Addiction Studies is an AQF Level 8 qualification with a standard full-time duration of 1 year or a duration of 2 years part time.",
