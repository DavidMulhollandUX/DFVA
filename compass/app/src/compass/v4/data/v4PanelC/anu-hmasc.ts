...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Diffuse Matter and Star Formation (ASTR4020)",
      "- **Career / Study Level**: Undergraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Mathematical Sciences.",
      "evidenceLines": [
        "- **Program Duration**: 1 year full-time",
        "- **Minimum Units Required**: 48 Units"
      ]
