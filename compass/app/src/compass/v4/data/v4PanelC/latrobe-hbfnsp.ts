...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "Gain the skills to make a difference in people's lives through food and nutrition."
    ]
  },
  "C2": {
    "score": 2,
    ...
    "evidenceLines": [
      ...
      "La Trobe's Bachelor of Food and Nutrition will equip you with the skills and knowledge to work with people, communities and organisations to prevent many chronic diseases."
    ]
  },
  "C3": {
    "score": 2,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "Designed by leading nutrition experts and in collaboration with industry, you'll get a practical hands-on experience while exploring a range of topics such as environmental sustainability of our food system, sustainable diets, food product development, culture and food, and nutrition and disease."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Food and Nutrition.",
      "evidenceLines": [
        "Note: Completion of this course is subject to core participation requirements, essential requirements, and additional costs. Please see the Entry requirements & pathways and Fees & scholarships tabs for more information.",
        "To qualify for the award of Bachelor of Food and Nutrition (HBFN, HBFNBU), students must complete 360 credit points consisting of:"
      ]
    },
    "G2": {
      "result": "PASS",
