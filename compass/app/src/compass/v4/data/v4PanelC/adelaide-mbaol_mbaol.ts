...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: mbaol_mbaol",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Managerial Economics (UoA) (ECON5014)",
      "Subject: Leadership and Influencing (BUSI5091)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/mbaol_mbaol"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Marketing for Managers (BUSI5092)",
      "Subject: Entrepreneurial Mindset (BUSI5093)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Accounting and Financial Management (BUSI5094)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Business Administration [Online].",
      "evidenceLines": [
        "The Master of Business Administration [Online] is a comprehensive degree that explores the core areas of business activity from finance and marketing through to strategy formulation and decision-making. The program also introduces students to the theories of complex systems, organisational behavior and leadership styles. Rigour and relevance are carefully balanced through the application of theory to authentic work place scenarios. Upon graduation  students will have developed a sound understanding of business management practices, organisational cultures and their own leadership style.",
        "The Master of Business Administration [Online] is an AQF Level 9 qualification with a standard full-time duration of 1.5 years. However, this program is only offered part-time for a duration of 2 years."
      ]
    },
    "G2": {
      "result": "PASS",
