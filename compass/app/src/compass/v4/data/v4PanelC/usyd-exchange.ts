...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: exchange",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
    ...
    "evidenceLines": [
      "**Academic Year**: 2026",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/arts-pg/coursework-areas/exchange.html",
      "- **Course / Program Identifier**: exchange"
    ]
  },
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Exchange and Study Abroad (FASS6901)",
      "Subject: Exchange and Study Abroad (FASS6902)",
      "Critically evaluate foundational principles, evidence bases, and contemporary methodologies in exchange and study abroad."
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Exchange and Study Abroad (FASS6903)",
      "Subject: Exchange and Study Abroad (FASS6904)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Synthesise disciplinary knowledge to resolve complex real-world challenges.",
      "Subject: Exchange and Study Abroad (FASS6905)",
      "- **Handbook URL**: https://www.sydney.edu.au/handbooks/arts-pg/coursework-areas/exchange.html"
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "The University of Sydney Study Abroad and Student Exchange Program provides you with the exciting opportunity to add an international perspective to your education at an Australian university with a reputation for excellence in teaching and research. You can study for one or two semesters from a wide-ranging selection of units of study on a non-award basis.",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Exchange, internships and projects.",
      "evidenceLines": [
        "The University of Sydney Study Abroad and Student Exchange Program provides you with the exciting opportunity to add an international perspective to your education at an Australian university with a reputation for excellence in teaching and research. You can study for one or two semesters from a wide-ranging selection of units of study on a non-award basis.",
