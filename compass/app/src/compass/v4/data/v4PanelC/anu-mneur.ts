...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Cell Physiology in Health and Disease (BIOL6174)",
      "Subject: Cellular Neuroscience (NEUR6101)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Systems Neuroscience (NEUR6102)",
      "Subject: Biological Basis of Psychology (PSYC6010)",
      "**Post Nominal**: Nominal MNeurosci"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Field of Education**: of Education Biological Sciences NEC",
      "Subject: Biological Basis of Psychology (PSYC6010)",
      "- **Career / Study Level**: Postgraduate"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Neuroscience.",
      "evidenceLines": [
        "- **Program Duration**: 2 year full-time",
