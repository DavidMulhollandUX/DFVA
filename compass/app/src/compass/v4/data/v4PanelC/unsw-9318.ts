...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Research Foundations in Art and Design (ADAD9114)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Work Integrated Learning (ADAD9115)",
      "Subject: Research Paper (ADAD9116)",
      "**CRICOS Code**: 082201A"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/9318",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Curating and Cultural Leadership.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 96",
