...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Optometric Preclinical Practice (OPTM6400)",
      "Subject: Contact Lenses (OPTM6411)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Clinical Optometry 4A (OPTM6412)",
      "Subject: Anterior Eye Therapeutics (OPTM6413)",
      "**CRICOS Code**: 093022B"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8095",
      "Subject: Binocular Vision, Paediatrics and Low Vision (OPTM6421)",
      "- **Total Units / Units of Credit (UOC)**: 96"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Clinical Optometry.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 96",
