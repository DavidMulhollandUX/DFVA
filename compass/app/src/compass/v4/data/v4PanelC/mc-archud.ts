...
const record: V4PanelC = {
  ...
  "C1": {
    "score": 2,
    "rationale": "Core group-assessed projects with individual accountability (ABPL90118, ABPL90140, ABPL90131) meet level 2; no core assessment requires coordinating people AND tools/AI systems as an assessed criterion, so level 3 is not met.",
    "evidenceLines": [
  ...
  "C2": {
    "score": 2,
    "rationale": "Core Design Studio C/E booklets require criterion-referenced appraisal of the student's own developing design/work against explicit performance criteria (level 2). No core assessment documents justified reliance/override decisions on a tool or collaborator, so level 3 is not met.",
    "evidenceLines": [
  ...
  "C3": {
    "score": 1,
    "rationale": "AI/ML content appears only in electives (ABPL90452, ABPL90123); core digital content is tool-operation only, capped at level 1 by the instrument's own migration note.",
    "evidenceLines": [
  ...
  "C4": {
    "score": 3,
    "rationale": "The required core Thesis is explicitly the program's culmination, staged and assessed as a self-scoped design-research investigation, matching the level-3 anchor.",
    "evidenceLines": [
  ...
  "C5": {
    "score": 2,
    "rationale": "The required Thesis documents an assessed, staged inquiry with a research question and evaluated precedents (level 2). The extract lacks explicit methodology-selection/data-collection or methodology-defence language needed for level 3, so resolved DOWN per the ambiguity rule.",
    "evidenceLines": [
      "Preliminary Thesis Proposal: Oral presentation (7 minutes) of research questions, accompanied by critical evaluation of relevant precedents from practice and research, and a draft 'thesis statement'",
  ...
  "W3": {
    "score": 1,
    "rationale": "The only work-situated-learning content is the elective 'Bower Studio - Community Development'; no core unit places students in a supervised real workplace, so this is level 1.",
    "evidenceLines": [
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Overwhelmingly compulsory specialist core (375 of 400 credit points), staged studio progressions, and professional accreditation (ARBV registration pathway) meet the G1 PASS anchor.",
      "evidenceLines": [
        "100 credit point of year 1 core subjects",
        "275 credit points of Architecture and Urban Design core subjects",
    ...
    "G2": {
      "result": "PASS",
      "rationale": "Core studios require defended design decisions under jury critique against real, complex site conditions, and the Thesis carries a pass-required hurdle on its Resolved Design stage, evidencing accountability under uncertainty.",
      "evidenceLines": [
        "Common to all studios will be sites that have cultural, environmental, political and legal complexities which designs will need to address.",
        "Hurdle requirement: A pass in the Resolved is required in order to pass the subject overall."
      ]
    }
  },
  "verified": {
