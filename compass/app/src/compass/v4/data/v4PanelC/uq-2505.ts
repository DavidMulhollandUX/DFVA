...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Social Research (SOCY2019)",
      "Subject: Introducing Quantitative Research (SOCY2339)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Qualitative Social Research (SOCY3329)",
      "Subject: Society, Challenges and Solutions: Introduction to the Social Sciences (SOSC1000)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2505",
      "Subject: Research, Planning and Design (SOSC3201)",
      "- **AQF Level**: Refer to your component degrees for AQF level."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelors of Arts / Social Science.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelors of Arts / Social Science a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
