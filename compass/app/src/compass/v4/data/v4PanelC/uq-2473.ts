...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2473",
      "Subject: Business Industry Placement (RBUS3999)",
      "- **Faculty**: of Business, Economics and Law"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Tourism, Hospitality and Event Management.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Tourism, Hospitality and Event Management a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
