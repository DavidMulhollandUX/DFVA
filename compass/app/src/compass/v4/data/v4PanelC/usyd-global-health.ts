...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: global-health",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Global Health Dissertation A (GLOH5304)",
      "Subject: Global Health Dissertation B (GLOH5305)",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/medicine-health-pg/coursework/global-health.html"
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      "Controlled trials (2CP)",
      "LO1 . Analytical thinking and skills to solve global health issues",
      "- **Faculty**: medicine-health-pg"
    ]
  },
  "C5": {
    ...
    "evidenceLines": [
      ...
      "LO2 . Advanced academic writing skills for communicating research"
    ]
  },
  "W1": {
    "score": 3,
    ...
    "evidenceLines": [
      "LO3 . Capability to work independently with minimum supervision to generate research output",
      "- **Institution**: The University of Sydney (USYD)",
      "- **Course / Program Identifier**: global-health"
    ]
  },
