...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "In the first year of the course, the fundamentals of biology and chemistry will be covered and in the second year fundamentals of biochemistry, animal nutrition and animal physiology will be covered."
    ]
  },
  "C2": {
    "score": 2,
    ...
    "evidenceLines": [
      ...
      "In addition, the students are required to complete the second year compulsory work-integrated subject as part of this course."
    ]
  },
  "C3": {
    "score": 2,
    ...
    "evidenceLines": [
      ...
      "Subject: INTRODUCTION TO ANIMAL AND AGRICULTURAL SCIENCES (AGR1AAS)",
      "Describe and explain basic concepts in animal and agricultural sciences and apply this knowledge to real-world problems in Australian or global agricultural/animal industries."
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Apply problem solving skills when issues affecting organization are identified"
    ]
  },
  "W1": {
    "score": 2,
    ...
    "evidenceLines": [
      "Communicate effectively using innovative resources.",
      "In the first year of the course, the fundamentals of biology and chemistry will be covered and in the second year fundamentals of biochemistry, animal nutrition and animal physiology will be covered.",
      "In addition, the students are required to complete the second year compulsory work-integrated subject as part of this course."
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "Speak and write effectively to a wide variety of stakeholders.",
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Associate Degree of Animal Biosciences, students must complete 240 credit points consisting of:",
      "In the first year of the course, the fundamentals of biology and chemistry will be covered and in the second year fundamentals of biochemistry, animal nutrition and animal physiology will be covered."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Associate Degree of Animal Biosciences.",
      "evidenceLines": [
        "To qualify for the award of Associate Degree of Animal Biosciences, students must complete 240 credit points consisting of:",
