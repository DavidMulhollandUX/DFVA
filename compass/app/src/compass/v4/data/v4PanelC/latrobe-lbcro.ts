...
const record: V4PanelC = {
  ...
  "C2": {
    ...
    "evidenceLines": [
      ...
      "Understand crime in its broader social context and how our responses are shaped by gender, race, power and money."
    ]
  },
  "C3": {
    "score": 2,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "Address real-world problems while gaining a deeper understanding of issues such as family violence, international crime, youth justice, imprisonment and deaths in custody."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Bachelor of Criminology, students must complete 360 credit points consisting of:",
      "Create innovative solutions to social issues and build a safer community with La Trobe's Bachelor of Criminology."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Criminology - On.",
      "evidenceLines": [
        "To qualify for the award of Bachelor of Criminology, students must complete 360 credit points consisting of:",
