...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: 3D Visualisation Studio (ADAD9110)",
      "Subject: Designing and Experiencing Immersion (DDES9901)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Human Dimensions in Immersive Environments (DDES9902)",
      "Subject: Narrative and Sensemaking in Immersive Environments (DDES9903)",
      "**CRICOS Code**: 099986A"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/9323",
      "Subject: Models, Systems and Solution Design (DDES9904)",
      "- **Total Units / Units of Credit (UOC)**: 72"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Simulation and Immersive Technologies.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 72",
