...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Teachers as Researchers (EDUC7520)",
      "Subject: Global Issues and Social Justice (EDUC7600)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Contemporary Theories of Development and Learning (EDUC7603)",
      "Subject: Teachers as Educational Innovators and Agents of Change (EDUC7604)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5685",
      "Subject: Building Professional Knowledge (EDUC7605)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Teaching (Secondary) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
