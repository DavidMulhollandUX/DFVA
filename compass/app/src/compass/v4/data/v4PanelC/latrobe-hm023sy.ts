...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: INDUSTRY PLACEMENT (LTU5IND)",
      "Subject: POLITICAL, ECONOMIC AND COMMERCIAL DETERMINANTS OF HEALTH (PHE5012)",
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "To qualify for the award of Master of Public Health, students must complete 240 credit points consisting of:",
        "240 credit points of core subjects which includes 100 hours of placement."
      ]
    },
    "G2": {
      "result": "PASS",
