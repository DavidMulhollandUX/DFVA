...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Clinical Epidemiology (PUBH7650)",
      "Subject: Special Groups in Sports Medicine (SPMD7002)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5420",
      "Subject: Upper Limb, Head, Neck and Trunk Sport Injuries (SPMD7003)",
      "- **Faculty**: of Health and Behavioural Sciences"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Sports Medicine.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Sports Medicine a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
