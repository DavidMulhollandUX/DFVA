...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Biological Concepts & Plant Science (AGRC1021)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Ecology of Agricultural Systems (AGRC1032)",
      "Subject: Food for a Healthy Planet (AGRC1040)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2335",
      "Subject: Cell & Tissue Biology for Agriculture & Veterinary Science (AGRC1041)",
      "- **AQF Level**: Refer to your component degrees for AQF level."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelors of Business Management / Science.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelors of Business Management / Science a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
