...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Engineering Contracts (CVEN4103)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Sustainability in Construction (CVEN4104)",
      "Subject: Rock and Slope Engineering (CVEN4201)",
      "**CRICOS Code**: 088839C"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3776",
      "Subject: Advanced Topics in Geotechnical Engineering (CVEN4202)",
      "- **Total Units / Units of Credit (UOC)**: 240"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 240",
        "- Fail more than half of the courses attempted, after completing 84 UOC or more of the Bachelor of Engineering (Honours) major"
      ]
    },
    "G2": {
      "result": "PASS",
