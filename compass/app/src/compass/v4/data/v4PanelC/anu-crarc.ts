...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Restitution and the archive? Using Archives and Special Collections (HUMN8036)",
      "Subject: Internship 1 (MUSC8004)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Indigenous Collections and Exhibitions (MUSC8006)",
      "Subject: Museums and Heritage Research Project (MUSC8009)",
      "**Post Nominal**: Nominal GCertReapration"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Field of Education**: of Education Indigenous Studies",
      "Subject: Repatriation: Principles, Policy and Practice (MUSC8019)",
      "- **Career / Study Level**: Postgraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate of the Repatriation of Ancestral Remains and Cultural Objects.",
      "evidenceLines": [
        "- **Program Duration**: 0.5 years",
        "- **Minimum Units Required**: 24 Units"
      ]
