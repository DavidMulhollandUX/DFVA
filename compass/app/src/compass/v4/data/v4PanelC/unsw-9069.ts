...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Exercise Oncology (EXPT4100)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Cardiorespiratory Rehabilitation (EXPT4136)",
      "Subject: Musculoskeletal and Movement Rehabilitation (EXPT4152)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/9069",
      "Subject: Rehabilitation for Neurological and Neurodegenerative Diseases  (EXPT4153)",
      "- **Total Units / Units of Credit (UOC)**: 72"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Clinical Exercise Physiology.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 72",
