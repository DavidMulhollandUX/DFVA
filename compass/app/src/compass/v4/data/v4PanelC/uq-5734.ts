...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Applied Econometrics for Macroeconomics and Finance (ECON7350)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Finance (FINM7401)",
      "Subject: Corporate Finance (FINM7402)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5734",
      "Subject: Portfolio Management (FINM7403)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Financial Mathematics.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Diploma in Financial Mathematics a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
