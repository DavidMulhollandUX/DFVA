...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "**Post Nominal**: Nominal MFinMgmtLaw"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Field of Education**: of Education Business and Commercial Law",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Financial Management and Law.",
      "evidenceLines": [
        "- **Program Duration**: 2 year full-time",
        "- **Minimum Units Required**: 96 Units"
      ]
