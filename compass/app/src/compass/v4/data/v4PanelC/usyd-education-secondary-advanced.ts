...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: education-secondary-advanced",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
    ...
    "evidenceLines": [
      "**Academic Year**: 2026",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/arts/coursework/education-secondary-advanced.html",
      "- **Course / Program Identifier**: education-secondary-advanced"
    ]
  },
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Modern Hebrew, a Living Language (HBRW3610)",
      "Subject: Modern Hebrew, a Living Language (HBRW3610)",
  ...
  "W3": {
    ...
    "evidenceLines": [
      "A second teaching area can be taken via a minor (36 credit points) or",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "gates": {
