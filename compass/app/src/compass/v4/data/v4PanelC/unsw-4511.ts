...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: ZHSS4002 - Arts Honours Research 2",
      "Subject: ZHSS4009 - International and Political Studies Honours Special Topic",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: ZHSS4001 - Arts Honours Research 1",
      "Subject: ZHSS4003 - Arts Honours Special Topic 1",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: ZHSS4012 - Arts Honours Research 3",
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4511",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Arts (Honours).",
      "evidenceLines": [
        "- **Institution**: University of New South Wales (UNSW Sydney)",
        "- **Total Units / Units of Credit (UOC)**: 48"
      ]
