...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gdimt_gdimedtech",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gdimt_gdimedtech"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "The Graduate Certificate in Diploma in Immersive Media Technologies is an AQF Level 8 qualification with a standard full-time duration of 1 year.",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Immersive Media Technologies.",
      "evidenceLines": [
        "The Graduate Certificate in Diploma in Immersive Media Technologies is an AQF Level 8 qualification with a standard full-time duration of 1 year.",
