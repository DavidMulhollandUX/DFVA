...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: pcepm_pcenvpm",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Research Design and Methods (ENVI6021)",
      "Subject: Environmental Planning and Governance (UoA) (ENVI5015)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/pcepm_pcenvpm"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: People and Environment in the Asia-Pacific Region (ENVI5003)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Sustainable Cities: Planning for Climate Change (ENVI5007)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "The Professional Certificate in Environmental Policy and Management is a non-AQF qualification program with a standard full-time duration of 0.5 years.",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Professional Certificate in Environmental Policy and Management.",
      "evidenceLines": [
        "The Professional Certificate in Environmental Policy and Management is a non-AQF qualification program with a standard full-time duration of 0.5 years.",
