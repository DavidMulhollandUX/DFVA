...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Fine Arts Honours Research Project 1 (DART4101)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Fine Arts Honours Research Project 2 (DART4102)",
      "Subject: Contemporary Art Research Methods (DART4300)",
      "**CRICOS Code**: 098001M"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4526",
      "Subject: Contemporary Art Research Methods (DART4300)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
