...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Qualitative Research: Public Health Applications (PUBH7003)",
      "Subject: Preventing Disease through Healthy Environments (PUBH7027)",
      "**Teaching Location**: External, Herston"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5759",
      "Subject: One Health: Diseases at the Human-Animal interface (PUBH7031)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Epidemiology.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Epidemiology a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
