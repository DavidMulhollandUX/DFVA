...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gdpup_gdpubpoli",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Research Methods (BUSI2034)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gdpup_gdpubpoli"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Fundamentals of Public Policy (POLI5003)",
      "Subject: Ethics and Politics in Policy (POLI5007)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Sustainable Cities: Climate Change and Planning (ENVI5000)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Public Policy.",
      "evidenceLines": [
        "The Graduate Diploma in Public Policy is an AQF Level 8 qualification with a standard full-time duration of 1 year.",
