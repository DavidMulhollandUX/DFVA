...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: bioethics",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Research Project A (BETH5301)",
      "Subject: Research Project A (BETH5301)",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/medicine-health-pg/coursework/bioethics.html"
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      "LO1 . LO1. discuss the main ethical theories and approaches used to analyse your topic of choice",
      "LO2 . LO2. outline and critically reflect on the main concepts relevant to health ethics topic of choice",
      "- **Faculty**: medicine-health-pg"
    ]
  },
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Research Project A (BETH5301)",
      "Subject: Research Project A (BETH5301)",
      "LO3 . LO3. synthesise and critically engage with the main ethical problems and associated arguments that arise in relation to your topic of choice."
    ]
  },
  "W1": {
    "score": 2,
    ...
    "evidenceLines": [
      "Research Paper Short research-based treatise. Due date in Week 13 is subject to confirmation.: 100%: Week 13 Due date : 29 May 2026 at 23:59% (Hurdle: False)",
      "- **Institution**: The University of Sydney (USYD)",
      "- **Course / Program Identifier**: bioethics"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bioethics.",
      "evidenceLines": [
        "Students in the coursework pathway must complete 48 credit points including:",
        "(a) 12 credit points from core units of study;"
      ]
    },
    "G2": {
      "result": "PASS",
