...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: internal-medicine",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/medicine-health-pg/coursework/internal-medicine.html"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Basic Rheumatology (INTM5003)",
      "Subject: Basic Gastroenterology (INTM5005)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Basic Endocrinology (INTM5006)",
      "- **Faculty**: medicine-health-pg"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Internal Medicine.",
      "evidenceLines": [
        "Students must complete 48 credit points, including:",
