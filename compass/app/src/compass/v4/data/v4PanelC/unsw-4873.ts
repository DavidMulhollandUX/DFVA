...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Introducing Law and Justice (LAWS1052)",
      "**CRICOS Code**: 110660D"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4873",
      "Subject: Legal Research and Writing (LAWS1055)",
      "- **Total Units / Units of Credit (UOC)**: 240"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Social Sciences / Law.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 240",
