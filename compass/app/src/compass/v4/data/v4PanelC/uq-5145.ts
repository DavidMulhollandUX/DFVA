...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Clinical Audiology I (AUDL7111)",
      "Subject: Professional Practice in Audiology I (AUDL7112)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Foundational Audiological Science (AUDL7113)",
      "Subject: Clinical Audiology II (AUDL7121)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5145",
      "Subject: Person and Family-Centred Audiology (AUDL7122)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Audiology Studies.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Audiology Studies a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
