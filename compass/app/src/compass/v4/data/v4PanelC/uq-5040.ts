...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5040",
      "Subject: Common and Specific Factors in Mental Health Treatments (PXMH7103)",
      "- **Teaching Location**: Herston"
    ]
  },
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Certificate in Mental Health a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
