...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Macroeconomics: Money and Finance (ECON1102)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=BP012"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Critical Thinking (PHIL1002)",
      "Subject: Understanding Politics and Policy (POLS1101)",
      "**Academic Year**: 2026"
    ]
  },
  "W1": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Philosophy, Politics and Economics.",
      "evidenceLines": [
        "English Language competency requirements",
