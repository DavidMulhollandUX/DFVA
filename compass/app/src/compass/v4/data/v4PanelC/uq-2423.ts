...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Biomedical Science Research Preparative Skills (BIOM6070)",
      "Subject: Biomedical Science Research Techniques (BIOM6080)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Biomedical Science Research Project (BIOM6100)",
      "Subject: Biomedical Science Research Project (BIOM6200)",
      "**Teaching Location**: St Lucia"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2423",
      "Subject: Biomedical Science Research Project (BIOM6200)",
      "- **Teaching Location**: St Lucia"
    ]
  },
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Biomedical Science (Honours) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
