...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Advanced Research Proposal for Environmental Management and Development (EMDV9008)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Advanced Research Project in Environmental Management & Development (EMDV9066)",
      "- **Career / Study Level**: Research"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Doctor of Philosophy, Crawford School of Public Policy.",
      "evidenceLines": [
        "- **Program Duration**: 4 year full-time",
        "- **Minimum Units Required**: 192 Units"
      ]
