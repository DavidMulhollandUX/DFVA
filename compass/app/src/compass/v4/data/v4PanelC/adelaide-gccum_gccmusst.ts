...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gccum_gccmusst",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gccum_gccmusst"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Museum Internship (LIBR5901)",
      "Subject: The Exhibition: Concept, Design and Delivery (LIBR5002)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Museum collections management (LIBR5008)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Curatorial and Museum Studies.",
      "evidenceLines": [
        "The Graduate Certificate in Curatorial and Museum Studies offers students core courses in museology and practice.",
