...
const record: V4PanelC = {
  ...
  "C4": {
    ...
    "evidenceLines": [
      "**Total Units / Units of Credit (UOC)**: 36",
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Infectious Diseases Challenges: Epidemiology and Control (PHCM9782)",
      "**CRICOS Code**: 0100356"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/5362",
      "Subject: Communicable Disease Control in Global Health (PHCM9784)",
      "- **Total Units / Units of Credit (UOC)**: 36"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 36",
        "Students must complete 36 Units of Credit (UOC) structured across the following academic components:"
      ]
    },
    "G2": {
      "result": "PASS",
