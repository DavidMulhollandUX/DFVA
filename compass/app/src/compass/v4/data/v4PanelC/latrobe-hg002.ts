...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "Advance your career with La Trobe’s Graduate Diploma in Nursing and develop specialist knowledge and skills."
    ]
  },
  "C2": {
    "score": 3,
    ...
    "evidenceLines": [
      ...
      "Choose from a wide range of clinical and non-clinical specialisations and build your dream career in nursing."
    ]
  },
  "C3": {
    "score": 2,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "Registered nurses working in Australia can access our clinical specialisations and complete advanced clinical training in a hospital work setting."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Nursing.",
      "evidenceLines": [
        "To qualify for the award of Graduate Diploma in Nursing, students must complete 120 credit points as follows:",
