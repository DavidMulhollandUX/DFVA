...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Antimicrobial Agents (MICR5833)",
      "Subject: Antimicrobial Agents (MICR5833)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=51500"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Doctor of Pharmacy.",
      "evidenceLines": [
        "website for details on admission requirements, intake periods, fees, availability to international students, careers information etc.",
        "Applicants presenting with the IELTS Academic require an overall score of at least 7.0 and no band less than 7.0 at the time of application."
      ]
    },
    "G2": {
      "result": "PASS",
