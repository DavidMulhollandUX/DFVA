...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Advanced Agronomy (AGRC7005)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5565",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Animal Science.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Certificate in Animal Science a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
