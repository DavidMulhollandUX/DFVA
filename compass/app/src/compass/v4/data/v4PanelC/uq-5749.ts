...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Translation and Interpreting in Community Settings (TRIN7220)",
      "Subject: Consecutive Interpreting (TRIN7230)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5749",
      "Subject: Consecutive Interpreting (TRIN7230)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Arts in Interpreting.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Certificate in Arts in Interpreting a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
