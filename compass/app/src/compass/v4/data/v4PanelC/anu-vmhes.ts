...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Introduction to Cultural Heritage Management (HUMN6051)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: UNESCO and World Heritage: Conserving Heritage Values (HUMN8019)",
      "Subject: Critical Issues in Heritage and Museum Studies (HUMN8027)",
      "**Post Nominal**: Nominal MMusmHteStAdv"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Field of Education**: of Education Studies in Human Society",
      "Subject: Heritage Tourism and Sustainable Development (HUMN8033)",
      "- **Career / Study Level**: Postgraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Museum and Heritage Studies.",
      "evidenceLines": [
        "- **Program Duration**: 1.5 year full-time",
        "- **Minimum Units Required**: 72 Units"
      ]
