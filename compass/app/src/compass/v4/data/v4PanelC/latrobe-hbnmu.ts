...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: NURSING: HEALTH PRIORITIES A (NSG2HPA)",
      "Employ appropriate evaluation approaches in teaching and learning to support continuous program improvement"
    ]
  },
  "W1": {
    "score": 3,
    ...
    "evidenceLines": [
      "Apply key theories and approaches to learning and teaching to support education in health care .",
      "Extend your passion for changing lives when you study a Bachelor of Nursing (Post Registration) in Singapore or Mauritius.",
      "As a La Trobe student, you'll gain the skills and confidence to care for people of all ages, making ethical, clinical decisions with compassion – and receive the same award as students in Australia."
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "Develop effective evidence -based teaching sessions that meet the needs of individuals, peers, families, carers or colleagues.",
      "Subject: NURSING AND MIDWIFERY RESEARCH (NSG2NMR)",
      "Through our partnership with the Singapore Nurses Association – PSB or Polytechnics Mauritius, you'll expand your knowledge of nursing practice."
    ]
  },
  "W3": {
