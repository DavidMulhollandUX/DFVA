...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Food & Fibre Case Studies I (AGRC1012)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "**Teaching Location**: Gatton, St Lucia"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2449",
      "Subject: Agricultural Biochemistry (AGRC2001)",
      "- **AQF Level**: Refer to your component degrees for AQF level."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelors of Agribusiness / Agricultural Science.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelors of Agribusiness / Agricultural Science a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
