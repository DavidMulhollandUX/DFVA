...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Operating International Business (IBUS7302)",
      "Subject: Globalisation and the World Economy (IBUS7306)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Global Management Thesis B (IBUS7325)",
      "Subject: Global Management Thesis C (IBUS7326)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5535",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Global Management.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Global Management a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
