...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: bcm_bconsmgt",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Data Analytics (ECON1012)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/bcm_bconsmgt"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Construction Management.",
      "evidenceLines": [
        "The Bachelor of Construction Management is an AQF Level 7 qualification with a standard full-time duration of 3 years.",
