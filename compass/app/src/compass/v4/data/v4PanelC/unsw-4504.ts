...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: ARTS4247 - Research Skills in the Humanities",
      "Subject: ARTS4249 - Advances in the Humanities",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: ARTS4835 - Linguistics Research Methods",
      "Subject: ARTS4836 - Advanced Studies in Linguistics",
      "**CRICOS Code**: 082196D"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: ARTS4247 - Research Skills in the Humanities",
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4504",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Arts (Honours).",
      "evidenceLines": [
        "- **Institution**: University of New South Wales (UNSW Sydney)",
        "- **Total Units / Units of Credit (UOC)**: 48"
      ]
