...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Property Performance Analysis (REST0001)",
      "Subject: Property Investment and Finance (REST0004)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Property Valuation (REST0005)",
      "Subject: Property Development and Feasibility Analysis (REST0006)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7127",
      "Subject: Property Industry Application (REST0010)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Property and Development.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
