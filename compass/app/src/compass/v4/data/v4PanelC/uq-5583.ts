...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5583",
      "Subject: Business Industry Placement (RBUS7999)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Business a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
