...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Programming as Problem Solving (COMP1100)",
      "Subject: Structured Programming (COMP1110)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**UAC Code**: code 136062 (B Computing)",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Computing.",
      "evidenceLines": [
        "- **Program Duration**: 3 year full-time",
        "A single three year undergraduate award offered by theANU College of Systems and Society"
      ]
    },
    "G2": {
      "result": "PASS",
