...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: social-justice-development-studies",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
    ...
    "evidenceLines": [
      "**Academic Year**: 2026",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/arts-pg/coursework-areas/social-justice-development-studies.html",
      "- **Course / Program Identifier**: social-justice-development-studies"
    ]
  },
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Dissertation Part A (DVST6911)",
      "Subject: Dissertation Part B (DVST6912)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Sites of Trauma, Landscapes of Genocide (JCTC6100)",
      "Subject: Social Issues Marketing (MECO6934)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "LO1 . write using concrete and well grounded case studies",
      "Subject: United Nations, Peace and Security (PACS6901)",
      "- **Handbook URL**: https://www.sydney.edu.au/handbooks/arts-pg/coursework-areas/social-justice-development-studies.html"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Social Justice.",
      "evidenceLines": [
        "Graduate Certificate in Social Justice (24 credit points, no stream);",
