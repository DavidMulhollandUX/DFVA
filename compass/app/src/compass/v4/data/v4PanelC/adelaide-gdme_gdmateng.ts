...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gdme_gdmateng",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Material Science & Engineering (ENGP5010)",
      "Subject: Materials Characterisation (ENGP6022)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gdme_gdmateng"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Nanomaterials (ENGP6024)",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Materials Engineering.",
      "evidenceLines": [
        "The Graduate Diploma in Materials Engineering is an AQF Level 8 qualification with a standard full-time duration of 1 year.",
        "Develop the ability to apply core concepts in Materials Engineering to engage in professional practice, and the ability to handle normal engineering and technical issues using data analysis. Understand the importance of life-long learning."
      ]
    },
    "G2": {
      "result": "PASS",
