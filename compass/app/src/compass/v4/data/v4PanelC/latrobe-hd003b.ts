...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "The Diploma of Preventive Care is an alternative exit course only from the Bachelor of Oral Health Science and the Bachelor of Dental Science (Honours)."
    ]
  },
  "C2": {
    "score": 2,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Diploma of Preventive Care, students must complete 120 credit points as follows:",
      "The Diploma of Preventive Care is an alternative exit course only from the Bachelor of Oral Health Science and the Bachelor of Dental Science (Honours)."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Diploma of Preventive Care.",
      "evidenceLines": [
        "To qualify for the award of Diploma of Preventive Care, students must complete 120 credit points as follows:",
