...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "If you’re passionate about sharing your love of learning, La Trobe’s Master of Teaching Nexus (Primary) will give you the tools to thrive in a rewarding teaching career."
    ]
  },
  "C2": {
    "score": 2,
  ...
  "C4": {
    ...
    "evidenceLines": [
      "Recognise and understand academic integrity responsibilities.",
      "Understand the importance of the acknowledgment and the referencing of sources",
      "Learn the most up-to-date skills for the modern classroom."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Master of Teaching Nexus (Primary), students must complete 240 credit points of study in total, consisting of:",
      "If you’re passionate about sharing your love of learning, La Trobe’s Master of Teaching Nexus (Primary) will give you the tools to thrive in a rewarding teaching career."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Teaching Nexus.",
      "evidenceLines": [
        "To qualify for the award of Master of Teaching Nexus (Primary), students must complete 240 credit points of study in total, consisting of:",
