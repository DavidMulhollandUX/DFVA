...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Development and Environment in the Anthropocene (EMDV8013)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Environmental Economics for Public Policy (EMDV8078)",
      "Subject: International Climate Change Policy and Economics (EMDV8080)",
      "**Post Nominal**: Nominal MEnergyChange"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Domestic Climate Change Policy and Economics (EMDV8081)",
      "- **Career / Study Level**: Postgraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Energy Change.",
      "evidenceLines": [
        "- **Program Duration**: 2 year full-time",
        "- **Minimum Units Required**: 96 Units"
      ]
