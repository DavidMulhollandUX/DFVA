...
const record: V4PanelC = {
  ...
  "C2": {
    ...
    "evidenceLines": [
      ...
      "Become a legal expert with valuable expertise in global affairs."
    ]
  },
  "C3": {
    "score": 2,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "You’ll develop your legal knowledge and skills as you build a deep understanding of global issues, diplomacy, politics, and international trade."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Bachelor of Laws (Honours)/Bachelor of Global Studies, students must complete 600 credit points consisting of:",
      "La Trobe’s Bachelor of Laws (Honours)/Bachelor of Global Studies is an immersive and flexible double degree giving you the skills and knowledge to succeed."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Laws (Honours)/Bachelor of Global Studies.",
      "evidenceLines": [
        "To qualify for the award of Bachelor of Laws (Honours)/Bachelor of Global Studies, students must complete 600 credit points consisting of:",
