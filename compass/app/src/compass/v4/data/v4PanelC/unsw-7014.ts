...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Reproductive Anatomy and Physiology (SWCH9000)",
      "Subject: Contraception (SWCH9002)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Menopause (SWCH9007)",
      "Subject: Reproductive, Perinatal Epidemiology and Biostatistics (SWCH9011)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7014",
      "Subject: The Impact of Infections on Reproductive Health (SWCH9012)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Women's Health Medicine.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
