...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: economics",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
    ...
    "evidenceLines": [
      "**Academic Year**: 2026",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/arts-pg/coursework-areas/economics.html",
      "- **Course / Program Identifier**: economics"
    ]
  },
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Master of Economics Capstone A (ECON7031)",
      "Subject: Foundation in Data Analytics for Business (QBUS5001)",
      "LO1 . Demonstrate understanding of insights provided by economics as they apply to real-world problems"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Quantitative Methods for Accounting (QBUS5002)",
      "Subject: Master of Economics Capstone A (ECON7031)",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "LO5 . Communicate (verbally and in writing) research results effectively to a broader audience",
      "- **Institution**: The University of Sydney (USYD)",
      "- **Course / Program Identifier**: economics"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "LO6 . Critically examine the nature and implications of assumptions and value judgements involved in economic research.",
      "Subject: Quantitative Methods for Accounting (QBUS5002)",
      "- **Handbook URL**: https://www.sydney.edu.au/handbooks/arts-pg/coursework-areas/economics.html"
    ]
  },
