...
const record: V4PanelC = {
  ...
  "C2": {
    ...
    "evidenceLines": [
      ...
      "The course examines management practice in relation to the Principles of Responsible Management Education (PRME), a United Nations-supported initiative that balances economic and sustainability goals."
    ]
  },
  "C3": {
    "score": 2,
    ...
    "evidenceLines": [
      ...
      "Second semester and Summer semester A: communicate in written and verbal form to produce professional artefacts."
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      "Second semester and Summer semester A: reflect on the development of communication skills for application to the workplace using appropriate technologies",
      "2 - Portfolio: 50% (Hurdle: None)",
      "You will develop your capability as a future-ready manager aware of global impact and able to address complex and pressing global challenges."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "The Master of Management is structured in three parts: Part A. Core studies, Part B. Discipline studies and Part C. Elective studies",
      "The focus of this course is the development of management capabilities in the context of dynamic organisational environments."
    ]
  },
  "gates": {
