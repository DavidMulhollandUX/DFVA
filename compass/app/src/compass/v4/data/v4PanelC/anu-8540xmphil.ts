...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Research Proposal (EMDV8008)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Applied Macro and Financial Econometrics (EMET6010)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Business and Economic Forecasting (EMET6012)",
      "- **Career / Study Level**: Research"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Philosophy, Crawford School of Public Policy.",
      "evidenceLines": [
        "- **Program Duration**: 2 year full-time",
        "- **Minimum Units Required**: 96 Units"
      ]
