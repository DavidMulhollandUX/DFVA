...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Genetics (BIOL2202)",
      "Subject: Genomics (BIOL3303)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2570",
      "Subject: Data Analytics and Information Management (BISM2202)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Information Technology a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
