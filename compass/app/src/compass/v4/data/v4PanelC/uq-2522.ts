...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Politics, Philosophy, Economics 2: Foundations of Policy Problems (PPES2101)",
      "Subject: Politics, Philosophy, Economics 3: Advanced Analysis of Complex Problems (PPES3101)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Politics, Philosophy, Economics 4: Toward Social and Economic Reform (PPES4100)",
      "Subject: Professional Practicum (PPES4999)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2522",
      "Subject: Professional Practicum (PPES4999)",
      "- **Faculty**: of Business, Economics and Law"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Politics, Philosophy and Economics.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Politics, Philosophy and Economics (Honours) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
