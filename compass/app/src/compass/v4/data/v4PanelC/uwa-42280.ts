...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Introductory Econometrics (ECON2271)",
      "Subject: Economic Research and Evaluation Methods (ECON5514)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=42280"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Economic Growth and Institutions (ECON5515)",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Public Policy.",
      "evidenceLines": [
        "website for details on admission requirements, intake periods, fees, availability to international students, careers information etc.",
