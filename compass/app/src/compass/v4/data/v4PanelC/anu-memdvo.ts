...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Australian National Internships Program A (ANIP6503)",
      "Subject: Development and Environment: Anthropological Perspectives (ANTH8007)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Graduate Academic and Research Skills for Public Policy (CRWF7900)",
      "**Post Nominal**: Nominal MEnvMgtDev"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Field of Education**: of Education Environmental Studies",
      "Subject: Public Policy and Professional Internship (CRWF8019)",
      "- **Career / Study Level**: Postgraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Environmental Management and Development.",
      "evidenceLines": [
        "- **Program Duration**: 2 year full-time",
        "- **Minimum Units Required**: 96 Units"
      ]
