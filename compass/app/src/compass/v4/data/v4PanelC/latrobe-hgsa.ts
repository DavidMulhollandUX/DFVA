...
const record: V4PanelC = {
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "You'll get hands-on experience with industry-standard technologies and cutting-edge sport analytics technology like Catapult GPS and LPS, Hudl SportsCode and IMeasureU (Inertial measurement units)."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Graduate Diploma in Sport Analytics, students must complete 120 credit points consisting of:",
      "La Trobe's Graduate Diploma in Sport Analytics is a formal qualification with hands-on experience with real sport datasets, and in-demand technical training in programming, databases, machine learning, and statistical analysis— all delivered flexibly with a mix of online and on-campus study suited to working professionals."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Sport Analytics.",
      "evidenceLines": [
        "To qualify for the award of Graduate Diploma in Sport Analytics, students must complete 120 credit points consisting of:",
