...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: SRAP5001 - Policy Analysis",
      "**CRICOS Code**: 083236D"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: LAWS8185 - Law, Urban Sustainability and the New Economy",
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8942",
      "- **Total Units / Units of Credit (UOC)**: 96"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Development Studies.",
      "evidenceLines": [
        "- **Institution**: University of New South Wales (UNSW Sydney)",
        "- **Total Units / Units of Credit (UOC)**: 96"
      ]
