...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CB004"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Mathematics Foundations: Methods (MATH1721)",
      "Subject: Mathematics Foundations: Specialist (MATH1722)",
      "Bachelor of Engineering (Honours)"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Institution**: The University of Western Australia (UWA)",
      "Subject: Physics Bridging Unit (PHYS1030)",
      "- **Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CB004"
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "(on StudentConnect, minors start with the code MNR), if they meet the pre-requisite requirements of those minors and can complete all majors and minors within the 240 credit points of their combined degree.",
      "- **Institution**: The University of Western Australia (UWA)"
    ]
  },
  "gates": {
