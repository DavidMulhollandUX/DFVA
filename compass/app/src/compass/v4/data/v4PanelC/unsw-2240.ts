...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/research/programs/2026/2240",
      "Subject: Research Design (BENV7020)",
      "- **Academic Organisation**: School of Built Environment"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Built Environment.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 96",
