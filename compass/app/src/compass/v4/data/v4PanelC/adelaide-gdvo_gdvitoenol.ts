...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gdvo_gdvitoenol",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Stabilisation and Clarification (WINE5001)",
      "Subject: Sensory Studies (WINE5002)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gdvo_gdvitoenol"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Cellar and Winery Waste Management (WINE5004)",
      "Subject: Introductory Winemaking (WINE5005)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Multiple Choice Questions: 10%% (Hurdle: False)",
      "Subject: Winemaking at Vintage (WINE5007)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Viticulture and Oenology.",
      "evidenceLines": [
        "The Graduate Diploma in Viticulture and Oenology is an AQF Level 8 program with a standard full-time duration of 1.0 year.",
