...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Fine Arts Studio: Record, Visualise & Imagine (ARTF1052)",
      "Subject: Digital Art and Object Making (ARTF1053)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=BP069"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Animation and Video (ARTF2021)",
      "Subject: Popular Culture in Asia (ASIA2004)",
      "**Academic Year**: 2026"
    ]
  },
  "W1": {
