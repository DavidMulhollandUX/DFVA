...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Aero Design and Manufacturing (AERO4100)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Biomaterials: Materials in Medicine (BIOE4305)",
      "Subject: Polymer Engineering (CHEE3301)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5745",
      "Subject: Engineering Asset Management (ENGG4103)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Materials and Manufacturing Engineering.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Materials and Manufacturing Engineering (Professional) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
