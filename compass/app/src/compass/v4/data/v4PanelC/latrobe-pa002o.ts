...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "Our Associate Degree of Cybersecurity opens doors to one of the most rapidly expanding global industries."
    ]
  },
  "C2": {
    "score": 3,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "La Trobe's Cybersecurity degree addresses the global shortage of cybersecurity professionals and prepares you with skills across IT, business, law, policy and strategic communication."
    ]
  },
  "C5": {
    "score": 3,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Associate Degree in Cybersecurity, students must complete 240 credit points consisting of:",
      "Our Associate Degree of Cybersecurity opens doors to one of the most rapidly expanding global industries."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Associate Degree in Cybersecurity - On.",
      "evidenceLines": [
        "To qualify for the award of Associate Degree in Cybersecurity, students must complete 240 credit points consisting of:",
