...
const record: V4PanelC = {
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Graduate Diploma in Mental Health, students must complete",
      "Understand the importance of the acknowledgment and the referencing of sources"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Mental Health - On.",
      "evidenceLines": [
        "To qualify for the award of Graduate Diploma in Mental Health, students must complete",
        "120 credit points in total consisting of:"
      ]
    },
    "G2": {
      "result": "PASS",
