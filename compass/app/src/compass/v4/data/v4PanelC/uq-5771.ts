...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Indigenous Language Revitalisation (AUIL7200)",
      "Subject: Indigenous Languages: Understanding Language Descriptions for Access and Use (AUIL7201)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Learning, Using and Sharing Indigenous Languages (AUIL7202)",
      "Subject: Building Strong Language Communities (AUIL7203)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5771",
      "Subject: Building Strong Language Communities (AUIL7203)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Indigenous Language Revitalisation.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Certificate in Indigenous Language Revitalisation a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
