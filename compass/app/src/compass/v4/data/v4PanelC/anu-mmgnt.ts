...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Evidence-Based Management (MGMT7250)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Organisational Behaviour (MGMT8003)",
      "Subject: Entrepreneurship and Innovation (MGMT8015)",
      "**Post Nominal**: Nominal MMgt"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Field of Education**: of Education Business and Management",
      "Subject: Strategic Management (MGMT8022)",
      "- **Career / Study Level**: Postgraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Program Duration**: 1 year full-time",
        "A single one year graduate award offered by theResearch School of Management"
      ]
    },
    "G2": {
      "result": "PASS",
