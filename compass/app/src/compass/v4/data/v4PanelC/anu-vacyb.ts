...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Framing Questions about Cybernetic Systems (CYBN6001)",
      "Subject: Cybernetic Practice (CYBN6002)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Building Cyber-Physical Systems (CYBN8001)",
      "Subject: Projects in Applied Cybernetics (CYBN8002)",
      "**Post Nominal**: Nominal MAppCybAdv"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Field of Education**: of Education Engineering and Related Techno",
      "Subject: Applied Cybernetics Professional Experience (CYBN8005)",
      "- **Career / Study Level**: Postgraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Applied Cybernetics.",
      "evidenceLines": [
        "- **Program Duration**: 1.5 year full-time",
        "- **Minimum Units Required**: 72 Units"
      ]
