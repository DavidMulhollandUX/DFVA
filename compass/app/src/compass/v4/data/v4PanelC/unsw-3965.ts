...
const record: V4PanelC = {
  ...
  "W1": {
    ...
    "evidenceLines": [
      "**Academic Organisation**: School of Biological, Earth and Environmental Sciences",
      "- **Institution**: University of New South Wales (UNSW Sydney)",
      "- **Study Level**: Undergraduate"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3965",
      "Subject: Environmental Justice (ARTS3241)",
      "- **Total Units / Units of Credit (UOC)**: 144"
    ]
  },
  "W3": {
