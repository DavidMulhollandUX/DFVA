...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: mcms_mcmusst",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/mcms_mcmusst"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Museum Studies Minor Research Project (LIBR6005)",
      "Subject: Curatorial and Museum Studies Research Thesis (LIBR6004)",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Curatorial and Museum Studies.",
      "evidenceLines": [
        "This program in Curatorial and Museum Studies offers students core courses in museology and practice in conjunction with research training and academic extension through the choice of elective courses. Students may also take a Work Integrated Learning course.",
