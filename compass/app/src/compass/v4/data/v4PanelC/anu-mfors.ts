...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Partnership Research for Agricultural and Natural Resource-Based Development (ENVS8018)",
      "Subject: Forests Research Essay (ENVS8105)",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Forests.",
      "evidenceLines": [
        "- **Program Duration**: 2 year full-time",
