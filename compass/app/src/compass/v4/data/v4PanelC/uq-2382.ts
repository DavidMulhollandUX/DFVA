...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: The Brain and Behavioural Sciences (NEUR1020)",
      "Subject: Policy Development and Practice (POLY3000)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2382",
      "Subject: Introduction to Psychology: Developmental, Social & Clinical Psychology (PSYC1030)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Social Work.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Social Work (Honours) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
