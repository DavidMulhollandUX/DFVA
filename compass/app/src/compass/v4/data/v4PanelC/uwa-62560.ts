...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Power and Machines (ELEC3016)",
      "Subject: Engineering Electrical Fundamentals (ENSC2003)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=62560"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Renewable and Future Energy.",
      "evidenceLines": [
        "website for details on admission requirements, intake periods, fees, availability to international students, careers information etc.",
