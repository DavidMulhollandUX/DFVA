...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Sensory Processes and Movement (VISN5512)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Disability and Inclusion in Vision Rehabilitation (VISN5513)",
      "Subject: Orientation and Mobility Techniques (VISN5521)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/5420",
      "Subject: Vision Rehabilitation  (VISN5522)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Orientation and Mobility.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 48",
