...
const record: V4PanelC = {
  ...
  "C2": {
    ...
    "evidenceLines": [
      ...
      "In this degree, you’ll learn to harness key AI technologies and applications that are sparking innovation in a range of industries."
    ]
  },
  "C3": {
    "score": 2,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "You’ll graduate with the technical capabilities to drive change and improve business outcomes across digital healthcare, smart manufacturing, smart cities, sustainable energy infrastructure, precision agriculture and more."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Master of Artificial Intelligence, students must complete 240 credit points",
      "Kickstart your career in this exciting field with La Trobe’s Master of Artificial Intelligence."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Artificial Intelligence - On.",
      "evidenceLines": [
        "To qualify for the award of Master of Artificial Intelligence, students must complete 240 credit points",
        "135 core credit-points"
      ]
    },
    "G2": {
      "result": "PASS",
