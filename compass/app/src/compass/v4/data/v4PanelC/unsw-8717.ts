...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Entrepreneurship and the Innovation Cycle  (CEIC8204)",
      "Subject: Principles of Programming (COMP9021)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Energy Storage (GSOE9111)",
      "Subject: Ethics and Leadership in Engineering (GSOE9510)",
      "**CRICOS Code**: 085912A"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8717",
