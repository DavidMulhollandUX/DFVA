...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Theory and Research in Strategic Management (MGTS6301)",
      "Subject: Organisational Research Paradigms (MGTS6600)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Marketing Theory and Research I (MKTG6500)",
      "Subject: Qualitative Business Research Methods II (RBUS6901)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2129",
      "Subject: Quantitative Business Research Methods I (RBUS6902)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Business Management.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Business Management (Honours) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
