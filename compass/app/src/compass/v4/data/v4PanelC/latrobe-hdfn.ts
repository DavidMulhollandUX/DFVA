...
const record: V4PanelC = {
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Diploma in Food and Nutrition, students must complete 120 credit points consisting of:",
      "Reflect critically on your own cultural attitudes, values and beliefs"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Diploma in Food and Nutrition.",
      "evidenceLines": [
        "To qualify for the award of Diploma in Food and Nutrition, students must complete 120 credit points consisting of:",
