...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2487",
      "Subject: Quantitative Methods in Biomedical Engineering (BIOE3001)",
      "- **AQF Level**: Refer to your component degrees for AQF level."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelors of Engineering (Honours) / Business Management a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
