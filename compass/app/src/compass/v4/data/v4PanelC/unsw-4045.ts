...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Culture, Experience and Change (ARTS1753)",
      "Subject: Rethinking the Social (ARTS1870)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4045",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Social Work.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 264",
