...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Applied Animal Nutrition & Grazing Management (ANIM2501)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Animal Breeding and Molecular Genetics (ANIM2503)",
      "Subject: Molecular Basis of Life (BIOC1011)",
      "**Teaching Location**: Gatton"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2378",
      "Subject: Digestion, Metabolism & Nutrition (VETS1003)",
      "- **Teaching Location**: Gatton"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Veterinary Science.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Veterinary Science (Honours) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
