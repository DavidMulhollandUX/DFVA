...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Development, Human Rights and Global Health (COMD5002)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Health Economics & Finance for Developing Countries (PHCM9443)",
      "**CRICOS Code**: 068959E"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7367",
      "Subject: Comparative Health Care Systems (PHCM9471)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Global Health.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
