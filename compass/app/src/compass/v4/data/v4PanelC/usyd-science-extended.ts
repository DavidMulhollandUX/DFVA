...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: science-extended",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
    ...
    "evidenceLines": [
      "**Academic Year**: 2026",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/science/coursework/science-extended.html",
      "- **Course / Program Identifier**: science-extended"
    ]
  },
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Indigenous Literacies in Academic Contexts A (INLI1001)",
      "Subject: Indigenous Cultural Capstone Project (INLI3000)",
  ...
  "W3": {
    ...
    "evidenceLines": [
      "The Bachelor of Science (Extended) requirements are detailed in the",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "The Bachelor of Science (Extended) requirements are detailed in the",
        "Honours is available as an additional year after completion of the Bachelor of Science. Admission requirements and unit of study information can be found on the"
      ]
    },
    "G2": {
      "result": "PASS",
