...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Management Accounting (ACCT1102)",
      "Subject: Financial Reporting and Analysis (ACCT1110)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2572",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelors of Commerce / Information Technology.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelors of Commerce / Information Technology a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
