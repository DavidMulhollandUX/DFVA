...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gcmla_gcmillaw",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Advanced Military Administrative Law (LAWS5077)",
      "Subject: Advanced Military Discipline Law (LAWS5019)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gcmla_gcmillaw"
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      "Analyse, interpret and apply applicable legislation and policy in administrative law.",
      "Provide advice on complex military administrative matters without supervision.",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Advanced Military Operations Law (LAWS5021)",
      "Subject: Advanced Military Administrative Law (LAWS5077)",
      "Formulate new policy based upon sound legal principles."
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Analyse military administrative law, practice and policy in the context of societal changes that impact on the ADF administrative system.",
      "Subject: Advanced Military Operations Law (LAWS5021)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "The Graduate Certificate in Military Law is an AQF Level 8 qualification with a standard full-time duration of 0.5 years.",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Military Law.",
      "evidenceLines": [
        "The Graduate Certificate in Military Law is an AQF Level 8 qualification with a standard full-time duration of 0.5 years.",
