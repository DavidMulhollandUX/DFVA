...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Criminal Law (LAWS4102)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=21320"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Contract (LAWS4103)",
      "Subject: Property Law (LAWS4104)",
      "**Academic Year**: 2026"
    ]
  },
  "W1": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in International Law.",
      "evidenceLines": [
        "This course aims to provide students with an understanding of the key international legal frameworks and public international law institutions in a range of areas and also includes units of specialised study.",
