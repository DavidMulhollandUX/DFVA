...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Foundations in Public Health and Health Care Systems (PHCM9041)",
      "Subject: Immunisation Policy and Practice (PHCM9050)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Academic Practice (PHCM9100)",
      "Subject: Economic Evaluation in Healthcare (PHCM9440)",
      "**CRICOS Code**: 0100357"
    ]
  },
  "W1": {
    ...
    "evidenceLines": [
      "**Academic Organisation**: School of Population Health",
      "- **Institution**: University of New South Wales (UNSW Sydney)",
      "- **Study Level**: Postgraduate"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7362",
      "Subject: Politics, Surveillance and Public Health (PHCM9522)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Infectious Diseases Intelligence.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
