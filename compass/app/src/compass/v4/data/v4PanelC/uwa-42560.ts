...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Quantitative Methods in Finance (FINA5521)",
      "Subject: Quantitative Methods in Finance (FINA5521)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=42560"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "website for details on admission requirements, intake periods, fees, availability to international students, careers information etc.",
        "All units in Core Group A (30 points)"
      ]
    },
    "G2": {
      "result": "PASS",
