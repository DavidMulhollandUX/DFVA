...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: egcba_exgcbusad",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/egcba_exgcbusad"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "The Executive Graduate Certificate in Business Administration is an AQF Level 8 program with a standard full-time duration of 0.5 years.",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Executive Graduate Certificate in Business Administration.",
      "evidenceLines": [
        "The Executive Graduate Certificate in Business Administration is an AQF Level 8 program with a standard full-time duration of 0.5 years.",
