...
const record: V4PanelC = {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Associate Degree in Human Services.",
      "evidenceLines": [
        "This course is an exit award only.",
        "To qualify for the award of Associate Degree in Human Services, students must complete 240 credit points consisting of:"
      ]
    },
    "G2": {
      "result": "PASS",
