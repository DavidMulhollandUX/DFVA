...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: ADAD9311 - Designing the Experience: Exhibitions and Beyond",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: DDES9124 - Hybrid Crafting: New Technologies, Traditional Techniques",
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8234",
      "- **Total Units / Units of Credit (UOC)**: 144"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in PR and Advertising / Design.",
      "evidenceLines": [
        "- **Institution**: University of New South Wales (UNSW Sydney)",
        "- **Total Units / Units of Credit (UOC)**: 144"
      ]
