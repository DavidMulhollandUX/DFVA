...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Master of Science Communication Research Project (SCOM8000)",
      "Subject: Science Communication Fieldwork Placement (SCOM8004)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Communicating Science with the Public (SCOM8014)",
      "Subject: Master of Science Communication Research Project (SCOM8000)",
      "**Post Nominal**: Nominal MScCommun"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Science Communication.",
      "evidenceLines": [
        "- **Program Duration**: 2 year full-time",
