...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Accounting for Decision Making (ACCT1101)",
      "Subject: Transforming Business with Information Systems (BISM1201)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Managing Business Data (BISM2207)",
      "Subject: Information Analysis and System Design (BISM3222)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2571",
      "Subject: Introduction to Software Innovation (COMP1100)",
      "- **AQF Level**: Refer to your component degrees for AQF level."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelors of Business Management / Information Technology.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelors of Business Management / Information Technology a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
