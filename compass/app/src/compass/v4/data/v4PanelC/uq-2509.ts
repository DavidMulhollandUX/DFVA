...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Strategic Communication (COMU1052)",
      "Subject: Data and Society (COMU1130)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2509",
      "Subject: Multimedia (COMU1140)",
      "- **AQF Level**: Refer to your component degrees for AQF level."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelors of Business Management / Communication.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelors of Business Management / Communication a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
