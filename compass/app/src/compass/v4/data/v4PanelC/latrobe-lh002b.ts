...
const record: V4PanelC = {
  ...
  "C2": {
    ...
    "evidenceLines": [
      ...
      "You’ll learn from expert academics who are leaders in environmental law, international law, intellectual property law and commercial law."
    ]
  },
  "C3": {
    "score": 2,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "Gain a deep understanding of key areas of legal practice and expand your knowledge with our diverse range of electives."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Laws (Honours) (Graduate Entry).",
      "evidenceLines": [
        "Complete 360 credit points",
