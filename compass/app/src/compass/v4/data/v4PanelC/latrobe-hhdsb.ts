...
const record: V4PanelC = {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Dental Science (Honours).",
      "evidenceLines": [
        "* Core participation requirements",
        "To qualify for the award of Bachelor of Dental Science (Honours) students must complete 600 credit points consisting of: 540 core credit-points 60 core-choice credit points"
      ]
    },
    "G2": {
      "result": "PASS",
