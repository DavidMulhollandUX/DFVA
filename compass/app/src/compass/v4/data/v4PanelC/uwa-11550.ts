...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Master of Social Work Research Project Part 1 (SWSP5603)",
      "Subject: Master of Social Work Research Project Part 1 (SWSP5603)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=11550"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "website for details on admission requirements, intake periods, fees, availability to international students, careers information etc.",
        "Please note that students seeking to undertake a Research Dissertation Project must meet the requirements as described in the pre-requisites of"
      ]
    },
    "G2": {
      "result": "PASS",
