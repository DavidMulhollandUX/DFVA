...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Tourism, Hospitality and Event Industries (TOUR7020)",
      "Subject: Tourism, Hospitality and Event Service (TOUR7021)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Disciplinary Foundations of Tourism, Hospitality and Events (TOUR7022)",
      "Subject: Managing Resources in Tourism, Hospitality & Events (TOUR7023)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5547",
      "Subject: Managing Resources in Tourism, Hospitality & Events (TOUR7023)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Tourism, Hotel and Event Management.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Certificate in Tourism, Hotel and Event Management a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
