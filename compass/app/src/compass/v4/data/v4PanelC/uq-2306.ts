...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2306",
      "Subject: Introduction to Role of Science and Technology Education in Society (EDUC1706)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Education (Primary) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
