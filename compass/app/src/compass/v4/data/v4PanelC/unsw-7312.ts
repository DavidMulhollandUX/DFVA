...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Applied Research Methods for Public Health (PHCM9132)",
      "Subject: Public Health Perspectives of Indigenous Health (PHCM9630)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Evidence-informed Decision-making (PHCM9781)",
      "Subject: Foundations of Epidemiology (PHCM9794)",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "**Academic Organisation**: School of Clinical Medicine",
      "- **Institution**: University of New South Wales (UNSW Sydney)",
      "- **Study Level**: Postgraduate"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7312",
      "Subject: Foundations of Biostatistics (PHCM9795)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Forensic Mental Health.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
