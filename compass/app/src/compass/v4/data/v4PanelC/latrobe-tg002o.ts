...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "The Graduate Diploma in Cybersecurity allows you to study from anywhere and have the flexibility to accommodate your work and life commitments."
    ]
  },
  "C2": {
    "score": 3,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "You may be eligible to continue into the Master of Cybersecurity upon completion of this Graduate Diploma."
    ]
  },
  "C5": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Cybersecurity  - On.",
      "evidenceLines": [
        "To qualify for the award of Graduate Diploma in Cybersecurity, students must complete 120 credit points consisting of:",
