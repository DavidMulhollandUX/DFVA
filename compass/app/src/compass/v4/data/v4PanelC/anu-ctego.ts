...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Cyber Law (LAWS8077)",
      "Subject: Artificial Intelligence and the Law (LAWS8405)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Digital Economies and the Law (LAWS8407)",
      "Subject: Information Technology Law (LAWS8445)",
      "**Post Nominal**: Nominal GCertTechGov"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Field of Education**: of Education Justice Administration",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate of Technology Governance.",
      "evidenceLines": [
        "- **Program Duration**: 0.5 years",
        "- **Minimum Units Required**: 24 Units"
      ]
