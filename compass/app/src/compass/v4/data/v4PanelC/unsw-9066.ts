...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Culinary Science and Food Service (DIET3001)",
      "Subject: Nutrients and Metabolism (DIET3002)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Inclusive Eating Practices (DIET3003)",
      "Subject: Nutrition Policies and Programs (DIET3006)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/9066",
      "Subject: Clinical Dietetics and Counselling 1 (DIET4001)",
      "- **Total Units / Units of Credit (UOC)**: 144"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Dietetics and Food Innovation.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 144",
