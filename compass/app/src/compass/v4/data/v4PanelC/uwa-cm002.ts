...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CM002"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Finance (FINA1221)",
      "Subject: Economic and Business Statistics (STAT1520)",
      "**Academic Year**: 2026"
    ]
  },
  "W1": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Economics and Master of Economics.",
      "evidenceLines": [
        "Students completing this double packaged award course will graduate with both an Undergraduate Degree and a Postgraduate Degree.",
