...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Accounting (ACCT5602)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=43200"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Economic Management and Strategy (ECON5503)",
      "Subject: Global Energy and Mineral Markets (ECON5504)",
      "**Academic Year**: 2026"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=43200",
      "Subject: Economics for Business: Applications and Policy (ECON5541)",
      "- **Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=43200"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Minerals and Energy Management.",
      "evidenceLines": [
        "Students study the relevant MBA units pertinent to the Minerals and Energy sectors.     The aim of the course is to equip participants with the requisite skill-sets to become senior industry decision-makers in the extractive industries, both metals/mining and energy.",
