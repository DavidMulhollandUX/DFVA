...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Special Topics in Earth Science (EMSC8014)",
      "Subject: Research Methods for Earth Sciences (EMSC8017)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Earth Science Research Project (EMSC8030)",
      "Subject: Earth Science Research Proposal and Presentation (EMSC8032)",
      "**Post Nominal**: Nominal MEarthScAdv"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Field of Education**: of Education Earth Sciences",
      "Subject: Science Internship (SCNC8000)",
      "- **Career / Study Level**: Postgraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Earth Sciences.",
      "evidenceLines": [
        "- **Program Duration**: 2 year full-time",
