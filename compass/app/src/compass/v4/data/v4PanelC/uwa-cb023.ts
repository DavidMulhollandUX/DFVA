...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CB023"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Economics for Business (ECON1000)",
      "Bachelor of Human Rights"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Microeconomics: Prices and Markets (ECON1101)",
      "- **Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CB023"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Human Rights and Bachelor of Commerce.",
      "evidenceLines": [
        "(on StudentConnect, minors start with the code MNR), if they meet the pre-requisite requirements of those majors and minors and can complete all majors and minors within the 192 credit points of their combined degree.",
        "(on StudentConnect, minors start with the code MNR), if they meet the pre-requisite requirements of those majors and minors and can complete all majors and minors within the 192 credit points of their combined degree."
      ]
