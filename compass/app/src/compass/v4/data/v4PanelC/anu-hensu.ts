...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Earth and Marine Sciences Honours Thesis (EMSC4005)",
      "Subject: Physics of the Earth Honours Reseach Project (EMSC4008)",
      "**Program Duration**: 5 year full-time"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Research Methods for Earth Sciences (EMSC4017)",
      "Subject: Final Honours Grade (HONS4602)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Honours Research Project (PHYS4110)",
      "- **Career / Study Level**: Undergraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Environment and Sustainability.",
      "evidenceLines": [
        "- **Program Duration**: 5 year full-time",
        "- **Minimum Units Required**: 48 Units"
      ]
