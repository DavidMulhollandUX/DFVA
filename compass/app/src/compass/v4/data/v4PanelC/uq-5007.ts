...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Accounting (ACCT7101)",
      "Subject: Agrifood Strategy & Competitiveness (AGRC7043)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Leadership in Rural Industries &; Communities (AGRC7046)",
      "Subject: Global Challenges in Agriculture (AGRC7047)",
      "**Teaching Location**: External, Gatton"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5007",
      "Subject: Agribusiness Value Chain Management (AGRC7050)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Agribusiness.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Certificate in Agribusiness a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
