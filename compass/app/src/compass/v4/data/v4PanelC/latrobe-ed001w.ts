...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "If you’re looking for a pathway to an accredited teaching degree, La Trobe’s Diploma of Teacher Education is the perfect opportunity to take your first step towards a rewarding career in teaching."
    ]
  },
  "C2": {
    "score": 2,
    ...
    "evidenceLines": [
      ...
      "When you successfully complete the Diploma of Teacher Education, you could progress to a Bachelor of Education (Primary), Bachelor of Education (Secondary) or Bachelor of Education (Early Childhood and Primary)."
    ]
  },
  "C3": {
    "score": 2,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "You’ll also receive advanced standing for up to one year of full-time study."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Diploma of Teacher Education - Albury.",
      "evidenceLines": [
        "To qualify for the award of Diploma of Teacher Education, students must complete 120 credit points of study in total, consisting of:",
