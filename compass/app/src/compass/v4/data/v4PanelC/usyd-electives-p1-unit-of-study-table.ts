...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: electives-p1-unit-of-study-table",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
    ...
    "evidenceLines": [
      "**Academic Year**: 2026",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/law/undergraduate/electives-p1-unit-of-study-table.html",
      "- **Course / Program Identifier**: electives-p1-unit-of-study-table"
    ]
  },
  "C3": {
    ...
    "evidenceLines": [
      "Subject: LAWS3508 - removed",
      "Subject: LAWS2019 - added",
      "Demonstrate comprehensive knowledge of core principles in removed."
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      "Apply critical thinking and analytical frameworks to complex problems in removed.",
      "Communicate technical arguments and findings clearly to professional audiences.",
      "- **Handbook URL**: https://www.sydney.edu.au/handbooks/law/undergraduate/electives-p1-unit-of-study-table.html"
    ]
  },
  "C5": {
    ...
    "evidenceLines": [
      "Subject: LAWS1026 - and LAWS1030",
      "Subject: LAWS2015 - and LAWS2016",
      "Major Assignment: 50%"
    ]
  },
  "W1": {
