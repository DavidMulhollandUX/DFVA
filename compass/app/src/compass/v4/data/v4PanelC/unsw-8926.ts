...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Advanced Behaviour Support Strategies (EDST5106)",
      "Subject: Teaching Methods for High Incidence Disabilities (EDST5107)",
      "**CRICOS Code**: 073442C"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8926",
      "Subject: Intellectual Disabilities (EDST5111)",
      "- **Total Units / Units of Credit (UOC)**: 96"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Teaching.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 96",
