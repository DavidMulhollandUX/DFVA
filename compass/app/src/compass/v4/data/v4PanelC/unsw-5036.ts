...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: FOOD9104 - Advanced Food and Health Security",
      "Subject: CEIC6712 - Pharmaceutical Design and Engineering",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: FOOD8010 - Food Products and Ingredients Technology",
      "Subject: CHEM2041 - Analytical Chemistry: Essential Methods",
      "**CRICOS Code**: 113780E"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: FOOD3060 - Food Processing Principles",
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/5036",
      "- **Total Units / Units of Credit (UOC)**: 72"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Food Science.",
      "evidenceLines": [
        "- **Institution**: University of New South Wales (UNSW Sydney)",
        "- **Total Units / Units of Credit (UOC)**: 72"
      ]
