...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gcpe_gcpeteng",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Water and Waste Water Treatment PG (ENGP5013)",
      "Subject: Material Science & Engineering (ENGP5010)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gcpe_gcpeteng"
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      "Explain fundamental water chemistry",
      "Identify the parameters that characterize the constituents found in potable water and wastewater",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Drilling Engineering and Well Completion (ENGPX405)",
      "Subject: Reservoir Engineering VII (ENGP5027)",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Petroleum Engineering.",
      "evidenceLines": [
        "The Graduate Certificate in Petroleum Engineering is an AQF Level 8 qualification with a standard full-time duration of 0.5 years.",
