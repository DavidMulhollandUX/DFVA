...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Digital Humanities Theories and Debates (HUMN8029)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: International Relations in the Information Age (INTR8066)",
      "Subject: Cyber Law (LAWS8077)",
      "**Post Nominal**: Nominal MTechGovn"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Blockchain and Legal Innovation I (LAWS8101)",
      "- **Career / Study Level**: Postgraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Technology Governance.",
      "evidenceLines": [
        "- **Program Duration**: 1 year full-time",
        "- **Minimum Units Required**: 48 Units"
      ]
