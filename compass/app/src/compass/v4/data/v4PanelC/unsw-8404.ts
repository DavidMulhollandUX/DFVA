...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Sustainable Management Accounting (ACCT5931)",
      "Subject: Data Literacy for Business (COMM5000)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Coding for Business (COMM5007)",
      "Subject: Enterprise Skills (COMM5008)",
      "**CRICOS Code**: 000933K"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8404",
      "Subject: Strategy, Marketing and Management (COMM5010)",
      "- **Total Units / Units of Credit (UOC)**: 72"
    ]
  },
  "W3": {
