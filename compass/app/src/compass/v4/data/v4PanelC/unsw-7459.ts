...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Sustainable and Inclusive Business (AGSM9161)",
      "Subject: Decarbonisation and Transition to Clean Energy (AGSM9162)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Sustainability Governance, Regulation and Reporting (AGSM9163)",
      "Subject: Sustainable Value Chains and Business Models (AGSM9164)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7459",
      "Subject: Sustainability Study Tour (AGSM9583)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Sustainable and Inclusive Business.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
