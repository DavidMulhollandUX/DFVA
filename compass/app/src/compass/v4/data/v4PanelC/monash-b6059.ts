...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      "If you are admitted at entry Level 1 you complete 72 credit points, comprising Part A, Part B and Part C.",
      "If you are admitted at entry Level 2 you complete 48 credit points, comprising Part B, and Part C.",
      "In this online course you will demonstrate skills in the ways data and analytics can support managerial decision making."
    ]
  },
  "C2": {
    "score": 2,
    ...
    "evidenceLines": [
      ...
      "You will learn key concepts and frameworks that enable the responsible use of data, recognising the unique limits of when and how data should be used to enhance organisational performance."
    ]
  },
  "C3": {
    "score": 2,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "You will also gain skills in the use of modern data analysis tools, such as PowerBI and RStudio, and demonstrate skills in the design of analytics projects."
    ]
  },
  "C5": {
    "score": 2,
    ...
    "evidenceLines": [
      "Subject: Decision making for managers (LEO5301)",
      "Subject: Data and analytics in organisations and society (LEO5302)",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "analyse organisations as dynamic, interconnected systems operating within complex and rapidly evolving environments",
      "In this online course you will demonstrate skills in the ways data and analytics can support managerial decision making.",
      "You will learn key concepts and frameworks that enable the responsible use of data, recognising the unique limits of when and how data should be used to enhance organisational performance."
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "apply design thinking processes, methods, and evaluative frameworks to collaboratively deliver innovative, impact-driven project outcomes",
      "Subject: Data analytics and insights generation (LEO5303)",
      "You will also gain skills in the use of modern data analysis tools, such as PowerBI and RStudio, and demonstrate skills in the design of analytics projects."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Managerial Analytics.",
      "evidenceLines": [
        "This course is structured in three parts. Part A. Core studies, Part B. Discipline studies and Part C. Application Studies",
        "Part A. Core studies"
      ]
