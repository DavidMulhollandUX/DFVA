...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Aboriginal Studies (ABTS1000)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Being Human: Cultural Diversity and Experience (ANTH1008)",
      "Subject: Forensics: The Archaeology of Death and Crime Scenes (ARCS2003)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2519",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Criminology and Criminal Justice.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Criminology and Criminal Justice a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
