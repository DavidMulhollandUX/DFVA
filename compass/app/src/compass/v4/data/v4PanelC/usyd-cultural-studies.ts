...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: cultural-studies",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
    ...
    "evidenceLines": [
      "**Academic Year**: 2026",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/arts-pg/coursework-areas/cultural-studies.html",
      "- **Course / Program Identifier**: cultural-studies"
    ]
  },
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Political Economy: A Primer (ECOP6101)",
      "Subject: Heritage Studies and Communities (MHST6915)",
      "LO1 . show a general familiarity with the basic concepts in the language of economics"
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      "LO2 . demonstrate understanding of core concepts and basic analytical tools used in political economic analysis",
      "LO3 . discuss the principal schools of thought in economics, their historical origins, their political orientation and their contemporary relevance",
      "- **Handbook URL**: https://www.sydney.edu.au/handbooks/arts-pg/coursework-areas/cultural-studies.html"
    ]
  },
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Critical Theory and Performance (PRFM5901)",
      "Subject: Global and Regional Migration (SCLG6700)",
      "LO4 . explain the connections between different economic viewpoints (e.g. on policy issues) and the theoretical frameworks of competing schools of economic thought"
    ]
  },
  "W1": {
    "score": 2,
    ...
    "evidenceLines": [
      "LO5 . independently gather information from libraries and other sources",
      "- **Institution**: The University of Sydney (USYD)",
      "- **Course / Program Identifier**: cultural-studies"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "LO6 . apply information collected to particular economic questions",
      "Subject: New Debates in Social Theory (SCLG6903)",
      "- **Handbook URL**: https://www.sydney.edu.au/handbooks/arts-pg/coursework-areas/cultural-studies.html"
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "Demonstrate an understanding of the core concepts and contexts of their development; range of perspectives, debates and cultural issues that are addressed in the field; and longstanding and changing modes of thinking about culture.",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Cultural Studies.",
      "evidenceLines": [
        "Demonstrate an understanding of the core concepts and contexts of their development; range of perspectives, debates and cultural issues that are addressed in the field; and longstanding and changing modes of thinking about culture.",
