...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Communication for Social Change Theory (COMU7000)",
      "Subject: Thesis (COMU7007)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5651",
      "Subject: Thesis (COMU7008)",
      "- **Faculty**: of Humanities and Social Sciences"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Communication.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Communication a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
