...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: sustainability",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/science-pg/coursework/sustainability.html"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Legal Reasoning and the Common Law System (LAWS6252)",
  ...
  "W3": {
    ...
    "evidenceLines": [
      "The Sustainability postgraduate requirements are detailed in the",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Sustainability.",
      "evidenceLines": [
        "The Sustainability postgraduate requirements are detailed in the",
