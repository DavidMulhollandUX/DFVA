...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gderp_gdecrepol",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Economic Principles (M) (ECON5048)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gderp_gdecrepol"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Cost-Benefit Analysis (ECON5016)",
      "Subject: Principles of International Trade and Development (ECON5017)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Learning Journal: 20%% (Hurdle: False)",
  ...
  "W3": {
    ...
    "evidenceLines": [
      "The Graduate Diploma in Economics and Resource Policy is an AQF Level 8 qualification with a standard full-time duration of 1 year.",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Economics and Resource Policy.",
      "evidenceLines": [
        "The Graduate Diploma in Economics and Resource Policy is an AQF Level 8 qualification with a standard full-time duration of 1 year.",
