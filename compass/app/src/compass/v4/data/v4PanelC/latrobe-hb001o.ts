...
const record: V4PanelC = {
  ...
  "C2": {
    ...
    "evidenceLines": [
      ...
      "Develop a comprehensive skillset covering areas like anatomy and physiology, health classification, data analytics, health informatics and health systems management."
    ]
  },
  "C3": {
    "score": 2,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "Build foundations in your first year, then deepen your expertise throughout your degree, including 55 days of supervised professional placement with our prestigious health partners."
    ]
  },
  "C5": {
    "score": 2,
    ...
    "evidenceLines": [
      "Subject: HUMAN PATHOPHYSIOLOGY (HBS3001)",
      "Subject: INTRODUCTION TO HEALTH CLASSIFICATION A (HIM1001)",
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Bachelor of Health Information Management students must complete 360 credit points consisting of:",
      "Combine the clinical and business sides of healthcare and use data to make a difference to the quality of patient care with La Trobe’s Bachelor of Health Information Management."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Health Information Management - On.",
      "evidenceLines": [
        "To qualify for the award of Bachelor of Health Information Management students must complete 360 credit points consisting of:",
        "360 core credit-points"
      ]
    },
    "G2": {
      "result": "PASS",
