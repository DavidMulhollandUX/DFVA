...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Disasters and Epidemics in Asia and the Pacific (ASIA8048)",
      "Subject: Social Conflict and Environmental Change (ASIA8050)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Governing the Globe? The theory, architecture, and practice of Global Governance (DIPL8021)",
      "**Post Nominal**: Nominal MGlobSecStrat"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Asia-Pacific Environmental Conflicts (EMDV8009)",
      "- **Program Duration**: 1 year full-time"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Global Securities and Strategy.",
      "evidenceLines": [
        "- **Program Duration**: 1 year full-time",
        "- **Minimum Units Required**: 48 Units"
      ]
