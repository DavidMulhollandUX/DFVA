...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Introduction to University (SCIF0000)",
      "Subject: Advancing Science (SCIF1001)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Level 2 Research Skills (SCIF2001)",
      "Subject: Graduation Portfolio (SCIF3010)",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "**Academic Organisation**: Faculty of Science",
      "- **Institution**: University of New South Wales (UNSW Sydney)",
      "- **Study Level**: Undergraduate"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3737",
      "Subject: Graduation Portfolio (SCIF3010)",
      "- **Total Units / Units of Credit (UOC)**: 240"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Advanced Science.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 240",
        "The Bachelor of Advanced Science (Honours) / Bachelor of Engineering Science (3737) is a 4-year non-accredited exit degree for students who do not meet the progression requirements of the Bachelor of Advanced Science (Honours) / Bachelor of Engineering (Honours) (3762) program. Only under limited circumstances may students request a transfer into this exit degree (advice from The Nucleus Student Hub should be sought)."
      ]
    },
    "G2": {
      "result": "PASS",
