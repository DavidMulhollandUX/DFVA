...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: International Human Rights Law (LAWS7156)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Principles of International Law (LAWS7710)",
      "Subject: Law of Armed Conflict (LAWS7711)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5641",
      "Subject: Law, Terrorism and Human Rights (LAWS7713)",
      "- **Faculty**: of Humanities and Social Sciences"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of International Relations a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
