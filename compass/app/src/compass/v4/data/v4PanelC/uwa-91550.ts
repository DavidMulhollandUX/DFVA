...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Aboriginal Health (AHEA5755)",
      "Subject: Developmental Origins of Health and Disease (APHB5501)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=91550"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "website for details on admission requirements, intake periods, fees, availability to international students, careers information etc.",
        "Master of Public Health (72 points 1.5 years) 91550 Sem 1, 2026 [xlsx]"
      ]
    },
    "G2": {
      "result": "PASS",
