...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: MATHEMATICAL APPLICATIONS IN BIOLOGY (MAT1MAB)",
      "Subject: PRINCIPLES OF PHYSICS A (PHY1SCA)",
      "Apply simulation techniques to investigate the behaviour of mathematical models."
    ]
  },
  "W1": {
    "score": 2,
    ...
    "evidenceLines": [
      "Express mathematical arguments in a clear and concise way.",
      "Reflect critically on your own cultural attitudes, values and beliefs",
      "Demonstrate knowledge of and respect for Indigenous Australian perspectives and experiences, history, culture and customs, including an appreciation of the local people and country"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "Apply algebraic techniques to transform equations used to specify mathematical models.",
      "Subject: PRINCIPLES OF PHYSICS B (PHY1SCB)",
      "Recall important details regarding the history, culture, customs and people of Indigenous Australia"
    ]
  },
  "W3": {
