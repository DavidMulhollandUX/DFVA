...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Film Studies (ARTS1060)",
      "Subject: Hollywood Film: Industry, Technology, Aesthetics (ARTS1062)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Screen Production I (ARTS1064)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3344",
      "Subject: Contemporary Approaches to Cinema (ARTS2061)",
      "- **Total Units / Units of Credit (UOC)**: 192"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Media / Arts.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 192",
