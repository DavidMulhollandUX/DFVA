...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: hmedi_hbmedia",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Honours Film Thesis Workshop (MDIA4002)",
      "Subject: Honours Film Thesis (MDIA4003)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/hmedi_hbmedia"
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      "Apply a wide range of conceptual approaches to film studies.",
      "Identify, analyse, and evaluate relevant primary and secondary sources",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "C5": {
  ...
  "W1": {
    ...
    "evidenceLines": [
      "Develop logical and coherent analytic arguments in both writing and orally",
      "- **Institution**: The University of Adelaide",
      "- **Program Identifier / Slug**: hmedi_hbmedia"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "Write and critique key research documents (e.g. a research proposal)",
      "Subject: Honours Film Thesis (MDIA4003)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
