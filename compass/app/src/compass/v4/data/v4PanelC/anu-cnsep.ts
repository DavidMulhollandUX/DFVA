...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: National Security Policymaking (NSPO8006)",
      "Subject: National Security: Concepts and Methods (NSPO8007)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Ethical Challenges for National Security (NSPO8008)",
      "Subject: Cyber and Emerging Technologies in National Security (NSPO8009)",
      "**Post Nominal**: Nominal GCertNaSecPol"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Leadership, Risk, and Crisis (NSPO8012)",
      "- **Career / Study Level**: Postgraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate of National Security Policy.",
      "evidenceLines": [
        "- **Program Duration**: 0.5 years",
        "- **Minimum Units Required**: 24 Units"
      ]
