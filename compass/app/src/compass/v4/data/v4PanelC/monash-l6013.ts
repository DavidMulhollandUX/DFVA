...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "This expert graduate course provides a thorough theoretical and practical grounding in one or more areas of law."
    ]
  },
  "C2": {
    "score": 3,
    ...
    "evidenceLines": [
      ...
      "It is suitable for graduates interested in developing or enhancing specialist careers with knowledge of the law."
    ]
  },
  "C3": {
    "score": 2,
    ...
    "evidenceLines": [
      "Subject: Australian legal reasoning and methods (LAW5000)",
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "In-class assessment: 20% (Hurdle: None)",
      "You investigate contemporary issues in law, practice and scholarship, and evaluate complex issues relevant to the field of theoretical, international, and interdisciplinary perspectives."
    ]
  },
  "C5": {
    "score": 2,
    ...
    "evidenceLines": [
      "Subject: Extended research (LAW5083)",
      "Subject: Minor thesis (LAW5084)",
      "Written Assessment: 40% (Hurdle: None)"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Legal Studies.",
      "evidenceLines": [
        "These studies enable you to gain fundamental knowledge of legal principles and concepts, and develop core skills in legal research and writing.",
        "Units are chosen from the law specialisations to meet the remaining credit points required for the course. Students may also apply for the MON5750 Monash Innovation Guarantee. Refer to the Notes section for further information."
      ]
    },
    "G2": {
      "result": "PASS",
