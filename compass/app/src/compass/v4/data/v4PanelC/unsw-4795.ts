...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Programming Fundamentals (COMP1511)",
      "Subject: Data Structures and Algorithms (COMP2521)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Database Systems (COMP3311)",
      "Subject: Introduction to Data Science and Decisions (DATA1001)",
      "**CRICOS Code**: 099873K"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4795",
      "Subject: Data Science and Decisions in Practice (DATA3001)",
      "- **Total Units / Units of Credit (UOC)**: 264"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Data Science and Decisions / Law.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 264",
