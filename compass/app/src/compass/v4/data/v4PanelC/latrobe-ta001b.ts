...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "If you’re keen to launch your career in engineering, La Trobe’s Associate Degree in Engineering Technology will give you solid foundations for success and a pathway to a world-class Bachelor’s degree in engineering."
    ]
  },
  "C2": {
    "score": 3,
    ...
    "evidenceLines": [
      ...
      "Learn how to tackle the big problems faced by engineers every day."
    ]
  },
  "C3": {
    "score": 3,
    ...
    "evidenceLines": [
      ...
      "Subject: PROGRAMMING FOR ENGINEERS AND SCIENTISTS (CSE1PES)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: INTRODUCTION TO ELECTRICAL AND ELECTRONIC ENGINEERING (ELE1IEL)",
      "Subject: COMPUTER AIDED DESIGN (EMS1CAD)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Demonstrate effective written communication skills by presenting an engineering technical report in a clear and logical fashion. Includes EA stage 1 competencies:3.2 Effective oral and written communication in professional and lay domains.",
      "Subject: ENGINEERING DESIGN AND PROBLEM SOLVING (EMS1EDP)",
      "Develop essential skills in maths, physics and computer programming."
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Associate Degree in Engineering Technology, students must complete 240 credit points consisting of:",
      "If you’re keen to launch your career in engineering, La Trobe’s Associate Degree in Engineering Technology will give you solid foundations for success and a pathway to a world-class Bachelor’s degree in engineering."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Associate Degree in Engineering Technology.",
      "evidenceLines": [
        "To qualify for the award of Associate Degree in Engineering Technology, students must complete 240 credit points consisting of:",
