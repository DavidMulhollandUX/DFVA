...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Skills in Practice (PLTX1020)",
      "Subject: Values in Practice (PLTX1040)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
    ...
    "evidenceLines": [
      "**Total Units / Units of Credit (UOC)**: 42",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Litigation Practice (PLTX1060)",
      "Subject: Transactional Practice (PLTX1080)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/5213",
      "Subject: Administrative Law Practice (PLTX1120)",
      "- **Total Units / Units of Credit (UOC)**: 42"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Legal Professional Practice.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 42",
