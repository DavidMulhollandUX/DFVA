...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Gender and Power in Asia (ASIA3004)",
      "Subject: Autocracy and Democracy in Asia (ASIA3005)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=BP034"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Reading Bodies (ENGL1902)",
      "Subject: Beyond 'Gender Wars' (GEND1901)",
      "**Academic Year**: 2026"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=BP034",
      "Subject: Masculinity, Nostalgia and Change (GEND2902)",
      "- **Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=BP034"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Human Rights.",
      "evidenceLines": [
        "All units have a value of six points unless otherwise stated.",
