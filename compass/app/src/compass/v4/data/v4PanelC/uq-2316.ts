...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Anthropology of Current World Issues (ANTH1030)",
      "Subject: Communicating Across Cultures: Theory and Practice (COMU1002)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2316",
      "Subject: Learning from the International Experience (COMU3060)",
      "- **Faculty**: of Humanities and Social Sciences"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of International Studies.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of International Studies a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
