...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: MDIA5001 - Writing for Media",
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8281",
      "- **Total Units / Units of Credit (UOC)**: 96"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in PR and Advertising.",
      "evidenceLines": [
        "- **Institution**: University of New South Wales (UNSW Sydney)",
        "- **Total Units / Units of Credit (UOC)**: 96"
      ]
