...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Statistics for Social Scientists (SOCR8001)",
      "Subject: Survey Data Analysis (SOCR8002)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Qualitative data collection (SOCR8008)",
      "Subject: Social Research Practice (SOCR8082)",
      "**Post Nominal**: Nominal GCertSocRes"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate of Social Research.",
      "evidenceLines": [
        "- **Program Duration**: 0.5 years",
        "- **Minimum Units Required**: 24 Units"
      ]
