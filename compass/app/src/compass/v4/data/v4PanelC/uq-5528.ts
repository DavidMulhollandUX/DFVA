...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: BIOE6100 - Fundamentals of Neuroengineering",
      "Subject: BIOE6403 - Biomedical Instrumentation",
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: ELEC7310 - Electricity Market Operation and Security",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: BIOE6100 - Fundamentals of Neuroengineering",
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5528",
      "- **Duration**: Not specified"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Engineering Science.",
      "evidenceLines": [
        "- **Institution**: The University of Queensland (UQ)",
        "- **Duration**: Not specified"
      ]
