...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: SRAP5106 - Academic Writing in the Social Sciences",
      "Subject: SRAP5107 - Research Project",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: PHCM9381 - Policy Studies",
      "Subject: SRAP5103 - Research Report",
      "**CRICOS Code**: 065349M"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8224",
      "- **Total Units / Units of Credit (UOC)**: 96"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Combined Arts/Social Sciences.",
      "evidenceLines": [
        "- **Institution**: University of New South Wales (UNSW Sydney)",
        "- **Total Units / Units of Credit (UOC)**: 96"
      ]
