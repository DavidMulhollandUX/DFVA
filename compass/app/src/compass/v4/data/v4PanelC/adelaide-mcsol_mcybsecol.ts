...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: mcsol_mcybsecol",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/mcsol_mcybsecol"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: OL Business Information Systems & Management (M) (BUSI6047)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Cyber Security [Online].",
      "evidenceLines": [
        "The Master of Cyber Security [Online] is an AQF Level 9 qualification with a standard full-time duration of 1.5 years. However, this program is only offered  part-time for a duration of 2 years.",
