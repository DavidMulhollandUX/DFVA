...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: COMD5004 - Climate Change Adaptation & Development",
      "Subject: SOCW7852 - Politics of International Aid",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: SRAP5101 - Research Methods and Project Design",
      "Subject: POLS5130 - International Peace and Security",
      "**CRICOS Code**: 083232G"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: MGMT5602 - Cross-Cultural Management",
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8233",
      "- **Total Units / Units of Credit (UOC)**: 96"
    ]
  },
  "W3": {
