...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: education",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
    ...
    "evidenceLines": [
      "**Academic Year**: 2026",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/arts-pg/coursework-areas/education.html",
      "- **Course / Program Identifier**: education"
    ]
  },
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Leading Organisations for Social Justice (EDPA5001)",
      "Subject: Effective Leadership and Change (EDPA5011)",
      "Critically evaluate foundational principles, evidence bases, and contemporary methodologies in leading organisations for social justice."
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Middle Leadership (EDPA6016)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Synthesise disciplinary knowledge to resolve complex real-world challenges.",
      "Subject: Leadership for Learning (EDPA6017)",
      "- **Handbook URL**: https://www.sydney.edu.au/handbooks/arts-pg/coursework-areas/education.html"
    ]
  },
  "W3": {
