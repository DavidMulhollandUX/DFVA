...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Indigenous Contexts of Education (EDST5115)",
      "Subject: Professional Inquiry (EDST5117)",
      "**CRICOS Code**: 099104G"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8925",
      "Subject: Creating Engaging Learning Environments (EDST5133)",
      "- **Total Units / Units of Credit (UOC)**: 96"
    ]
  },
  "W3": {
