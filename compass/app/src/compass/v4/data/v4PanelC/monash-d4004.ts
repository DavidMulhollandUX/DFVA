...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "This course is designed for students with a first qualification in an education discipline or related discipline including but not limited to TESOL, counselling, and the social sciences, who wish to pursue learning that will generate new knowledge and understanding through educational research."
    ]
  },
  "C2": {
    "score": 2,
    ...
    "evidenceLines": [
      ...
      "This course orientates you to educational research and provides you with an understanding of educational research methodologies and research design."
    ]
  },
  "C3": {
    "score": 2,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "You will apply this understanding through the design and implementation of a research project which will demonstrate your capacity to undertake and communicate research synthesis, analysis and evaluation."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate of Educational Research.",
      "evidenceLines": [
        "24 credit points",
