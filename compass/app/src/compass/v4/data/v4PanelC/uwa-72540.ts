...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Environmental Assessment (ENVT3361)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=72540"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Advanced Land Use and Management (ENVT4401)",
      "Subject: Using Drones for Catchment and Environmental Management (ENVT4406)",
      "**Academic Year**: 2026"
    ]
  },
  "W1": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Hydrogeology.",
      "evidenceLines": [
        "website for details on admission requirements, intake periods, fees, availability to international students, careers information etc.",
