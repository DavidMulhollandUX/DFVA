...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: ARTS2248 - Disasters and Society",
      "Subject: SOLA5056 - Sustainable Energy for Developing Countries",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: ENGG4102 - Humanitarian Engineering Project",
      "Subject: ARTS2752 - Local Politics of Humanitarian and Development Action",
      "**CRICOS Code**: 001881J"
    ]
  },
  "W1": {
    ...
    "evidenceLines": [
      "**Academic Organisation**: School of Chemical Engineering",
      "- **Institution**: University of New South Wales (UNSW Sydney)",
      "- **Study Level**: Undergraduate"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "Subject: CEIC4008 - Product Design Project Thesis B",
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3061",
      "- **Total Units / Units of Credit (UOC)**: 192"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Food Science (Honours).",
      "evidenceLines": [
        "- **Institution**: University of New South Wales (UNSW Sydney)",
        "- **Total Units / Units of Credit (UOC)**: 192"
      ]
