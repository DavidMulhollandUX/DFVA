...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Crime and the Criminal Process (JURD7121)",
      "Subject: Criminal Laws (JURD7122)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Lawyers, Ethics and Justice (JURD7130)",
      "Subject: Principles of Public Law (JURD7141)",
      "**CRICOS Code**: 068850G"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/9150",
      "Subject: Principles of Private Law (JURD7150)",
      "- **Total Units / Units of Credit (UOC)**: 144"
    ]
  },
  "W3": {
