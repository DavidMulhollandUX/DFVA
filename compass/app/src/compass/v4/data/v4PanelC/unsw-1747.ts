...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Community Eye Health (OPTM7001)",
      "Subject: Epidemiology of Blinding Eye Diseases (OPTM7003)",
      "**AQF Level**: Level 10"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Eye Care Program Management (OPTM7006)",
      "Subject: Advanced Contact Lens Studies 1 (OPTM7104)",
      "**CRICOS Code**: 093084K"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/research/programs/2026/1747",
      "Subject: Evidence Based Optometry (OPTM7302)",
      "- **Delivery Mode**: Face-to-face (includes blended), Research"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Clinical Research in Optometry.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 144",
