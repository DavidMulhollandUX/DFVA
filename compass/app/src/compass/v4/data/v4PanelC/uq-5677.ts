...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Advancing Research Inquiry (HLTH7315)",
      "Subject: Applied Physiology and Pathophysiology (NURS7242)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Physical Assessment and Clinical Decision Making for Independent Practice (NURS7243)",
      "Subject: Pharmacology and prescribing for Independent Practice (NURS7244)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5677",
      "Subject: Advanced Clinical Leadership (NURS7245)",
      "- **Faculty**: of Health and Behavioural Sciences"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Nurse Practitioner a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
