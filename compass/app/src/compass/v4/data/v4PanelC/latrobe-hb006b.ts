...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "Get the skills and confidence to advocate and care for mothers and babies in all clinical situations with this four-year double degree, La Trobe's Bachelor of Nursing/Bachelor of Midwifery."
    ]
  },
  "C2": {
    "score": 3,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "Move into real-world environments in hospitals and healthcare networks in your first year, reaping the benefits of our long-standing partnerships with top-tier maternity providers like Mercy Health, The Royal Women's Hospital and Bendigo Health."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: MIDWIFERY, NURSING AND HEALTH CARE CONTEXTS (MID1001)",
      "Move into real-world environments in hospitals and healthcare networks in your first year, reaping the benefits of our long-standing partnerships with top-tier maternity providers like Mercy Health, The Royal Women's Hospital and Bendigo Health."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Nursing/Bachelor of Midwifery.",
      "evidenceLines": [
        "Note: Completion of this course is subject to core participation requirements, essential requirements, and additional costs. Please see the Entry requirements & pathways and Fees & scholarships tabs for more information.",
        "To qualify for the award of Bachelor of Nursing/Bachelor of Midwifery, students must complete 480 credit points consisting of:"
      ]
    },
    "G2": {
      "result": "PASS",
