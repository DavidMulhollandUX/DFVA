...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Introduction to International Security Studies (STST1001)",
      "Subject: Security Concepts in the Asia-Pacific (STST2001)",
      "**Program Duration**: 3 year full-time"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Living with Giants: Australia's Security in a Contested Asia (STST3002)",
      "Subject: Introduction to International Security Studies (STST1001)",
      "**Post Nominal**: Nominal BIntSecSt"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**UAC Code**: code 132105 (B International Security Stud)",
      "Subject: Living with Giants: Australia's Security in a Contested Asia (STST3002)",
      "- **Career / Study Level**: Undergraduate"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of International Security Studies.",
      "evidenceLines": [
        "- **Program Duration**: 3 year full-time",
        "A single three year undergraduate award offered by theANU College of Asia and the Pacific"
      ]
    },
    "G2": {
      "result": "PASS",
