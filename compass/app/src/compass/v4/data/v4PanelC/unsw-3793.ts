...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3793",
      "Subject: Industrial Training (ENGG4999)",
      "- **Total Units / Units of Credit (UOC)**: 264"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Fine Arts / Engineering.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 264",
        "Bachelor of Engineering (Honours) Progression Requirements"
      ]
    },
    "G2": {
      "result": "PASS",
