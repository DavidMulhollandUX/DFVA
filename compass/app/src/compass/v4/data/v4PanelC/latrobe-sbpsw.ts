...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: APPLIED PSYCHOLOGY (PSY1APP)",
      "Subject: INTRODUCTORY PSYCHOLOGY: BRAIN AND MIND (PSY1BAM)",
      "Describe how psychology theory and practice can be applied in a range of professions and fields"
    ]
  },
  "W1": {
    "score": 2,
    ...
    "evidenceLines": [
      "Evaluate the career options for psychology graduates and apply the insights gained to personal career plans.",
      "Understand the human mind and how it drives behaviour.",
      "La Trobe's Bachelor of Psychological Science will prepare you for a career as a professional psychologist, or in a psychology-related field across industries from clinical psychology to human services and marketing."
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "Work collaboratively to produce an integrated presentation and communicate with an audience.",
      "Subject: INTRODUCTION TO BEHAVIOURAL NEUROSCIENCE 1A (PSY1BNA)",
      "Elective subjects with a choice of minor sequences in Human Relationships and Neuroscience gives you the flexibility to work towards the career you want."
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Bachelor of Psychological Science, students must complete 360 credit points in total consisting of:",
      "Understand the human mind and how it drives behaviour."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Psychological Science - Albury.",
      "evidenceLines": [
        "To qualify for the award of Bachelor of Psychological Science, students must complete 360 credit points in total consisting of:",
