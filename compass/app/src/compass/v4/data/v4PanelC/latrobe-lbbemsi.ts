...
const record: V4PanelC = {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "* Completion requirements",
        "This degree is being phased out. No new enrolments will be permitted from Semester 2 2022. Prospective students should see the requirements for the Bachelor of Business majoring in Event Management or Tourism and Hospitality course at the Singapore Campus."
      ]
    },
    "G2": {
      "result": "PASS",
