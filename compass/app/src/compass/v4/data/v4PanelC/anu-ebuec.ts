...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Business Reporting and Analysis (BUSN1001)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Accounting Processes and Systems (BUSN1002)",
      "Subject: Introduction to Commercial Law (BUSN1101)",
      "**Post Nominal**: Nominal DipBusEc"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Field of Education**: of Education Business and Management not el",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Diploma of Business and Economics.",
      "evidenceLines": [
        "- **Program Duration**: 1 year full-time",
        "- **Minimum Units Required**: 48 Units"
      ]
