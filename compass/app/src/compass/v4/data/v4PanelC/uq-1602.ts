...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: CHIN1100 - Spoken Chinese IA",
      "Subject: CHIN1200 - Written Chinese IA",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: CHIN2100 - Spoken Chinese IB",
      "Subject: CHIN3010 - Spoken Chinese IIB",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: CHIN1100 - Spoken Chinese IA",
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=1602",
      "- **Duration**: Not specified"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Diploma in Languages.",
      "evidenceLines": [
        "- **Institution**: The University of Queensland (UQ)",
        "- **Duration**: Not specified"
      ]
