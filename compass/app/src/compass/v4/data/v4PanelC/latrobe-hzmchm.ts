...
const record: V4PanelC = {
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "In your first year, you'll learn the foundations of human bioscience."
    ]
  },
  "C5": {
    "score": 2,
    ...
    "evidenceLines": [
      ...
      "Subject: PATHOPHYSIOLOGY (HBS2PAT)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: HEALTHCARE IN AUSTRALIA (HIM1HAU)",
      "In your first year, you'll learn the foundations of human bioscience."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "The qualification awarded on graduation is recognised in the Australian Qualifications Framework (AQF) as Level 7.",
        "To qualify for the award of Bachelor of Health Sciences (Medical Classification)/Bachelor of Health Information Management (HZMCHM) students must complete a total 480 credit points consisting of:"
      ]
    },
    "G2": {
      "result": "PASS",
