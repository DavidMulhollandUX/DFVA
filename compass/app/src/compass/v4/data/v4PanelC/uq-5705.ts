...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Participatory Development Communication (COMU7013)",
      "Subject: Risk Communication (COMU7111)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Health Economics (ECON7460)",
      "**Teaching Location**: Gatton, External, Herston, Pharmacy Aust Cntr Excellence, St Lucia"
    ]
  },
  "W1": {
    "score": 3,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5705",
      "Subject: The Economics of Climate Change (ECON7760)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Environmental Health Sciences.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Diploma in Environmental Health Sciences a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
