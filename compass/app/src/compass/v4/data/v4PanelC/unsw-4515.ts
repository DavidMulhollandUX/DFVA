...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: COMP3891 - Extended Operating Systems",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: COMP4963 - Computer Science Thesis C",
      "Subject: COMP4961 - Computer Science Thesis A",
      "**CRICOS Code**: 084277J"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: COMP3821 - Extended Algorithm Design and Analysis",
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4515",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Computer Science & Engineering (Honours).",
      "evidenceLines": [
        "- **Institution**: University of New South Wales (UNSW Sydney)",
        "- **Total Units / Units of Credit (UOC)**: 48"
      ]
