...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: The Macroeconomy (ECON7021)",
      "Subject: Microeconomic Analysis (ECON7030)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Economic Analysis of Strategy (ECON7070)",
      "Subject: Economics of Financial Markets (ECON7200)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5010",
      "Subject: Elements of Econometrics (ECON7310)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Economics.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "Since the Graduate Certificate in Economics is of only one semester duration, the skills acquired would need to be complemented by other skills and/or training possessed by the graduate. The graduate certificate program would be useful for business graduates, scientists, engineers and librarians as they would gain some skills in economics."
      ]
    },
    "G2": {
      "result": "PASS",
