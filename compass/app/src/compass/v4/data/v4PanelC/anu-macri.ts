...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Advanced Criminological Theory (CRIM8005)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Advanced Criminology Seminar (CRIM8012)",
      "Subject: International Climate Change Policy and Economics (EMDV8080)",
      "**Post Nominal**: Nominal MAppCrim"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Field of Education**: of Education Criminology",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Applied Criminology.",
      "evidenceLines": [
        "- **Program Duration**: 1 year full-time",
        "- **Minimum Units Required**: 48 Units"
      ]
