...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: LAWS1121 - Legal System and Skills A",
      "Subject: ATSI1012 - Aboriginal Sydney",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: LAWS1124 - Lawyers and Society",
      "Subject: ATSI1011 - Indigenous Australia",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: LAWS1122 - Legal System and Skills B",
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/7016",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Humanities.",
      "evidenceLines": [
        "- **Institution**: University of New South Wales (UNSW Sydney)",
        "- **Total Units / Units of Credit (UOC)**: 48"
      ]
