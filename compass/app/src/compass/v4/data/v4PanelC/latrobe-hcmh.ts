...
const record: V4PanelC = {
  ...
  "C2": {
    ...
    "evidenceLines": [
      ...
      "As we respond to the challenges of a changing world, mental health is in the spotlight."
    ]
  },
  "C3": {
    "score": 2,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "Rapid changes to our social fabric have created significant challenges for individuals and their communities."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Graduate Certificate in Mental Health, students must complete 60 credit points in total consisting of:",
      "Make a difference in your community's mental health."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Mental Health.",
      "evidenceLines": [
        "To qualify for the award of Graduate Certificate in Mental Health, students must complete 60 credit points in total consisting of:",
        "60 credit points core subjects."
      ]
    },
    "G2": {
      "result": "PASS",
