...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: mmsci_mmasci",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Optimisation (MATHX205)",
      "Subject: Fluid Mechanics (ENGM2005)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/mmsci_mmasci"
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      "Translate problem statements describing a real-world scenario into a mathematical formulation",
      "Analyse the computational complexity in various algorithm designs",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Decision Science PG (MATH5112)",
      "Subject: Cryptography PG (COMP5086)",
      "Formulate and solve linear programming problems and integer programming problems"
    ]
  },
  "W1": {
    "score": 2,
    ...
    "evidenceLines": [
      "Solve optimisation problems using computer programs and packages.",
      "- **Institution**: The University of Adelaide",
      "- **Program Identifier / Slug**: mmsci_mmasci"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "Collaborate in small teams to generate solutions to larger problems and produce a report",
      "Subject: Complex Analysis (MATHX208)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Mathematical Sciences.",
      "evidenceLines": [
        "The Master of Mathematical Sciences is an AQF Level 9 Masters qualification with a standard full-time duration of 2 years.",
