...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Foundations of Literacy in Education (EDST1120)",
      "**CRICOS Code**: 113668E"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4072",
      "Subject: Foundations of History and Geography in Education (EDST1143)",
      "- **Total Units / Units of Credit (UOC)**: 192"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 192",
        "It is designed to cater for students who do not meet the eligibility criteria for embedded honours. Students who do not achieve a 75+ WAM at the end of Year 3 Term 1 (or equivalent 114 UOC) in the Bachelor of Education (Primary) (Honours) will transfer to the Bachelor of Education (Primary)."
      ]
    },
    "G2": {
      "result": "PASS",
