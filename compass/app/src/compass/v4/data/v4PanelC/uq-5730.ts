...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Global South Cities: Development Planning Theory and Practice (PLAN7612)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Masterclass (UDAD7004)",
      "Subject: Urban Design: Urban Futures (UDAD7006)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5730",
      "Subject: Contemporary Urbanism (UDAD7014)",
      "- **Faculty**: of Engineering, Architecture and Information Technology"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Urban Development and Design.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Certificate in Urban Development and Design a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
