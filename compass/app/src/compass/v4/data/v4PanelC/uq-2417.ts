...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Honours Research Project (SCIE4010)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Honours Research Project (SCIE4020)",
      "Subject: Literature Review and Project Research Proposal (SCIE4040)",
      "**Teaching Location**: Gatton"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2417",
      "Subject: Literature Review and Project Research Proposal (SCIE4040)",
      "- **Teaching Location**: Gatton"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Equine Science.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Equine Science (Honours) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
