...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: management-cems",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Enterprise Management in China (IBUS6020)",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/business-school-pg/coursework/management-cems.html"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Managing People and Organisations (MMGT6004)",
      "Subject: Marketing (MMGT6008)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Data-Driven Management Decision Making (MMGT6012)",
      "- **Faculty**: business-school-pg"
    ]
  },
  "W3": {
