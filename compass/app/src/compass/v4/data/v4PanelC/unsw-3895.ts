...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Fundamentals of Biochemistry (BIOC2181)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Chemistry for Health Sciences (CHEM1832)",
      "Subject: Analytical Chemistry for the Pharmaceutical Sciences (CHEM2051)",
      "**CRICOS Code**: 109398A"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/3895",
      "Subject: Medicines: Small Molecules to Macromolecules (CHEM2832)",
      "- **Total Units / Units of Credit (UOC)**: 240"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Pharmaceutical Medicine / Pharmacy.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 240",
