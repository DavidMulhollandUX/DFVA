...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Change Management (ZZBU6409)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Leadership Development (ZZBU6413)",
      "Subject: Behaviour in Organisations (ZZSC5111)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7513",
      "Subject: Research and Evidence in Organisations (ZZSC5112)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Business Psychology.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
