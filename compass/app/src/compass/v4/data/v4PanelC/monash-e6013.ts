...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "Master of Applied Engineering provides advanced engineering education-related knowledge and skills in applied engineering with specialisations catering for the demands in South East Asia."
    ]
  },
  "C2": {
    "score": 3,
    ...
    "evidenceLines": [
      ...
      "The course focuses on the optimisation of system design from the perspective of productivity and analysis."
    ]
  },
  "C3": {
    "score": 3,
    ...
    "evidenceLines": [
      "Subject: Waste management and biomass transformation (CHE5805)",
      "Subject: Low-carbon technology (CHE5806)",
      "Mid-term tests: 20% (Hurdle: Threshold)"
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      "Labs: 30% (Hurdle: Threshold)",
      "Open-ended project: 20% (Hurdle: Threshold)",
      "After completion, you will be able to apply this knowledge and skills to design, implement and improve systems in the industrial, energy and technology sectors."
    ]
  },
  "C5": {
    "score": 2,
    ...
    "evidenceLines": [
      "Subject: Carbon footprint and energy management (CHE5807)",
      "Subject: Carbon capture, storage and utilisation (CHE5833)",
      "Final assessment: 30% (Hurdle: Threshold)"
    ]
  },
  "W1": {
    "score": 2,
    ...
    "evidenceLines": [
      "Integrate low-carbon technology with carbon capture and storage methods to meet net-zero goals and optimise resource use.",
      "Master of Applied Engineering provides advanced engineering education-related knowledge and skills in applied engineering with specialisations catering for the demands in South East Asia.",
      "The course focuses on the optimisation of system design from the perspective of productivity and analysis."
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "Evaluate the sustainability and energy efficiency of low-carbon technologies in relation to economic, social, and environmental factors.",
      "Subject: Autonomous vehicle system (CIV5100)",
      "After completion, you will be able to apply this knowledge and skills to design, implement and improve systems in the industrial, energy and technology sectors."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Applied Engineering.",
      "evidenceLines": [
        "You must complete one of the following specialisations (48 credit points) :",
