...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Corporate Governance (BUSN8045)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Global Law, Justice and Development (LAWS8001)",
      "**Post Nominal**: Nominal MGovnAdv"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Governance.",
      "evidenceLines": [
        "- **Program Duration**: 1.5 year full-time",
        "- **Minimum Units Required**: 72 Units"
      ]
