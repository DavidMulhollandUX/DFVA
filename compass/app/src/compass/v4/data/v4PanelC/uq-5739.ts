...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Environmental Health Risk - Biological Hazards (ENVH7001)",
      "Subject: Applied Research Methods (ENVM7003)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Environmental Problem Solving (ENVM7512)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5739",
      "Subject: Sustainable Business Practice (ENVM7536)",
      "- **AQF Level**: Refer to your component degrees for AQF level."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Masters of Occupational Hygiene / Occupational Health and Safety Science.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Masters of Occupational Hygiene / Occupational Health and Safety Science a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
