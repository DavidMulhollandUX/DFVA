...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gcnsc_gcnsicnol",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Microbiology and Epidemiology (NURS5036)",
      "Subject: Infection Control Nursing (NURS5037)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gcnsc_gcnsicnol"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "This program in only offered part-time (1 year duration).",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Nursing Science.",
      "evidenceLines": [
        "This program in only offered part-time (1 year duration).",
        "This program in only offered part-time (1 year duration)."
      ]
