...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Gender in Korean History (ASIA2006)",
      "Subject: The Making of Modern Japan: From Samurai to Economic Superpower and Beyond (ASIA2009)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: History of International Relations in Northeast Asia (ASIA2017)",
      "Subject: The Politics of China (ASIA2026)",
      "**Post Nominal**: Nominal BAsiaPaciAff"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Japanese Politics (ASIA2031)",
      "- **Career / Study Level**: Undergraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Asia.",
      "evidenceLines": [
        "- **Program Duration**: 4 year full-time",
        "- **Minimum Units Required**: 192 Units"
      ]
