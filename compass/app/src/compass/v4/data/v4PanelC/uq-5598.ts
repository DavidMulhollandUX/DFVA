...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Bioinformatics 2: Development & Research (BINF7000)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Advanced Genome Informatics (BINF7001)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5598",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Bioinformatics Research Extensive.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Bioinformatics Research Extensive a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
