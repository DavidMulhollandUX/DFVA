...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gdes_gdeducst",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Critical Orientations to School Leadership (EDUC6018)",
      "Subject: Educational Leadership in Diverse Contexts (EDUC5208)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gdes_gdeducst"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Introduction to Wellbeing in Education (EDUC5072)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Understand the links between a critical orientation in the study of school leadership and school-based projects of positive reform",
      "Subject: Mixed Methods Research (EDUC6105)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "The Graduate Diploma in Education Studies is an AQF Level 8 qualification with a standard full-time duration of 1 year.",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Education Studies.",
      "evidenceLines": [
        "The Graduate Diploma in Education Studies is an AQF Level 8 qualification with a standard full-time duration of 1 year.",
