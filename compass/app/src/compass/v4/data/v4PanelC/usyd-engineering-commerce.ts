...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: engineering-commerce",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: INFO1110 - Introduction to Programming",
      "Subject: INFO1910 - Introduction to Programming (Advanced)",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/business-school/coursework/engineering-commerce.html"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: ENGG1810 - Introduction to Engineering Computing",
      "Subject: MATH1061 - Mathematics 1A",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: MATH1062 - Mathematics 1B",
  ...
  "W3": {
    ...
    "evidenceLines": [
      "Course resolutions",
      "Commerce and Engineering Honours",
      "Subject: INFO1910 - Introduction to Programming (Advanced)"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Engineering Honours and Bachelor of Commerce.",
      "evidenceLines": [
        "- **Institution**: The University of Sydney (USYD)",
        "- **Faculty**: business-school"
      ]
