...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: The Presentation and Diagnostic Features of Autism Across the Lifespan (PSYC5520)",
      "Subject: Key Principles in Autism Assessment and Diagnosis: A Lifespan Approach (PSYC5521)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=70230"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Autism Diagnosis.",
      "evidenceLines": [
        "website for details on admission requirements, intake periods, fees, availability to international students, careers information etc.",
