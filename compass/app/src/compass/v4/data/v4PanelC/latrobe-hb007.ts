...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: HEALTHCARE AUSTRALIA (NSG1003)",
      "Recall important details regarding the history, culture, customs and people of Indigenous Australia"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "* Core participation requirements",
        "Note:_Completion of this course is subject to core participation requirements, essential requirements, and additional costs. Please see the[Entry requirements & pathways](https://www.latrobe.edu.au/courses/bachelor-of-nursing-bachelor-of-psychological-science#/entry-requirements) and [Fees & scholarships](https://www.latrobe.edu.au/courses/bachelor-of-nursing-bachelor-of-psychological-science#/fees) tabs for more information._"
      ]
    },
    "G2": {
      "result": "PASS",
