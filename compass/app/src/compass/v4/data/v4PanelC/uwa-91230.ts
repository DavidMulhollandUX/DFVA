...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Food and Nutrition in Population Health (PUBH2208)",
      "Subject: Biostatistics I (PUBH4401)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=91230"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Health Program Evaluation (PUBH5705)",
      "**Academic Year**: 2026"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=91230",
      "Subject: Public Health Field Trip (PUBH5721)",
      "- **Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=91230"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Population Health Studies.",
      "evidenceLines": [
        "This course allows students maximum flexibility to tailor their studies in population health to meet their personal or professional interests or requirements. The course has also been designed as a pathway for those who wish to enrol into a Master of Public Health but who do not have the required educational background.",
