...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: American Empire (ZHSS8102)",
      "Subject: Strategic Communication (ZHSS8125)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Contemporary Warfare (ZHSS8201)",
      "Subject: Foundations of Modern Strategy (ZHSS8203)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7572",
      "Subject: Modern Naval History and Strategy (ZHSS8204)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Strategy and Security.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
