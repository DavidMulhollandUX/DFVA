...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Developing Skills in Medicine (MEDI7200)",
      "Subject: Clinical Immersion (MEDI7300)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Transition to Practice (MEDI7400)",
      "Subject: Developing Skills in Medicine (MEDI7200)",
      "**Teaching Location**: Clinical Units, Teaching Hosps, St Lucia"
    ]
  },
  "W1": {
    "score": 3,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5741",
      "Subject: Transition to Practice (MEDI7400)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Doctor of Medicine.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Doctor of Medicine a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
