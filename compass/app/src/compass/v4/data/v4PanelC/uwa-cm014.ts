...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CM014"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Agribusiness and Master of Agricultural Economics.",
      "evidenceLines": [
        "Students completing this double packaged award course will graduate with both a Bachelor of Agribusiness  majoring in Agricultural Science and Agribusiness, and a Master of Agricultural Economics.",
        "The Masters component of the course will give students an appreciation of  key elements of agricultural economics, with the overall course emphasis on the application of theory to real world circumstances. The core themes of the course are - applied economic analysis, policy analysis, and agribusiness management and analysis."
      ]
    },
    "G2": {
      "result": "PASS",
