...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Mental Health Assessment and Treatment (PSCY9020)",
      "Subject: Fundamental Psychological Therapy Skills (PSCY9021)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Philosophies of Mental Health Care, Services and Systems (PSCY9022)",
      "Subject: Assessing Risk and Managing Challenging Behaviour (PSCY9023)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7365",
      "Subject: Assessing Risk and Managing Challenging Behaviour (PSCY9023)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Mental Health Practice.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
