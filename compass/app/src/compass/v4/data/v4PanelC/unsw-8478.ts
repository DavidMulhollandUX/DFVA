...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Life Cycle Engineering (GSOE9340)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Engineering Project Management (GSOE9820)",
      "Subject: Adaptive Leadership (ZCBU8101)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8478",
      "Subject: Mission Engineering Capability Development for Socio-Technical Systems (ZCSY8701)",
      "- **Total Units / Units of Credit (UOC)**: 96"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Digital Engineering.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 96",
        "1. Apply core digital engineering principles to the design and implementation of complex systems, ensuring integration and coherence across all system components."
      ]
    },
    "G2": {
      "result": "PASS",
