...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gdins_gdintsec",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: International Security (PG) (POLI5004)",
      "Subject: International Security (POLI3031)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gdins_gdintsec"
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      ...
      "Critical Analysis: 20%% (Hurdle: False)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Terrorism and Global Politics (POLI2007)",
      "Subject: The Ethics of War and Peace (PG) (POLI5013)",
      "Critical Analysis: 20%% (Hurdle: False)"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: The Ethics of War and Peace (POLI3013)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in International Security.",
      "evidenceLines": [
        "This program introduces students to the core trends, issues and analyses of contemporary international security. Students will acquire in-depth knowledge of current international security challenges and global politics and develop skills in understanding how these can be managed or mitigated.",
