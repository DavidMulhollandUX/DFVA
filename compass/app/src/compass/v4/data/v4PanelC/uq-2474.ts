...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Financial Management (FINM1416)",
      "Subject: Business Law (LAWS1100)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2474",
      "Subject: Introduction to Management (MGTS1301)",
      "- **AQF Level**: Refer to your component degrees for AQF level."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelors of Arts / Tourism, Hospitality and Event Management.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelors of Arts / Tourism, Hospitality and Event Management a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
