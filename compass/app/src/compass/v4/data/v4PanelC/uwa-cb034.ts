...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CB034"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "(on StudentConnect, minors start with the code MNR), if they meet the pre-requisite requirements of that minor and can complete all majors and minors within the 240 credit points of their combined degree.",
      "- **Institution**: The University of Western Australia (UWA)"
    ]
  },
  "gates": {
