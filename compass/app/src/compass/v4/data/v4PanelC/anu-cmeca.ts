...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Middle Eastern Economies (IDEC8034)",
      "Subject: Islamic Economies in Practice (IDEC8035)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Critical Perspectives on Arabic Culture (MEAS6003)",
      "Subject: Iran in World Politics (MEAS6004)",
      "**Post Nominal**: Nominal GC MECAsSt"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Modern Iraq: State, Politics and Society (MEAS6005)",
      "- **Career / Study Level**: Postgraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate of Middle Eastern and Central Asian Studies.",
      "evidenceLines": [
        "- **Program Duration**: 0.5 years",
        "- **Minimum Units Required**: 24 Units"
      ]
