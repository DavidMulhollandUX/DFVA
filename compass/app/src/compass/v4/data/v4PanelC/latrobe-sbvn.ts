...
const record: V4PanelC = {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Veterinary Nursing.",
      "evidenceLines": [
        "The qualification awarded on graduation is recognised in the Australian Qualifications Framework (AQF) as Level 7.",
        "To qualify for the award of Bachelor of Veterinary Nursing, students must complete 360 credit points"
      ]
    },
    "G2": {
      "result": "PASS",
