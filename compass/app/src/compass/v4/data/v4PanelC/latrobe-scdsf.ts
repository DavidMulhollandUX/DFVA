...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "Every data scientist must become a master of mathematics, modelling and database design."
    ]
  },
  "C2": {
    "score": 3,
    ...
    "evidenceLines": [
      ...
      "With La Trobe’s Graduate Certificate in Data Science Fundamentals, you’ll take your first big steps towards this important goal."
    ]
  },
  "C3": {
    "score": 3,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "Gain valuable skills and knowledge, learn from industry experts and build your professional networks."
    ]
  },
  "C5": {
    "score": 3,
    ...
    "evidenceLines": [
      "Subject: MATHEMATICS FOR DATA SCIENCE (MAT4MDS)",
      "Subject: PROBABILITY AND STATISTICS FOR DATA SCIENCE (STM4PSD)",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "Apply mathematical skills to analysis of data science literature.",
      "Every data scientist must become a master of mathematics, modelling and database design.",
      "With La Trobe’s Graduate Certificate in Data Science Fundamentals, you’ll take your first big steps towards this important goal."
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "Perform mathematical calculations relevant to data science fluently and accurately.",
      "Subject: PROBABILITY AND STATISTICS FOR DATA SCIENCE (STM4PSD)",
      "Gain valuable skills and knowledge, learn from industry experts and build your professional networks."
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Graduate Certificate in Data Science Fundamentals students must complete 60 credit points",
      "Every data scientist must become a master of mathematics, modelling and database design."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Data Science Fundamentals.",
      "evidenceLines": [
        "To qualify for the award of Graduate Certificate in Data Science Fundamentals students must complete 60 credit points",
