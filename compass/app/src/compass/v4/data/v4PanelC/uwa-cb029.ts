...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Language for humans and non-humans (LING1001)",
      "Subject: Language, mind and brain (LING1002)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CB029"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: How Language Shapes Society (LING2008)",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Modern Languages and Bachelor of Science.",
      "evidenceLines": [
        "), if they meet the pre-requisite requirements of those majors and minors and can complete all majors and minors within the 192 credit points of their combined degree.",
        "), if they meet the pre-requisite requirements of those majors and minors and can complete all majors and minors within the 192 credit points of their combined degree."
      ]
