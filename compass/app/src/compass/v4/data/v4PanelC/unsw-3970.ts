...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3970",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Science.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 144",
        "The Bachelor of Science allows you to develop expertise in a wide range of science areas. This degree is ideal for students who seek a 'generalist' degree in which there is a large element of choice. Students are encouraged to choose a broad range of courses in the first year, to expand their general understanding of Science which then enables them to choose from a wide selection of major options in the second and third year. There is also the option to apply for an additional Honours year at the end of the program, subject to a student's academic performance and other criteria. The rules and requirements for the degree are set out below."
      ]
    },
    "G2": {
      "result": "PASS",
