...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "Turn your concern for others into a rewarding career and change lives when you become a Registered Nurse."
    ]
  },
  "C2": {
    "score": 3,
    ...
    "evidenceLines": [
      ...
      "As a La Trobe student, you'll gain the skills and confidence to care for people of all ages, making ethical, clinical decisions with compassion."
    ]
  },
  "C3": {
    "score": 2,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "In each year of your course, you'll learn real-world experience in hospital and healthcare settings, so you'll graduate with practical skills in time management, team leadership and caseload coordination."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Bachelor of Nursing (Pre-registration), students must complete 360 credit points consisting of:",
      "Turn your concern for others into a rewarding career and change lives when you become a Registered Nurse."
    ]
  },
  "gates": {
