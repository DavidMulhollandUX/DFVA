...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "**Post Nominal**: Nominal MEnvRscEc"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Public Sector Economics (ECON6034)",
      "- **Career / Study Level**: Postgraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Environmental and Resource Economics.",
      "evidenceLines": [
        "- **Program Duration**: 2 year full-time",
        "- **Minimum Units Required**: 96 Units"
      ]
