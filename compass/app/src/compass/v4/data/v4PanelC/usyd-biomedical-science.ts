...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: biomedical-science",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: BMSC5001 - Clinical Laboratory Science",
      "Subject: BMSC5901 - Clinical Laboratory Science (Advanced)",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/medicine-health-pg/coursework/biomedical-science.html"
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      "Demonstrate comprehensive knowledge of core concepts and methodological frameworks in clinical laboratory science.",
      "Apply critical problem solving and rigorous evaluation to complex issues in clinical laboratory science.",
      "- **Faculty**: medicine-health-pg"
    ]
  },
  "C5": {
    ...
    "evidenceLines": [
      "Subject: GMED5002 - Genomics, Omics and Medical Applications",
      "Subject: BMSC5002 - Advances in Disease Diagnosis and Treatment",
      "Communicate findings, technical arguments, and solutions clearly in academic and professional contexts."
    ]
  },
  "W1": {
    "score": 3,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: GMED5001 - Genomics in Clinical Practice",
      "Final Assessment: 50%",
      "- **Faculty**: medicine-health-pg"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Biomedical Science.",
      "evidenceLines": [
        "- **Institution**: The University of Sydney (USYD)",
        "- **Faculty**: medicine-health-pg"
      ]
