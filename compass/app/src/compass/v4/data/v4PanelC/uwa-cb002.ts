...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CB002"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Introductory Chemistry (CHEX1003)",
      "Bachelor of Environmental Science"
    ]
  },
  "W1": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Environmental Science and Bachelor of Science.",
      "evidenceLines": [
        "(on StudentConnect, minors start with the code MNR), if they meet the pre-requisite requirements of those majors and minors and can complete all majors and minors within the 192 credit points of their combined degree.",
        "(on StudentConnect, minors start with the code MNR), if they meet the pre-requisite requirements of those majors and minors and can complete all majors and minors within the 192 credit points of their combined degree."
      ]
