...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Capstone Research (IDES4100)",
      "Subject: Advanced Studio (IDES4111)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Industrial Design Capstone Project A (IDES4113)",
      "Subject: Industrial Design Capstone Project B (IDES4114)",
      "**CRICOS Code**: 098444F"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4525",
      "Subject: Industrial Design Capstone Project B (IDES4114)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Industrial Design.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 48",
