...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gdfod_gdforodon",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Forensic Odontology Research Part 1 (DENT5009)",
      "Subject: Forensic Odontology Research Part 2 (DENT5010)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gdfod_gdforodon"
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      "Adopt and employ professional attitudes and standards/values by displaying the highest levels of integrity in all aspects of professional life.",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Research Methods and Ethics (DENT5011)",
      "Subject: Integrated Forensic Science (DENT5012)",
      "Provide forensic odontology services of the highest quality in a contemporary, ethical and legal environment and apply a broad understanding of social, political and cultural perspectives to inform quality practice."
    ]
  },
  "W1": {
    "score": 2,
    ...
    "evidenceLines": [
      "Be committed to take a leadership role in actively promoting the importance of forensic odontology in dental, judicial, and community settings with emphasis on world best practice standards.",
      "- **Institution**: The University of Adelaide",
      "- **Program Identifier / Slug**: gdfod_gdforodon"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "Effectively seek, analyse and evaluate data, materials and technology, as well as to produce expert opinions relating to the scope of forensic odontology.",
      "Subject: Principles and Methods of Forensic Odontology (DENT5008)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Forensic Odontology.",
      "evidenceLines": [
        "The Graduate Diploma in Forensic Odontology is an AQF Level 8 qualification with a standard full-time duration of 1 year.",
