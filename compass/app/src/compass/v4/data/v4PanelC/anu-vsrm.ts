...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Principles of Population Analysis (DEMO8008)",
      "Subject: Population and Society: Theory and Empirical Perspectives (DEMO8024)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: International Migration (DEMO8047)",
      "Subject: Sex, Gender and Population (DEMO8048)",
      "**Post Nominal**: Nominal MSocResMthAdv"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Population Issues in Asia and their Implications for World Development (DEMO8090)",
      "- **Program Duration**: 1.5 year full-time"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Social Research Methods.",
      "evidenceLines": [
        "- **Program Duration**: 1.5 year full-time",
        "- **Minimum Units Required**: 72 Units"
      ]
