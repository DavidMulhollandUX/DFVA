...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: CLINICAL NEUROPSYCHOLOGY DISSERTATION (PSYC7031)",
      "Subject: Child and Adolescent Emotional Health (PSYC7043)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Evidence based Parenting and Family Intervention (PSYC7053)",
      "Subject: Assessment in Psychological Practice (PSYC7112)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5766",
      "Subject: Adult Psychopathology (PSYC7113)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Clinical Neuropsychology and Clinical Psychology.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Clinical Neuropsychology and Clinical Psychology a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
