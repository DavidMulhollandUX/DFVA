...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: IEST7500 - Environmental Technologies: Challenges & Opportunities",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: SRAP5004 - Policy, Accountability and Governance",
      "Subject: SUSD0010 - Managing the Sustainable Built Environment",
      "**CRICOS Code**: 080063M"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: GEOS9011 - Environmental Impact Assessment",
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8623",
      "- **Total Units / Units of Credit (UOC)**: 96"
    ]
  },
  "W3": {
