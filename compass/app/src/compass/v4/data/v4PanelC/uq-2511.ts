...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Interdisciplinary Thinking (HUMN1100)",
      "Subject: Perspectives in Humanities (HUMN1201)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Cross-Cultural Humanities (HUMN2200)",
      "Subject: Humanities and the Big Questions (HUMN3100)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2511",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelors of Humanities / Laws.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelors of Humanities / Laws (Honours) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
