...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "**Post Nominal**: Nominal BDevStYIA"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Field of Education**: of Education Sociology",
      "Subject: Vietnamese 4 (VIET2003)",
      "- **Career / Study Level**: Undergraduate"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Development Studies.",
      "evidenceLines": [
        "- **Program Duration**: 4 year full-time",
        "- **Minimum Units Required**: 192 Units"
      ]
