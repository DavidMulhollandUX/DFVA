...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Programming Fundamentals (COMP7710)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Responsible Practice, Innovation and Leadership (COMP8280)",
      "Subject: Discrete Mathematical Models (MATH6005)",
      "**Post Nominal**: Nominal MComp"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Computing.",
      "evidenceLines": [
        "- **Program Duration**: 2 year full-time",
