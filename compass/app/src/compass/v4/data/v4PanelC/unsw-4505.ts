...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Puzzles, Planning, and Presentation for Honours in the Social Sciences (ARTS4266)",
      "Subject: Methodologies in the Social Sciences: Questions and Quandaries (ARTS4268)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "W1": {
    ...
    "evidenceLines": [
      "**Academic Organisation**: School of Law, Society and Criminology",
      "- **Institution**: University of New South Wales (UNSW Sydney)",
      "- **Study Level**: Undergraduate"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4505",
      "Subject: Methodologies in the Social Sciences: Questions and Quandaries (ARTS4268)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Criminology.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 48",
        "The Bachelor of Criminology (Honours) [BCCJ (Hons)] is a 48 UOC (one year equivalent) advanced undergraduate degree for high achieving students which may be taken upon completion of an undergraduate pass degree in Criminology & Criminal Justice. The BCCJ (Hons) can be completed full-time or part-time."
      ]
    },
    "G2": {
      "result": "PASS",
