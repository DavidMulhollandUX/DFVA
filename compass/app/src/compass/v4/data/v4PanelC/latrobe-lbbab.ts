...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: WATER MANAGEMENT (AGR3WMT)",
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To attain the Bachelor of Business (Agribusiness), students will be required to complete 360 credit points in total consisting of:",
      "Join the exciting world of agribusiness."
    ]
  },
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "To attain the Bachelor of Business (Agribusiness), students will be required to complete 360 credit points in total consisting of:",
        "240 credit points core subjects, and"
      ]
    },
    "G2": {
      "result": "PASS",
