...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Psychology: Mind and Brain (PSYC1101)",
      "Subject: Psychology: Behaviour in Context (PSYC1102)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CB009"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Research Methods and Analysis in Psychology I (PSYC2203)",
      "Subject: Psychology and Social Behaviour (PSYC2212)",
      "Bachelor of Agricultural Science"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Institution**: The University of Western Australia (UWA)",
      "Subject: Psychology: Lifespan Development (PSYC2213)",
      "- **Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CB009"
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "(on StudentConnect, minors start with the code MNR), if they meet the pre-requisite requirements of those majors and minors and can complete all majors and minors within the 192 credit points of their combined degree.",
      "- **Institution**: The University of Western Australia (UWA)"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Agricultural Science and Bachelor of Arts.",
      "evidenceLines": [
        "(on StudentConnect, minors start with the code MNR), if they meet the pre-requisite requirements of those majors and minors and can complete all majors and minors within the 192 credit points of their combined degree.",
        "(on StudentConnect, minors start with the code MNR), if they meet the pre-requisite requirements of those majors and minors and can complete all majors and minors within the 192 credit points of their combined degree."
      ]
