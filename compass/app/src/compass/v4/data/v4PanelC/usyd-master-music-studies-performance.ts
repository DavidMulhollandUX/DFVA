...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: master-music-studies-performance",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Creative Work Seminar 1 (MCGY5111)",
      "Subject: Creative Work Seminar 2 (MCGY5112)",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/conservatorium/postgraduate/master-music-studies-performance.html"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Music Through Ethnography (MCGY5601)",
      "Subject: Research Skills for Music Performance (MCGY5610)",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "Q&A based on creative work demonstration oral presentation based on performance or composition demonstration: 30%: Multiple weeks% (Hurdle: False)",
      "- **Institution**: The University of Sydney (USYD)",
      "- **Course / Program Identifier**: master-music-studies-performance"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "Q&A based on creative work oral presentation based on performance or composition demonstration: 30%: Multiple weeks% (Hurdle: False)",
      "Subject: Dissertation 1 (MCGY5618)",
      "- **Handbook URL**: https://www.sydney.edu.au/handbooks/conservatorium/postgraduate/master-music-studies-performance.html"
    ]
  },
  "W3": {
