...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: bsc_bscssap",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Programming (Matlab and C) (COMP1014)",
      "Subject: Mathematics IA (MATH1050)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/bsc_bscssap"
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      "Formulate and solve engineering problems involving ordinary differential equations and linear systems of equations",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Engineering Modelling 1 (ENGI1004)",
      "Subject: Mathematics IB (MATH2050)",
      "Solve first and second order ordinary differential equations and systems of ordinary differential equations"
    ]
  },
  "W1": {
    "score": 2,
