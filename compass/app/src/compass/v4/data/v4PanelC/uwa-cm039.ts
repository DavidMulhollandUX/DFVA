...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CM039"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CM039",
      "Subject: Biological Anthropology: Genes and Society (ANHB3321)",
      "- **Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CM039"
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "Students completing this double packaged award course will graduate with both a Bachelor of Human Sciences (Pharmaceutical Health) and a Doctor of Pharmacy.",
      "- **Institution**: The University of Western Australia (UWA)"
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Human Sciences.",
      "evidenceLines": [
        "Students completing this double packaged award course will graduate with both a Bachelor of Human Sciences (Pharmaceutical Health) and a Doctor of Pharmacy.",
        "Students who complete the combined degree (CBD) will receive advanced standing for four level 3 pharmacy units (24 points), which will be credited toward the Doctor of Pharmacy component of the course."
      ]
    },
    "G2": {
      "result": "PASS",
