...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Architectural History and Theory 1 (ARCH1000)",
      "Subject: Architectural Design Studio 1 (ARCH1101)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Architectural Design Studio 2 (ARCH1102)",
      "Subject: Architectural Design Studio 3A (ARCH1105)",
      "**CRICOS Code**: 059439D"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3635",
      "Subject: Architectural History and Theory 2 (ARCH1222)",
      "- **Total Units / Units of Credit (UOC)**: 192"
    ]
  },
  "W3": {
