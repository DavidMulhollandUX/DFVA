...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "Step into an in-demand career at the frontlines of an increasingly complex digital landscape with La Trobe's Bachelor of Computer Science."
    ]
  },
  "C2": {
    "score": 3,
    ...
    "evidenceLines": [
      ...
      "At La Trobe, you’ll get more than a basic technical foundation."
    ]
  },
  "C3": {
    "score": 3,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "We’ll prepare you to face the challenges of a networked society by building a solid foundation in programming, algorithms, databases, networks, cybersecurity, and AI — the essential skills every modern computer scientist needs."
    ]
  },
  "C5": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Computer Science.",
      "evidenceLines": [
        "To qualify for the award of Bachelor of Computer Science, students must complete 360 credit points consisting of:",
