...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Managing Organisational Behaviour (MGTS7601)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Strategic Human Resource Management (MGTS7603)",
      "Subject: Magnetic Resonance Instrumentation (MRES7002)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5096",
      "Subject: MR Safety and Monitoring (MRES7003)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Magnetic Resonance Technology.",
      "evidenceLines": [
        "- **Duration**: Not specified",
