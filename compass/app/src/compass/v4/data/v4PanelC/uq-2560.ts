...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2560",
      "Subject: Operating Systems Architecture (COMP3301)",
      "- **AQF Level**: Refer to your component degrees for AQF level."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Computer Science / Master of Cyber Security.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Computer Science / Master of Cyber Security a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
