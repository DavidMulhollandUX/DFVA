...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Competition law (LAW5312)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: International environmental law (LAW5314)",
      "This course provides you with the legal knowledge that will give you a competitive edge in your chosen career."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate of Legal Studies.",
      "evidenceLines": [
        "24 credit points",
        "**Law studies** **24 credit points**"
      ]
    },
    "G2": {
      "result": "PASS",
