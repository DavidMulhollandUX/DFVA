...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Assessing and Interpreting Child and Adolescent Mental Health and Wellbeing (EDUC5010)",
      "Subject: Promoting Child and Adolescent Positive Mental Health and Wellbeing (EDUC5011)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=30380"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Promoting Positive Mental Health and Wellbeing: Translating Theory into Practice (EDUC5012)",
      "Subject: Childhood and Adolescent Developmental Psychopathology (EDUC5639)",
      "**Academic Year**: 2026"
    ]
  },
  "W1": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Mental Health and Wellbeing in Education.",
      "evidenceLines": [
        "website for details on admission requirements, intake periods, fees, availability to international students, careers information etc.",
