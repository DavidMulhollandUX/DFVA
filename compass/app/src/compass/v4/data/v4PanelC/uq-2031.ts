...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: BIOM6070 - Biomedical Science Research Preparative Skills",
      "Subject: BIOM6080 - Biomedical Science Research Techniques",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: BIOM6100 - Biomedical Science Research Project",
      "Subject: BIOM6200 - Biomedical Science Research Project",
      "**Teaching Location**: Herston, St Lucia"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: BIOM6070 - Biomedical Science Research Preparative Skills",
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2031",
      "- **Duration**: Not specified"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Science (Honours).",
      "evidenceLines": [
        "- **Institution**: The University of Queensland (UQ)",
        "- **Duration**: Not specified"
      ]
