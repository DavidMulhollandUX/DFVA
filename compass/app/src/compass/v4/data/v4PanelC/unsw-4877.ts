...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4877",
      "Subject: Torts (LAWS1061)",
      "- **Total Units / Units of Credit (UOC)**: 240"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Fine Arts / Law.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 240",
