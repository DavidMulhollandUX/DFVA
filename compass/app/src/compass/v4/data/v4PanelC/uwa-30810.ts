...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Doctoral Thesis (full-time) (EDUC9930)",
      "Subject: Doctoral Thesis (part-time) (EDUC9940)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=30810"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Doctor of Education.",
      "evidenceLines": [
        "website for details on admission requirements, intake periods, fees, availability to international students, careers information etc.",
