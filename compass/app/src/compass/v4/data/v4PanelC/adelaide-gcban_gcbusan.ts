...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gcban_gcbusan",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Fundamentals of Business Analytics (UoA) (BAFI5005)",
      "Subject: Fundamentals of Business Analytics (BUSI6022)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gcban_gcbusan"
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      ...
      "Apply programming methods to manipulate and analyse data for business decision-making",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Predictive and Visual Analytics (UoA) (BAFI5027)",
      "Subject: Predictive and Visual Analytics (BAFI6003)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Demonstrate the ability to explain the background of business analytics.",
      "Subject: Customer Analytics (UoA) (BAFI5028)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "The Graduate Certificate in Business Analytics is an AQF level 8 program with a standard full-time duration of 0.5 years.",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "gates": {
