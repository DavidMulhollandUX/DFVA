...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5255",
      "Subject: Cyber Security Governance, Policy, Ethics and Law (CYBR7003)",
      "- **Faculty**: of Engineering, Architecture and Information Technology"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Cyber Security.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Diploma in Cyber Security a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
