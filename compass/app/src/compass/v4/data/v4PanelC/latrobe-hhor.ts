...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: CLINICAL ANATOMY AND NEUROSCIENCES (HBS2CAN)",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Orthoptics (Honours).",
      "evidenceLines": [
        "* Core participation requirements",
        "To qualify for the award of Bachelor of Orthoptics (Honours) students must complete 480 credit points consisting of: 420 core credit points One, 60 credit point minor"
      ]
    },
    "G2": {
      "result": "PASS",
