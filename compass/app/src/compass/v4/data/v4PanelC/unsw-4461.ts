...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Organisational Behaviour (ZBUS1101)",
      "Subject: Business Economics (ZBUS1102)",
      "**AQF Level**: Level 7"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Foundations of Management (ZBUS1104)",
      "Subject: Law, Force and Legitimacy (ZGEN2215)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4461",
      "Subject: Introduction to Strategic Studies (ZGEN2222)",
      "- **Total Units / Units of Credit (UOC)**: 144"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Arts.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 144",
