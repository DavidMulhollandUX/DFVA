...
const record: V4PanelC = {
  ...
  "C4": {
    ...
    "evidenceLines": [
      "**Total Units / Units of Credit (UOC)**: 264",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "**Academic Organisation**: School of Materials Science & Engineering",
      "- **Institution**: University of New South Wales (UNSW Sydney)",
      "- **Study Level**: Undergraduate"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3134",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Materials Science and Engineering.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 264",
        "Students must complete 264 Units of Credit (UOC) structured across the following academic components:"
      ]
    },
    "G2": {
      "result": "PASS",
