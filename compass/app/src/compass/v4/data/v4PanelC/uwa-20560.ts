...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Foundations of Law and Legal Institutions (LAWS4227)",
      "Subject: Foundations of Law and Legal Institutions (LAWS4227)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=20560"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Resources and International Commercial Law.",
      "evidenceLines": [
        "website for details on admission requirements, intake periods, fees, availability to international students, careers information etc.",
        "Foundations of Law and Legal Institutions is a core unit in this program for all students who have not completed a law degree or have not completed a law degree based on the common law. (6 points):"
      ]
    },
    "G2": {
      "result": "PASS",
