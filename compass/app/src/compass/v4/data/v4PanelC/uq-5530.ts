...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: EIBS7302 - Managing Innovation",
      "Subject: MGTS7612 - The Fundamentals of Designing and Staffing Organisations",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: MGTS7309 - Decision Making and Reporting for Sustainability",
      "Subject: ELEC7309 - Power System Planning and Reliability",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: EIBS7302 - Managing Innovation",
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5530",
      "- **Duration**: Not specified"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Engineering Science (Management).",
      "evidenceLines": [
        "- **Institution**: The University of Queensland (UQ)",
        "- **Duration**: Not specified"
      ]
