...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Computation in Financial Mathematics (MATH4090)",
      "Subject: Financial Calculus (MATH4091)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: General Relativity (MATH4105)",
      "Subject: Topics in Mathematical Physics (MATH4108)",
      "**Teaching Location**: St Lucia"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2421",
      "Subject: Topics in Applied and Computational Mathematics (MATH4210)",
      "- **Teaching Location**: St Lucia"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Mathematics (Honours) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
