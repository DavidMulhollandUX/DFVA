...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Genocide: Perception and Intervention (ZHSS8210)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8632",
      "Subject: The Development of the Art of War: A Survey (ZHSS8221)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Special Operations and Irregular Warfare.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 48",
