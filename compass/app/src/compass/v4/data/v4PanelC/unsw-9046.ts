...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Independent Study (PHCM9103)",
      "**CRICOS Code**: 061597E"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/9046",
      "Subject: Qualitative Research Methods (PHCM9120)",
      "- **Total Units / Units of Credit (UOC)**: 72"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Public Health.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 72",
