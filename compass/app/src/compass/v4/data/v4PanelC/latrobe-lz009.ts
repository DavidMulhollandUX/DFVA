...
const record: V4PanelC = {
  ...
  "W3": {
    ...
    "evidenceLines": [
      "Complete a total of at least five years full-time study or its part time equivalent.To qualify for the award of Bachelor of Laws (Honours)/Bachelor of Arts, students must complete 600 credit points consisting of: 360 credit points of Law coded subjects, of which:240 core credit points30 or 45 core-choice credit… For more content click the Read more button below.",
      "Reflect critically on your own cultural attitudes, values and beliefs"
    ]
  },
  "gates": {
