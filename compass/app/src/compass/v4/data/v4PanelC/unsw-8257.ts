...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Law for Psychologists 1 (LAWS9800)",
      "Subject: Law for Psychologists 2 (LAWS9810)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Applications of Forensic Psychology (PSYC7402)",
      "Subject: Experimental Psychology and Law (PSYC7403)",
      "**CRICOS Code**: 028068E"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8257",
      "Subject: Professional and Ethical Practice (Forensic) 1 (PSYC7409)",
      "- **Total Units / Units of Credit (UOC)**: 96"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Psychology.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 96",
