...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Civil and Environmental Engineering Computations (CVEN2002)",
      "Subject: Engineering Operations and Control (CVEN3101)",
      "**AQF Level**: Level 7"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Transport and Highway Engineering (CVEN3401)",
      "Subject: Water Resources Engineering (CVEN3501)",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "**Academic Organisation**: School of Civil and Environmental Engineering",
      "- **Institution**: University of New South Wales (UNSW Sydney)",
      "- **Study Level**: Undergraduate"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3775",
      "Subject: Operations and Projects (CVEN4102)",
      "- **Total Units / Units of Credit (UOC)**: 192"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Surveying.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 192",
