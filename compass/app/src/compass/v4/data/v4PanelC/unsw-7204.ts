...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Research and Theories of Translation and Interpreting (MODL5100)",
      "Subject: Interpreting in Legal Settings (MODL5101)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Interpreting in Community Settings (MODL5102)",
      "Subject: Multimedia Translation (MODL5103)",
      "**CRICOS Code**: 106116G"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7204",
      "Subject: Specialised Translation (MODL5104)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
