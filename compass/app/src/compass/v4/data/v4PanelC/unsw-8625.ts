...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Leadership (AGSM6131)",
      "Subject: Strategy (AGSM6143)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Accounting and Financial Management (AGSM6210)",
      "Subject: Data Analytics and Decision-making (AGSM6234)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8625",
      "Subject: Marketing Management (AGSM6251)",
      "- **Total Units / Units of Credit (UOC)**: 72"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Business Administration.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 72",
