...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      "evaluate the 'economic way of thinking' about a broad range of individual, business and government choices and decisions",
      "apply economic principles to evaluate economic institutions, economic decisions and performance",
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Microeconomics (ECF1100)",
      "Subject: Macroeconomics (ECF1200)",
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "Refer to each partner course for the post nominals for the degree awarded",
        "The course develops through the five themes of Part A. Core studies, Part B. Education studies, Part C. Curriculum studies, Part D. Discipline studies and Part E. Professional experience. The nature and proportion of units required among these themes will differ depending upon your specialisation and discipline studies. In this double degree you will complete:"
      ]
    },
    "G2": {
      "result": "PASS",
