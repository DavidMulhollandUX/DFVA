...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Topics in Classics (CLAS4008)",
      "Subject: Classics Now! (CLAS4022)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Thesis (THES4105)",
      "Subject: Topics in Classics (CLAS4008)",
      "**Post Nominal**: Nominal BClassStHons"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Field of Education**: of Education Language and Literature not el",
      "Subject: Thesis (THES4105)",
      "- **Career / Study Level**: Undergraduate"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Classical Studies.",
      "evidenceLines": [
        "- **Program Duration**: 1 year full-time",
