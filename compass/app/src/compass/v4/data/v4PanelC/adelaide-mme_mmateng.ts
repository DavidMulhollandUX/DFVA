...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: mme_mmateng",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/mme_mmateng"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Materials Engineering.",
      "evidenceLines": [
        "The Master of Materials Engineering is an AQF Level 9 qualification with a standard full-time duration of 2 years.",
        "Develop the ability to apply core concepts in Materials Engineering to engage in scientific research or professional practice, and the ability to handle complex engineering and technical issues using critical thinking and data analysis. Understand the importance of life-long learning."
      ]
    },
    "G2": {
      "result": "PASS",
