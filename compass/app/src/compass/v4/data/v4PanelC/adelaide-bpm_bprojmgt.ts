...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: bpm_bprojmgt",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Data Analytics (ECON1012)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/bpm_bprojmgt"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Project Management.",
      "evidenceLines": [
        "The Bachelor of Project Management is an AQF Level 7 qualification with a standard full-time duration of 3 years.",
        "Communicate project requirements to various stakeholders and resolve issues within a project team."
      ]
    },
    "G2": {
      "result": "PASS",
