...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Advanced Research Project in Chemistry (CHEM8033)",
      "Subject: Advanced Research Project in Chemistry (CHEM8033)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Advanced Research Project in Chemistry (CHEM8033)",
      "Subject: Advanced Research Project in Chemistry (CHEM8033)",
      "**Post Nominal**: Nominal MSciMatSc"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Field of Education**: of Education Chemical Sciences",
      "Subject: Advanced Research Project in Chemistry (CHEM8033)",
      "- **Career / Study Level**: Postgraduate"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Science in Materials Science.",
      "evidenceLines": [
        "- **Program Duration**: 2 year full-time",
