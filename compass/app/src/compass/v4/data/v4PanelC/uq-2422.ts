...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Research Methods (SCIE4000)",
      "Subject: Veterinary Technology Honours Practicum (VETS6622)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Honours Research Project in Veterinary Technology (VETS6631)",
      "Subject: Honours Research Project in Veterinary Technology (VETS6632)",
      "**Teaching Location**: Gatton"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2422",
      "Subject: Honours Research Project in Veterinary Technology (VETS6632)",
      "- **Teaching Location**: Gatton"
    ]
  },
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Veterinary Technology (Honours) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
