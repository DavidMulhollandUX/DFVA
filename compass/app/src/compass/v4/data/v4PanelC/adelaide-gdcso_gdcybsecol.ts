...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gdcso_gdcybsecol",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Political Institutions and Policy-Making (POLI5006)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gdcso_gdcybsecol"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: OL Business Data & Cyber Security (M) (BUSI5089)",
      "Subject: Business Data & Cyber Security (M) (BAFI5030)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: OL Information Risks, Threats and Controls (M) (BUSI5090)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Cyber Security [Online].",
      "evidenceLines": [
        "The Graduate Diploma in Cyber Security [Online] is an AQF Level 8 qualification with a standard full-time duration of 1 year. However, this program is only offered part-time for a duration of 1.3 years.",
