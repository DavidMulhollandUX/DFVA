...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "Gain the skills, knowledge and experience you need to launch an agricultural career with La Trobe's Diploma of Agricultural Science."
    ]
  },
  "C2": {
    "score": 2,
    ...
    "evidenceLines": [
      ...
      "Build foundational skills in agriculture, across plant and animal sciences, agricultural systems, agribusiness, land and soil management, and sustainable agricultural practices."
    ]
  },
  "C3": {
    "score": 2,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "Graduate with the qualification you need to fast-track your agricultural career in just twelve months."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Diploma of Agricultural Science, students must complete 120 credit points consisting of:",
      "Gain the skills, knowledge and experience you need to launch an agricultural career with La Trobe's Diploma of Agricultural Science."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Diploma of Agricultural Science - Albury.",
      "evidenceLines": [
        "To qualify for the award of Diploma of Agricultural Science, students must complete 120 credit points consisting of:",
