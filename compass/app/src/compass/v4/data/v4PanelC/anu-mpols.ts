...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Global Crisis, Global Protest (INTR8084)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Critical Approaches and Methods in the Study of the Middle East and Central Asia (MEAS8001)",
      "Subject: Drivers of Violent Extremism: The Local and the Global in the Middle East (MEAS8111)",
      "**Post Nominal**: Nominal MPolsSc"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Field of Education**: of Education Political Science",
      "Subject: Dynamics of Israeli-Palestinian Conflict (MEAS8112)",
      "- **Career / Study Level**: Postgraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Political Science.",
      "evidenceLines": [
        "- **Program Duration**: 1.5 year full-time",
        "- **Minimum Units Required**: 72 Units"
      ]
