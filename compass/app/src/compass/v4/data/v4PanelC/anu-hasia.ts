...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Fundamentals of Research Design in Asia-Pacific Culture, History and Languages (ASIA4001)",
      "**Post Nominal**: Nominal BAsSt Hons"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Field of Education**: of Education Language and Literature",
      "Subject: Thesis (THES4502)",
      "- **Career / Study Level**: Undergraduate"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Asian Studies.",
      "evidenceLines": [
        "- **Program Duration**: 1 year full-time",
        "- **Minimum Units Required**: 48 Units"
      ]
