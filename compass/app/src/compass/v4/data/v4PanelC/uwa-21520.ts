...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Theory, Method and Contemporary Issues of International Law (LAWS5225)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=21520"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Approaches to International Relations (POLS5661)",
      "Subject: Foundations of Law and Legal Institutions (LAWS4227)",
      "**Academic Year**: 2026"
    ]
  },
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "website for details on admission requirements, intake periods, fees, availability to international students, careers information etc.",
        "Admission Schedule A: English Language Competence Requirements."
      ]
    },
    "G2": {
      "result": "PASS",
