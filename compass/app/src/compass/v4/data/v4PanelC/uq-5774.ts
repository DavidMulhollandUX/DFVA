...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: MINE3110 - Mining Geomechanics",
      "Subject: MINE4126 - Mining Systems and Automation",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: MINE6111 - Principles of Fleet Management",
      "Subject: MINE6120 - Short Term Mine Planning and Scheduling",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: MINE3110 - Mining Geomechanics",
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5774",
      "- **Duration**: Not specified"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Resource Development.",
      "evidenceLines": [
        "- **Institution**: The University of Queensland (UQ)",
        "- **Duration**: Not specified"
      ]
