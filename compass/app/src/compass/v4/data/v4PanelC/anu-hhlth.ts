...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Data Analysis and Methods in Biological Anthropology (BIAN4011)",
      "**Post Nominal**: Nominal BHealthSciHons"
    ]
  },
  "W1": {
    "score": 3,
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Field of Education**: of Education Public Health",
      "Subject: Biology IV Honours (BIOL4001)",
      "- **Career / Study Level**: Undergraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Health Science.",
      "evidenceLines": [
        "- **Program Duration**: 1 year full-time",
        "- **Minimum Units Required**: 48 Units"
      ]
