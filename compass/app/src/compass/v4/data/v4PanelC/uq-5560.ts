...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Digital Health (HLTH7001)",
      "Subject: Digital Health in Clinical Practice (HLTH7002)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Core Knowledge & Professional Practice (IMED7001)",
      "Subject: Clinical and Dermatoscopic Diagnosis in Skin Cancer Practice (IMED7002)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5560",
      "Subject: Assessment & Diagnosis (IMED7003)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Medicine.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Certificate in Medicine a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
