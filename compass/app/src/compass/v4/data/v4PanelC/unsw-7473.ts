...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: People and Systems (ZCBU8102)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
    ...
    "evidenceLines": [
      ...
      "**Delivery Mode**: Fully online, Distance (online with some face-to-face), Face-to-face (includes blended)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Public Service Implementation (ZCBU8103)",
      "Subject: Public Service Performance and Evaluation (ZCBU8104)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7473",
      "Subject: Defence Logistics Management (ZCBU8105)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Public Service Implementation.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
