...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Society, Law and Politics (ANTH2406)",
      "Subject: Ethnography (ANTH3001)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=BH017"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Indigenous Australia (ANTH3601)",
      "Subject: Humanities in Health and Medicine (BMED2001)",
      "**Academic Year**: 2026"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=BH017",
      "Subject: Narrative Medicine for research, education and practice (BMED3001)",
      "- **Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=BH017"
    ]
  },
  "W3": {
