...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: CEIC4954 - Research Thesis Extension",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: GSOE9010 - Engineering Postgraduate Coursework Research Skills",
      "Subject: GSOE9510 - Ethics and Leadership in Engineering",
      "**CRICOS Code**: 084283M"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: GSOE9830 - Economic Decision Analysis in Engineering",
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8037",
      "- **Total Units / Units of Credit (UOC)**: 96"
    ]
  },
  "W3": {
