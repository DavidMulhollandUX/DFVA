...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gdamh_gdadmhlt",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Co-Existing Addiction and Mental Health Disorders (NURS5034)",
      "Subject: Co-Existing Addiction and Mental Health Disorders (PHAR5042)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gdamh_gdadmhlt"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Mental Health (NURS5035)",
      "Subject: Mental Health (PHAR5043)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Drug Effects and Biology of Addiction (PHAR5014)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Addiction and Mental Health.",
      "evidenceLines": [
        "The Graduate Diploma in Addiction and Mental Health is an AQF Level 8 qualification with a standard full-time duration of 1 year.",
