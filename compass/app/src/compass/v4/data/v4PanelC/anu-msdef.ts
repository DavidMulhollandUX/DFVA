...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "**Post Nominal**: Nominal MStratDef"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Strategy and Defence.",
      "evidenceLines": [
        "- **Program Duration**: 1 year full-time",
        "- **Minimum Units Required**: 48 Units"
      ]
