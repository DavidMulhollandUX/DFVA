...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Learning and Development for Educators (EDUC1650)",
      "Subject: A Sociological Orientation to Education (EDUC1710)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Indigenous Knowledge & Education (EDUC2090)",
      "Subject: Teachers as Educational Innovators and Agents of Change (EDUC2604)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2539",
      "Subject: Literacy and Numeracy Across the Curriculum (EDUC2630)",
      "- **AQF Level**: Refer to your component degrees for AQF level."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelors of Music / Education.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelors of Music / Education (Secondary) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
