...
const record: V4PanelC = {
  ...
  "C2": {
    ...
    "evidenceLines": [
      ...
      "This practice-based qualification builds on the existing Graduate Certificate of Clinical Simulation."
    ]
  },
  "C3": {
    "score": 2,
    ...
    "evidenceLines": [
      "Subject: Foundations of health professions education: Clinical Simulation (HCS5100)",
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "It is suitable for a broad range of health professionals and others who are, or will be, engaged in simulation-based education."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Clinical Simulation.",
      "evidenceLines": [
        "This course is structured into three parts: Part A. Core studies, Part B. Applied studies, and Part C. Specified elective studies. Each part comprises a combination of units and short courses.",
        "Part A. Core studies"
      ]
