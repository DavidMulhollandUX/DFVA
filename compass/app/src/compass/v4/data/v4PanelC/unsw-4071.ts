...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4071",
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 192",
        "Students who do not achieve a 75+ WAM at the end of Year 3 Term 1 (or equivalent 114 UOC) in the Bachelor of Education (Primary) (Honours) will transfer to the Bachelor of Education (Primary) (4072)."
      ]
    },
    "G2": {
      "result": "PASS",
