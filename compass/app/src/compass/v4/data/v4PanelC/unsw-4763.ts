...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Power and Powerlessness (ARTS2871)",
      "Subject: Criminology: An Introduction (CRIM1010)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Introduction to Criminal Justice (CRIM1011)",
      "Subject: Issues in Policing (CRIM2014)",
      "**CRICOS Code**: 059028A"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4763",
      "Subject: Criminal Law and Justice 1 (CRIM2020)",
      "- **Total Units / Units of Credit (UOC)**: 240"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Criminology & Criminal Justice / Law.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 240",
