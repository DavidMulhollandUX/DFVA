...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Numerical Methods in Computational Science (COSC2500)",
      "Subject: Visualization, Computer Graphics & Data Analysis (COSC3000)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2500",
      "Subject: High-Performance Computing (COSC3500)",
      "- **AQF Level**: Refer to your component degrees for AQF level."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelors of Mathematics / Business Management.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelors of Mathematics / Business Management a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
