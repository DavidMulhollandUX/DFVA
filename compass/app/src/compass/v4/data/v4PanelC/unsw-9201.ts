...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Biodiversity and Conservation of Natural Resources (BIOS6671)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Climate Change Adaptation & Development (COMD5004)",
      "Subject: Social and Environmental Sustainability (COMM5202)",
      "**CRICOS Code**: 000733G"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/9201",
      "Subject: Corporate Responsibility and Accountability (COMM5709)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "W3": {
