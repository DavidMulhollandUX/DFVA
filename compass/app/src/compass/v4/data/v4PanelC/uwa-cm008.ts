...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Animal Diversity (ANIM2220)",
      "Subject: Frontiers in Biology (BIOL1130)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CM008"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Environmental Science and Master of Environmental Science.",
      "evidenceLines": [
        "Students completing this double packaged award course will graduate with both a Bachelor of  Environmental Science majoring in Environmental Science and Management or Environmental Science and Ecology, and a Master of Environmental Science.",
