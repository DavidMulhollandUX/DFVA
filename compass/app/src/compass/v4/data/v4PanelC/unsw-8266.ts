...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Neuropsychology Professional and Ethical Practice 1 (NPEP1) (PSYC7237)",
      "Subject: Neuropsychology Professional and Ethical Practice 2 (NPEP2) (PSYC7238)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Neuropsychology Professional and Ethical Practice 3 (NPEP3) (PSYC7239)",
      "Subject: Clinical Neuropsychology 1: Disruptions (PSYC7240)",
      "**CRICOS Code**: 114034J"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8266",
      "Subject: Clinical Neuropsychology 2: Lifespan (PSYC7241)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Clinical Neuropsychology.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 48",
