...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Sustainable Energy Technologies and Supply Systems (ENGY7000)",
      "Subject: Net Zero Pathways for Business (ENGY7001)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Energy and Development (ENGY7002)",
      "Subject: Energy Transitions in Industrial Processes (ENGY7003)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5683",
      "Subject: Energy Investment and Finance (ENGY7004)",
      "- **Faculty**: of Engineering, Architecture and Information Technology"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Sustainable Energy.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Diploma in Sustainable Energy a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
