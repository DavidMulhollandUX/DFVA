...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: bhmsa_bhlthmsca",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Physical Activity and Health (HLTH1003)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/bhmsa_bhlthmsca"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Fitness and Lifestyle Management (HLTH1004)",
      "Subject: Medical Radiation Human Anatomy (HLTH1006)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Case Study: 25%% (Hurdle: False)",
      "Subject: Societal Issues in Clinical Exercise Physiology (HLTH2007)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "The Bachelor of Health and Medical Sciences (Advanced) is an AQF Level 7 qualification with a standard full-time duration of 3 years.",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "gates": {
