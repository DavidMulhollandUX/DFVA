...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Engineering Practice 3 (GENG3000)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=BH011"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Engineering Research Project Part 1 (GENG4411)",
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "website for details on admission requirements, intake periods, fees, availability to international students, careers information etc.",
        "achieved an ATAR of at least 80, or equivalent as recognised by UWA; and meet the additional requirements stated at (2) below"
      ]
    },
    "G2": {
      "result": "PASS",
