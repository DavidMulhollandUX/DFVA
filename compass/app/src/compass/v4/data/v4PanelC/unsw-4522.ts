...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4522",
      "Subject: ADA Professional Placement (FADA6700)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Construction Management and Property.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 48",
