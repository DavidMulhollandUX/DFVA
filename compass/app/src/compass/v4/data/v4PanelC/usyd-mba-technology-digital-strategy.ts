...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: mba-technology-digital-strategy",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Leading Strategic Digital Transformation (DMBA6001)",
      "Subject: Emerging Technology, Disruption and Foresight (DMBA6002)",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/business-school-pg/coursework/mba-technology-digital-strategy.html"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Go-to-market: Customer Strategy and Execution (DMBA6003)",
      "Subject: Digital Collaboration, Work and Organisation (DMBA6004)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Critically evaluate foundational principles, evidence bases, and contemporary methodologies in emerging technology, disruption and foresight.",
      "Subject: Agile Project Development (DMBA6005)",
      "- **Faculty**: business-school-pg"
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of the Master of Business Administration (Technology and Digital Strategy), a candidate must complete 72 credit points of units of study, comprising:",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "gates": {
