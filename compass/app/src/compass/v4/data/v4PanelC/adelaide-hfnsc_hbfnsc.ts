...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: hfnsc_hbfnsc",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Introduction to Health Ethics (HLTH1001)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/hfnsc_hbfnsc"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Food and Nutrition Science.",
      "evidenceLines": [
        "The Bachelor of Food and Nutrition Science (Honours) [4 years] is an AQF Level 8 program with a standard full-time duration of 4 years.",
