...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Theoretical Studies in Translation and Interpreting (TRIN7110)",
      "Subject: Professional Skills for Translators and Interpreters (TRIN7120)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Interpreting Skills and Practice (TRIN7130)",
      "Subject: Translation in a Globalised Marketplace (TRIN7140)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5751",
      "Subject: Translation in Business Settings (TRIN7210)",
      "- **Faculty**: of Humanities and Social Sciences"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Arts in Translation and Interpreting.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Diploma in Arts in Translation and Interpreting a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
