...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Research Design (BENV7020)",
  ...
  "C4": {
    ...
    "evidenceLines": [
      "**Total Units / Units of Credit (UOC)**: 108",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Management of Construction Organisations (CONS0002)",
      "Subject: Construction Informatics (CONS0005)",
      "**CRICOS Code**: 102395E"
    ]
  },
  "W1": {
    ...
    "evidenceLines": [
      "**Academic Organisation**: Faculty of Arts, Design and Architecture",
      "- **Institution**: University of New South Wales (UNSW Sydney)",
      "- **Study Level**: Postgraduate"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8318",
      "Subject: Construction Planning and Control (CONS0009)",
      "- **Total Units / Units of Credit (UOC)**: 108"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Construction Project Management / Property and Development.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 108",
        "The program is offered over a minimum of six terms, leading to the award of the degree of Master of Construction Project Management and Master of Property Development."
      ]
    },
    "G2": {
      "result": "PASS",
