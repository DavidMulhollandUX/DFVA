...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Contemporary Australia (AUST1000)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2529",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelors of Human Movement and Nutrition Sciences / Journalism.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelors of Human Movement and Nutrition Sciences / Journalism a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
