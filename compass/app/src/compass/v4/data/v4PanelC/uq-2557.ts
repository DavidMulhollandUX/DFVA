...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Functional and Logic Programming (COMP3400)",
      "Subject: Algorithms and Data Structures (COMP3506)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Artificial Intelligence (COMP3702)",
      "Subject: Pattern Recognition and Analysis (COMP3710)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2557",
      "Subject: Natural Language Processing (COMP4703)",
      "- **AQF Level**: Refer to your component degrees for AQF level."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Mathematics / Master of Data Science.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Mathematics / Master of Data Science a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
