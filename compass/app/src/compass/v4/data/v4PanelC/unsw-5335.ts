...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Financial Literacy for Business Decisions (ACCT5906)",
      "Subject: Engineering Postgraduate Coursework Research Skills (GSOE9010)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Engineering Postgraduate Coursework Research Skills (GSOE9011)",
      "Subject: Launching a Startup (GSOE9220)",
      "**CRICOS Code**: 084281B"
    ]
  },
  "W1": {
    ...
    "evidenceLines": [
      "**Academic Organisation**: School of Minerals & Energy Resources Engineering",
      "- **Institution**: University of New South Wales (UNSW Sydney)",
      "- **Study Level**: Postgraduate"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/5335",
      "Subject: Data Analytics and Automated Technologies for Minerals and Energy Resources (MERE8810)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Mining Engineering.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 48",
        "The Graduate Diploma in Mining Engineering will be awarded after successful completion of 48 Units of Credit (UOC). The program can be undertaken either full-time or part-time, providing flexibility to accommodate the schedules of working professionals. Most courses are delivered in a modular format, either face-to-face or online, in intensive block periods. This delivery mode is particularly well-suited for employees of mining companies and associated service providers, allowing them to balance their studies with their work commitments."
      ]
    },
    "G2": {
      "result": "PASS",
