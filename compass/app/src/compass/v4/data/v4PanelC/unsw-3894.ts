...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Human Biochemistry of Health and Disease (BIOC3261)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/3894",
      "Subject: Introduction to Dietetics and Food Innovation  (DIET1001)",
      "- **Total Units / Units of Credit (UOC)**: 240"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Nutrition / Dietetics and Food Innovation.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 240",
        "Award on Completion"
      ]
