...
const record: V4PanelC = {
  ...
  "C2": {
    ...
    "evidenceLines": [
      ...
      "Designed and delivered in consultation with industry leaders, our Master's equips you to meet contemporary manufacturing challenges using revolutionary technologies like artificial intelligence, robotics and machine learning."
    ]
  },
  "C3": {
    "score": 3,
    ...
    "evidenceLines": [
      "Subject: MECHANICS OF COMPOSITE MATERIALS (CIV5MCM)",
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "You'll gain proficiency in system design, materials processing and sustainable engineering while enhancing your employability with enterprise skills in consultation, negotiation, risk and project management."
    ]
  },
  "C5": {
    "score": 2,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Master of Manufacturing Engineering, students must complete 240 credit points consisting of:",
      "Get the right mix of engineering know-how and business acumen to drive innovation across industries with La Trobe’s accredited Master of Manufacturing Engineering."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Manufacturing Engineering.",
      "evidenceLines": [
        "To qualify for the award of Master of Manufacturing Engineering, students must complete 240 credit points consisting of:",
