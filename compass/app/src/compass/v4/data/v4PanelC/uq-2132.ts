...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: ECON6101 - Microeconomics for Honours",
      "Subject: ECON6102 - Macroeconomics for Honours",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: ECON6103 - Econometrics for Honours",
      "Subject: ECON6201 - Honours Research Thesis",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: ECON6101 - Microeconomics for Honours",
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2132",
      "- **Duration**: Not specified"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Economics (Honours).",
      "evidenceLines": [
        "- **Institution**: The University of Queensland (UQ)",
        "- **Duration**: Not specified"
      ]
