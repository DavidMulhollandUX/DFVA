...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      ...
      "Subject: Cyber Defence: Network Security Operations (ZEIT8026)",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "**Academic Organisation**: UC School of Humanities and Social Sciences",
      "- **Institution**: University of New South Wales (UNSW Sydney)",
      "- **Study Level**: Postgraduate"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7331",
      "Subject: Information Assurance Principles (ZEIT8032)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Cyber Security, Strategy and Diplomacy.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
