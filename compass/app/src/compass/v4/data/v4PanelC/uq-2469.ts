...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Introductory Macroeconomics (ECON1020)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Tools of Economic Analysis (ECON1050)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2469",
      "Subject: Intermediate Microeconomics (ECON2010)",
      "- **AQF Level**: Refer to your component degrees for AQF level."
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelors of Economics / Laws.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelors of Economics / Laws (Honours) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
