...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: arts-laws",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
    ...
    "evidenceLines": [
      "**Academic Year**: 2026",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/arts/coursework/arts-laws.html",
      "- **Course / Program Identifier**: arts-laws"
    ]
  },
  "C3": {
    ...
    "evidenceLines": [
      "Subject: MECO1001 - Introduction to Media Studies",
      "Subject: MECO1002 - Media 4.0: Work and Policy",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: MECO2601 - Media Production: Radio and Podcasting",
      "Subject: MECO2603 - Public Relations",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: MECO2605 - Media, Law and Ethics",
      "Online test See assessment details on MECO 1001 Canvas site for further information: 30%: Formal exam period%",
      "- **Faculty**: arts"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Arts and Bachelor of Laws.",
      "evidenceLines": [
        "- **Institution**: The University of Sydney (USYD)",
        "- **Faculty**: arts"
      ]
