...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CM013"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Decisions from Data in  Agriculture (AGRI3003)",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Agricultural Science and  Master of Agricultural Science.",
      "evidenceLines": [
        "website for details on admission requirements, intake periods, fees, availability to international students, careers information etc.",
        "achieved an ATAR of at least 90, or equivalent as recognised by UWA; and meet the additional requirements stated at (2) below"
      ]
    },
    "G2": {
      "result": "PASS",
