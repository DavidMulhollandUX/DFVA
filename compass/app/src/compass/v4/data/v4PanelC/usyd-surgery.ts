...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: surgery",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: SURG5100 - Surgical Professionalism and Leadership",
      "Subject: CEPI5100 - Introduction to Clinical Epidemiology",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/medicine-health-pg/coursework/surgery.html"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: FMHU5002 - Introductory Biostatistics",
      "Subject: SURG5035 - Surgical Research and Evaluation",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "Discussions Boards 5 x Online discussion boards: 20%: Multiple weeks%",
      "- **Institution**: The University of Sydney (USYD)",
      "- **Course / Program Identifier**: surgery"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "Subject: SURG5027 - Head and Neck by Dissection",
      "Workshop Full day online workshop: 0%: Week 05 Due date : 29 Mar 2026 at 23:59%",
      "- **Faculty**: medicine-health-pg"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Surgery.",
      "evidenceLines": [
        "- **Institution**: The University of Sydney (USYD)",
        "- **Faculty**: medicine-health-pg"
      ]
