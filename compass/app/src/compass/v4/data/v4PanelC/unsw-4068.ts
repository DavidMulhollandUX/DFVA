...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Learning and Teaching: Language, Literacy and Numeracy (EDST1003)",
      "Subject: Educational Psychology (EDST1101)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Social Perspectives in Education (EDST1104)",
      "Subject: Professional Engagement (EDST2002)",
      "**CRICOS Code**: 110687D"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4068",
      "Subject: Indigenous Perspectives in Education (EDST2009)",
      "- **Total Units / Units of Credit (UOC)**: 192"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Fine Arts / Education.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 192",
        "The double degree, Bachelor of Fine Arts Bachelor of Education (Secondary) (BFA BEd) is a four-year program (192 UOC) for intending secondary school teachers. The program is a nationally accredited pre-service qualification."
      ]
    },
    "G2": {
      "result": "PASS",
