...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: hhmsc_hbhlthmeds",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Honours Foundation Research Skills (HLTH4005)",
      "Subject: Honours Biomedicine Research Project Part A (HLTH1033)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/hhmsc_hbhlthmeds"
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      "Formulate a research question for investigation",
      "Develop a search strategy relevant to a research question",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Honours Biomedicine Research Project Part A (HLTH4020)",
      "Subject: Honours Biomedicine Research Project Part B (HLTH1034)",
      "Write a research proposal applying the key elements of research design"
    ]
  },
  "W1": {
    "score": 3,
    ...
    "evidenceLines": [
      "Demonstrate principles of best practice in professional and ethical standards in health and medical research",
      "- **Institution**: The University of Adelaide",
      "- **Program Identifier / Slug**: hhmsc_hbhlthmeds"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "Multiple Choice Questions: 0%% (Hurdle: False)",
      "Subject: Honours Biomedicine Research Project Part B (HLTH4021)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Health and Medical Sciences.",
      "evidenceLines": [
        "The Bachelor of Health and Medical Sciences (Honours) is an AQF Level 8 qualification with a standard full-time duration of 1 year.",
