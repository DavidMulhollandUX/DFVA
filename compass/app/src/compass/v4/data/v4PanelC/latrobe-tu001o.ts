...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "If you're interested in building your digital skillset or taking the first step towards a career at the digital frontlines, La Trobe's Undergraduate Certificate in Cybersecurity provides you with the foundational knowledge to upskill or pursue a new career in the emerging area of cybersecurity."
    ]
  },
  "C2": {
    "score": 3,
    ...
    "evidenceLines": [
      ...
      "You'll develop the foundational knowledge in the areas of cybersecurity, coding and programming, ethical hacking, cryptography and computer networks."
    ]
  },
  "C3": {
    "score": 3,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "Gain an introduction into common technologies used to identify and mitigate threats including firewalls, intrusion detection systems, intrusion protection systems and honeypots."
    ]
  },
  "C5": {
    "score": 3,
    ...
    "evidenceLines": [
      ...
      "Subject: HUMAN FACTORS IN CYBERSECURITY (CSE2HUM)",
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Undergraduate Certificate in Cybersecurity, students must complete 60 credit points consisting of:",
      "If you're interested in building your digital skillset or taking the first step towards a career at the digital frontlines, La Trobe's Undergraduate Certificate in Cybersecurity provides you with the foundational knowledge to upskill or pursue a new career in the emerging area of cybersecurity."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Undergraduate Certificate in Cybersecurity.",
      "evidenceLines": [
        "To qualify for the award of Undergraduate Certificate in Cybersecurity, students must complete 60 credit points consisting of:",
