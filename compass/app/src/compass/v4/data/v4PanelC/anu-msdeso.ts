...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Negotiation and Conflict Resolution (DIPL8044)",
      "Subject: Introduction to Systems Engineering (ENGN8100)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Changing Geopolitics and International Relations in the Pacific (INTR8043)",
      "Subject: China's Global Engagement (INTR8060)",
      "**Post Nominal**: Nominal MStratDefSt"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Principles of International Law (LAWS8182)",
      "- **Career / Study Level**: Postgraduate"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Strategic and Defence Studies.",
      "evidenceLines": [
        "- **Program Duration**: 1.5 year full-time",
        "- **Minimum Units Required**: 72 Units"
      ]
