...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Literature Review (Honours) (ZBUS4001)",
      "Subject: Research Methods (Honours) (ZBUS4002)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Business Research 1 (Honours) (ZBUS4101)",
      "Subject: Business Research 2 (Honours) (ZBUS4102)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4512",
      "Subject: Business Research 2 (Honours) (ZBUS4102)",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
