...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: TRANSFORMING LIVES THROUGH CARE (ANT1TLC)",
      "Subject: SUSTAINABILITY, RESILIENCE, AND COLLAPSE: FROM PAST SOCIETIES TO THE END OF CIVILISATION (ARC2SRC)",
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Associate Degree in Urban and Regional Environments, students must complete a total 240 credit points consisting of:",
      "La Trobe’s Associate Degree in Urban and Regional Environments gives you a foothold in the vital area of community and environmental planning and development."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Associate Degree in Urban and Regional Environments.",
      "evidenceLines": [
        "To qualify for the award of Associate Degree in Urban and Regional Environments, students must complete a total 240 credit points consisting of:",
