...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: commerce-science",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Accounting for Decision Making (BUSS1030)",
      "Subject: Accounting for Decision Making (BUSS1030)",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/business-school/coursework/commerce-science.html"
    ]
  },
  "C4": {
    "score": 3,
    ...
    "evidenceLines": [
      "Critically evaluate foundational principles, evidence bases, and contemporary methodologies in accounting for decision making.",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Commerce and Bachelor of Science.",
      "evidenceLines": [
        "Commerce degree core",
        "Commerce degree core"
      ]
