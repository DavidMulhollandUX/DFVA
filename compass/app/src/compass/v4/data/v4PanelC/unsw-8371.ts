...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: ESG Reporting and Enterprise Value Creation (ACCT5925)",
      "Subject: Financial Accounting (ACCT5930)",
      "**CRICOS Code**: 078546K"
    ]
  },
  "W1": {
    ...
    "evidenceLines": [
      "**Academic Organisation**: School of Management and Governance",
      "- **Institution**: University of New South Wales (UNSW Sydney)",
      "- **Study Level**: Postgraduate"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8371",
      "Subject: NGOs, Civil Society and Development (COMD5000)",
      "- **Total Units / Units of Credit (UOC)**: 96"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in International Business.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 96",
