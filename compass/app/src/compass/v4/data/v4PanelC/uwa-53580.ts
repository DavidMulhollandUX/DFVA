...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Research Methods in Applied Settings (PSYC5513)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=53580"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Assessment and Selection (PSYC5514)",
      "Subject: Organisational Development and Change (PSYC5515)",
      "**Academic Year**: 2026"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=53580",
      "Subject: MIOP Practical Placement 3 (PSYC5517)",
      "- **Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=53580"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Industrial and Organisational Psychology.",
      "evidenceLines": [
        "Industrial and Organisational Psychology is a specialist area that applies psychological knowledge and skills to workplaces with the aim of improving organisational effectiveness and the quality of work life. This two-year course includes nine coursework units, a research project, and 1000 hours of practical placement spread over three different settings.",
