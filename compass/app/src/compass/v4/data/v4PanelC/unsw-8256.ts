...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Psychological Assessment (PSYC7001)",
      "Subject: Adult and Child Clinical Psychology 2 (PSYC7204)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Clinical Neuropsychology (PSYC7210)",
      "Subject: Adult and Child Clinical Psychology 1 (PSYC7212)",
      "**CRICOS Code**: 001934A"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8256",
      "Subject: Psychology of Health and Illness (PSYC7220)",
      "- **Total Units / Units of Credit (UOC)**: 96"
    ]
  },
  "W3": {
