...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Algebraic Methods of Mathematical Physics (MATH7133)",
      "Subject: Computational Physics I (PHYS3071)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5711",
      "Subject: Condensed Matter Physics (PHYS4030)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Quantum Technology.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Quantum Technology a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
