...
const record: V4PanelC = {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3890",
      "Subject: Evolutionary and Functional Biology (BIOS1101)",
      "- **Total Units / Units of Credit (UOC)**: 144"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Applied Exercise Science.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 144",
