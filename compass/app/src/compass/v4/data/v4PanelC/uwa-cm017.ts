...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=CM017"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of  Sport and Exercise Sciences  and Master of Public Health.",
      "evidenceLines": [
        "Students completing this double packaged award course will graduate with both a Bachelor of Sport and Exercise Sciences majoring in Sport Science, Exercise and Health, and a Master of Public Health.",
