...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Teaching Foundations (EDHE6001)",
      "Subject: Teaching in Practice (EDHE6003)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Leading Teaching Project (EDHE6004)",
      "Subject: Teaching Foundations (EDHE6001)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5775",
      "Subject: Leading Teaching Project (EDHE6004)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in University Teaching Practice.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Certificate in University Teaching Practice a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
