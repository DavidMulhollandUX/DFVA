...
const record: V4PanelC = {
  ...
  "C4": {
    ...
    "evidenceLines": [
      "**Total Units / Units of Credit (UOC)**: 372",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "**Academic Organisation**: Faculty of Medicine and Health",
      "- **Institution**: University of New South Wales (UNSW Sydney)",
      "- **Study Level**: Undergraduate"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3856",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Medicine / Arts.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 372",
        "Students must complete 372 Units of Credit (UOC) structured across the following academic components:"
      ]
    },
    "G2": {
      "result": "PASS",
