...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Rehabilitation Engineering and Assistive Technology (BIOM9551)",
      "Subject: Research Skills in Vision Science (OPTM7208)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Health Promotion and Social Perspectives of Health (PHCM9012)",
      "Subject: Ethics and Law in Public Health (PHCM9331)",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "**Academic Organisation**: School of Optometry and Vision Science",
      "- **Institution**: University of New South Wales (UNSW Sydney)",
      "- **Study Level**: Postgraduate"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7431",
      "Subject: The Visual System, Impairments and Implications (VISN5511)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Vision Impairment.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
