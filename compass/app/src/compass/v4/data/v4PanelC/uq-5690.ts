...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Business Industry Placement (RBUS7999)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5690",
      "Subject: Business Industry Placement (RBUS7999)",
      "- **Faculty**: The University of Queensland"
    ]
  },
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Entrepreneurship and Innovation.",
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Entrepreneurship and Innovation a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
