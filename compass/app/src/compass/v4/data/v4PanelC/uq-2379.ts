...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Functional Neuroanatomy (ANAT3022)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: The New Psychology of Health (HLTH3132)",
      "Subject: Music, Cognition & Development (MUSC3340)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=2379",
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Bachelor of Psychological Science (Honours) a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
