...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gdmen_gdmaren",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Principles of Submarine Design (ENGIX501)",
      "Subject: Introduction to Submarine Design (ENGM5006)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gdmen_gdmaren"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Submarine Design and Construction (ENGI5015)",
      "Subject: Submarine Design (ENGI5035)",
      "Explain the various balances to reach in order to prepare for seaworthiness demonstration"
    ]
  },
  "W1": {
    "score": 2,
    ...
    "evidenceLines": [
      "Compare design options and trade-offs to help achieve top level performances on submarines for resistance and energy/propulsion",
      "- **Institution**: The University of Adelaide",
      "- **Program Identifier / Slug**: gdmen_gdmaren"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      ...
      "Subject: Systems Engineering 1 (ENGM5005)",
      "- **Academic Calendar Year**: 2025/2026"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Diploma in Maritime Engineering.",
      "evidenceLines": [
        "The Graduate Diploma in Maritime Engineering is an AQF Level 8 qualification with a standard full-time duration of 1 year.",
