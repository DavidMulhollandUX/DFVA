...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: education-leadership-aboriginal-education",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
    ...
    "evidenceLines": [
      "**Academic Year**: 2026",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/arts-pg/coursework-areas/education-leadership-aboriginal-education.html",
      "- **Course / Program Identifier**: education-leadership-aboriginal-education"
    ]
  },
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Effective Leadership and Change (EDPA5011)",
      "Subject: Leadership: International Perspectives (EDPA6015)",
      "Critically evaluate foundational principles, evidence bases, and contemporary methodologies in effective leadership and change."
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Globalisation and Education (EDPB5002)",
      "Subject: Global Education and Equity (EDPB5016)",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "Critically evaluate foundational principles, evidence bases, and contemporary methodologies in leadership: international perspectives.",
      "- **Institution**: The University of Sydney (USYD)",
      "- **Course / Program Identifier**: education-leadership-aboriginal-education"
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "Synthesise disciplinary knowledge to resolve complex real-world challenges.",
      "Subject: Students with Disability (EDPD5001)",
      "- **Handbook URL**: https://www.sydney.edu.au/handbooks/arts-pg/coursework-areas/education-leadership-aboriginal-education.html"
    ]
  },
  "W3": {
