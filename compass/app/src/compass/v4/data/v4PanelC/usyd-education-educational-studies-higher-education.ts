...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Course / Program Identifier**: education-educational-studies-higher-education",
      "- **Institution**: The University of Sydney (USYD)"
    ]
  },
  "C2": {
    ...
    "evidenceLines": [
      "**Academic Year**: 2026",
      "**Handbook URL**: https://www.sydney.edu.au/handbooks/arts-pg/coursework-areas/education-educational-studies-higher-education.html",
      "- **Course / Program Identifier**: education-educational-studies-higher-education"
    ]
  },
  "C3": {
    ...
    "evidenceLines": [
      "Subject: University Teaching and Learning (EDPR5001)",
      "Subject: Reflection and Practice in University T and L (EDPR5002)",
      "Critically evaluate foundational principles, evidence bases, and contemporary methodologies in university teaching and learning."
    ]
  },
  "C4": {
    "score": 3,
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: University Teaching Portfolios (EDPR5003)",
      "Subject: Developing Integ eLearning Env Higher Ed (EDPR6012)",
  ...
  "W1": {
    ...
    "evidenceLines": [
      "Critically evaluate foundational principles, evidence bases, and contemporary methodologies in reflection and practice in university t and l.",
      "- **Institution**: The University of Sydney (USYD)",
      "- **Course / Program Identifier**: education-educational-studies-higher-education"
    ]
  },
