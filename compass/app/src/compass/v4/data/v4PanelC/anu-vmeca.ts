...
const record: V4PanelC = {
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Program Duration**: 2 year full-time",
        "A single two year graduate award offered by theANU College of Arts and Social Sciences"
      ]
    },
    "G2": {
      "result": "PASS",
