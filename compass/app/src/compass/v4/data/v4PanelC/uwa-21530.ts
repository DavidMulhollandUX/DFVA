...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Intersections of Law, Policy and Governance (LAWS5260)",
      "Subject: The Politics of Public Policy (POLS5501)",
      "**Handbook URL**: https://www.handbooks.uwa.edu.au/coursedetails?code=21530"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Master of Law, Policy and Government.",
      "evidenceLines": [
        "website for details on admission requirements, intake periods, fees, availability to international students, careers information etc.",
