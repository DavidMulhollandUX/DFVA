...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Representations of War (ZHSS8105)",
      "**AQF Level**: Level 9"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: War and Memory (ZHSS8106)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/8571",
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in War Studies.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 48",
