...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "With our flexible Bachelor of Arts, you can choose from an incredible array of majors and minors."
    ]
  },
  "C2": {
    "score": 2,
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the Bachelor of Arts students must complete 360 credit points of study that includes:",
      "With our flexible Bachelor of Arts, you can choose from an incredible array of majors and minors."
    ]
  },
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "To qualify for the Bachelor of Arts students must complete 360 credit points of study that includes:",
        "* Your remaining 240 credit points (usually 16 x 15 credit point subjects) can be completed in a number of ways, for example:"
      ]
    },
    "G2": {
      "result": "PASS",
