...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "If you're passionate about making a difference to the wellbeing of others, La Trobe's Undergraduate Certificate provides you with the foundational knowledge to upskill or pursue a new career in health sciences."
    ]
  },
  "C2": {
    "score": 3,
    ...
    "evidenceLines": [
      ...
      "Our health sciences curriculum is uniquely aligned with industry trends, focusing on real-world and data-driven health solutions to equip students with the in-demand skills in today’s evolving health sector."
    ]
  },
  "C3": {
    "score": 2,
  ...
  "C4": {
    ...
    "evidenceLines": [
      ...
      "You'll develop the foundational knowledge in the health sciences and the interdisciplinary skills to prepare you for future studies and employment in the field of health sciences."
    ]
  },
  "C5": {
    "score": 2,
    ...
    "evidenceLines": [
      "Subject: HUMAN STRUCTURE AND FUNCTION (PAM1HSF)",
      "Subject: UNDERSTANDING HEALTH AND WELLBEING (PHE1UHW)",
      "Describe your desired career path, as well as the skills and attributes that employers are seeking in graduates, and reflect on your career planning"
    ]
  },
  "W1": {
    "score": 3,
    ...
    "evidenceLines": [
      "Relate the anatomical organisation of selected systems of the body to their physiological function",
      "If you're passionate about making a difference to the wellbeing of others, La Trobe's Undergraduate Certificate provides you with the foundational knowledge to upskill or pursue a new career in health sciences.",
      "Our health sciences curriculum is uniquely aligned with industry trends, focusing on real-world and data-driven health solutions to equip students with the in-demand skills in today’s evolving health sector."
    ]
  },
  "W2": {
    ...
    "evidenceLines": [
      "Work collaboratively to communicate basic physiological and anatomical principles to your peers",
      "Subject: MAKING SENSE OF DATA (STM1001)",
      "You'll develop the foundational knowledge in the health sciences and the interdisciplinary skills to prepare you for future studies and employment in the field of health sciences."
    ]
  },
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the Undergraduate Certificate in Health Sciences, students must complete 60 credit points consisting of:",
      "If you're passionate about making a difference to the wellbeing of others, La Trobe's Undergraduate Certificate provides you with the foundational knowledge to upskill or pursue a new career in health sciences."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Undergraduate Certificate in Health Sciences.",
      "evidenceLines": [
        "To qualify for the Undergraduate Certificate in Health Sciences, students must complete 60 credit points consisting of:",
