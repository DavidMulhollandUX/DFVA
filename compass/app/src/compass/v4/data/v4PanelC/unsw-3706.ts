...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: ENGG4060 - Student Initiated Project",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: CHEM3031 - Inorganic Chemistry: Transition Metals and Complexes",
      "Subject: DESN2000 - Engineering Design and Professional Practice",
      "**CRICOS Code**: 067602J"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: CHEM1811 - Engineering Chemistry 1A",
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/3706",
      "- **Total Units / Units of Credit (UOC)**: 144"
    ]
  },
  "W3": {
