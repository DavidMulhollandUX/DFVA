...
const record: V4PanelC = {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Framing Questions about Cybernetic Systems (CYBN6001)",
      "Subject: Framing Questions about Cybernetic Systems (CYBN6001)",
      "**Post Nominal**: Nominal GCertAppCy"
    ]
  },
  "W1": {
    "score": 2,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate of Applied Cybernetics.",
      "evidenceLines": [
        "- **Program Duration**: 0.5 years",
        "- **Minimum Units Required**: 24 Units"
      ]
