...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      ...
      "Subject: Operations Delivery and Transformation (BISM7807)",
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: Digitalising Business (BISM7808)",
      "Subject: Business Economics (ECON7012)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5770",
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Master of Business Administration a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
