...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: ECON4350 - Special Topics in Economics",
      "Subject: ECON4303 - Labour Economics",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: ECON3202 - Mathematical Economics",
      "Subject: ECON2101 - Microeconomics 2",
      "**CRICOS Code**: 080466C"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "Subject: ECON3123 - Organisational Economics",
      "**Handbook URL**: https://handbook.unsw.edu.au/undergraduate/programs/2026/4501",
      "- **Total Units / Units of Credit (UOC)**: 48"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Commerce (Honours).",
      "evidenceLines": [
        "- **Institution**: University of New South Wales (UNSW Sydney)",
        "- **Total Units / Units of Credit (UOC)**: 48"
      ]
