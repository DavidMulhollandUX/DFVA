...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Communication Skills for Creative Disciplines (ADAD9113)",
      "Subject: Designing the Experience: Exhibitions and Beyond (ADAD9311)",
      "**AQF Level**: Level 8"
    ]
  },
  "C4": {
  ...
  "C5": {
    ...
    "evidenceLines": [
      "Subject: World Biennales: Field Trip (SAHT6700)",
      "Subject: Audience Engagement (SAHT9122)",
      "**CRICOS Code**: 082203K"
    ]
  },
  "W1": {
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://handbook.unsw.edu.au/postgraduate/programs/2026/7318",
      "Subject: Visual and Museum Cultures of the Asia Pacific (SAHT9131)",
      "- **Total Units / Units of Credit (UOC)**: 24"
    ]
  },
  "W3": {
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Cultural Leadership.",
      "evidenceLines": [
        "- **Total Units / Units of Credit (UOC)**: 24",
