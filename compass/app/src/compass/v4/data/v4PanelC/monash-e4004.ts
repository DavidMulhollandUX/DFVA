...
const record: V4PanelC = {
  ...
  "W3": {
    ...
    "evidenceLines": [
      "The course comprises 24 credit points: Part A: Core studies (6 credit points) and Part B: Elective studies (18 credit points)",
      "Address the challenges in palm oil industries and formulate sustainable approaches to promote sustainability."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Postgraduate Certificate of Applied Engineering.",
      "evidenceLines": [
        "The course comprises 24 credit points: Part A: Core studies (6 credit points) and Part B: Elective studies (18 credit points)",
