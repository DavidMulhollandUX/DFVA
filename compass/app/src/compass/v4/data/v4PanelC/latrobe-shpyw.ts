...
const record: V4PanelC = {
  ...
  "W3": {
    ...
    "evidenceLines": [
      "To qualify for the award of Bachelor of Psychology (Honours), students must complete 480 credit points consisting of:",
      "Understand the human mind and how it drives behaviour."
    ]
  },
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Bachelor of Psychology (Honours) - Albury.",
      "evidenceLines": [
        "To qualify for the award of Bachelor of Psychology (Honours), students must complete 480 credit points consisting of:",
