...
const record: V4PanelC = {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Writing Politics (POLS7000)",
      "Subject: Foundations in Politics, Policy and International Relations (POLS7002)",
  ...
  "W2": {
    ...
    "evidenceLines": [
      "**Handbook URL**: https://my.uq.edu.au/programs-courses/program.html?acad_prog=5643",
  ...
  "gates": {
    "G1": {
      ...
      "evidenceLines": [
        "- **Duration**: Not specified",
        "To graduate with a Graduate Certificate in International Relations a student must have successfully completed all requirements of the program as"
      ]
    },
    "G2": {
      "result": "PASS",
