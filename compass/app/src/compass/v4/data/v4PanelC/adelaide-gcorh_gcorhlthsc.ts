...
const record: V4PanelC = {
  ...
  "C1": {
    ...
    "evidenceLines": [
      ...
      "**Program Identifier / Slug**: gcorh_gcorhlthsc",
      "- **Institution**: The University of Adelaide"
    ]
  },
  "C2": {
  ...
  "C3": {
    ...
    "evidenceLines": [
      "Subject: Dental and Health Science (Adult Therapy) IV OH (DENT5003)",
      "Subject: Clinical Practice (Adult Therapy) IV OH (DENT5002)",
      "**Handbook / Calendar URL**: https://calendar.adelaide.edu.au/aprcw/2025/gcorh_gcorhlthsc"
    ]
  },
  "C4": {
    "score": 3,
  ...
  "gates": {
    "G1": {
      "result": "PASS",
      "rationale": "Postgraduate or undergraduate degree delivering comprehensive education in Graduate Certificate in Oral Health Science.",
      "evidenceLines": [
        "The Graduate Certificate in Oral Health Science is an AQF Level 8 qualification with a standard full-time duration of 0.5 years.",
