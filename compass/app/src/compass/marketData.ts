...
export const MARKET_DATA: Record<string, MarketFieldData> = {
  engineering: {
    ...
    sources: [
      ...
      "QILT GOS 2024 International Report Tables",
      "JSA Skills Priority List 2025",
      "Felten, Raj & Seamans (2021) AI Occupational Exposure Index",
    ],
    year: 2024,
  },
  it: {
    ...
    internationalEmploymentRate: 0.49,
  ...
  health: {
    ...
    internationalEmploymentRate: 0.56,
  ...
  science: {
    ...
    internationalEmploymentRate: 0.48,
...
export function getFieldForCourse(courseCode: string): string {
  ...
  const map: Record<string, string> = {
    ...
    "mc-scicmp": "it",
    "mc-is": "it",
    "mc-indeng": "engineering",
    "746st": "engineering",
    "mc-eng": "engineering",
    "mc-engbiom": "engineering",
    "mc-engchem": "engineering",
    "mc-engcivil": "engineering",
    "mc-engelec": "engineering",
    "mc-engmech": "engineering",
    "mc-engmtrl": "engineering",
    "mc-engsoft": "engineering",
    "mc-engstruct": "engineering",
    "mc-propsyc": "health",
    "527cl": "health",
    "mc-phtyph": "health",
    "mc-surged": "health",
    ...
    "mc-ba": "business",
    "mc-intlbiz": "business",
    "mc-supplychain": "business",
    "mc-hrm": "business",
    "mc-entre": "business",
    "mc-busana": "business",
    "mc-mgt": "business",
    // Actuarial programs sit in Management and Commerce (JSA HEO broad 08, banking
    // and finance), not the broad natural-and-physical-sciences pool.
    "mc-actscfin": "business",
    "mc-actsc": "business",
    ...
    "mc-prop": "business",
    "mc-scwr": "creative_arts",
    "mc-film": "creative_arts",
    "mc-finearts": "creative_arts",
    "mc-curating": "creative_arts",
    "mc-music": "creative_arts",
    "mc-musiced": "creative_arts",
    "mc-musicperf": "creative_arts",
    "mc-musictherapy": "creative_arts",
    "mc-intedib": "education",
    "mc-teachprim": "education",
    "mc-teachsec": "education",
    "mc-ed": "education",
    "mc-edlead": "education",
    "mc-tesol": "education",
    "mc-comlaw": "law",
    ...
    "mc-agr": "agriculture",
    "mc-food": "agriculture",
    "mc-forest": "agriculture",
    "mc-agribus": "agriculture",
    "mc-animsci": "agriculture",
    "439fs": "science",
    "b-des": "architecture",
    "mc-appliedling": "education",
    "mc-creativewrit": "creative_arts",
    "mc-crim": "law",
    "mc-devstud": "other",
    "mc-journ": "creative_arts",
    "mc-intlrel": "other",
    "mc-pubpol": "other",
    "mc-socpol": "other",
  };
...
export function scoreOutcomeEvidence(field: string): number {
  ...
  if (d.employmentRate > 0.8) score += 1;
  if (d.employmentRate3yr > 0.9) score += 1;
